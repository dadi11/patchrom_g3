...
public abstract class AbstractAccountAuthenticator {
    ...
    class C00031 implements Runnable {
        ...
        C00031(AccountAuthenticatorResponse accountAuthenticatorResponse) {
    ...
    class C00042 implements Runnable {
        ...
        C00042(AccountAuthenticatorResponse accountAuthenticatorResponse) {
            this.val$response = accountAuthenticatorResponse;
        }
    ...
    public Bundle getAccountCredentialsForCloning(AccountAuthenticatorResponse response, Account account) throws NetworkErrorException {
        new Thread(new C00031(response)).start();
        return null;
    }
    ...
    public Bundle addAccountFromCredentials(AccountAuthenticatorResponse response, Account account, Bundle accountCredentials) throws NetworkErrorException {
        new Thread(new C00042(response)).start();
        return null;
    }
}
