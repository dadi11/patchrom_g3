...
public class SQLiteQueryBuilder {
    ...
    public SQLiteQueryBuilder() {
        ...
        this.mTables = ProxyInfo.LOCAL_EXCL_LIST;
    ...
    public static String buildQueryString(boolean distinct, String tables, String[] columns, String where, String groupBy, String having, String orderBy, String limit) {
        if (TextUtils.isEmpty(groupBy) && !TextUtils.isEmpty(having)) {
            ...
            StringBuilder query = new StringBuilder(KeyEvent.KEYCODE_SYSRQ);
            query.append("SELECT ");
            if (distinct) {
    ...
    public String buildUnionQuery(String[] subQueries, String sortOrder, String limit) {
        StringBuilder query = new StringBuilder(AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
