...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    class C01621 extends ThreadLocal<SQLiteSession> {
        C01621() {
        }
    ...
    static class C01632 implements FileFilter {
    ...
    static {
        $assertionsDisabled = !SQLiteDatabase.class.desiredAssertionStatus() ? true : $assertionsDisabled;
    ...
    private SQLiteDatabase(String path, int openFlags, CursorFactory cursorFactory, DatabaseErrorHandler errorHandler) {
        this.mThreadSession = new C01621();
    ...
    public static boolean deleteDatabase(File file) {
        ...
        if (dir != null) {
            File[] files = dir.listFiles(new C01632(file.getName() + "-mj"));
            if (files != null) {
                File[] arr$ = files;
                int len$ = arr$.length;
