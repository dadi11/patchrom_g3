...
/*
            Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:17:? in {6, 13, 15, 16, 18, 19} preds:[]
...
*/
            ...
            r5 = r11.getStatement(r13);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r5.clearBindings();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r8 = r12.valueSet();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r3 = r8.iterator();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
        L_0x0014:
            r8 = r3.hasNext();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            if (r8 == 0) goto L_0x005f;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
        L_0x001a:
            r1 = r3.next();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r1 = (java.util.Map.Entry) r1;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r4 = r1.getKey();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r4 = (java.lang.String) r4;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r2 = r11.getColumnIndex(r4);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r8 = r1.getValue();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            android.database.DatabaseUtils.bindObjectToProgram(r5, r2, r8);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            goto L_0x0014;
        L_0x0032:
            r0 = move-exception;
            r8 = "DatabaseUtils";	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = new java.lang.StringBuilder;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9.<init>();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r10 = "Error inserting ";	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = r9.append(r10);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = r9.append(r12);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r10 = " into table  ";	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = r9.append(r10);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r10 = r11.mTableName;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = r9.append(r10);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r9 = r9.toString();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            android.util.Log.e(r8, r9, r0);	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r6 = -1;
            r8 = r11.mDb;
            r8.endTransaction();
        L_0x005e:
            return r6;
        L_0x005f:
            r6 = r5.executeInsert();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r8 = r11.mDb;	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r8.setTransactionSuccessful();	 Catch:{ SQLException -> 0x0032, all -> 0x006e }
            r8 = r11.mDb;
            r8.endTransaction();
            goto L_0x005e;
        L_0x006e:
        ...
        public long execute() {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:14:? in {3, 10, 12, 13, 15, 16} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.rerun(BlockProcessor.java:44)
	at jadx.core.dex.visitors.blocksmaker.BlockFinallyExtract.visit(BlockFinallyExtract.java:57)
...
*/
        ...
        L_0x0005:
            ...
            throw r1;
        L_0x000e:
            r1 = r5.mPreparedStatement;	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = r1.executeInsert();	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r5.mPreparedStatement = r4;
        L_0x0016:
            return r2;
        L_0x0017:
            r0 = move-exception;
            r1 = "DatabaseUtils";	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = new java.lang.StringBuilder;	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2.<init>();	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r3 = "Error executing InsertHelper with table ";	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = r2.append(r3);	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r3 = r5.mTableName;	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = r2.append(r3);	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = r2.toString();	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            android.util.Log.e(r1, r2, r0);	 Catch:{ SQLException -> 0x0017, all -> 0x0037 }
            r2 = -1;
            r5.mPreparedStatement = r4;
            goto L_0x0016;
        L_0x0037:
        ...
        private void buildSQL() throws SQLException {
            ...
            sb.append(" (");
            StringBuilder sbv = new StringBuilder(AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            sbv.append("VALUES (");
    ...
    public static String getHexCollationKey(String name) {
        byte[] arr = getCollationKeyInBytes(name);
        return new String(Hex.encodeHex(arr), 0, getKeyLen(arr) * STATEMENT_UPDATE);
    }
    ...
    public static void createDbFromSqlStatements(Context context, String dbName, int dbVersion, String sqlStatements) {
        ...
        String[] arr$ = TextUtils.split(sqlStatements, ";\n");
        int len$ = arr$.length;
        for (int i$ = 0; i$ < len$; i$ += STATEMENT_SELECT) {
    ...
    public static int findRowIdColumnIndex(String[] columnNames) {
        ...
        for (int i = 0; i < length; i += STATEMENT_SELECT) {
            if (columnNames[i].equals(SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID)) {
                return i;
            }
        }
        return -1;
