...
public class TextToSpeech {
    ...
    class AnonymousClass16 implements Action<Integer> {
        ...
        AnonymousClass16(Locale locale) {
            this.val$loc = locale;
        }
    ...
    class AnonymousClass17 implements Action<Integer> {
        ...
        AnonymousClass17(File file, CharSequence charSequence, Bundle bundle, String str) {
            this.val$file = file;
            this.val$text = charSequence;
            this.val$params = bundle;
            this.val$utteranceId = str;
        }
    ...
    class C07121 implements Action<Void> {
        C07121() {
        }
    ...
    class C07132 implements Action<Integer> {
        final /* synthetic */ Bundle val$params;
        final /* synthetic */ int val$queueMode;
        final /* synthetic */ CharSequence val$text;
        final /* synthetic */ String val$utteranceId;

        C07132(CharSequence charSequence, int i, Bundle bundle, String str) {
            this.val$text = charSequence;
    ...
    class C07143 implements Action<Integer> {
        final /* synthetic */ String val$earcon;
        final /* synthetic */ Bundle val$params;
        final /* synthetic */ int val$queueMode;
        final /* synthetic */ String val$utteranceId;

        C07143(String str, int i, Bundle bundle, String str2) {
            this.val$earcon = str;
            this.val$queueMode = i;
            this.val$params = bundle;
            this.val$utteranceId = str2;
        }
    ...
    class C07154 implements Action<Integer> {
        final /* synthetic */ long val$durationInMs;
        final /* synthetic */ int val$queueMode;
        final /* synthetic */ String val$utteranceId;

        C07154(long j, int i, String str) {
    ...
    class C07165 implements Action<Set<String>> {
        final /* synthetic */ Locale val$locale;

        C07165(Locale locale) {
    ...
    class C07176 implements Action<Boolean> {
        C07176() {
        }
    ...
    class C07187 implements Action<Integer> {
        C07187() {
        }
    ...
    class C07198 implements Action<Locale> {
        C07198() {
        }
    ...
    class C07209 implements Action<Integer> {
        final /* synthetic */ Locale val$loc;

        C07209(Locale locale) {
            this.val$loc = locale;
        }
        ...
        public Integer run(ITextToSpeechService service) throws RemoteException {
            ...
            try {
                ...
                try {
                    ...
                    if (result >= 0) {
                        if (result < TextToSpeech.QUEUE_DESTROY) {
                            variant = ProxyInfo.LOCAL_EXCL_LIST;
                            if (result < TextToSpeech.QUEUE_ADD) {
                ...
                synchronized (TextToSpeech.this.mStartLock) {
                    if (isCancelled()) {
                        ...
                        try {
                            ...
                            num = Integer.valueOf(TextToSpeech.SUCCESS);
                        } catch (RemoteException e) {
                            Log.e(TextToSpeech.TAG, "Error connecting to service, setCallback() failed");
                            num = Integer.valueOf(TextToSpeech.LANG_MISSING_DATA);
                        }
                    }
                }
                return num;
    ...
    private <R> R runAction(Action<R> action, R errorResult, String method, boolean reconnect, boolean onlyEstablishedConnection) {
        synchronized (this.mStartLock) {
            if (this.mServiceConnection == null) {
                ...
                errorResult = this.mServiceConnection.runAction(action, errorResult, method, reconnect, onlyEstablishedConnection);
            }
        }
        return errorResult;
    }
    ...
    public void shutdown() {
        synchronized (this.mStartLock) {
            ...
            runActionNoReconnect(new C07121(), null, "shutdown", false);
        }
    }
    ...
    public int speak(CharSequence text, int queueMode, Bundle params, String utteranceId) {
        return ((Integer) runAction(new C07132(text, queueMode, params, utteranceId), Integer.valueOf(LANG_MISSING_DATA), "speak")).intValue();
    }
    ...
    public int playEarcon(String earcon, int queueMode, Bundle params, String utteranceId) {
        return ((Integer) runAction(new C07143(earcon, queueMode, params, utteranceId), Integer.valueOf(LANG_MISSING_DATA), "playEarcon")).intValue();
    }
    ...
    public int playSilentUtterance(long durationInMs, int queueMode, String utteranceId) {
        return ((Integer) runAction(new C07154(durationInMs, queueMode, utteranceId), Integer.valueOf(LANG_MISSING_DATA), "playSilentUtterance")).intValue();
    }
    ...
    public Set<String> getFeatures(Locale locale) {
        return (Set) runAction(new C07165(locale), null, "getFeatures");
    }

    public boolean isSpeaking() {
        return ((Boolean) runAction(new C07176(), Boolean.valueOf(false), "isSpeaking")).booleanValue();
    }

    public int stop() {
        return ((Integer) runAction(new C07187(), Integer.valueOf(LANG_MISSING_DATA), "stop")).intValue();
    }
    ...
    public Locale getDefaultLanguage() {
        return (Locale) runAction(new C07198(), null, "getDefaultLanguage");
    }

    public int setLanguage(Locale loc) {
        return ((Integer) runAction(new C07209(loc), Integer.valueOf(STOPPED), "setLanguage")).intValue();
    }
