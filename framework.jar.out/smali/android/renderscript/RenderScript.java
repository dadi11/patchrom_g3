...
public class RenderScript {
    ...
    static {
        sInitialized = LOG_ENABLED;
        if (!SystemProperties.getBoolean("config.disable_renderscript", LOG_ENABLED)) {
            try {
                Class<?> vm_runtime = Class.forName("dalvik.system.VMRuntime");
                sRuntime = vm_runtime.getDeclaredMethod("getRuntime", new Class[CREATE_FLAG_NONE]).invoke(null, new Object[CREATE_FLAG_NONE]);
