...
public class Matrix4f {
    ...
    public void loadIdentity() {
        this.mMat[0] = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
        this.mMat[1] = 0.0f;
        this.mMat[2] = 0.0f;
        this.mMat[3] = 0.0f;
        this.mMat[4] = 0.0f;
        this.mMat[5] = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
        this.mMat[6] = 0.0f;
        this.mMat[7] = 0.0f;
        this.mMat[8] = 0.0f;
        this.mMat[9] = 0.0f;
        this.mMat[10] = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
        this.mMat[11] = 0.0f;
        this.mMat[12] = 0.0f;
        this.mMat[13] = 0.0f;
        this.mMat[14] = 0.0f;
        this.mMat[15] = LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
    }
    ...
    public void loadRotate(float rot, float x, float y, float z) {
        ...
        if (len == LayoutParams.BRIGHTNESS_OVERRIDE_FULL) {
            float recipLen = LayoutParams.BRIGHTNESS_OVERRIDE_FULL / len;
            x *= recipLen;
            y *= recipLen;
            z *= recipLen;
        }
        float nc = LayoutParams.BRIGHTNESS_OVERRIDE_FULL - c;
        float xy = x * y;
        float yz = y * z;
        float zx = z * x;
        float xs = x * s;
    ...
    public void loadOrthoWindow(int w, int h) {
        loadOrtho(0.0f, (float) w, (float) h, 0.0f, LayoutParams.BRIGHTNESS_OVERRIDE_NONE, LayoutParams.BRIGHTNESS_OVERRIDE_FULL);
    }
    ...
    public void loadFrustum(float l, float r, float b, float t, float n, float f) {
        ...
        this.mMat[11] = LayoutParams.BRIGHTNESS_OVERRIDE_NONE;
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        if (w > h) {
            ...
            m1.loadFrustum(-aspect, aspect, LayoutParams.BRIGHTNESS_OVERRIDE_NONE, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, SensorManager.LIGHT_CLOUDY);
        } else {
            aspect = ((float) h) / ((float) w);
            m1.loadFrustum(LayoutParams.BRIGHTNESS_OVERRIDE_NONE, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, -aspect, aspect, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, SensorManager.LIGHT_CLOUDY);
        }
        m2.loadRotate(180.0f, 0.0f, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, 0.0f);
        m1.loadMultiply(m1, m2);
        m2.loadScale(-2.0f, 2.0f, LayoutParams.BRIGHTNESS_OVERRIDE_FULL);
        m1.loadMultiply(m1, m2);
    ...
    public boolean inverse() {
        ...
        det = LayoutParams.BRIGHTNESS_OVERRIDE_FULL / det;
        for (i = 0; i < 16; i++) {
