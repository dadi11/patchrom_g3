...
public final class MediaProjectionManager {
    ...
    private static final class CallbackDelegate extends Stub {
        ...
        class C04241 implements Runnable {
            ...
            C04241(MediaProjectionInfo mediaProjectionInfo) {
        ...
        class C04252 implements Runnable {
            ...
            C04252(MediaProjectionInfo mediaProjectionInfo) {
                this.val$info = mediaProjectionInfo;
            }
        ...
        public void onStart(MediaProjectionInfo info) {
            this.mHandler.post(new C04241(info));
        }

        public void onStop(MediaProjectionInfo info) {
            this.mHandler.post(new C04252(info));
        }
    }
