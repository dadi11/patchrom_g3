...
public class RingtoneManager {
    ...
    static {
        String[] strArr = new String[TYPE_ALARM];
        strArr[ID_COLUMN_INDEX] = SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID;
        strArr[TYPE_RINGTONE] = WatchedPrograms.COLUMN_TITLE;
        strArr[URI_COLUMN_INDEX] = "\"" + Media.INTERNAL_CONTENT_URI + "\"";
        strArr[3] = "title_key";
        INTERNAL_COLUMNS = strArr;
        strArr = new String[TYPE_ALARM];
        strArr[ID_COLUMN_INDEX] = SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID;
        strArr[TYPE_RINGTONE] = WatchedPrograms.COLUMN_TITLE;
        strArr[URI_COLUMN_INDEX] = "\"" + Media.EXTERNAL_CONTENT_URI + "\"";
        strArr[3] = "title_key";
