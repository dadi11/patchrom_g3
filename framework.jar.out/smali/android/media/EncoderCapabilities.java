...
public class EncoderCapabilities {
    ...
    public static class VideoEncoderCap {
        ...
        private VideoEncoderCap(int codec, int minBitRate, int maxBitRate, int minFrameRate, int maxFrameRate, int minFrameWidth, int maxFrameWidth, int minFrameHeight, int maxFrameHeight, int maxHFRFrameWidth, int maxHFRFrameHeight, int maxHFRMode) {
            this.mCodec = codec;
            this.mMinBitRate = minBitRate;
            this.mMaxBitRate = maxBitRate;
            ...
            this.mMaxHFRFrameWidth = maxHFRFrameWidth;
            this.mMaxHFRFrameHeight = maxHFRFrameHeight;
            this.mMaxHFRMode = maxHFRMode;
        }
    }
