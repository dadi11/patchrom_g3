...
public class AudioFormat {
    ...
    public static class Builder {
        ...
        public Builder setEncoding(int encoding) throws IllegalArgumentException {
            switch (encoding) {
                ...
                case AudioFormat.ENCODING_AMRNB /*100*/:
                case AudioFormat.ENCODING_AMRWB /*101*/:
                case AudioFormat.ENCODING_EVRC /*102*/:
                case AudioFormat.ENCODING_EVRCB /*103*/:
                case AudioFormat.ENCODING_EVRCWB /*104*/:
                case AudioFormat.ENCODING_EVRCNW /*105*/:
    ...
    public static int getBytesPerSample(int audioFormat) {
        switch (audioFormat) {
            ...
            case ENCODING_AMRNB /*100*/:
                return CHANNEL_OUT_LOW_FREQUENCY;
            case ENCODING_AMRWB /*101*/:
                return 61;
            case ENCODING_EVRC /*102*/:
            case ENCODING_EVRCB /*103*/:
            case ENCODING_EVRCWB /*104*/:
            case ENCODING_EVRCNW /*105*/:
                return 23;
            default:
