...
public final class MediaMetadata implements Parcelable {
    ...
    static class C03721 implements Creator<MediaMetadata> {
        C03721() {
        }
    ...
    static {
        ...
        EDITOR_KEY_MAPPING.put(KeyEvent.KEYCODE_BUTTON_Z, METADATA_KEY_RATING);
        EDITOR_KEY_MAPPING.put(MediaMetadataEditor.RATING_KEY_BY_USER, METADATA_KEY_USER_RATING);
        EDITOR_KEY_MAPPING.put(METADATA_TYPE_TEXT, METADATA_KEY_ALBUM);
        EDITOR_KEY_MAPPING.put(13, METADATA_KEY_ALBUM_ARTIST);
        EDITOR_KEY_MAPPING.put(METADATA_TYPE_BITMAP, METADATA_KEY_ARTIST);
        EDITOR_KEY_MAPPING.put(METADATA_TYPE_RATING, METADATA_KEY_AUTHOR);
        EDITOR_KEY_MAPPING.put(METADATA_TYPE_LONG, METADATA_KEY_TRACK_NUMBER);
