...
class ClosedCaptionWidget extends ViewGroup implements RenderingWidget, DisplayListener {
    ...
    class ClosedCaptionRenderer extends CaptioningChangeListener {
    ...
    private static class CCLayout extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int lineHeightMeasureSpec = MeasureSpec.makeMeasureSpec(((int) (((float) safeHeight) * SAFE_AREA_RATIO)) / MAX_ROWS, EditorInfo.IME_FLAG_NO_ENTER_ACTION);
            int lineWidthMeasureSpec = MeasureSpec.makeMeasureSpec(safeWidth, EditorInfo.IME_FLAG_NO_ENTER_ACTION);
            for (int i = 0; i < MAX_ROWS; i++) {
    ...
    private static class CCLineBox extends TextView {
        ...
        CCLineBox(Context context) {
            super(context);
            this.mTextColor = -1;
            this.mBgColor = Spanned.SPAN_USER;
            this.mEdgeType = 0;
            this.mEdgeColor = 0;
            setGravity(17);
            ...
            this.mOutlineWidth = (float) res.getDimensionPixelSize(17105024);
            this.mShadowRadius = (float) res.getDimensionPixelSize(17105022);
            this.mShadowOffset = (float) res.getDimensionPixelSize(17105023);
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            this.mOutlineWidth = (EDGE_OUTLINE_RATIO * fontSize) + LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
            this.mShadowRadius = (EDGE_SHADOW_RATIO * fontSize) + LayoutParams.BRIGHTNESS_OVERRIDE_FULL;
            this.mShadowOffset = this.mShadowRadius;
            setScaleX(LayoutParams.BRIGHTNESS_OVERRIDE_FULL);
    ...
    public ClosedCaptionWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mCaptioningListener = new ClosedCaptionRenderer();
        setLayerType(1, null);
