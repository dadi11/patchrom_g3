...
public final class Rating implements Parcelable {
    ...
    static class C03891 implements Creator<Rating> {
        C03891() {
        }

        public Rating createFromParcel(Parcel p) {
            return new Rating(p.readFloat(), null);
        }
    ...
    public static Rating newHeartRating(boolean hasHeart) {
        return new Rating(RATING_HEART, hasHeart ? LayoutParams.BRIGHTNESS_OVERRIDE_FULL : 0.0f);
    }

    public static Rating newThumbRating(boolean thumbIsUp) {
        return new Rating(RATING_THUMB_UP_DOWN, thumbIsUp ? LayoutParams.BRIGHTNESS_OVERRIDE_FULL : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != LayoutParams.BRIGHTNESS_OVERRIDE_FULL) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == LayoutParams.BRIGHTNESS_OVERRIDE_FULL) {
            return true;
        }
        return false;
    }
