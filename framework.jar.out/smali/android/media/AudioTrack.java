...
public class AudioTrack {
    ...
    private class NativeEventHandlerDelegate {
        ...
        /* renamed from: android.media.AudioTrack.NativeEventHandlerDelegate.1 */
        class C03651 extends Handler {
            ...
            C03651(Looper x0, AudioTrack audioTrack, AudioTrack audioTrack2, OnPlaybackPositionUpdateListener onPlaybackPositionUpdateListener) {
        ...
        NativeEventHandlerDelegate(AudioTrack track, OnPlaybackPositionUpdateListener listener, Handler handler) {
            Looper looper;
            if (handler != null) {
            ...
            if (looper != null) {
                this.mHandler = new C03651(looper, AudioTrack.this, track, listener);
            } else {
                this.mHandler = null;
            }
        }
    ...
    private static boolean isMultichannelConfigSupported(int channelConfig) {
        ...
        if (channelCount > CHANNEL_COUNT_MAX) {
            ...
            return false;
        } else if ((channelConfig & KeyEvent.KEYCODE_BUTTON_5) != 0 && (channelConfig & KeyEvent.KEYCODE_BUTTON_5) != KeyEvent.KEYCODE_BUTTON_5) {
