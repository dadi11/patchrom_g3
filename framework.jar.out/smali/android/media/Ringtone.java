...
public class Ringtone {
    ...
    static {
        MEDIA_COLUMNS = new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "_data", WatchedPrograms.COLUMN_TITLE};
    }
    ...
    private static String getTitle(Context context, Uri uri, boolean followSettingsUri) {
        ...
        if (uri != null) {
            ...
            if (!"settings".equals(authority)) {
                ...
                title = context.getString(17040577, getTitle(context, RingtoneManager.getActualDefaultRingtoneUri(context, RingtoneManager.getDefaultType(uri)), LOGD));
            }
        }
        if (title == null) {
            title = context.getString(17040580);
            if (title == null) {
