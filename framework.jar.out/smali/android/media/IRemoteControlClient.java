...
public interface IRemoteControlClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteControlClient {
        ...
        private static class Proxy implements IRemoteControlClient {
            ...
            public void onInformationRequested(int generationId, int infoFlags) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onInformationRequested, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void informationRequestForDisplay(IRemoteControlDisplay rcd, int w, int h) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(w);
                    _data.writeInt(h);
                    this.mRemote.transact(Stub.TRANSACTION_informationRequestForDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setCurrentClientGenerationId(int clientGeneration) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setCurrentClientGenerationId, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void plugRemoteControlDisplay(IRemoteControlDisplay rcd, int w, int h) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(w);
                    _data.writeInt(h);
                    this.mRemote.transact(Stub.TRANSACTION_plugRemoteControlDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void unplugRemoteControlDisplay(IRemoteControlDisplay rcd) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_unplugRemoteControlDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setBitmapSizeForDisplay(IRemoteControlDisplay rcd, int w, int h) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(w);
                    _data.writeInt(h);
                    this.mRemote.transact(Stub.TRANSACTION_setBitmapSizeForDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setWantsSyncForDisplay(IRemoteControlDisplay rcd, boolean wantsSync) throws RemoteException {
                IBinder iBinder = null;
                int i = Stub.TRANSACTION_onInformationRequested;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (rcd != null) {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setWantsSyncForDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void enableRemoteControlDisplay(IRemoteControlDisplay rcd, boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_enableRemoteControlDisplay, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void seekTo(int clientGeneration, long timeMs) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_seekTo, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void updateMetadata(int clientGeneration, int key, Rating value) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(key);
                    if (value != null) {
                        _data.writeInt(Stub.TRANSACTION_onInformationRequested);
                        value.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_updateMetadata, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setPlayItem(int scope, long uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeLong(uid);
                    this.mRemote.transact(Stub.TRANSACTION_setPlayItem, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setBrowsedPlayer() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_setBrowsedPlayer, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void getNowPlayingEntries() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getNowPlayingEntries, _data, null, Stub.TRANSACTION_onInformationRequested);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_onInformationRequested /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onInformationRequested(data.readInt(), data.readInt());
                    return true;
                case TRANSACTION_informationRequestForDisplay /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_setCurrentClientGenerationId /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    setCurrentClientGenerationId(data.readInt());
                    return true;
                case TRANSACTION_plugRemoteControlDisplay /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_setBitmapSizeForDisplay /*6*/:
                    ...
                    return true;
                case TRANSACTION_setWantsSyncForDisplay /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_enableRemoteControlDisplay /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        _arg1 = true;
                ...
                case TRANSACTION_seekTo /*9*/:
                    ...
                    return true;
                case TRANSACTION_updateMetadata /*10*/:
                    Rating _arg2;
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_setPlayItem /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    setPlayItem(data.readInt(), data.readLong());
                    return true;
                case TRANSACTION_setBrowsedPlayer /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    setBrowsedPlayer();
                    return true;
                case TRANSACTION_getNowPlayingEntries /*13*/:
                    data.enforceInterface(DESCRIPTOR);
