            ...
            class C04311 implements Runnable {
                ...
                public void run() {
                    ...
                    for (int i = 0; i < size; i++) {
                        controllers.add(new MediaController(MediaSessionManager.this.mContext, (Token) this.val$tokens.get(i)));
                    }
