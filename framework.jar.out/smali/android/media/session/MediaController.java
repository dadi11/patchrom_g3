...
public final class MediaController {
    ...
    private static final class CallbackStub extends Stub {
        ...
        public void onUpdateFolderInfoBrowsedPlayer(String stringUri) {
            ...
            MediaController controller = (MediaController) this.mController.get();
            if (controller != null) {
                controller.postMessage(MediaController.MSG_FOLDER_INFO_BROWSED_PLAYER, stringUri, null);
            }
        }
        ...
        public void onUpdateNowPlayingEntries(long[] playList) {
            ...
            MediaController controller = (MediaController) this.mController.get();
            if (controller != null) {
                controller.postMessage(MediaController.MSG_UPDATE_NOWPLAYING_ENTRIES, playList, null);
            }
        }
        ...
        public void onUpdateNowPlayingContentChange() {
            ...
            MediaController controller = (MediaController) this.mController.get();
            if (controller != null) {
                controller.postMessage(MediaController.MSG_UPDATE_NOWPLAYING_CONTENT_CHANGE, null, null);
            }
        }
        ...
        public void onPlayItemResponse(boolean success) {
            ...
            MediaController controller = (MediaController) this.mController.get();
            if (controller != null) {
                controller.postMessage(MediaController.MSG_PLAY_ITEM_RESPONSE, new Boolean(success), null);
            }
        }
    }
    ...
    private static final class MessageHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (this.mRegistered) {
                switch (msg.what) {
                    case MediaController.MSG_EVENT /*1*/:
                        this.mCallback.onSessionEvent((String) msg.obj, msg.getData());
                    case MediaController.MSG_UPDATE_PLAYBACK_STATE /*2*/:
                        this.mCallback.onPlaybackStateChanged((PlaybackState) msg.obj);
                    case MediaController.MSG_UPDATE_METADATA /*3*/:
                        this.mCallback.onMetadataChanged((MediaMetadata) msg.obj);
                    case MediaController.MSG_UPDATE_VOLUME /*4*/:
                        this.mCallback.onAudioInfoChanged((PlaybackInfo) msg.obj);
                    case MediaController.MSG_UPDATE_QUEUE /*5*/:
                        this.mCallback.onQueueChanged((List) msg.obj);
                    case MediaController.MSG_UPDATE_QUEUE_TITLE /*6*/:
                        this.mCallback.onQueueTitleChanged((CharSequence) msg.obj);
                    case MediaController.MSG_UPDATE_EXTRAS /*7*/:
                        this.mCallback.onExtrasChanged((Bundle) msg.obj);
                    case MediaController.MSG_FOLDER_INFO_BROWSED_PLAYER /*8*/:
                        this.mCallback.onUpdateFolderInfoBrowsedPlayer((String) msg.obj);
                    case MediaController.MSG_UPDATE_NOWPLAYING_ENTRIES /*9*/:
                        this.mCallback.onUpdateNowPlayingEntries((long[]) msg.obj);
                    case MediaController.MSG_UPDATE_NOWPLAYING_CONTENT_CHANGE /*10*/:
                        this.mCallback.onUpdateNowPlayingContentChange();
                    case MediaController.MSG_PLAY_ITEM_RESPONSE /*11*/:
                        this.mCallback.onPlayItemResponse(((Boolean) msg.obj).booleanValue());
                    case MediaController.MSG_DESTROYED /*12*/:
    ...
    public final class TransportControls {
        ...
        public void setRemoteControlClientPlayItem(long uid, int scope) {
            ...
            try {
                MediaController.this.mSessionBinder.setRemoteControlClientPlayItem(uid, scope);
            } catch (RemoteException e) {
