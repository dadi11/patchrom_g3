    ...
    public static abstract class Stub extends Binder implements ISessionCallback {
        ...
        private static class Proxy implements ISessionCallback {
            ...
            public void setRemoteControlClientBrowsedPlayer() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteControlClientBrowsedPlayer, _data, null, Stub.TRANSACTION_onCommand);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setRemoteControlClientPlayItem(long uid, int scope) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteControlClientPlayItem, _data, null, Stub.TRANSACTION_onCommand);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void getRemoteControlClientNowPlayingEntries() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRemoteControlClientNowPlayingEntries, _data, null, Stub.TRANSACTION_onCommand);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_onSeekTo /*13*/:
                    ...
                    return true;
                case TRANSACTION_setRemoteControlClientBrowsedPlayer /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientBrowsedPlayer();
                    return true;
                case TRANSACTION_setRemoteControlClientPlayItem /*15*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientPlayItem(data.readLong(), data.readInt());
                    return true;
                case TRANSACTION_getRemoteControlClientNowPlayingEntries /*16*/:
                    data.enforceInterface(DESCRIPTOR);
                    getRemoteControlClientNowPlayingEntries();
                    return true;
                case TRANSACTION_onRate /*17*/:
                    Rating _arg03;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onRate(_arg03);
                    return true;
                case TRANSACTION_onCustomAction /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readString();
                    if (data.readInt() != 0) {
                        _arg1 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    ...
                    return true;
                case TRANSACTION_onAdjustVolume /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    onAdjustVolume(data.readInt());
                    return true;
                case TRANSACTION_onSetVolumeTo /*20*/:
                    data.enforceInterface(DESCRIPTOR);
