        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_seekTo /*23*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setRemoteControlClientBrowsedPlayer /*24*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientBrowsedPlayer();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setRemoteControlClientPlayItem /*25*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientPlayItem(data.readLong(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getRemoteControlClientNowPlayingEntries /*26*/:
                    data.enforceInterface(DESCRIPTOR);
                    getRemoteControlClientNowPlayingEntries();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_rate /*27*/:
                    Rating _arg03;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_sendCustomAction /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readString();
                    if (data.readInt() != 0) {
                        _arg1 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getMetadata /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_getPlaybackState /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getQueue /*31*/:
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_getQueueTitle /*32*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getExtras /*33*/:
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_getRatingType /*34*/:
                    data.enforceInterface(DESCRIPTOR);
