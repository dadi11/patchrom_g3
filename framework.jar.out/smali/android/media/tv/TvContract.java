...
public final class TvContract {
    ...
    public static final Uri buildChannelUriForPassthroughInput(String inputId) {
        return new Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(AUTHORITY).appendPath(PATH_PASSTHROUGH).appendPath(inputId).build();
    }
    ...
    private static final boolean isTvUri(Uri uri) {
        return uri != null && ContentResolver.SCHEME_CONTENT.equals(uri.getScheme()) && AUTHORITY.equals(uri.getAuthority());
    }
