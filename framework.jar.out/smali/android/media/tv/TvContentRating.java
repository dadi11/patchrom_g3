...
public final class TvContentRating {
    ...
    public final boolean contains(TvContentRating rating) {
        ...
        } else if (!rating.getMainRating().equals(this.mRating) || !rating.getDomain().equals(this.mDomain) || !rating.getRatingSystem().equals(this.mRatingSystem) || !rating.getMainRating().equals(this.mRating)) {
            return false;
        } else {
