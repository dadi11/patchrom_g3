        ...
        private static class Proxy implements IVolumeController {
            ...
            public void masterVolumeChanged(int flags) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(flags);
                    this.mRemote.transact(Stub.TRANSACTION_masterVolumeChanged, _data, null, Stub.TRANSACTION_displaySafeVolumeWarning);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_volumeChanged /*2*/:
                    ...
                    return true;
                case TRANSACTION_masterVolumeChanged /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    masterVolumeChanged(data.readInt());
                    return true;
                case TRANSACTION_masterMuteChanged /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    masterMuteChanged(data.readInt());
                    return true;
                case TRANSACTION_setLayoutDirection /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    setLayoutDirection(data.readInt());
                    return true;
                case TRANSACTION_dismiss /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    dismiss();
                    return true;
