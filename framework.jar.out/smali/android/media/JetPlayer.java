    ...
    private class NativeEventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            synchronized (JetPlayer.this.mEventListenerLock) {
                OnJetEventListener listener = this.mJet.mJetEventListener;
            }
            switch (msg.what) {
                case JetPlayer.JET_EVENT /*1*/:
                    if (listener != null) {
                        JetPlayer.this.mJetEventListener.onJetEvent(this.mJet, (short) ((msg.arg1 & JetPlayer.JET_EVENT_SEG_MASK) >> JetPlayer.JET_EVENT_SEG_SHIFT), (byte) ((msg.arg1 & JetPlayer.JET_EVENT_TRACK_MASK) >> JetPlayer.JET_EVENT_TRACK_SHIFT), (byte) (((msg.arg1 & JetPlayer.JET_EVENT_CHAN_MASK) >> JetPlayer.JET_EVENT_CHAN_SHIFT) + JetPlayer.JET_EVENT), (byte) ((msg.arg1 & JetPlayer.JET_EVENT_CTRL_MASK) >> JetPlayer.JET_EVENT_CTRL_SHIFT), (byte) (msg.arg1 & JetPlayer.JET_EVENT_VAL_MASK));
                    }
                case JetPlayer.JET_USERID_UPDATE /*2*/:
                    if (listener != null) {
                        listener.onJetUserIdUpdate(this.mJet, msg.arg1, msg.arg2);
                    }
                case JetPlayer.JET_NUMQUEUEDSEGMENT_UPDATE /*3*/:
                    if (listener != null) {
                        listener.onJetNumQueuedSegmentUpdate(this.mJet, msg.arg1);
                    }
                case JetPlayer.JET_PAUSE_UPDATE /*4*/:
                    if (listener != null) {
