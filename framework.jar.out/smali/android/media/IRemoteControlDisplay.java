    ...
    public static abstract class Stub extends Binder implements IRemoteControlDisplay {
        ...
        private static class Proxy implements IRemoteControlDisplay {
            ...
            public void setCurrentClientId(int clientGeneration, PendingIntent clientMediaIntent, boolean clearing) throws RemoteException {
                int i = Stub.TRANSACTION_setCurrentClientId;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(clientGeneration);
                    if (clientMediaIntent != null) {
                        _data.writeInt(Stub.TRANSACTION_setCurrentClientId);
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setCurrentClientId, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setEnabled, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setPlaybackState(int generationId, int state, long stateChangeTimeMs, long currentPosMs, float speed) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setPlaybackState, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setTransportControlInfo(int generationId, int transportControlFlags, int posCapabilities) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setTransportControlInfo, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setMetadata(int generationId, Bundle metadata) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setMetadata, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setArtwork(int generationId, Bitmap artwork) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setArtwork, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setAllMetadata(int generationId, Bundle metadata, Bitmap artwork) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAllMetadata, _data, null, Stub.TRANSACTION_setCurrentClientId);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            Bundle _arg1;
            switch (code) {
                case TRANSACTION_setCurrentClientId /*1*/:
                ...
                case TRANSACTION_setArtwork /*6*/:
                    ...
                    return true;
                case TRANSACTION_setAllMetadata /*7*/:
                    Bitmap _arg22;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
