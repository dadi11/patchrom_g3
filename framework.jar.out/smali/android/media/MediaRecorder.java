...
public class MediaRecorder {
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MEDIA_RECORDER_EVENT_LIST_START /*1*/:
                case MEDIA_RECORDER_TRACK_EVENT_LIST_START /*100*/:
                ...
                case MEDIA_RECORDER_EVENT_INFO /*2*/:
                case MEDIA_RECORDER_TRACK_EVENT_INFO /*101*/:
    ...
    public void setProfile(CamcorderProfile profile) {
        ...
        if ((profile.quality < MEDIA_RECORDER_TRACK_INFO_LIST_START || profile.quality > MEDIA_RECORDER_TRACK_INFO_INITIAL_DELAY_MS) && profile.audioCodec >= 0) {
    ...
    public void setOrientationHint(int degrees) {
        if (degrees == 0 || degrees == 90 || degrees == KeyEvent.KEYCODE_STB_INPUT || degrees == 270) {
