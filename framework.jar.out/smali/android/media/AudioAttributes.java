...
public final class AudioAttributes implements Parcelable {
    ...
    static class C03531 implements Creator<AudioAttributes> {
        C03531() {
        }

        public AudioAttributes createFromParcel(Parcel p) {
            return new AudioAttributes(null);
        }
    ...
    public static class Builder {
        ...
        public Builder setInternalCapturePreset(int preset) {
            if (preset == LayoutParams.LAST_SUB_WINDOW || preset == AudioAttributes.USAGE_NOTIFICATION_COMMUNICATION_INSTANT || preset == AudioSource.FM_TUNER) {
                this.mSource = preset;
            } else {
