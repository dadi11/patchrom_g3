...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_addMediaPlayerAndUpdateRemoteController = 75;
        ...
        static final int TRANSACTION_getRemoteControlClientNowPlayingEntries = 72;
        ...
        static final int TRANSACTION_removeMediaPlayerAndUpdateRemoteController = 76;
        ...
        static final int TRANSACTION_setRemoteControlClientBrowsedPlayer = 71;
        static final int TRANSACTION_setRemoteControlClientPlayItem = 73;
        ...
        static final int TRANSACTION_updateRemoteControllerOnExistingMediaPlayers = 74;
        ...
        private static class Proxy implements IAudioService {
            ...
            public void adjustSuggestedStreamVolume(int direction, int suggestedStreamType, int flags, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_adjustSuggestedStreamVolume, _data, _reply, 0);
            ...
            public void adjustMasterVolume(int direction, int flags, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(flags);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_adjustMasterVolume, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setRemoteStreamVolume(int index) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(index);
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteStreamVolume, _data, null, Stub.TRANSACTION_adjustSuggestedStreamVolume);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void setMasterVolume(int index, int flags, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(flags);
                    _data.writeString(callingPackage);
                    this.mRemote.transact(Stub.TRANSACTION_setMasterVolume, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setStreamSolo(int streamType, boolean state, IBinder cb) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setStreamSolo, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setStreamMute(int streamType, boolean state, IBinder cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    _data.writeStrongBinder(cb);
                    this.mRemote.transact(Stub.TRANSACTION_setStreamMute, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getMasterVolume() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMasterVolume, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getMasterMaxVolume() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMasterMaxVolume, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getLastAudibleMasterVolume() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getLastAudibleMasterVolume, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean registerRemoteControlDisplay(IRemoteControlDisplay rcd, int w, int h) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(w);
                    _data.writeInt(h);
                    this.mRemote.transact(Stub.TRANSACTION_registerRemoteControlDisplay, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
                    }
            ...
            public boolean registerRemoteController(IRemoteControlDisplay rcd, int w, int h, ComponentName listenerComp) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_registerRemoteController, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public void unregisterRemoteControlDisplay(IRemoteControlDisplay rcd) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_unregisterRemoteControlDisplay, _data, null, Stub.TRANSACTION_adjustSuggestedStreamVolume);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void remoteControlDisplayUsesBitmapSize(IRemoteControlDisplay rcd, int w, int h) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(w);
                    _data.writeInt(h);
                    this.mRemote.transact(Stub.TRANSACTION_remoteControlDisplayUsesBitmapSize, _data, null, Stub.TRANSACTION_adjustSuggestedStreamVolume);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void remoteControlDisplayWantsPlaybackPositionSync(IRemoteControlDisplay rcd, boolean wantsSync) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_remoteControlDisplayWantsPlaybackPositionSync, _data, null, Stub.TRANSACTION_adjustSuggestedStreamVolume);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public int getMasterStreamType() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMasterStreamType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setRemoteControlClientBrowsedPlayer() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteControlClientBrowsedPlayer, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void getRemoteControlClientNowPlayingEntries() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRemoteControlClientNowPlayingEntries, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setRemoteControlClientPlayItem(long uid, int scope) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteControlClientPlayItem, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void updateRemoteControllerOnExistingMediaPlayers() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_updateRemoteControllerOnExistingMediaPlayers, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void addMediaPlayerAndUpdateRemoteController(String packageName) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_addMediaPlayerAndUpdateRemoteController, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void removeMediaPlayerAndUpdateRemoteController(String packageName) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_removeMediaPlayerAndUpdateRemoteController, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_requestAudioFocus /*42*/:
                    ...
                    _result2 = requestAudioFocus(_arg0, data.readInt(), data.readStrongBinder(), android.media.IAudioFocusDispatcher.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readString(), data.readInt(), android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_abandonAudioFocus /*43*/:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    IAudioFocusDispatcher _arg02 = android.media.IAudioFocusDispatcher.Stub.asInterface(data.readStrongBinder());
                ...
                case TRANSACTION_registerRemoteControlDisplay /*46*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = registerRemoteControlDisplay(android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_adjustSuggestedStreamVolume : 0);
                    return true;
                case TRANSACTION_registerRemoteController /*47*/:
                    ComponentName _arg3;
                    data.enforceInterface(DESCRIPTOR);
                    IRemoteControlDisplay _arg03 = android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder());
                ...
                case TRANSACTION_unregisterRemoteControlDisplay /*48*/:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterRemoteControlDisplay(android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case TRANSACTION_remoteControlDisplayUsesBitmapSize /*49*/:
                    data.enforceInterface(DESCRIPTOR);
                    remoteControlDisplayUsesBitmapSize(android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt());
                    return true;
                case TRANSACTION_remoteControlDisplayWantsPlaybackPositionSync /*50*/:
                    data.enforceInterface(DESCRIPTOR);
                    remoteControlDisplayWantsPlaybackPositionSync(android.media.IRemoteControlDisplay.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    return true;
                ...
                case TRANSACTION_registerAudioPolicy /*68*/:
                    ...
                    String _result5 = registerAudioPolicy(_arg05, android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                ...
                case TRANSACTION_setFocusPropertiesForPolicy /*70*/:
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setRemoteControlClientBrowsedPlayer /*71*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientBrowsedPlayer();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getRemoteControlClientNowPlayingEntries /*72*/:
                    data.enforceInterface(DESCRIPTOR);
                    getRemoteControlClientNowPlayingEntries();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setRemoteControlClientPlayItem /*73*/:
                    data.enforceInterface(DESCRIPTOR);
                    setRemoteControlClientPlayItem(data.readLong(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_updateRemoteControllerOnExistingMediaPlayers /*74*/:
                    data.enforceInterface(DESCRIPTOR);
                    updateRemoteControllerOnExistingMediaPlayers();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_addMediaPlayerAndUpdateRemoteController /*75*/:
                    data.enforceInterface(DESCRIPTOR);
                    addMediaPlayerAndUpdateRemoteController(data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeMediaPlayerAndUpdateRemoteController /*76*/:
                    data.enforceInterface(DESCRIPTOR);
                    removeMediaPlayerAndUpdateRemoteController(data.readString());
                    reply.writeNoException();
                    return true;
