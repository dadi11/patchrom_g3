...
public class AudioRecord {
    ...
    private void audioParamCheck(int audioSource, int sampleRateInHz, int audioFormat) throws IllegalArgumentException {
        if (audioSource < 0 || !(audioSource <= MediaRecorder.getAudioSourceMax() || audioSource == AudioSource.FM_TUNER || audioSource == LayoutParams.LAST_SUB_WINDOW)) {
    ...
    private void audioBuffSizeCheck(int audioBufferSize) throws IllegalArgumentException {
        ...
        if (this.mRecordSource == 7 && this.mAudioFormat != NATIVE_EVENT_MARKER) {
            frameSizeInBytes = this.mChannelCount * STATE_INITIALIZED;
        }
        if (audioBufferSize % frameSizeInBytes != 0 || audioBufferSize < STATE_INITIALIZED) {
    ...
    public static int getMinBufferSize(int sampleRateInHz, int channelConfig, int audioFormat) {
        ...
        switch (channelConfig) {
            ...
            case LayoutParams.SOFT_INPUT_ADJUST_NOTHING /*48*/:
                ...
                break;
            case KeyEvent.KEYCODE_TV_AUDIO_DESCRIPTION /*252*/:
                channelCount = 6;
                break;
            default:
        ...
        if (audioFormat == NATIVE_EVENT_MARKER || audioFormat == 100 || audioFormat == KeyEvent.KEYCODE_BUTTON_Z || audioFormat == KeyEvent.KEYCODE_BUTTON_L1 || audioFormat == KeyEvent.KEYCODE_BUTTON_R1 || audioFormat == KeyEvent.KEYCODE_BUTTON_L2 || audioFormat == KeyEvent.KEYCODE_BUTTON_R2) {
    ...
    public void startRecording() throws IllegalStateException {
        ...
        } else if (this.mState != STATE_INITIALIZED) {
