...
# static fields
.field protected static final HTTP_TEMP_REDIRECT:I = 0x133

.field protected static final MAX_REDIRECTS:I = 0x14
...
# instance fields
.field protected mAllowCrossDomainRedirect:Z

.field private mAllowCrossProtocolRedirect:Z

.field protected mConnection:Ljava/net/HttpURLConnection;

.field protected mCurrentOffset:J
...
.method public disconnect()V
    ...
    .line 126
    invoke-virtual {p0}, Landroid/media/MediaHTTPConnection;->teardownConnection()V
...
.method public getMIMEType()Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {p0, v2, v3}, Landroid/media/MediaHTTPConnection;->seekTo(J)V
    :try_end_0
...
.method protected readAt(J[BI)I
    .locals 9
    .param p1, "offset"    # J
    .param p3, "data"    # [B
    .param p4, "size"    # I
...
.method protected seekTo(J)V
    ...
    .prologue
    .line 166
    invoke-virtual/range {p0 .. p0}, Landroid/media/MediaHTTPConnection;->teardownConnection()V
