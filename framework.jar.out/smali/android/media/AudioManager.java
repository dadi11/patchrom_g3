...
public class AudioManager {
    ...
    /* renamed from: android.media.AudioManager.1 */
    class C03561 extends Stub {
        C03561() {
        }
    ...
    private class FocusEventHandlerDelegate {
        ...
        class C03571 extends Handler {
            final /* synthetic */ AudioManager val$this$0;

            C03571(Looper x0, AudioManager audioManager) {
        ...
        FocusEventHandlerDelegate() {
            ...
            if (looper != null) {
                this.mHandler = new C03571(looper, AudioManager.this);
            } else {
                this.mHandler = null;
            }
        }
    ...
    public AudioManager(Context context) {
        ...
        this.mAudioFocusDispatcher = new C03561();
        this.mICallBack = new Binder();
        this.mContext = context;
        this.mUseMasterVolume = this.mContext.getResources().getBoolean(17956881);
        this.mUseVolumeKeySounds = this.mContext.getResources().getBoolean(17956882);
    ...
    public void preDispatchKeyEvent(KeyEvent event, int stream) {
        ...
        if (keyCode != 25 && keyCode != 24 && keyCode != KeyEvent.KEYCODE_VOLUME_MUTE && this.mVolumeKeyUpTime + 300 > SystemClock.uptimeMillis()) {
    ...
    public boolean isBluetoothA2dpOn() {
        if (AudioSystem.getDeviceConnectionState(FLAG_SHOW_SILENT_HINT, ProxyInfo.LOCAL_EXCL_LIST) == 0) {
            return false;
        }
        return true;
    }
    ...
    public void playSoundEffect(int effectType) {
        if (effectType >= 0 && effectType < STREAM_INCALL_MUSIC && querySoundEffectsEnabled(Process.myUserHandle().getIdentifier())) {
            try {
    ...
    public void playSoundEffect(int effectType, int userId) {
        if (effectType >= 0 && effectType < STREAM_INCALL_MUSIC && querySoundEffectsEnabled(userId)) {
            try {
                getService().playSoundEffect(effectType);
            } catch (RemoteException e) {
                Log.e(TAG, "Dead object in playSoundEffect" + e);
    ...
    public void playSoundEffect(int effectType, float volume) {
        if (effectType >= 0 && effectType < STREAM_INCALL_MUSIC) {
            try {
    ...
    public void registerMediaButtonEventReceiver(ComponentName eventReceiver) {
        if (eventReceiver != null) {
            if (eventReceiver.getPackageName().equals(this.mContext.getPackageName())) {
                ...
                mediaButtonIntent.addFlags(EditorInfo.IME_FLAG_NO_EXTRACT_UI);
    ...
    public void setRemoteControlClientPlayItem(long uid, int scope) {
        try {
            getService().setRemoteControlClientPlayItem(uid, scope);
        } catch (RemoteException e) {
