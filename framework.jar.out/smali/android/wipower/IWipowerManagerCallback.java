...
public interface IWipowerManagerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWipowerManagerCallback {
        ...
        private static class Proxy implements IWipowerManagerCallback {
            ...
            public void onWipowerStateChange(int state) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onWipowerStateChange, _data, _reply, 0);
            ...
            public void onWipowerAlert(byte alert) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onWipowerAlert, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onWipowerData(byte[] value) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onWipowerData, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void onPowerApply(byte value) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onPowerApply, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onWipowerStateChange /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onWipowerStateChange(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onWipowerAlert /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onWipowerAlert(data.readByte());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onWipowerData /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onWipowerData(data.createByteArray());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onPowerApply /*4*/:
                    data.enforceInterface(DESCRIPTOR);
