...
import android.wipower.IWipowerManagerCallback.Stub;
...
public final class WipowerManager {
    ...
    private final IWipowerManagerCallback mWiPowerMangerCallback;

    /* renamed from: android.wipower.WipowerManager.1 */
    ...
    /* renamed from: android.wipower.WipowerManager.2 */
    class C11092 implements ServiceConnection {
        C11092() {
        }

        public void onServiceConnected(ComponentName className, IBinder service) {
            WipowerManager.mService = IWipower.Stub.asInterface(service);
    ...
    private WipowerManager(Context context, WipowerManagerCallback callback) {
        this.mWiPowerMangerCallback = new C11081();
        this.mConnection = new C11092();
        if (mService == null) {
            try {
    ...
    static boolean isWipowerSupported() {
        if (SystemProperties.getBoolean("ro.bluetooth.a4wp", false) == DBG) {
