...
public interface IGpsStatusListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGpsStatusListener {
        ...
        private static class Proxy implements IGpsStatusListener {
            ...
            public void onGpsStarted() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onGpsStarted, _data, null, Stub.TRANSACTION_onGpsStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onGpsStopped() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onGpsStopped, _data, null, Stub.TRANSACTION_onGpsStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onFirstFix(int ttff) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(ttff);
                    this.mRemote.transact(Stub.TRANSACTION_onFirstFix, _data, null, Stub.TRANSACTION_onGpsStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSvStatusChanged(int svCount, int[] prns, float[] snrs, float[] elevations, float[] azimuths, int ephemerisMask, int almanacMask, int usedInFixMask) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onSvStatusChanged, _data, null, Stub.TRANSACTION_onGpsStarted);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onNmeaReceived(long timestamp, String nmea) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onNmeaReceived, _data, null, Stub.TRANSACTION_onGpsStarted);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onGpsStarted /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onGpsStarted();
                    return true;
                case TRANSACTION_onGpsStopped /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onGpsStopped();
                    return true;
                case TRANSACTION_onFirstFix /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onFirstFix(data.readInt());
                    return true;
                case TRANSACTION_onSvStatusChanged /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    onSvStatusChanged(data.readInt(), data.createIntArray(), data.createFloatArray(), data.createFloatArray(), data.createFloatArray(), data.readInt(), data.readInt(), data.readInt());
                    return true;
                case TRANSACTION_onNmeaReceived /*5*/:
                    data.enforceInterface(DESCRIPTOR);
