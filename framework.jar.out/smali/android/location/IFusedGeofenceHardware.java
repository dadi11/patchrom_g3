...
public interface IFusedGeofenceHardware extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFusedGeofenceHardware {
        ...
        private static class Proxy implements IFusedGeofenceHardware {
            ...
            public boolean isSupported() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isSupported, _data, _reply, 0);
            ...
            public void addGeofences(GeofenceHardwareRequestParcelable[] geofenceRequestsArray) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_addGeofences, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void removeGeofences(int[] geofenceIds) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_removeGeofences, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void pauseMonitoringGeofence(int geofenceId) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_pauseMonitoringGeofence, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void resumeMonitoringGeofence(int geofenceId, int monitorTransitions) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_resumeMonitoringGeofence, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void modifyGeofenceOptions(int geofenceId, int lastTransition, int monitorTransitions, int notificationResponsiveness, int unknownTimer, int sourcesToUse) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_modifyGeofenceOptions, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_isSupported /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result = isSupported();
                    reply.writeNoException();
                    reply.writeInt(_result ? TRANSACTION_isSupported : 0);
                    return true;
                case TRANSACTION_addGeofences /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    addGeofences((GeofenceHardwareRequestParcelable[]) data.createTypedArray(GeofenceHardwareRequestParcelable.CREATOR));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeGeofences /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    removeGeofences(data.createIntArray());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_pauseMonitoringGeofence /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    pauseMonitoringGeofence(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_resumeMonitoringGeofence /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    resumeMonitoringGeofence(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_modifyGeofenceOptions /*6*/:
                    data.enforceInterface(DESCRIPTOR);
