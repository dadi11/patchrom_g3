...
public class GeoFenceParams implements Parcelable {
    public static final Creator<GeoFenceParams> CREATOR;
    ...
    /* renamed from: android.location.GeoFenceParams.1 */
    static class C03321 implements Creator<GeoFenceParams> {
        C03321() {
        }

        public GeoFenceParams createFromParcel(Parcel in) {
            return new GeoFenceParams(null);
        }
