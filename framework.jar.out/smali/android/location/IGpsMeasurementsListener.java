...
public interface IGpsMeasurementsListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGpsMeasurementsListener {
        ...
        private static class Proxy implements IGpsMeasurementsListener {
            ...
            public void onGpsMeasurementsReceived(GpsMeasurementsEvent event) throws RemoteException {
                ...
                try {
                    ...
                    if (event != null) {
                        _data.writeInt(Stub.TRANSACTION_onGpsMeasurementsReceived);
                        event.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_onGpsMeasurementsReceived, _data, null, Stub.TRANSACTION_onGpsMeasurementsReceived);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onStatusChanged(int status) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onStatusChanged, _data, null, Stub.TRANSACTION_onGpsMeasurementsReceived);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onGpsMeasurementsReceived /*1*/:
                    GpsMeasurementsEvent _arg0;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (GpsMeasurementsEvent) GpsMeasurementsEvent.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
