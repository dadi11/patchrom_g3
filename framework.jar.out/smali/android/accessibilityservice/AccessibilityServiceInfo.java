...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    static class C00021 implements Creator<AccessibilityServiceInfo> {
        C00021() {
        }
    ...
    static {
        ...
        sAvailableCapabilityInfos.put(FEEDBACK_SPOKEN, new CapabilityInfo(FEEDBACK_SPOKEN, 17039707, 17039708));
        sAvailableCapabilityInfos.put(FLAG_INCLUDE_NOT_IMPORTANT_VIEWS, new CapabilityInfo(FLAG_INCLUDE_NOT_IMPORTANT_VIEWS, 17039709, 17039710));
        sAvailableCapabilityInfos.put(FLAG_REQUEST_TOUCH_EXPLORATION_MODE, new CapabilityInfo(FLAG_REQUEST_TOUCH_EXPLORATION_MODE, 17039711, 17039712));
        sAvailableCapabilityInfos.put(FLAG_REQUEST_ENHANCED_WEB_ACCESSIBILITY, new CapabilityInfo(FLAG_REQUEST_ENHANCED_WEB_ACCESSIBILITY, 17039713, 17039714));
        CREATOR = new C00021();
    }
