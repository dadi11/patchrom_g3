...
class IInputMethodSessionWrapper extends Stub implements Callback {
    ...
    public void executeMessage(Message msg) {
        ...
        if (this.mInputMethodSession == null) {
            switch (msg.what) {
                case DO_UPDATE_SELECTION /*90*/:
                case DO_APP_PRIVATE_COMMAND /*100*/:
                    msg.obj.recycle();
                    return;
                default:
                    return;
        ...
        switch (msg.what) {
            ...
            case DO_UPDATE_SELECTION /*90*/:
                ...
                args.recycle();
            case DO_UPDATE_CURSOR /*95*/:
                this.mInputMethodSession.updateCursor((Rect) msg.obj);
            case DO_UPDATE_CURSOR_ANCHOR_INFO /*99*/:
            ...
            case DO_APP_PRIVATE_COMMAND /*100*/:
                ...
                args.recycle();
            case DO_TOGGLE_SOFT_INPUT /*105*/:
                this.mInputMethodSession.toggleSoftInput(msg.arg1, msg.arg2);
            case DO_FINISH_SESSION /*110*/:
                doFinishSession();
            case DO_VIEW_CLICKED /*115*/:
    ...
    public void finishInput() {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessage(DO_FINISH_INPUT));
    }

    public void displayCompletions(CompletionInfo[] completions) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageO(DO_DISPLAY_COMPLETIONS, completions));
    }

    public void updateExtractedText(int token, ExtractedText text) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageIO(DO_UPDATE_EXTRACTED_TEXT, token, text));
    }
    ...
    public void updateSelection(int oldSelStart, int oldSelEnd, int newSelStart, int newSelEnd, int candidatesStart, int candidatesEnd) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageIIIIII(DO_UPDATE_SELECTION, oldSelStart, oldSelEnd, newSelStart, newSelEnd, candidatesStart, candidatesEnd));
    }

    public void viewClicked(boolean focusChanged) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(DO_VIEW_CLICKED, focusChanged ? 1 : 0));
    }

    public void updateCursor(Rect newCursor) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageO(DO_UPDATE_CURSOR, newCursor));
    }

    public void updateCursorAnchorInfo(CursorAnchorInfo cursorAnchorInfo) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageO(DO_UPDATE_CURSOR_ANCHOR_INFO, cursorAnchorInfo));
    }
    ...
    public void toggleSoftInput(int showFlags, int hideFlags) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageII(DO_TOGGLE_SOFT_INPUT, showFlags, hideFlags));
    }

    public void finishSession() {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessage(DO_FINISH_SESSION));
    }
}
