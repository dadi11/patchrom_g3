...
class IInputMethodWrapper extends Stub implements Callback {
    ...
    public void bindInput(InputBinding binding) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageO(DO_SET_INPUT_CONTEXT, new InputBinding(new InputConnectionWrapper(IInputContext.Stub.asInterface(binding.getConnectionToken())), binding)));
    }
    ...
    public void startInput(IInputContext inputContext, EditorInfo attribute) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageOO(DO_START_INPUT, inputContext, attribute));
    }

    public void restartInput(IInputContext inputContext, EditorInfo attribute) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageOO(DO_RESTART_INPUT, inputContext, attribute));
    }
