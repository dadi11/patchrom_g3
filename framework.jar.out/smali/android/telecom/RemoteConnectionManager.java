...
public class RemoteConnectionManager {
    ...
    public RemoteConnectionManager(ConnectionService ourConnectionServiceImpl) {
        this.mRemoteConnectionServices = new HashMap();
    ...
    public void conferenceRemoteConnections(RemoteConnection a, RemoteConnection b) {
        ...
        Log.m11w((Object) this, "Request to conference incompatible remote connections (%s,%s) (%s,%s)", a.getConnectionService(), a.getId(), b.getConnectionService(), b.getId());
    }
}
