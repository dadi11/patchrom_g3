...
final class ConnectionServiceAdapter implements DeathRecipient {
    ...
    void setIsConferenced(String callId, String conferenceCallId) {
        for (IConnectionServiceAdapter adapter : this.mAdapters) {
            try {
                Log.m3d((Object) this, "sending connection %s with conference %s", callId, conferenceCallId);
    ...
    void queryRemoteConnectionServices(RemoteServiceCallback callback) {
        if (this.mAdapters.size() == 1) {
            try {
                ...
                Log.m5e((Object) this, e, "Exception trying to query for remote CSs", new Object[0]);
            }
        }
    }
    ...
    void setVideoState(String callId, int videoState) {
        Log.m9v((Object) this, "setVideoState: %d", Integer.valueOf(videoState));
        for (IConnectionServiceAdapter adapter : this.mAdapters) {
            try {
    ...
    void setConferenceableConnections(String callId, List<String> conferenceableCallIds) {
        Log.m9v((Object) this, "setConferenceableConnections: %s, %s", callId, conferenceableCallIds);
        for (IConnectionServiceAdapter adapter : this.mAdapters) {
            try {
    ...
    void addExistingConnection(String callId, ParcelableConnection connection) {
        Log.m9v((Object) this, "addExistingConnection: %s", callId);
        for (IConnectionServiceAdapter adapter : this.mAdapters) {
            try {
