...
class Ripple {
    ...
    /* renamed from: android.graphics.drawable.Ripple.1 */
    ...
    public Ripple(RippleDrawable owner, Rect bounds, float startingX, float startingY) {
        ...
        this.mTweenX = 0.0f;
        this.mTweenY = 0.0f;
        this.mAnimationListener = new C01941();
        this.mOwner = owner;
        this.mBounds = bounds;
    ...
    public void enter() {
        ...
        ObjectAnimator radius = ObjectAnimator.ofFloat(this, "radiusGravity", new float[]{GLOBAL_SPEED});
        radius.setAutoCancel(true);
        radius.setDuration((long) radiusDuration);
        radius.setInterpolator(LINEAR_INTERPOLATOR);
        radius.setStartDelay(RIPPLE_ENTER_DELAY);
        ObjectAnimator cX = ObjectAnimator.ofFloat(this, "xGravity", new float[]{GLOBAL_SPEED});
        cX.setAutoCancel(true);
        cX.setDuration((long) radiusDuration);
        cX.setInterpolator(LINEAR_INTERPOLATOR);
        cX.setStartDelay(RIPPLE_ENTER_DELAY);
        ObjectAnimator cY = ObjectAnimator.ofFloat(this, "yGravity", new float[]{GLOBAL_SPEED});
    ...
    private void exitSoftware(int radiusDuration, int opacityDuration) {
        ObjectAnimator radiusAnim = ObjectAnimator.ofFloat(this, "radiusGravity", new float[]{GLOBAL_SPEED});
        radiusAnim.setAutoCancel(true);
        radiusAnim.setDuration((long) radiusDuration);
        radiusAnim.setInterpolator(DECEL_INTERPOLATOR);
        ObjectAnimator xAnim = ObjectAnimator.ofFloat(this, "xGravity", new float[]{GLOBAL_SPEED});
        xAnim.setAutoCancel(true);
        xAnim.setDuration((long) radiusDuration);
        xAnim.setInterpolator(DECEL_INTERPOLATOR);
        ObjectAnimator yAnim = ObjectAnimator.ofFloat(this, "yGravity", new float[]{GLOBAL_SPEED});
