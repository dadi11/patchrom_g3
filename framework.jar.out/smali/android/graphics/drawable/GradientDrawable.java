...
public class GradientDrawable extends Drawable {
    ...
    static /* synthetic */ class C01901 {
        static final /* synthetic */ int[] f17x8f1352bc;

        static {
            f17x8f1352bc = new int[Orientation.values().length];
            try {
                f17x8f1352bc[Orientation.TOP_BOTTOM.ordinal()] = GradientDrawable.RADIUS_TYPE_FRACTION;
            } catch (NoSuchFieldError e) {
            }
            try {
                f17x8f1352bc[Orientation.TR_BL.ordinal()] = GradientDrawable.SWEEP_GRADIENT;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f17x8f1352bc[Orientation.RIGHT_LEFT.ordinal()] = GradientDrawable.RING;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f17x8f1352bc[Orientation.BR_TL.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f17x8f1352bc[Orientation.BOTTOM_TOP.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f17x8f1352bc[Orientation.BL_TR.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f17x8f1352bc[Orientation.LEFT_RIGHT.ordinal()] = 7;
        ...
        if (this.mGradientIsDirty) {
            ...
            if (colors != null) {
                ...
                if (st.mGradient == 0) {
                    ...
                    switch (C01901.f17x8f1352bc[st.mOrientation.ordinal()]) {
                        case RADIUS_TYPE_FRACTION /*1*/:
                            x0 = r.left;
                            y0 = r.top;
                            x1 = x0;
                ...
                if (st.mColorStateList == null) {
                    this.mFillPaint.setColor(Spanned.SPAN_USER);
                }
            }
        }
