        ...
        while (parser.next() != 3) {
            if (parser.getEventType() == 2) {
                if (parser.getName().equals("font")) {
                    ...
                    fonts.add(new Font("/system/fonts/" + parser.nextText(), weightStr == null ? Voice.QUALITY_HIGH : Integer.parseInt(weightStr), "italic".equals(parser.getAttributeValue(null, TtmlUtils.TAG_STYLE))));
                } else {
                    skip(parser);
                }
            }
