...
public class Matrix {
    ...
    /* renamed from: android.graphics.Matrix.1 */
    static class C01751 extends Matrix {
        C01751() {
        }
    ...
    public enum ScaleToFit {
        FILL(Matrix.MSCALE_X),
        START(Matrix.MSKEW_X),
        CENTER(Matrix.MTRANS_X),
        END(Matrix.MSKEW_Y);
