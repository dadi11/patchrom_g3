...
public class Atlas {
    ...
    private static class SlicePolicy extends Policy {
        ...
        private static class Cell {
            ...
            public String toString() {
                return String.format("cell[x=%d y=%d width=%d height=%d", new Object[]{Integer.valueOf(this.f11x), Integer.valueOf(this.f12y), Integer.valueOf(this.width), Integer.valueOf(this.height)});
            }
        }
        ...
        private boolean insert(Cell cell, Cell prev, int width, int height, Entry entry) {
            ...
            first.f11x = (cell.f11x + width) + this.mPadding;
            first.f12y = cell.f12y;
            first.width = deltaWidth - this.mPadding;
            second.f11x = cell.f11x;
            second.f12y = (cell.f12y + height) + this.mPadding;
    ...
    private static Policy findPolicy(Type type, int width, int height, int flags) {
        switch (C01721.$SwitchMap$android$graphics$Atlas$Type[type.ordinal()]) {
