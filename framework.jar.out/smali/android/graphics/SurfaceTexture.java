...
public class SurfaceTexture {
    ...
    class C01811 extends Handler {
        ...
        C01811(Looper x0, Callback x1, boolean x2, OnFrameAvailableListener onFrameAvailableListener) {
    ...
    public void setOnFrameAvailableListener(OnFrameAvailableListener listener, Handler handler) {
        if (listener != null) {
            ...
            this.mOnFrameAvailableHandler = new C01811(looper, null, true, listener);
            return;
        }
