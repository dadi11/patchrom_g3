...
public final class Rect implements Parcelable {
    ...
    static class C01781 implements Creator<Rect> {
        C01781() {
        }
    ...
    public void scaleRoundIn(float scale) {
        if (scale != LayoutParams.BRIGHTNESS_OVERRIDE_FULL) {
            this.left = (int) Math.ceil((double) (((float) this.left) * scale));
            this.top = (int) Math.ceil((double) (((float) this.top) * scale));
            this.right = (int) Math.floor((double) (((float) this.right) * scale));
            this.bottom = (int) Math.floor((double) (((float) this.bottom) * scale));
        }
    }
}
