...
public class View implements Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    public static final Property<View, Float> f0X;
    public static final Property<View, Float> f1Y;
    public static final Property<View, Float> f2Z;
    ...
    class C08371 implements OnClickListener {
        ...
        public void onClick(View v) {
            if (this.mHandler == null) {
                try {
                    Class cls = View.this.getContext().getClass();
                    String str = this.val$handlerName;
                    Class[] clsArr = new Class[View.VIEW_STATE_WINDOW_FOCUSED];
                    clsArr[View.VISIBLE] = View.class;
                    this.mHandler = cls.getMethod(str, clsArr);
                    ...
                    throw new IllegalStateException("Could not find a method " + this.val$handlerName + "(View) in the activity " + View.this.getContext().getClass() + " for onClick handler" + " on view " + View.this.getClass() + idText, e);
                }
            }
            try {
                Method method = this.mHandler;
                Context context = View.this.getContext();
                Object[] objArr = new Object[View.VIEW_STATE_WINDOW_FOCUSED];
                objArr[View.VISIBLE] = View.this;
    ...
    class C08382 implements Predicate<View> {
    ...
    static class C08393 extends FloatProperty<View> {
        C08393(String x0) {
            super(x0);
        }
    ...
    static class C08404 extends FloatProperty<View> {
        C08404(String x0) {
            super(x0);
        }
    ...
    static class C08415 extends FloatProperty<View> {
        C08415(String x0) {
            super(x0);
        }
    ...
    static class C08426 extends FloatProperty<View> {
        C08426(String x0) {
            super(x0);
        }
    ...
    static class C08437 extends FloatProperty<View> {
        C08437(String x0) {
            super(x0);
        }
    ...
    static class C08448 extends FloatProperty<View> {
        C08448(String x0) {
            super(x0);
        }
    ...
    static class C08459 extends FloatProperty<View> {
        C08459(String x0) {
            super(x0);
        }
    ...
    public static class BaseSavedState extends AbsSavedState {
        ...
        static class C08461 implements Creator<BaseSavedState> {
            C08461() {
            }
    ...
    private final class CheckForTap implements Runnable {
        ...
        public void run() {
            ...
            View.this.setPressed(true, this.f90x, this.f91y);
    ...
    public static class DragShadowBuilder {
        ...
        public void onProvideShadowMetrics(Point shadowSize, Point shadowTouchPoint) {
            ...
            if (view != null) {
                ...
                shadowTouchPoint.set(shadowSize.f13x / View.VIEW_STATE_SELECTED, shadowSize.f14y / View.VIEW_STATE_SELECTED);
                return;
            }
    ...
    private class SendViewScrolledAccessibilityEvent implements Runnable {
        ...
        public void run() {
            View.this.sendAccessibilityEvent(View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY);
    ...
    static {
        ...
        VIEW_STATE_IDS = new int[]{16842909, VIEW_STATE_WINDOW_FOCUSED, 16842913, VIEW_STATE_SELECTED, 16842908, VIEW_STATE_FOCUSED, 16842910, VIEW_STATE_ENABLED, 16842919, VIEW_STATE_PRESSED, 16843518, VIEW_STATE_ACTIVATED, 16843547, VIEW_STATE_ACCELERATED, 16843623, WILL_NOT_DRAW, 16843624, VIEW_STATE_DRAG_CAN_ACCEPT, 16843625, VIEW_STATE_DRAG_HOVERED};
        if (VIEW_STATE_IDS.length / VIEW_STATE_SELECTED != R.styleable.ViewDrawableStates.length) {
            throw new IllegalStateException("VIEW_STATE_IDs array length does not match ViewDrawableStates style array");
        }
        int i;
        int j;
        int[] orderedIds = new int[VIEW_STATE_IDS.length];
        for (i = VISIBLE; i < R.styleable.ViewDrawableStates.length; i += VIEW_STATE_WINDOW_FOCUSED) {
        ...
        PFLAG2_TEXT_ALIGNMENT_FLAGS = new int[]{VISIBLE, PFLAG_LAYOUT_REQUIRED, RECENT_APPS_VISIBLE, AudioSystem.DEVICE_OUT_ALL_USB, SYSTEM_UI_TRANSPARENT, 40960, 49152};
        sNextGeneratedId = new AtomicInteger(VIEW_STATE_WINDOW_FOCUSED);
        ALPHA = new C08393("alpha");
        TRANSLATION_X = new C08404("translationX");
        TRANSLATION_Y = new C08415("translationY");
        TRANSLATION_Z = new C08426("translationZ");
        f0X = new C08437("x");
        f1Y = new C08448("y");
        f2Z = new C08459("z");
    ...
    protected boolean isVisibleToUser(Rect boundInView) {
        ...
        visibleRect.offset(-offset.f13x, -offset.f14y);
    ...
    View findUserSetNextFocus(View root, int direction) {
        switch (direction) {
            case VIEW_STATE_WINDOW_FOCUSED /*1*/:
                return this.mID != NO_ID ? root.findViewByPredicateInsideOut(this, new C08382(this.mID)) : null;
            ...
            switch (event.getAction()) {
                case VISIBLE /*0*/:
                    ...
                    if (!performButtonActionOnTouchDown(event)) {
                        ...
                        this.mPendingCheckForTap.f90x = event.getX();
                        this.mPendingCheckForTap.f91y = event.getY();
    ...
    public final boolean getLocalVisibleRect(Rect r) {
        ...
        r.offset(-offset.f13x, -offset.f14y);
        return true;
    }
    ...
    public final boolean startDrag(ClipData data, DragShadowBuilder shadowBuilder, Object myLocalState, int flags) {
        ...
        if (shadowSize.f13x < 0 || shadowSize.f14y < 0 || shadowTouchPoint.f13x < 0 || shadowTouchPoint.f14y < 0) {
            throw new IllegalStateException("Drag shadow dimensions must not be negative");
        }
        Surface surface = new Surface();
        Canvas canvas;
        try {
            IBinder token = this.mAttachInfo.mSession.prepareDrag(this.mAttachInfo.mWindow, flags, shadowSize.f13x, shadowSize.f14y, surface);
            if (token == null) {
                return DBG;
            }
            ...
            boolean okay = this.mAttachInfo.mSession.performDrag(this.mAttachInfo.mWindow, token, (float) shadowSize.f13x, (float) shadowSize.f14y, (float) shadowTouchPoint.f13x, (float) shadowTouchPoint.f14y, data);
            surface.release();
            return okay;
        } catch (Throwable e) {
