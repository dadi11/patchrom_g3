...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        static class C08771 implements Creator<LayoutParams> {
            C08771() {
            }
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(this.f95x);
            out.writeInt(this.f96y);
        ...
        public LayoutParams(Parcel in) {
            ...
            this.f95x = in.readInt();
            this.f96y = in.readInt();
        ...
        public String toString() {
            ...
            if (!(this.surfaceInsets.left == 0 && this.surfaceInsets.top == 0 && this.surfaceInsets.right == 0 && this.surfaceInsets.bottom == 0)) {
        ...
        public void scale(float scale) {
            this.f95x = (int) ((((float) this.f95x) * scale) + 0.5f);
            this.f96y = (int) ((((float) this.f96y) * scale) + 0.5f);
            if (this.width > 0) {
        ...
        void backup() {
            ...
            backup[SOFT_INPUT_STATE_UNSPECIFIED] = this.f95x;
            backup[TYPE_BASE_APPLICATION] = this.f96y;
        ...
        void restore() {
            int[] backup = this.mCompatibilityParamsBackup;
            if (backup != null) {
                this.f95x = backup[SOFT_INPUT_STATE_UNSPECIFIED];
                this.f96y = backup[TYPE_BASE_APPLICATION];
