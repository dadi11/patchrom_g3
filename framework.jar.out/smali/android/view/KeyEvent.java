...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    static class C08241 implements Creator<KeyEvent> {
        C08241() {
        }
    ...
    public static class DispatcherState {
        ...
        public void handleUpEvent(KeyEvent event) {
            ...
            if (this.mDownKeyCode == keyCode) {
                KeyEvent.access$076(event, KeyEvent.META_ALT_LOCKED);
                this.mDownKeyCode = KeyEvent.KEYCODE_UNKNOWN;
                this.mDownTarget = null;
            }
        }
    ...
    static {
        String[] strArr = new String[META_ALT_RIGHT_ON];
        strArr[KEYCODE_UNKNOWN] = "META_SHIFT_ON";
        strArr[META_SHIFT_ON] = "META_ALT_ON";
        strArr[META_ALT_ON] = "META_SYM_ON";
        strArr[KEYCODE_HOME] = "META_FUNCTION_ON";
        strArr[META_SYM_ON] = "META_ALT_LEFT_ON";
        strArr[KEYCODE_CALL] = "META_ALT_RIGHT_ON";
        strArr[KEYCODE_ENDCALL] = "META_SHIFT_LEFT_ON";
        strArr[KEYCODE_0] = "META_SHIFT_RIGHT_ON";
        strArr[META_FUNCTION_ON] = "META_CAP_LOCKED";
        strArr[KEYCODE_2] = "META_ALT_LOCKED";
        strArr[MAX_RECYCLED] = "META_SYM_LOCKED";
        strArr[KEYCODE_4] = "0x00000800";
        strArr[KEYCODE_5] = "META_CTRL_ON";
        strArr[KEYCODE_6] = "META_CTRL_LEFT_ON";
        strArr[KEYCODE_7] = "META_CTRL_RIGHT_ON";
        strArr[KEYCODE_8] = "0x00008000";
        strArr[META_ALT_LEFT_ON] = "META_META_ON";
        strArr[KEYCODE_STAR] = "META_META_LEFT_ON";
        strArr[KEYCODE_POUND] = "META_META_RIGHT_ON";
        strArr[KEYCODE_DPAD_UP] = "0x00080000";
        strArr[KEYCODE_DPAD_DOWN] = "META_CAPS_LOCK_ON";
        strArr[KEYCODE_DPAD_LEFT] = "META_NUM_LOCK_ON";
        strArr[KEYCODE_DPAD_RIGHT] = "META_SCROLL_LOCK_ON";
        strArr[KEYCODE_DPAD_CENTER] = "0x00800000";
        strArr[KEYCODE_VOLUME_UP] = "0x01000000";
        strArr[KEYCODE_VOLUME_DOWN] = "0x02000000";
        strArr[KEYCODE_POWER] = "0x04000000";
        strArr[KEYCODE_CAMERA] = "0x08000000";
        strArr[KEYCODE_CLEAR] = "0x10000000";
        strArr[KEYCODE_A] = "0x20000000";
        strArr[KEYCODE_B] = "0x40000000";
        strArr[KEYCODE_C] = "0x80000000";
        META_SYMBOLIC_NAMES = strArr;
    ...
    public final void setTainted(boolean tainted) {
        this.mFlags = tainted ? this.mFlags | FLAG_TAINTED : this.mFlags & ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    }
    ...
    public static int normalizeMetaState(int metaState) {
        ...
        if ((ViewGroup.FOCUS_BLOCK_DESCENDANTS & metaState) != 0) {
    ...
    public static String metaStateToString(int metaState) {
        ...
        while (metaState != 0) {
            boolean isSet = (metaState & META_SHIFT_ON) != 0 ? true : DEBUG;
            metaState >>>= META_SHIFT_ON;
            if (isSet) {
