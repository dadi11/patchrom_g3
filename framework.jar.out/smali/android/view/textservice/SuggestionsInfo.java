...
public final class SuggestionsInfo implements Parcelable {
    ...
    static class C09071 implements Creator<SuggestionsInfo> {
        C09071() {
        }
    ...
    static {
        EMPTY = (String[]) ArrayUtils.emptyArray(String.class);
        CREATOR = new C09071();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mSuggestionsAvailable ? RESULT_ATTR_IN_THE_DICTIONARY : 0);
    }
