...
public final class Display {
    ...
    public void getSize(Point outSize) {
        synchronized (this) {
            ...
            outSize.f13x = this.mTempMetrics.widthPixels;
            outSize.f14y = this.mTempMetrics.heightPixels;
        }
    }
    ...
    public void getCurrentSizeRange(Point outSmallestSize, Point outLargestSize) {
        synchronized (this) {
            updateDisplayInfoLocked();
            outSmallestSize.f13x = this.mDisplayInfo.smallestNominalAppWidth;
            outSmallestSize.f14y = this.mDisplayInfo.smallestNominalAppHeight;
            outLargestSize.f13x = this.mDisplayInfo.largestNominalAppWidth;
            outLargestSize.f14y = this.mDisplayInfo.largestNominalAppHeight;
        }
    }
    ...
    public void getRealSize(Point outSize) {
        synchronized (this) {
            updateDisplayInfoLocked();
            outSize.f13x = this.mDisplayInfo.logicalWidth;
            outSize.f14y = this.mDisplayInfo.logicalHeight;
        }
    }
