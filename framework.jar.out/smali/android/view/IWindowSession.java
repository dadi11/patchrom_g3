...
public interface IWindowSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowSession {
        ...
        private static class Proxy implements IWindowSession {
            ...
            public int addToDisplay(IWindow window, int seq, LayoutParams attrs, int viewVisibility, int layerStackId, Rect outContentInsets, Rect outStableInsets, InputChannel outInputChannel) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int relayout(IWindow window, int seq, LayoutParams attrs, int requestedWidth, int requestedHeight, int viewVisibility, int flags, Rect outFrame, Rect outOverscanInsets, Rect outContentInsets, Rect outVisibleInsets, Rect outStableInsets, Configuration outConfig, Surface outSurface) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setUniverseTransform(IBinder window, float alpha, float offx, float offy, float dsdx, float dtdx, float dsdy, float dtdy) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setUniverseTransform, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_addToDisplay /*2*/:
                    ...
                    _result = addToDisplay(_arg0, _arg1, _arg2, _arg3, _arg42, _arg5, _arg6, _arg7);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg5 != null) {
                        reply.writeInt(TRANSACTION_add);
                ...
                case TRANSACTION_relayout /*6*/:
                    ...
                    Surface _arg13 = new Surface();
                    _result = relayout(_arg0, _arg1, _arg2, _arg3, _arg42, _arg52, _arg63, _arg72, _arg8, _arg9, _arg10, _arg11, _arg122, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg72 != null) {
                        reply.writeInt(TRANSACTION_add);
                        _arg72.writeToParcel(reply, TRANSACTION_add);
                    } else {
                        reply.writeInt(0);
                    }
                    if (_arg8 != null) {
                ...
                case TRANSACTION_outOfMemory /*8*/:
                    ...
                    return true;
                case TRANSACTION_setTransparentRegion /*9*/:
                    Region _arg14;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = android.view.IWindow.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        _arg14 = (Region) Region.CREATOR.createFromParcel(data);
                    } else {
                        _arg14 = null;
                    }
                    setTransparentRegion(_arg0, _arg14);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setInsets /*10*/:
                    Rect _arg23;
                    Rect _arg32;
                    Region _arg43;
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getDisplayFrame /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = android.view.IWindow.Stub.asInterface(data.readStrongBinder());
                    _arg12 = new Rect();
                ...
                case TRANSACTION_prepareDrag /*16*/:
                    ...
                    if (_arg44 != null) {
                        reply.writeInt(TRANSACTION_add);
                        _arg44.writeToParcel(reply, TRANSACTION_add);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
                case TRANSACTION_performDrag /*17*/:
                    ClipData _arg64;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = android.view.IWindow.Stub.asInterface(data.readStrongBinder());
                ...
                case TRANSACTION_sendWallpaperCommand /*24*/:
                    ...
                    Bundle _result4 = sendWallpaperCommand(_arg02, _arg16, _arg22, _arg3, _arg42, _arg54, data.readInt() != 0);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(TRANSACTION_add);
                    ...
                    return true;
                case TRANSACTION_wallpaperCommandComplete /*25*/:
                    Bundle _arg17;
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                    ...
                    wallpaperCommandComplete(_arg02, _arg17);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setUniverseTransform /*26*/:
                    data.enforceInterface(DESCRIPTOR);
                    setUniverseTransform(data.readStrongBinder(), data.readFloat(), data.readFloat(), data.readFloat(), data.readFloat(), data.readFloat(), data.readFloat(), data.readFloat());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_onRectangleOnScreenRequested /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getWindowId /*28*/:
                    data.enforceInterface(DESCRIPTOR);
    ...
    int addToDisplay(IWindow iWindow, int i, LayoutParams layoutParams, int i2, int i3, Rect rect, Rect rect2, InputChannel inputChannel) throws RemoteException;
    ...
    int relayout(IWindow iWindow, int i, LayoutParams layoutParams, int i2, int i3, int i4, int i5, Rect rect, Rect rect2, Rect rect3, Rect rect4, Rect rect5, Configuration configuration, Surface surface) throws RemoteException;
