...
public final class ViewRootImpl implements ViewParent, Callbacks, HardwareDrawCallbacks {
    ...
    class C08673 implements FrameCallback {
        C08673() {
        }
    ...
    class C08684 implements Runnable {
        C08684() {
        }
        ...
        public void run() {
            ...
            ViewRootImpl.this.mMediaDisabled = SystemProperties.getBoolean(ViewRootImpl.PROPERTY_MEDIA_DISABLED, ViewRootImpl.LOCAL_LOGV);
            ...
            ViewRootImpl.this.mIsCircularEmulator = SystemProperties.getBoolean(ViewRootImpl.PROPERTY_EMULATOR_CIRCULAR, ViewRootImpl.LOCAL_LOGV);
        }
    }
    ...
    final class AccessibilityInteractionConnectionManager implements AccessibilityStateChangeListener {
        ...
        public void ensureConnection() {
            if (!(ViewRootImpl.this.mAttachInfo.mAccessibilityWindowId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED ? true : ViewRootImpl.LOCAL_LOGV)) {
        ...
        public void ensureNoConnection() {
            if (ViewRootImpl.this.mAttachInfo.mAccessibilityWindowId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED ? true : ViewRootImpl.LOCAL_LOGV) {
                ViewRootImpl.this.mAttachInfo.mAccessibilityWindowId = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    ...
    abstract class InputStage {
        ...
        protected boolean shouldDropInputEvent(QueuedInputEvent q) {
            if (ViewRootImpl.this.mView == null || !ViewRootImpl.this.mAdded) {
                ...
                return true;
            } else if ((ViewRootImpl.this.mAttachInfo.mHasWindowFocus && !ViewRootImpl.this.mStopped) || q.mEvent.isFromSource(FINISH_NOT_HANDLED)) {
    ...
    final class EarlyPostImeInputStage extends InputStage {
        ...
        private int processPointerEvent(QueuedInputEvent q) {
            ...
            if (event.isTouchEvent()) {
                ViewRootImpl.this.mLastTouchPoint.f15x = event.getRawX();
                ViewRootImpl.this.mLastTouchPoint.f16y = event.getRawY();
            }
            return 0;
        }
    }
    ...
    private class SendWindowContentChangedAccessibilityEvent implements Runnable {
        ...
        public void run() {
            if (AccessibilityManager.getInstance(ViewRootImpl.this.mContext).isEnabled()) {
                ...
                event.setEventType(AccessibilityNodeInfo.ACTION_PREVIOUS_HTML_ELEMENT);
        ...
        private void update(MotionEvent event, boolean synthesizeNewKeys) {
            ...
            if (xDirection != this.mLastXDirection) {
                if (this.mLastXKeyCode != 0) {
                    removeMessages(MSG_ENQUEUE_X_AXIS_KEY_REPEAT);
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(time, time, MSG_ENQUEUE_X_AXIS_KEY_REPEAT, this.mLastXKeyCode, 0, metaState, deviceId, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, source));
            ...
            if (yDirection != this.mLastYDirection) {
                if (this.mLastYKeyCode != 0) {
                    removeMessages(MSG_ENQUEUE_Y_AXIS_KEY_REPEAT);
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(time, time, MSG_ENQUEUE_X_AXIS_KEY_REPEAT, this.mLastYKeyCode, 0, metaState, deviceId, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, source));
    ...
    final class SyntheticTouchNavigationHandler extends Handler {
        ...
        public SyntheticTouchNavigationHandler() {
            ...
            this.mFlingRunnable = new C08691();
        }
        ...
        private void sendKeyDownOrRepeat(long time, int keyCode, int metaState) {
            ...
            ViewRootImpl.this.enqueueInputEvent(new KeyEvent(this.mPendingKeyDownTime, time, 0, this.mPendingKeyCode, this.mPendingKeyRepeatCount, this.mPendingKeyMetaState, this.mCurrentDeviceId, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, this.mCurrentSource));
        }

        private void sendKeyUp(long time) {
            if (this.mPendingKeyCode != 0) {
                ViewRootImpl.this.enqueueInputEvent(new KeyEvent(this.mPendingKeyDownTime, time, ViewRootImpl.MSG_INVALIDATE, this.mPendingKeyCode, 0, this.mPendingKeyMetaState, this.mCurrentDeviceId, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, this.mCurrentSource));
                this.mPendingKeyCode = 0;
            }
        }
        ...
        public void process(MotionEvent event) {
            ...
            switch (action) {
                case Toast.LENGTH_SHORT /*0*/:
                    ...
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(curTime, curTime, 0, ViewRootImpl.MSG_INVALIDATE_WORLD, 0, metaState, -1, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU));
                    break;
                case ViewRootImpl.MSG_INVALIDATE /*1*/:
                    this.mX.reset(ViewRootImpl.MSG_INVALIDATE_RECT);
                    this.mY.reset(ViewRootImpl.MSG_INVALIDATE_RECT);
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(curTime, curTime, ViewRootImpl.MSG_INVALIDATE, ViewRootImpl.MSG_INVALIDATE_WORLD, 0, metaState, -1, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU));
                    break;
            }
            ...
            if (keycode != 0) {
                ...
                if (accelMovement > movement) {
                    movement--;
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(curTime, curTime, ViewRootImpl.MSG_INVALIDATE_RECT, keycode, accelMovement - movement, metaState, -1, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU));
                }
                while (movement > 0) {
                    movement--;
                    curTime = SystemClock.uptimeMillis();
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(curTime, curTime, 0, keycode, 0, metaState, -1, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU));
                    ViewRootImpl.this.enqueueInputEvent(new KeyEvent(curTime, curTime, ViewRootImpl.MSG_INVALIDATE, keycode, 0, metaState, -1, 0, AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT, KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU));
                }
                this.mLastTime = curTime;
            }
        }
            ...
            switch (msg.what) {
                ...
                case ViewRootImpl.MSG_WINDOW_FOCUS_CHANGED /*6*/:
                    if (ViewRootImpl.this.mAdded) {
                        ...
                        if (hasWindowFocus) {
                            ViewRootImpl.this.ensureTouchModeLocally(msg.arg2 != 0 ? true : ViewRootImpl.LOCAL_LOGV);
                        ...
                        if (hasWindowFocus) {
                            if (!(imm == null || !ViewRootImpl.this.mLastWasImTarget || ViewRootImpl.this.isInLocalFocusMode())) {
                                imm.onWindowFocus(ViewRootImpl.this.mView, ViewRootImpl.this.mView.findFocus(), ViewRootImpl.this.mWindowAttributes.softInputMode, !ViewRootImpl.this.mHasHadWindowFocus ? true : ViewRootImpl.LOCAL_LOGV, ViewRootImpl.this.mWindowAttributes.flags);
                            }
                ...
                case ViewRootImpl.MSG_DISPATCH_INPUT_EVENT /*7*/:
                    ...
                    return;
                case ViewRootImpl.MSG_DISPATCH_APP_VISIBILITY /*8*/:
                    ViewRootImpl.this.handleAppVisibility(msg.arg1 != 0 ? true : ViewRootImpl.LOCAL_LOGV);
                    return;
                case ViewRootImpl.MSG_DISPATCH_GET_NEW_SURFACE /*9*/:
                ...
                case ViewRootImpl.MSG_DISPATCH_KEY_FROM_IME /*11*/:
                    ...
                    ViewRootImpl.this.enqueueInputEvent(event, null, ViewRootImpl.MSG_INVALIDATE, true);
                    return;
                case ViewRootImpl.MSG_FINISH_INPUT_CONNECTION /*12*/:
                    imm = InputMethodManager.peekInstance();
                    if (imm != null) {
    ...
    static class C0870W extends IWindow.Stub {
        private final WeakReference<ViewRootImpl> mViewAncestor;
        private final IWindowSession mWindowSession;

        C0870W(ViewRootImpl viewAncestor) {
        ...
        public void executeCommand(String command, String parameters, ParcelFileDescriptor out) {
            ...
            if (viewAncestor != null) {
                ...
                if (C0870W.checkCallingPermission("android.permission.DUMP") != 0) {
    ...
    public ViewRootImpl(Context context, Display display) {
        ...
        this.mDisplayListener = new C08651();
        ...
        this.mWindowIsRound = context.getResources().getBoolean(17956989);
    }
    ...
    void dispatchApplyInsets(View host) {
        ...
        boolean isRound = ((this.mIsEmulator && this.mIsCircularEmulator) || this.mWindowIsRound) ? true : LOCAL_LOGV;
        ...
        if (host != null && this.mAdded) {
            ...
            if (this.mFirst) {
                ...
                if (lp.type == LayoutParams.TYPE_STATUS_BAR_PANEL || lp.type == LayoutParams.TYPE_INPUT_METHOD) {
                    ...
                    desiredWindowWidth = size.f13x;
                    desiredWindowHeight = size.f14y;
                } else {
            ...
            boolean layoutRequested = this.mLayoutRequested;
            if (layoutRequested) {
        ...
        try {
            ...
            if (this.mLayoutRequesters.size() > 0) {
                ...
                if (validLayoutRequesters != null) {
                    ...
                    if (validLayoutRequesters != null) {
                        getRunQueue().post(new C08662(validLayoutRequesters));
                    }
                }
            }
            Trace.traceEnd(8);
    ...
    private void profileRendering(boolean enabled) {
        if (this.mProfileRendering) {
            ...
            if (this.mRenderProfilingEnabled) {
                if (this.mRenderProfiler == null) {
                    this.mRenderProfiler = new C08673();
                }
        ...
        if (surface.isValid()) {
            ...
            if (!dirty.isEmpty() || this.mIsAnimating || accessibilityFocusDirty) {
                if (this.mAttachInfo.mHardwareRenderer != null && this.mAttachInfo.mHardwareRenderer.isEnabled()) {
                    ...
                    if (this.mSurface.isValid() && dirty != null) {
                        this.mSurface.setDirtyRect(dirty);
                    }
                    dirty.setEmpty();
        ...
        if (this.mView != null && this.mAdded) {
            ...
            if (what == MSG_WINDOW_FOCUS_CHANGED) {
                ...
                if (what == MSG_INVALIDATE_RECT || what == MSG_DIE) {
                    ...
                    event.mX = this.mDragPoint.f15x;
                    event.mY = this.mDragPoint.f16y;
                }
    ...
    public void getLastTouchPoint(Point outLocation) {
        outLocation.f13x = (int) this.mLastTouchPoint.f15x;
        outLocation.f14y = (int) this.mLastTouchPoint.f16y;
    }
    ...
    public void dispatchMoved(int newX, int newY) {
        if (this.mTranslator != null) {
            ...
            newX = (int) (((double) point.f15x) + 0.5d);
            newY = (int) (((double) point.f16y) + 0.5d);
        }
