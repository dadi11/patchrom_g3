...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    class C08583 implements TransitionListener {
        C08583() {
        }
    ...
    public ViewGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mLayoutTransitionListener = new C08583();
        initViewGroup();
    ...
    public boolean dispatchDragEvent(DragEvent event) {
        ...
        switch (event.mAction) {
            ...
            case PERSISTENT_SCROLLING_CACHE /*2*/:
                ...
                if (target != null) {
                    event.mX = localPoint.f15x;
                    event.mY = localPoint.f16y;
    ...
    public boolean getChildVisibleRect(View child, Rect r, Point offset) {
        ...
        if (offset != null) {
            if (!child.hasIdentityMatrix()) {
                ...
                position[PERSISTENT_NO_CACHE] = (float) offset.f13x;
                position[PERSISTENT_ANIMATION_CACHE] = (float) offset.f14y;
                child.getMatrix().mapPoints(position);
                offset.f13x = (int) (position[PERSISTENT_NO_CACHE] + 0.5f);
                offset.f14y = (int) (position[PERSISTENT_ANIMATION_CACHE] + 0.5f);
            }
            offset.f13x += dx;
            offset.f14y += dy;
        }
