...
public final class WindowManagerGlobal {
    ...
    static class C08781 extends Stub {
        C08781() {
        }
        ...
        synchronized (WindowManagerGlobal.class) {
            if (sWindowSession == null) {
                try {
                    ...
                    sWindowSession = getWindowManagerService().openSession(new C08781(), imm.getClient(), imm.getInputContext());
                } catch (RemoteException e) {
        ...
        if (view == null) {
            ...
            synchronized (this.mLock) {
                if (this.mSystemPropertyUpdater == null) {
                    this.mSystemPropertyUpdater = new C08792();
