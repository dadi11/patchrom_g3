...
final class AccessibilityInteractionController {
    ...
    private class AccessibilityNodePrefetcher {
        ...
        public void prefetchAccessibilityNodeInfos(View view, int virtualViewId, int fetchFlags, List<AccessibilityNodeInfo> outInfos) {
            ...
            if (virtualViewId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
        ...
        private void prefetchPredecessorsOfVirtualNode(AccessibilityNodeInfo root, View providerHost, AccessibilityNodeProvider provider, List<AccessibilityNodeInfo> outInfos) {
            ...
            while (accessibilityViewId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED && outInfos.size() < MAX_ACCESSIBILITY_NODE_INFO_BATCH_SIZE) {
                int virtualDescendantId = AccessibilityNodeInfo.getVirtualDescendantId(parentNodeId);
                if (virtualDescendantId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED || accessibilityViewId == providerHost.getAccessibilityViewId()) {
                    AccessibilityNodeInfo parent;
                    if (virtualDescendantId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
        ...
        private void prefetchSiblingsOfVirtualNode(AccessibilityNodeInfo current, View providerHost, AccessibilityNodeProvider provider, List<AccessibilityNodeInfo> outInfos) {
            ...
            if (parentVirtualDescendantId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED || parentAccessibilityViewId == providerHost.getAccessibilityViewId()) {
                AccessibilityNodeInfo parent;
                if (parentVirtualDescendantId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
    ...
    private void findAccessibilityNodeInfoByAccessibilityIdUiThread(Message message) {
        ...
        try {
            if (this.mViewRootImpl.mView != null && this.mViewRootImpl.mAttachInfo != null) {
                ...
                if (accessibilityViewId == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
        ...
        try {
            if (this.mViewRootImpl.mView != null && this.mViewRootImpl.mAttachInfo != null) {
                ...
                if (target != null && isShown(target)) {
                    AccessibilityNodeProvider provider = target.getAccessibilityNodeProvider();
                    if (provider != null) {
                        succeeded = virtualDescendantId != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED ? provider.performAction(virtualDescendantId, action, arguments) : provider.performAction(-1, action, arguments);
                    } else if (virtualDescendantId == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
    ...
    private void applyAppScaleAndMagnificationSpecIfNeeded(Point point, MagnificationSpec spec) {
        ...
        if (shouldApplyAppScaleAndMagnificationSpec(applicationScale, spec)) {
            if (applicationScale != LayoutParams.BRIGHTNESS_OVERRIDE_FULL) {
                point.f13x = (int) (((float) point.f13x) * applicationScale);
                point.f14y = (int) (((float) point.f14y) * applicationScale);
            }
            if (spec != null) {
                point.f13x = (int) (((float) point.f13x) * spec.scale);
                point.f14y = (int) (((float) point.f14y) * spec.scale);
                point.f13x += (int) spec.offsetX;
                point.f14y += (int) spec.offsetY;
            }
        }
    }
            ...
            if (shouldApplyAppScaleAndMagnificationSpec(applicationScale, spec)) {
                ...
                if (spec != null) {
                    ...
                    if (attachInfo.mDisplay != null) {
                        ...
                        int displayWidth = this.mTempPoint.f13x;
                        int displayHeight = this.mTempPoint.f14y;
    ...
    private boolean shouldApplyAppScaleAndMagnificationSpec(float appScale, MagnificationSpec spec) {
        return (appScale == LayoutParams.BRIGHTNESS_OVERRIDE_FULL && (spec == null || spec.isNop())) ? false : true;
    }
}
