...
public final class AccessibilityManager {
    ...
    public static AccessibilityManager getInstance(Context context) {
        synchronized (sInstanceSync) {
            if (sInstance == null) {
                int userId;
                if (Binder.getCallingUid() == LayoutParams.TYPE_APPLICATION_PANEL || context.checkCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS") == 0 || context.checkCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS_FULL") == 0) {
                    userId = -2;
                } else {
