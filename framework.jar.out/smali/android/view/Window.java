...
public abstract class Window {
    ...
    public void clearPrivateFlags(int flags) {
        setPrivateFlags(PROGRESS_START, flags);
    }
    ...
    public void setDisableWallpaperTouchEvents(boolean disable) {
        setPrivateFlags(disable ? AccessibilityNodeInfo.ACTION_COPY : PROGRESS_START, AccessibilityNodeInfo.ACTION_COPY);
    }
