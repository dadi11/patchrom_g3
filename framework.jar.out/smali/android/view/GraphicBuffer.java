...
public class GraphicBuffer implements Parcelable {
    public static final Creator<GraphicBuffer> CREATOR;
    ...
    /* renamed from: android.view.GraphicBuffer.1 */
    static class C08171 implements Creator<GraphicBuffer> {
        C08171() {
        }
        ...
        public GraphicBuffer createFromParcel(Parcel in) {
            ...
            if (nativeObject != 0) {
                return new GraphicBuffer(height, format, usage, nativeObject, null);
            }
            return null;
        }
