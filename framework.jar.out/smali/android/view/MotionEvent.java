...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    static class C08271 implements Creator<MotionEvent> {
        C08271() {
        }
    ...
    public static final class PointerCoords {
        ...
        public void copyFrom(PointerCoords other) {
            ...
            this.f85x = other.f85x;
            this.f86y = other.f86y;
        ...
        public float getAxisValue(int axis) {
            switch (axis) {
                case MotionEvent.AXIS_X /*0*/:
                    return this.f85x;
                case MotionEvent.TOOL_TYPE_FINGER /*1*/:
                    return this.f86y;
                case MotionEvent.TOOL_TYPE_STYLUS /*2*/:
                    return this.pressure;
                case MotionEvent.TOOL_TYPE_MOUSE /*3*/:
                    return this.size;
                case MotionEvent.TOOL_TYPE_ERASER /*4*/:
                    return this.touchMajor;
                case MotionEvent.AXIS_TOUCH_MINOR /*5*/:
                    return this.touchMinor;
                case MotionEvent.AXIS_TOOL_MAJOR /*6*/:
                    return this.toolMajor;
                case MotionEvent.AXIS_TOOL_MINOR /*7*/:
                    return this.toolMinor;
                case INITIAL_PACKED_AXIS_VALUES /*8*/:
                ...
                default:
                    ...
                    return this.mPackedAxisValues[Long.bitCount(((-1 >>> axis) ^ -1) & bits)];
            }
        }
        ...
        public void setAxisValue(int axis, float value) {
            switch (axis) {
                ...
                default:
                    ...
                    int index = Long.bitCount(((-1 >>> axis) ^ -1) & bits);
                    float[] values = this.mPackedAxisValues;
                    if ((bits & axisBit) == 0) {
                        if (values == null) {
                            ...
                            if (count >= values.length) {
                                float[] newValues = new float[(count * MotionEvent.TOOL_TYPE_STYLUS)];
                                System.arraycopy(values, MotionEvent.AXIS_X, newValues, MotionEvent.AXIS_X, index);
                                System.arraycopy(values, index, newValues, index + MotionEvent.TOOL_TYPE_FINGER, count - index);
                                values = newValues;
                                this.mPackedAxisValues = values;
                            } else if (index != count) {
                                System.arraycopy(values, index, values, index + MotionEvent.TOOL_TYPE_FINGER, count - index);
                            }
                        }
    ...
    static {
        ...
        names.append(TOOL_TYPE_FINGER, "AXIS_Y");
        names.append(TOOL_TYPE_STYLUS, "AXIS_PRESSURE");
        names.append(TOOL_TYPE_MOUSE, "AXIS_SIZE");
        names.append(TOOL_TYPE_ERASER, "AXIS_TOUCH_MAJOR");
        ...
        names.append(EDGE_RIGHT, "AXIS_ORIENTATION");
        names.append(AXIS_VSCROLL, "AXIS_VSCROLL");
        names.append(MAX_RECYCLED, "AXIS_HSCROLL");
        ...
        names.append(BUTTON_FORWARD, "AXIS_HAT_Y");
        ...
        String[] strArr = new String[AXIS_GENERIC_1];
        strArr[AXIS_X] = "BUTTON_PRIMARY";
        strArr[TOOL_TYPE_FINGER] = "BUTTON_SECONDARY";
        strArr[TOOL_TYPE_STYLUS] = "BUTTON_TERTIARY";
        strArr[TOOL_TYPE_MOUSE] = "BUTTON_BACK";
        strArr[TOOL_TYPE_ERASER] = "BUTTON_FORWARD";
        strArr[AXIS_TOUCH_MINOR] = "0x00000020";
        strArr[AXIS_TOOL_MAJOR] = "0x00000040";
        strArr[AXIS_TOOL_MINOR] = "0x00000080";
        strArr[EDGE_RIGHT] = "0x00000100";
        strArr[AXIS_VSCROLL] = "0x00000200";
        strArr[MAX_RECYCLED] = "0x00000400";
        strArr[AXIS_Z] = "0x00000800";
        strArr[AXIS_RX] = "0x00001000";
        strArr[AXIS_RY] = "0x00002000";
        strArr[AXIS_RZ] = "0x00004000";
        strArr[AXIS_HAT_X] = "0x00008000";
        strArr[BUTTON_FORWARD] = "0x00010000";
        strArr[AXIS_LTRIGGER] = "0x00020000";
        strArr[AXIS_RTRIGGER] = "0x00040000";
        strArr[AXIS_THROTTLE] = "0x00080000";
        strArr[AXIS_RUDDER] = "0x00100000";
        strArr[AXIS_WHEEL] = "0x00200000";
        strArr[AXIS_GAS] = "0x00400000";
        strArr[AXIS_BRAKE] = "0x00800000";
        strArr[AXIS_DISTANCE] = "0x01000000";
        strArr[AXIS_TILT] = "0x02000000";
        strArr[26] = "0x04000000";
        strArr[27] = "0x08000000";
        strArr[28] = "0x10000000";
        strArr[29] = "0x20000000";
        strArr[30] = "0x40000000";
        strArr[31] = "0x80000000";
        BUTTON_SYMBOLIC_NAMES = strArr;
        TOOL_TYPE_SYMBOLIC_NAMES = new SparseArray();
        names = TOOL_TYPE_SYMBOLIC_NAMES;
        names.append(AXIS_X, "TOOL_TYPE_UNKNOWN");
    ...
    public final boolean isTainted() {
        return (HISTORY_CURRENT & getFlags()) != 0;
    }

    public final void setTainted(boolean tainted) {
        int flags = getFlags();
        nativeSetFlags(this.mNativePtr, tainted ? HISTORY_CURRENT | flags : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED & flags);
    }

    public final boolean isTargetAccessibilityFocus() {
        return (FLAG_TARGET_ACCESSIBILITY_FOCUS & getFlags()) != 0;
    }

    public final void setTargetAccessibilityFocus(boolean targetsFocus) {
        int flags = getFlags();
        nativeSetFlags(this.mNativePtr, targetsFocus ? FLAG_TARGET_ACCESSIBILITY_FOCUS | flags : -1073741825 & flags);
    }
            ...
            if (nativeGetSource(this.mNativePtr) == nativeGetSource(event.mNativePtr)) {
                if (nativeGetFlags(this.mNativePtr) == nativeGetFlags(event.mNativePtr)) {
                    ...
                    synchronized (gSharedTempLock) {
                        ...
                        for (int h = AXIS_X; h <= historySize; h += TOOL_TYPE_FINGER) {
                            int historyPos;
                            if (h == historySize) {
    ...
    public final MotionEvent clampNoHistory(float left, float top, float right, float bottom) {
        ...
        synchronized (gSharedTempLock) {
            ...
            for (int i = AXIS_X; i < pointerCount; i += TOOL_TYPE_FINGER) {
                ...
                pc[i].f85x = clamp(pc[i].f85x, left, right);
                pc[i].f86y = clamp(pc[i].f86y, top, bottom);
            }
    ...
    public final MotionEvent split(int idBits) {
        ...
        synchronized (gSharedTempLock) {
            ...
            int newAction;
            if (oldActionMasked != AXIS_TOUCH_MINOR && oldActionMasked != AXIS_TOOL_MAJOR) {
                newAction = oldAction;
            } else if (newActionPointerIndex < 0) {
                newAction = TOOL_TYPE_STYLUS;
            } else if (newPointerCount == TOOL_TYPE_FINGER) {
                newAction = oldActionMasked == AXIS_TOUCH_MINOR ? AXIS_X : TOOL_TYPE_FINGER;
            } else {
                newAction = oldActionMasked | (newActionPointerIndex << EDGE_RIGHT);
            }
    ...
    public static String buttonStateToString(int buttonState) {
        ...
        int i = AXIS_X;
        while (buttonState != 0) {
            boolean isSet = (buttonState & TOOL_TYPE_FINGER) != 0;
