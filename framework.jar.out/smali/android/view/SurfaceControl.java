...
public class SurfaceControl {
    ...
    public void setTransparent(boolean isTransparent) {
        checkNotReleased();
        if (isTransparent) {
            nativeSetFlags(this.mNativeObject, SURFACE_TRANSPARENT, SURFACE_TRANSPARENT);
        } else {
            nativeSetFlags(this.mNativeObject, POWER_MODE_OFF, SURFACE_TRANSPARENT);
        }
    }
    ...
    public static Bitmap screenshot(int width, int height) {
        return nativeScreenshot(getBuiltInDisplay(POWER_MODE_OFF), new Rect(), width, height, (int) POWER_MODE_OFF, POWER_MODE_OFF, true, false, POWER_MODE_OFF);
    }
