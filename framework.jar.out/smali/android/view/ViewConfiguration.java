...
public class ViewConfiguration {
    ...
    private ViewConfiguration(Context context) {
        ...
        this.mMaximumDrawingCacheSize = (size.f13x * 4) * size.f14y;
        ...
        if (!this.sHasPermanentMenuKeySet) {
            switch (res.getInteger(17694846)) {
        ...
        this.mFadingMarqueeEnabled = res.getBoolean(17956884);
        ...
        this.mGlobalActionsKeyTimeout = (long) res.getInteger(17694838);
    }
