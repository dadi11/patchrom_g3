...
public class DrmInfoEvent extends DrmEvent {
    ...
    private void checkTypeValidity(int type) {
        if ((type < TYPE_ALREADY_REGISTERED_BY_ANOTHER_ACCOUNT || type > TYPE_RIGHTS_REMOVED) && type != LayoutParams.TYPE_APPLICATION_MEDIA && type != LayoutParams.TYPE_APPLICATION_SUB_PANEL) {
