...
public class Camera {
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Camera.CAMERA_MSG_ERROR /*1*/:
                ...
                case Camera.CAMERA_MSG_FOCUS /*4*/:
                ...
                case Camera.CAMERA_MSG_ZOOM /*8*/:
                    if (Camera.this.mZoomListener != null) {
                        ...
                        access$1000.onZoomChange(i, z, this.mCamera);
                    }
                ...
                case Camera.CAMERA_MSG_FOCUS_MOVE /*2048*/:
                    if (Camera.this.mAutoFocusMoveCallback != null) {
                        AutoFocusMoveCallback access$1300 = Camera.this.mAutoFocusMoveCallback;
                        if (msg.arg1 != 0) {
                            success = true;
                        }
                        access$1300.onAutoFocusMoving(success, this.mCamera);
                    }
                case Camera.CAMERA_MSG_STATS_DATA /*4096*/:
                    int[] statsdata = new int[KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU];
                    for (int i2 = Camera.NO_ERROR; i2 < KeyEvent.KEYCODE_TV_MEDIA_CONTEXT_MENU; i2 += Camera.CAMERA_MSG_ERROR) {
                        statsdata[i2] = Camera.byteToInt((byte[]) msg.obj, i2 * Camera.CAMERA_MSG_FOCUS);
                    }
                    if (Camera.this.mCameraDataCallback != null) {
                        Camera.this.mCameraDataCallback.onCameraData(statsdata, this.mCamera);
                    }
                case Camera.CAMERA_MSG_META_DATA /*8192*/:
    ...
    public static class Face {
        ...
        public Face() {
            this.id = Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED;
            this.leftEye = null;
            this.rightEye = null;
            this.mouth = null;
        }
    ...
    public class Parameters {
        ...
        public String flatten() {
            ...
            flattened.deleteCharAt(flattened.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED);
            return flattened.toString();
        }

        public void unflatten(String flattened) {
            this.mMap.clear();
            StringSplitter<String> splitter = new SimpleStringSplitter(PhoneNumberUtils.WAIT);
            splitter.setString(flattened);
            for (String kv : splitter) {
                int pos = kv.indexOf(61);
                if (pos != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
        ...
        public void set(String key, String value) {
            if (key.indexOf(61) != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED || key.indexOf(59) != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED || key.indexOf(PREVIEW_FPS_MIN_INDEX) != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
                Log.e(Camera.TAG, "Key \"" + key + "\" contains invalid character (= or ; or \\0)");
            } else if (value.indexOf(61) == Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED && value.indexOf(59) == Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED && value.indexOf(PREVIEW_FPS_MIN_INDEX) == Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
                put(key, value);
            } else {
        ...
        private void set(String key, List<Area> areas) {
            ...
            for (int i = PREVIEW_FPS_MIN_INDEX; i < areas.size(); i += PREVIEW_FPS_MAX_INDEX) {
                ...
                buffer.append(PhoneNumberUtils.PAUSE);
                ...
                buffer.append(')');
                if (i != areas.size() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
                    buffer.append(PhoneNumberUtils.PAUSE);
                }
            }
        ...
        public List<Integer> getSupportedPreviewFormats() {
            ...
            while (i$.hasNext()) {
                int f = pixelFormatForCameraFormat((String) i$.next());
                if (f != 0) {
        ...
        private int pixelFormatForCameraFormat(String format) {
            ...
            if (format.equals(PIXEL_FORMAT_RGB565)) {
                return Camera.CAMERA_MSG_FOCUS;
            }
        ...
        public void setRotation(int rotation) {
            if (rotation == 0 || rotation == 90 || rotation == KeyEvent.KEYCODE_STB_INPUT || rotation == 270) {
        ...
        private ArrayList<String> split(String str) {
            ...
            StringSplitter<String> splitter = new SimpleStringSplitter(PhoneNumberUtils.PAUSE);
        ...
        private void splitInt(String str, int[] output) {
            if (str != null) {
                ...
                for (String s : splitter) {
                    ...
                    output[index] = Integer.parseInt(s.replaceAll("\\s", ProxyInfo.LOCAL_EXCL_LIST));
                    index = index2;
                }
            }
        }
        ...
        private float getFloat(String key, float defaultValue) {
            try {
                defaultValue = Float.parseFloat((String) this.mMap.get(key));
        ...
        private int getInt(String key, int defaultValue) {
            try {
                defaultValue = Integer.parseInt((String) this.mMap.get(key));
            } catch (NumberFormatException e) {
            }
            return defaultValue;
        }
        ...
        private Size strToSize(String str) {
            ...
            int pos = str.indexOf(KeyEvent.KEYCODE_SYSRQ);
            if (pos != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
        ...
        private ArrayList<int[]> splitRange(String str) {
            if (str != null && str.charAt(PREVIEW_FPS_MIN_INDEX) == '(' && str.charAt(str.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) == ')') {
                ...
                do {
                    ...
                    if (endIndex == Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
                        endIndex = str.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED;
                    }
                    splitInt(str.substring(fromIndex, endIndex), range);
                    rangeList.add(range);
                    fromIndex = endIndex + 3;
                } while (endIndex != str.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED);
                if (rangeList.size() == 0) {
                    return null;
                }
                return rangeList;
        ...
        private ArrayList<Area> splitArea(String str) {
            if (str != null && str.charAt(PREVIEW_FPS_MIN_INDEX) == '(' && str.charAt(str.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) == ')') {
                ...
                do {
                    ...
                    result.add(new Area(new Rect(array[PREVIEW_FPS_MIN_INDEX], array[PREVIEW_FPS_MAX_INDEX], array[FOCUS_DISTANCE_FAR_INDEX], array[3]), array[Camera.CAMERA_MSG_FOCUS]));
                    fromIndex = endIndex + 3;
                } while (endIndex != str.length() + Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED);
                if (result.size() == 0) {
                    return null;
        ...
        private Coordinate strToCoordinate(String str) {
            ...
            int pos = str.indexOf(KeyEvent.KEYCODE_SYSRQ);
            if (pos != Camera.CAMERA_HAL_API_VERSION_UNSPECIFIED) {
                return new Coordinate(Integer.parseInt(str.substring(PREVIEW_FPS_MIN_INDEX, pos)), Integer.parseInt(str.substring(pos + PREVIEW_FPS_MAX_INDEX)));
            }
    ...
    public static Camera open() {
        ...
        for (int i = NO_ERROR; i < numberOfCameras; i += CAMERA_MSG_ERROR) {
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
        ...
        return native_setup(new WeakReference(this), cameraId, halVersion, ActivityThread.currentPackageName());
    }
    ...
    public final void cancelAutoFocus() {
        ...
        this.mEventHandler.removeMessages(CAMERA_MSG_FOCUS);
    }

    public void setAutoFocusMoveCallback(AutoFocusMoveCallback cb) {
        this.mAutoFocusMoveCallback = cb;
        enableFocusMoveCallback(this.mAutoFocusMoveCallback != null ? CAMERA_MSG_ERROR : NO_ERROR);
    }
    ...
    public final void takePicture(ShutterCallback shutter, PictureCallback raw, PictureCallback postview, PictureCallback jpeg) {
        ...
        if (this.mShutterCallback != null) {
            msgType = NO_ERROR | CAMERA_MSG_SHUTTER;
        }
    ...
    public final void sendVendorCommand(int cmd, int arg1, int arg2) {
        if (cmd < LayoutParams.TYPE_APPLICATION_PANEL) {
    ...
    private static int byteToInt(byte[] b, int offset) {
        int value = NO_ERROR;
        for (int i = NO_ERROR; i < CAMERA_MSG_FOCUS; i += CAMERA_MSG_ERROR) {
            value += (b[(3 - i) + offset] & EditorInfo.IME_MASK_ACTION) << ((3 - i) * CAMERA_MSG_ZOOM);
        }
        return value;
    }
    ...
    public int getCurrentFocusPosition() {
        ...
        return CAMERA_HAL_API_VERSION_UNSPECIFIED;
    }
