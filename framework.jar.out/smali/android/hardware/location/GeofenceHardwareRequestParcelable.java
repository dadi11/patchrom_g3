...
public final class GeofenceHardwareRequestParcelable implements Parcelable {
    public static final Creator<GeofenceHardwareRequestParcelable> CREATOR;
    private int mId;
    private GeofenceHardwareRequest mRequest;

    /* renamed from: android.hardware.location.GeofenceHardwareRequestParcelable.1 */
    static class C03041 implements Creator<GeofenceHardwareRequestParcelable> {
        C03041() {
        }
