    ...
    public static class TimerStatusData {
        ...
        static TimerStatusData parseFrom(int result) {
            ...
            if (data.mProgrammed) {
                ...
                data.mDurationHour = bcdByteToInt((byte) ((result >> 16) & EditorInfo.IME_MASK_ACTION));
                data.mDurationMinute = bcdByteToInt((byte) ((result >> 8) & EditorInfo.IME_MASK_ACTION));
            } else {
                data.mNotProgrammedError = (result >> 24) & 15;
                data.mDurationHour = bcdByteToInt((byte) ((result >> 16) & EditorInfo.IME_MASK_ACTION));
                data.mDurationMinute = bcdByteToInt((byte) ((result >> 8) & EditorInfo.IME_MASK_ACTION));
            }
            data.mExtraError = result & EditorInfo.IME_MASK_ACTION;
            return data;
        }
