        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_canChangeSystemAudioMode /*12*/:
                    ...
                    reply.writeNoException();
                    if (_result) {
                        i = TRANSACTION_getSupportedTypes;
                    }
                    reply.writeInt(i);
                    return true;
                ...
                case TRANSACTION_setSystemAudioMode /*14*/:
                    ...
                    setSystemAudioMode(_arg02, android.hardware.hdmi.IHdmiControlCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case TRANSACTION_sendVendorCommand /*24*/:
                    ...
                    sendVendorCommand(_arg0, _arg1, _arg22, _arg3);
                    reply.writeNoException();
                    return true;
