...
public final class MeteringRectangle {
    ...
    public MeteringRectangle(int x, int y, int width, int height, int meteringWeight) {
        ...
        this.mWeight = Preconditions.checkArgumentInRange(meteringWeight, METERING_WEIGHT_DONT_CARE, METERING_WEIGHT_MAX, "meteringWeight");
    }
    ...
    public MeteringRectangle(Point xy, Size dimensions, int meteringWeight) {
        ...
        this.mX = Preconditions.checkArgumentNonnegative(xy.f13x, "x must be nonnegative");
        this.mY = Preconditions.checkArgumentNonnegative(xy.f14y, "y must be nonnegative");
