        ...
        public T unmarshal(ByteBuffer buffer) {
            ...
            if (elementSize != Marshaler.NATIVE_SIZE_DYNAMIC) {
                ...
                if (MarshalQueryableArray.VERBOSE) {
                    Log.v(MarshalQueryableArray.TAG, String.format("Attempting to unpack array (count = %d, element size = %d, bytes remaining = %d) for type %s", new Object[]{Integer.valueOf(arraySize), Integer.valueOf(elementSize), Integer.valueOf(remaining), this.mClass}));
                }
