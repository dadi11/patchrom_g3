    ...
    private class MarshalerRange extends Marshaler<Range<T>> {
        ...
        protected MarshalerRange(TypeReference<Range<T>> typeReference, int nativeType) {
            ...
            try {
                ...
                try {
                    ...
                    Class[] clsArr = new Class[MarshalQueryableRange.RANGE_COUNT];
                    clsArr[0] = Comparable.class;
                    clsArr[1] = Comparable.class;
        ...
        public Range<T> unmarshal(ByteBuffer buffer) {
            ...
            try {
                ...
                Object[] objArr = new Object[MarshalQueryableRange.RANGE_COUNT];
                objArr[0] = lower;
                objArr[1] = upper;
                return (Range) constructor.newInstance(objArr);
        ...
        public int getNativeSize() {
            ...
            if (nestedSize != NATIVE_SIZE_DYNAMIC) {
                return nestedSize * MarshalQueryableRange.RANGE_COUNT;
            }
        ...
        public int calculateMarshalSize(Range<T> value) {
            ...
            return nativeSize != NATIVE_SIZE_DYNAMIC ? nativeSize : this.mNestedTypeMarshaler.calculateMarshalSize(value.getLower()) + this.mNestedTypeMarshaler.calculateMarshalSize(value.getUpper());
        }
    }
