...
public class RequestHolder {
    ...
    public static final class Builder {
        ...
        public RequestHolder build(long frameNumber) {
            return new RequestHolder(this.mSubsequenceId, this.mRequest, this.mRepeating, frameNumber, this.mNumJpegTargets, this.mNumPreviewTargets, null);
        }
    }

    private RequestHolder(int requestId, int subsequenceId, CaptureRequest request, boolean repeating, long frameNumber, int numJpegTargets, int numPreviewTargets) {
        this.mFailed = false;
        this.mRepeating = repeating;
        this.mRequest = request;
        this.mRequestId = requestId;
