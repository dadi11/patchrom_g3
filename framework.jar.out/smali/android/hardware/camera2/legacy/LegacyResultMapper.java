...
public class LegacyResultMapper {
    ...
    private static CameraMetadataNative convertResultMetadata(LegacyRequest legacyRequest) {
        ...
        result.set(CaptureResult.COLOR_CORRECTION_ABERRATION_MODE, Integer.valueOf(1));
        ...
        result.set(CaptureResult.NOISE_REDUCTION_MODE, Integer.valueOf(1));
        return result;
    }
    ...
    private static void mapAeAndFlashMode(CameraMetadataNative m, CameraCharacteristics characteristics, Parameters p) {
        ...
        if (flashModeSetting != null) {
            ...
            switch (flashModeSetting.hashCode()) {
                case 3551:
                    if (flashModeSetting.equals(Parameters.ZSL_ON)) {
                        i = 2;
                        break;
                    }
                    break;
                case 109935:
                    if (flashModeSetting.equals(Parameters.ZSL_OFF)) {
                        i = 0;
                        break;
                    }
                    break;
                case 3005871:
                    if (flashModeSetting.equals(Parameters.WHITE_BALANCE_AUTO)) {
                        i = 1;
                        break;
                    }
                    break;
    ...
    private static int convertLegacyAfMode(String mode) {
        ...
        switch (mode.hashCode()) {
            case -194628547:
                ...
                break;
            case 3005871:
                if (mode.equals(Parameters.WHITE_BALANCE_AUTO)) {
                    i = 0;
                    break;
                }
                break;
