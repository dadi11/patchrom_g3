...
public class UsbDevice implements Parcelable {
    ...
    static class C03181 implements Creator<UsbDevice> {
        C03181() {
        }
        ...
        public UsbDevice createFromParcel(Parcel in) {
            ...
            UsbDevice device = new UsbDevice(name, vendorId, productId, clasz, subClass, protocol, manufacturerName, productName, serialNumber);
