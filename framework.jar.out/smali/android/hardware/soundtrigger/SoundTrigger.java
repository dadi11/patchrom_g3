...
public class SoundTrigger {
    ...
    public static class ConfidenceLevel implements Parcelable {
        ...
        /* renamed from: android.hardware.soundtrigger.SoundTrigger.ConfidenceLevel.1 */
        static class C03061 implements Creator<ConfidenceLevel> {
            C03061() {
            }
    ...
    public static class Keyphrase implements Parcelable {
        ...
        static class C03071 implements Creator<Keyphrase> {
            C03071() {
            }
    ...
    public static class RecognitionEvent implements Parcelable {
        ...
        static class C03131 implements Creator<RecognitionEvent> {
            C03131() {
            }
    ...
    public static class KeyphraseRecognitionEvent extends RecognitionEvent {
        ...
        static class C03081 implements Creator<KeyphraseRecognitionEvent> {
            C03081() {
            }
    ...
    public static class KeyphraseRecognitionExtra implements Parcelable {
        ...
        static class C03091 implements Creator<KeyphraseRecognitionExtra> {
            C03091() {
            }
    ...
    public static class KeyphraseSoundModel extends SoundModel implements Parcelable {
        ...
        static class C03101 implements Creator<KeyphraseSoundModel> {
            C03101() {
            }
    ...
    public static class ModuleProperties implements Parcelable {
        ...
        static class C03111 implements Creator<ModuleProperties> {
            C03111() {
            }
    ...
    public static class RecognitionConfig implements Parcelable {
        ...
        static class C03121 implements Creator<RecognitionConfig> {
            C03121() {
            }
    ...
    public static class SoundModelEvent implements Parcelable {
        ...
        static class C03141 implements Creator<SoundModelEvent> {
            C03141() {
            }
