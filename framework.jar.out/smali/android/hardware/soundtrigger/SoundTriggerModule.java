...
public class SoundTriggerModule {
    ...
    private class NativeEventHandlerDelegate {
        ...
        class C03151 extends Handler {
            ...
            C03151(Looper x0, SoundTriggerModule soundTriggerModule, StatusListener statusListener) {
                this.val$this$0 = soundTriggerModule;
        ...
        NativeEventHandlerDelegate(StatusListener listener, Handler handler) {
            ...
            if (looper != null) {
                this.mHandler = new C03151(looper, SoundTriggerModule.this, listener);
            } else {
                this.mHandler = null;
            }
        }
