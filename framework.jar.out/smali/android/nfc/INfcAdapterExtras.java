        ...
        private static class Proxy implements INfcAdapterExtras {
            ...
            public int getCardEmulationRoute(String pkg) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(pkg);
                    this.mRemote.transact(Stub.TRANSACTION_getCardEmulationRoute, _data, _reply, 0);
                    _reply.readException();
            ...
            public void setCardEmulationRoute(String pkg, int route) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setCardEmulationRoute, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public String getDriverName(String pkg) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(pkg);
                    this.mRemote.transact(Stub.TRANSACTION_getDriverName, _data, _reply, 0);
                    _reply.readException();
