...
class CalendarViewLegacyDelegate extends AbstractCalendarViewDelegate {
    ...
    class C09461 extends DataSetObserver {
        C09461() {
        }
    ...
    class C09472 implements OnScrollListener {
        C09472() {
        }
    ...
    private class WeekView extends View {
        ...
        public void init(int weekNumber, int selectedWeekDay, int focusedMonth) {
            ...
            if (CalendarViewLegacyDelegate.this.mShowWeekNumber) {
                access$2200 = CalendarViewLegacyDelegate.this.mDaysPerWeek + CalendarViewLegacyDelegate.UNSCALED_WEEK_SEPARATOR_LINE_WIDTH;
            } else {
            ...
            if (CalendarViewLegacyDelegate.this.mShowWeekNumber) {
                ...
                i = 0 + CalendarViewLegacyDelegate.UNSCALED_WEEK_SEPARATOR_LINE_WIDTH;
            }
 ...
 */
        ...
        private class WeeksAdapter extends BaseAdapter implements OnTouchListener {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                weekView.init(position, this.mSelectedWeek == position ? this.mSelectedDate.get(CalendarViewLegacyDelegate.DAYS_PER_WEEK) : CalendarViewLegacyDelegate.DEFAULT_WEEK_DAY_TEXT_APPEARANCE_RES_ID, this.mFocusedMonth);
                return weekView;
            }
        ...
        CalendarViewLegacyDelegate(CalendarView delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            String minDate = a.getString(UNSCALED_LIST_SCROLL_TOP_OFFSET);
            ...
            this.mDateTextAppearanceResId = a.getResourceId(UNSCALED_WEEK_MIN_VISIBLE_HEIGHT, 16973894);
            updateDateTextSize();
            ...
            View content = ((LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(17367097, null, false);
            this.mDelegator.addView(content);
            this.mListView = (ListView) this.mDelegator.findViewById(C0000R.id.list);
            this.mDayNamesHeader = (ViewGroup) content.findViewById(16909024);
            this.mMonthName = (TextView) content.findViewById(16909023);
            setUpHeader();
            setUpListView();
            setUpAdapter();
        ...
        private static boolean isSameDate(Calendar firstDate, Calendar secondDate) {
            return (firstDate.get(UNSCALED_SELECTED_DATE_VERTICAL_BAR_WIDTH) == secondDate.get(UNSCALED_SELECTED_DATE_VERTICAL_BAR_WIDTH) && firstDate.get(UNSCALED_WEEK_SEPARATOR_LINE_WIDTH) == secondDate.get(UNSCALED_WEEK_SEPARATOR_LINE_WIDTH)) ? DEFAULT_SHOW_WEEK_NUMBER : false;
        }

        private void setUpAdapter() {
            if (this.mAdapter == null) {
                this.mAdapter = new WeeksAdapter(this.mContext);
                this.mAdapter.registerDataSetObserver(new C09461());
        ...
        private void setUpHeader() {
            ...
            for (i = this.mFirstDayOfWeek; i < count; i += UNSCALED_WEEK_SEPARATOR_LINE_WIDTH) {
                int calendarDay;
                if (i > DAYS_PER_WEEK) {
                    calendarDay = i - 7;
                } else {
        ...
        private void setUpListView() {
            ...
            this.mListView.setOnScrollListener(new C09472());
