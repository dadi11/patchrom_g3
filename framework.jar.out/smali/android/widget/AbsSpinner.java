...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C09231 implements Creator<SavedState> {
            C09231() {
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(preferredWidth, getSuggestedMinimumWidth()), widthMeasureSpec, 0), View.resolveSizeAndState(Math.max(preferredHeight, getSuggestedMinimumHeight()), heightMeasureSpec, 0));
