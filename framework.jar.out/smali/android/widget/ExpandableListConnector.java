...
class ExpandableListConnector extends BaseAdapter implements Filterable {
    ...
    static class GroupMetadata implements Parcelable, Comparable<GroupMetadata> {
        ...
        static class C09731 implements Creator<GroupMetadata> {
            C09731() {
            }
    ...
    public static class PositionMetadata {
        ...
        static {
            sPool = new ArrayList(MAX_POOL_SIZE);
        }
    ...
    public ExpandableListConnector(ExpandableListAdapter expandableListAdapter) {
        this.mMaxExpGroupCount = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
