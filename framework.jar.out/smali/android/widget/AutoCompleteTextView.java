...
public class AutoCompleteTextView extends EditText implements FilterListener {
    ...
    class C09441 implements android.widget.PopupWindow.OnDismissListener {
        final /* synthetic */ OnDismissListener val$dismissListener;

        C09441(OnDismissListener onDismissListener) {
    ...
    private static class PopupDataSetObserver extends DataSetObserver {
        ...
        private PopupDataSetObserver(AutoCompleteTextView view) {
            this.updateRunnable = new C09451();
    ...
    public AutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mPopup.setListSelector(a.getDrawable(EXPAND_MAX));
        ...
        this.mHintResource = a.getResourceId(1, 17367244);
        this.mPopup.setOnItemClickListener(new DropDownItemClickListener());
        setCompletionHint(a.getText(0));
        int inputType = getInputType();
        if ((inputType & 15) == 1) {
            setRawInputType(inputType | AccessibilityNodeInfo.ACTION_CUT);
        }
        a.recycle();
        setFocusable(true);
    ...
    public void setCompletionHint(CharSequence hint) {
        ...
        if (hint == null) {
            ...
            TextView hintView = (TextView) LayoutInflater.from(getContext()).inflate(this.mHintResource, null).findViewById(C0000R.id.text1);
    ...
    public void setOnDismissListener(OnDismissListener dismissListener) {
        ...
        if (dismissListener != null) {
            wrappedListener = new C09441(dismissListener);
        }
    ...
    public void showDropDown() {
        ...
        if (!isPopupShowing()) {
            ...
            this.mPopup.setListItemExpandMax(EXPAND_MAX);
        }
        this.mPopup.show();
