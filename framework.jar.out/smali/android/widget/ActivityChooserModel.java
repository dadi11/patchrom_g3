...
public class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        ...
        r3 = 0;
        r0 = r18;
        r15 = r0.mContext;	 Catch:{ FileNotFoundException -> 0x0028 }
        r0 = r18;
        r0 = r0.mHistoryFileName;	 Catch:{ FileNotFoundException -> 0x0028 }
        r16 = r0;
        r3 = r15.openFileInput(r16);	 Catch:{ FileNotFoundException -> 0x0028 }
        r8 = android.util.Xml.newPullParser();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = java.nio.charset.StandardCharsets.UTF_8;	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = r15.name();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r8.setInput(r3, r15);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r12 = 0;
    L_0x001d:
        r15 = 1;
        if (r12 == r15) goto L_0x002a;
    L_0x0020:
        r15 = 2;
        if (r12 == r15) goto L_0x002a;
    L_0x0023:
        r12 = r8.next();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        goto L_0x001d;
    L_0x0028:
        r4 = move-exception;
    L_0x0029:
    ...
    L_0x002a:
        ...
        r16 = r8.getName();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = r15.equals(r16);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        if (r15 != 0) goto L_0x0067;
    L_0x0036:
        r15 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r16 = "Share records file does not start with historical-records tag.";
        r15.<init>(r16);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        throw r15;	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
    L_0x003e:
        r14 = move-exception;
        r15 = LOG_TAG;	 Catch:{ all -> 0x00f1 }
        r16 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00f1 }
        r16.<init>();	 Catch:{ all -> 0x00f1 }
        r17 = "Error reading historical recrod file: ";
        r16 = r16.append(r17);	 Catch:{ all -> 0x00f1 }
        r0 = r18;
        r0 = r0.mHistoryFileName;	 Catch:{ all -> 0x00f1 }
        r17 = r0;
        r16 = r16.append(r17);	 Catch:{ all -> 0x00f1 }
        r16 = r16.toString();	 Catch:{ all -> 0x00f1 }
        r0 = r16;
        android.util.Log.e(r15, r0, r14);	 Catch:{ all -> 0x00f1 }
    ...
    L_0x0067:
        r0 = r18;
        r5 = r0.mHistoricalRecords;	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r5.clear();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
    L_0x006e:
        r12 = r8.next();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = 1;
    ...
    L_0x0080:
        ...
        if (r12 == r15) goto L_0x006e;
    L_0x0083:
        r7 = r8.getName();	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = "historical-record";
        r15 = r15.equals(r7);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
    ...
    L_0x0097:
        ...
        r16 = r16.toString();	 Catch:{ all -> 0x00f1 }
        r0 = r16;
        android.util.Log.e(r15, r0, r6);	 Catch:{ all -> 0x00f1 }
        if (r3 == 0) goto L_0x0029;
    L_0x00ba:
    ...
    L_0x00c2:
        ...
        r16 = "activity";
        r0 = r16;
        r2 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = 0;
        r16 = "time";
        r0 = r16;
        r15 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r10 = java.lang.Long.parseLong(r15);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r15 = 0;
        r16 = "weight";
        r0 = r16;
        r15 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r13 = java.lang.Float.parseFloat(r15);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r9 = new android.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r9.<init>(r2, r10, r13);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        r5.add(r9);	 Catch:{ XmlPullParserException -> 0x003e, IOException -> 0x0097 }
        goto L_0x006e;
    L_0x00f1:
        r15 = move-exception;
