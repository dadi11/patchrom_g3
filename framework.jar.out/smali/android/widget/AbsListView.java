...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, OnGlobalLayoutListener, FilterListener, OnTouchModeChangeListener, RemoteAdapterConnectionCallback {
    ...
    static final Interpolator sLinearInterpolator;
    ...
    class C09163 implements Runnable {
        final /* synthetic */ View val$child;
        final /* synthetic */ PerformClick val$performClick;

        C09163(View view, PerformClick performClick) {
            this.val$child = view;
    ...
    class C09174 implements Runnable {
        C09174() {
        }
        ...
        public void run() {
            if (AbsListView.this.mTouchMode == 0) {
                ...
                if (child != null && !child.hasFocusable()) {
                    ...
                    point[AbsListView.TRANSCRIPT_MODE_DISABLED] = this.f98x;
                    point[AbsListView.TRANSCRIPT_MODE_NORMAL] = this.f99y;
                    ...
                    if (AbsListView.this.mSelector != null) {
                        ...
                        AbsListView.this.mSelector.setHotspot(this.f98x, this.f99y);
                    }
                    if (longClickable) {
    ...
    private class FlingRunnable implements Runnable {
        ...
        class C09181 implements Runnable {
            ...
            public void run() {
                ...
                if (vt != null && activeId != AbsListView.TOUCH_MODE_UNKNOWN) {
                    vt.computeCurrentVelocity(android.view.WindowManager.LayoutParams.TYPE_APPLICATION_PANEL, (float) AbsListView.this.mMaximumVelocity);
        ...
        FlingRunnable() {
            this.mCheckFlywheel = new C09181();
        ...
        void startOverfling(int initialVelocity) {
            this.mScroller.setInterpolator(null);
            this.mScroller.fling(AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.this.mScrollY, AbsListView.TRANSCRIPT_MODE_DISABLED, initialVelocity, AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.TRANSCRIPT_MODE_DISABLED, RtlSpacingHelper.UNDEFINED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.this.getHeight());
            AbsListView.this.mTouchMode = AbsListView.TOUCH_MODE_OVERFLING;
            AbsListView.this.invalidate();
            AbsListView.this.postOnAnimation(this);
        }
        ...
        public void run() {
            ...
            if (delta > 0) {
                ...
                delta = Math.min(((AbsListView.this.getHeight() - AbsListView.this.mPaddingBottom) - AbsListView.this.mPaddingTop) + AbsListView.TOUCH_MODE_UNKNOWN, delta);
            } else {
                ...
                delta = Math.max(-(((AbsListView.this.getHeight() - AbsListView.this.mPaddingBottom) - AbsListView.this.mPaddingTop) + AbsListView.TOUCH_MODE_UNKNOWN), delta);
            }
            ...
            if (atEnd) {
                if (motionView != null) {
                    AbsListView.this.overScrollBy(AbsListView.TRANSCRIPT_MODE_DISABLED, -(delta - (motionView.getTop() - oldTop)), AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.this.mScrollY, AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.TRANSCRIPT_MODE_DISABLED, AbsListView.this.mOverflingDistance, AbsListView.PROFILE_SCROLLING);
                }
                if (more) {
                    edgeReached(delta);
                }
    ...
    private class InputConnectionWrapper implements InputConnection {
        ...
        public int getCursorCapsMode(int reqModes) {
            if (this.mTarget == null) {
                return AccessibilityNodeInfo.ACTION_COPY;
            }
        ...
        public boolean finishComposingText() {
            return (this.mTarget == null || this.mTarget.finishComposingText()) ? true : AbsListView.PROFILE_SCROLLING;
        }
    ...
    class ListItemAccessibilityDelegate extends AccessibilityDelegate {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            if (position == AbsListView.TOUCH_MODE_UNKNOWN || adapter == null) {
                return AbsListView.PROFILE_SCROLLING;
            }
            ...
            switch (action) {
                ...
                case RelativeLayout.START_OF /*16*/:
                    return AbsListView.this.isClickable() ? AbsListView.this.performItemClick(host, position, id) : AbsListView.PROFILE_SCROLLING;
                case AccessibilityNodeInfo.ACTION_LONG_CLICK /*32*/:
                    return AbsListView.this.isLongClickable() ? AbsListView.this.performLongPress(host, position, id) : AbsListView.PROFILE_SCROLLING;
                default:
                    return AbsListView.PROFILE_SCROLLING;
            }
        }
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            if (!AbsListView.this.mDataChanged) {
                ...
                if (adapter != null && AbsListView.this.mItemCount > 0 && motionPosition != AbsListView.TOUCH_MODE_UNKNOWN && motionPosition < adapter.getCount() && sameWindow()) {
    ...
    class PositionScroller extends AbsPositionScroller implements Runnable {
        ...
        class C09213 implements Runnable {
            ...
            C09213(int i, int i2, int i3) {
                this.val$position = i;
                this.val$postOffset = i2;
        ...
        public void start(int position) {
            stop();
            if (AbsListView.this.mDataChanged) {
                AbsListView.this.mPositionScrollAfterLayout = new C09191(position);
                return;
            }
        ...
        public void start(int position, int boundPosition) {
            ...
            if (boundPosition == AbsListView.TOUCH_MODE_UNKNOWN) {
                ...
                AbsListView.this.mPositionScrollAfterLayout = new C09202(position, boundPosition);
            } else {
                int childCount = AbsListView.this.getChildCount();
                if (childCount != 0) {
                    int viewTravelCount;
        ...
        public void startWithOffset(int position, int offset, int duration) {
            ...
            if (AbsListView.this.mDataChanged) {
                ...
                AbsListView.this.mPositionScrollAfterLayout = new C09213(position, postOffset, duration);
                return;
            }
            int childCount = AbsListView.this.getChildCount();
            if (childCount != 0) {
                ...
                case MOVE_DOWN_BOUND /*3*/:
                    ...
                    if (firstPos != r0 && childCount > MOVE_DOWN_POS && firstPos + childCount < AbsListView.this.mItemCount) {
                        ...
                        if (nextPos < this.mBoundPos) {
                            AbsListView.this.smoothScrollBy(Math.max(AbsListView.TRANSCRIPT_MODE_DISABLED, (nextViewHeight + nextViewTop) - extraScroll), this.mScrollDuration, true);
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C09221 implements Creator<SavedState> {
            C09221() {
            }
    ...
    private void useDefaultSelector() {
        setSelector(getContext().getDrawable(C0000R.drawable.list_selector_background));
    }
        ...
        if (this.mTouchMode == TOUCH_MODE_OVERFLING) {
            ...
            if (!this.mDataChanged) {
                if (this.mTouchMode == TOUCH_MODE_FLING) {
                    ...
                    this.mPendingCheckForTap.f98x = ev.getX();
                    this.mPendingCheckForTap.f99y = ev.getY();
    ...
    private void clearScrollingCache() {
        if (!isHardwareAccelerated()) {
            if (this.mClearScrollingCache == null) {
                this.mClearScrollingCache = new C09174();
            }
    ...
    private EditText getTextFilterInput() {
        if (this.mTextFilter == null) {
            this.mTextFilter = (EditText) LayoutInflater.from(getContext()).inflate(17367271, null);
