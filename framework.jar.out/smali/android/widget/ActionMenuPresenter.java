...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu) {
            super(context, subMenu, null, false, 16843844);
    ...
    private class OverflowMenuButton extends ImageButton implements ActionMenuChildView {
        ...
        class C09251 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C09251(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C09251(this, ActionMenuPresenter.this));
        }
    ...
    private static class SavedState implements Parcelable {
        ...
        static class C09261 implements Creator<SavedState> {
            C09261() {
            }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(17694851);
        }
        if (this.mMenu != null) {
