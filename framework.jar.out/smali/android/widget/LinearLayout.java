...
public class LinearLayout extends ViewGroup {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (i2 = SHOW_DIVIDER_NONE; i2 < count; i2 += VERTICAL) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        childState = View.combineMeasuredStates(childState, child.getMeasuredState() & Spanned.SPAN_USER);
                    }
                    if (isExactly) {
        ...
        setMeasuredDimension((Spanned.SPAN_USER & childState) | widthSizeAndState, View.resolveSizeAndState(Math.max(maxHeight + (this.mPaddingTop + this.mPaddingBottom), getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
        if (matchHeight) {
