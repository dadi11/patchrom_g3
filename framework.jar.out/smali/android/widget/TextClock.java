...
public class TextClock extends TextView {
    ...
    class C10641 extends ContentObserver {
        C10641(Handler x0) {
            super(x0);
        }
    ...
    class C10652 extends BroadcastReceiver {
        C10652() {
        }
    ...
    /* renamed from: android.widget.TextClock.3 */
    ...
    public TextClock(Context context) {
        super(context);
        this.mFormatChangeObserver = new C10641(new Handler());
        this.mIntentReceiver = new C10652();
        this.mTicker = new C10663();
        init();
    }
