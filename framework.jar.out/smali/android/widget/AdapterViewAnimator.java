...
public abstract class AdapterViewAnimator extends AdapterView<Adapter> implements RemoteAdapterConnectionCallback, Advanceable {
    ...
    class C09361 implements Runnable {
        ...
        class C09351 implements Runnable {
            ...
            public void run() {
                if (C09361.this.val$viewData != null) {
                    AdapterViewAnimator.this.performItemClick(C09361.this.val$v, C09361.this.val$viewData.adapterPosition, C09361.this.val$viewData.itemId);
                } else {
                    AdapterViewAnimator.this.performItemClick(C09361.this.val$v, 0, 0);
                }
            }
        }

        C09361(View view, ViewAndMetaData viewAndMetaData) {
            this.val$v = view;
        ...
        public void run() {
            ...
            AdapterViewAnimator.this.post(new C09351());
        }
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C09381 implements Creator<SavedState> {
            C09381() {
            }
            ...
            case TOUCH_MODE_DOWN_IN_CURRENT_VIEW /*1*/:
                if (this.mTouchMode == TOUCH_MODE_DOWN_IN_CURRENT_VIEW) {
                    ...
                    if (v != null && isTransformedTouchPointInView(ev.getX(), ev.getY(), v, null)) {
                        ...
                        showTapFeedback(v);
                        postDelayed(new C09361(v, viewData), (long) ViewConfiguration.getPressedStateDuration());
                        handled = true;
                    }
                }
                this.mTouchMode = 0;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightSpecMode == 0) {
            ...
            heightSpecSize = height > heightSpecSize ? heightSpecSize | WindowManagerPolicy.FLAG_INJECTED : height;
        }
        if (widthSpecMode == 0) {
            ...
            widthSpecSize = width > widthSpecSize ? widthSpecSize | WindowManagerPolicy.FLAG_INJECTED : width;
        }
