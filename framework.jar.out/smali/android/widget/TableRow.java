...
public class TableRow extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.column = a.getInt(LOCATION, -1);
            this.span = a.getInt(LOCATION_NEXT, LOCATION_NEXT);
            if (this.span <= LOCATION_NEXT) {
                this.span = LOCATION_NEXT;
            }
            a.recycle();
        }
    ...
    void measureChildBeforeLayout(View child, int childIndex, int widthMeasureSpec, int totalWidth, int heightMeasureSpec, int totalHeight) {
        if (this.mConstrainedColumnWidths != null) {
            ...
            int measureMode = EditorInfo.IME_FLAG_NO_ENTER_ACTION;
            int columnWidth = 0;
            int span = lp.span;
            ...
            if (isHorizontalGravity) {
                measureMode = RtlSpacingHelper.UNDEFINED;
            }
                ...
                if (layoutParams.span == 1) {
                    ...
                    switch (layoutParams.width) {
                        ...
                        case ListPopupWindow.MATCH_PARENT /*-1*/:
                            ...
                            break;
                        default:
                            spec = MeasureSpec.makeMeasureSpec(layoutParams.width, EditorInfo.IME_FLAG_NO_ENTER_ACTION);
                            break;
                    }
