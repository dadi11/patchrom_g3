...
public class AbsoluteLayout extends ViewGroup {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.f100x = a.getDimensionPixelOffset(0, 0);
            this.f101y = a.getDimensionPixelOffset(1, 0);
            a.recycle();
        }
        ...
        public String debug(String output) {
            return output + "Absolute.LayoutParams={width=" + android.view.ViewGroup.LayoutParams.sizeToString(this.width) + ", height=" + android.view.ViewGroup.LayoutParams.sizeToString(this.height) + " x=" + this.f100x + " y=" + this.f101y + "}";
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                int childBottom = lp.f101y + child.getMeasuredHeight();
                maxWidth = Math.max(maxWidth, lp.f100x + child.getMeasuredWidth());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
                int childLeft = this.mPaddingLeft + lp.f100x;
                int childTop = this.mPaddingTop + lp.f101y;
