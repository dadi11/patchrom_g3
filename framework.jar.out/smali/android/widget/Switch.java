...
public class Switch extends CompoundButton {
    ...
    static class C10581 extends FloatProperty<Switch> {
        C10581(String x0) {
            super(x0);
        }
    ...
    public Switch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTextPaint = new TextPaint((int) TOUCH_MODE_DOWN);
        ...
        this.mThumbDrawable = a.getDrawable(TOUCH_MODE_DRAGGING);
        ...
        this.mTextOff = a.getText(TOUCH_MODE_DOWN);
        this.mShowText = a.getBoolean(9, true);
        ...
        int appearance = a.getResourceId(MONOSPACE, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        setSwitchTypefaceByIndex(appearance.getInt(TOUCH_MODE_DOWN, -1), appearance.getInt(TOUCH_MODE_DRAGGING, -1));
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        return new StaticLayout(transformed, this.mTextPaint, (int) Math.ceil((double) Layout.getDesiredWidth(transformed, this.mTextPaint)), Alignment.ALIGN_NORMAL, LayoutParams.BRIGHTNESS_OVERRIDE_FULL, 0.0f, true);
    }
                ...
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? LayoutParams.BRIGHTNESS_OVERRIDE_FULL : LayoutParams.BRIGHTNESS_OVERRIDE_NONE;
                        }
                        if (isLayoutRtl()) {
                            dPos = -dPos;
                        }
                        float newPos = MathUtils.constrain(this.mThumbPosition + dPos, 0.0f, LayoutParams.BRIGHTNESS_OVERRIDE_FULL);
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        if (commitChange) {
            this.mVelocityTracker.computeCurrentVelocity(LayoutParams.TYPE_APPLICATION_PANEL);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        float targetPosition = newCheckedState ? LayoutParams.BRIGHTNESS_OVERRIDE_FULL : 0.0f;
    ...
    public void setChecked(boolean checked) {
        ...
        setThumbPosition(checked ? LayoutParams.BRIGHTNESS_OVERRIDE_FULL : 0.0f);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & KeyEvent.KEYCODE_FORWARD_DEL) {
    ...
    private int getThumbOffset() {
        float thumbPosition;
        if (isLayoutRtl()) {
            thumbPosition = LayoutParams.BRIGHTNESS_OVERRIDE_FULL - this.mThumbPosition;
        } else {
