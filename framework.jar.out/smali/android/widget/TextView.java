...
public class TextView extends View implements OnPreDrawListener {
    ...
    private static final Metrics UNKNOWN_BORING;
    ...
    class C10671 implements Runnable {
        ...
        C10671(CharSequence charSequence) {
    ...
    class C10682 implements Runnable {
        C10682() {
        }
    ...
    class C10693 implements Runnable {
        C10693() {
        }
    ...
    private class ChangeWatcher implements TextWatcher, SpanWatcher {
        ...
        public void afterTextChanged(Editable buffer) {
            ...
            if (MetaKeyKeyListener.getMetaState((CharSequence) buffer, (int) AccessibilityNodeInfo.ACTION_PREVIOUS_HTML_ELEMENT) != 0) {
    ...
    private static final class Marquee {
        ...
        class C10711 implements FrameCallback {
            C10711() {
            }
        ...
        class C10722 implements FrameCallback {
            C10722() {
            }
        ...
        class C10733 implements FrameCallback {
            C10733() {
            }

            public void doFrame(long frameTimeNanos) {
                if (Marquee.this.mStatus == TextView.SIGNED) {
        ...
        Marquee(TextView v) {
            this.mStatus = (byte) 0;
            this.mTickCallback = new C10711();
            this.mStartCallback = new C10722();
            this.mRestartCallback = new C10733();
            this.mPixelsPerSecond = SensorManager.MAGNETIC_FIELD_EARTH_MIN * v.getContext().getResources().getDisplayMetrics().density;
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C10741 implements Creator<SavedState> {
            C10741() {
            }
    ...
    static {
        ...
        iArr[MARQUEE_FADE_NORMAL] = 16843597;
    ...
    public TextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (textColor == null) {
            textColor = ColorStateList.valueOf(Spanned.SPAN_USER);
        }
    ...
    public void setError(CharSequence error) {
        ...
        Drawable dr = getContext().getDrawable(17302604);
    ...
    public boolean bringPointIntoView(int offset) {
        ...
        switch (C10704.$SwitchMap$android$text$Layout$Alignment[layout.getParagraphAlignment(line).ordinal()]) {
            case SANS /*1*/:
                grav = SANS;
                break;
            case SIGNED /*2*/:
