...
public class ProgressBar extends View {
    ...
    private static class RefreshData {
        ...
        static {
            sPool = new SynchronizedPool(POOL_MAX);
        }
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int resID = a.getResourceId(13, C0000R.anim.linear_interpolator);
        if (resID > 0) {
    ...
    public void setProgressDrawable(Drawable d) {
        if (this.mProgressDrawable != d) {
            ...
            updateDrawableState();
            doRefreshProgress(C0000R.id.progress, this.mProgress, false, false);
            doRefreshProgress(C0000R.id.secondaryProgress, this.mSecondaryProgress, false, false);
        }
    }
    ...
    private void applyPrimaryProgressTint() {
        if (this.mProgressTintInfo.mHasProgressTint || this.mProgressTintInfo.mHasProgressTintMode) {
            Drawable target = getTintTarget(C0000R.id.progress, true);
            if (target != null) {
    ...
    private void applyProgressBackgroundTint() {
        if (this.mProgressTintInfo.mHasProgressBackgroundTint || this.mProgressTintInfo.mHasProgressBackgroundTintMode) {
            Drawable target = getTintTarget(C0000R.id.background, false);
            if (target != null) {
    ...
    private void applySecondaryProgressTint() {
        if (this.mProgressTintInfo.mHasSecondaryProgressTint || this.mProgressTintInfo.mHasSecondaryProgressTintMode) {
            Drawable target = getTintTarget(C0000R.id.secondaryProgress, false);
            if (target != null) {
    ...
    private synchronized void doRefreshProgress(int id, int progress, boolean fromUser, boolean callBackToApp) {
        ...
        if (d != null) {
            ...
            int level = (int) (SensorManager.LIGHT_OVERCAST * scale);
            if (progressDrawable == null) {
                progressDrawable = d;
            }
        ...
        if (callBackToApp && id == C0000R.id.progress) {
    ...
    synchronized void setProgress(int progress, boolean fromUser) {
        if (!this.mIndeterminate) {
            ...
            if (progress != this.mProgress) {
                ...
                refreshProgress(C0000R.id.progress, this.mProgress, fromUser);
            }
        }
    }
    ...
    public synchronized void setSecondaryProgress(int secondaryProgress) {
        if (!this.mIndeterminate) {
            ...
            if (secondaryProgress != this.mSecondaryProgress) {
                ...
                refreshProgress(C0000R.id.secondaryProgress, this.mSecondaryProgress, false);
            }
        }
    }
    ...
    public synchronized void setMax(int max) {
        ...
        if (max != this.mMax) {
            ...
            refreshProgress(C0000R.id.progress, this.mProgress, false);
        }
    }
        ...
        if (d != null) {
            ...
            if (this.mHasAnimation) {
                ...
                try {
                    ...
                    d.setLevel((int) (SensorManager.LIGHT_OVERCAST * scale));
