...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    class C10571 implements Delayer {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            this.mText1 = (TextView) v.findViewById(C0000R.id.text1);
            this.mText2 = (TextView) v.findViewById(C0000R.id.text2);
            this.mIcon1 = (ImageView) v.findViewById(C0000R.id.icon1);
            this.mIcon2 = (ImageView) v.findViewById(C0000R.id.icon2);
            this.mIconRefine = (ImageView) v.findViewById(16909188);
        }
    }
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchable, WeakHashMap<String, ConstantState> outsideDrawablesCache) {
        ...
        getFilter().setDelayer(new C10571());
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        String query = constraint == null ? ProxyInfo.LOCAL_EXCL_LIST : constraint.toString();
        if (this.mSearchView.getVisibility() != 0 || this.mSearchView.getWindowVisibility() != 0) {
            return null;
        }
        try {
            Cursor cursor = this.mSearchManager.getSuggestions(this.mSearchable, query, QUERY_LIMIT);
            if (cursor == null) {
                return null;
            }
            cursor.getCount();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(16909188)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(18219010, colorValue, true);
    ...
    private Drawable getDrawable(Uri uri) {
        ...
        try {
            if (ContentResolver.SCHEME_ANDROID_RESOURCE.equals(uri.getScheme())) {
                ...
                return r.f3r.getDrawable(r.id, this.mContext.getTheme());
            }
    ...
    private Drawable getActivityIcon(ComponentName component) {
        ...
        try {
            ActivityInfo activityInfo = pm.getActivityInfo(component, AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
