        ...
        while (!patternScanner.atEnd()) {
            ...
            switch (state) {
                ...
                case BitmapReflectionAction.TAG /*12*/:
                    ...
                    r48.add(new ConnectCommand(curSourceFilterName, curSourcePortName, curTargetFilterName, curTargetPortName));
                    state = 16;
                    break;
    ...
    private void applySettings() throws GraphIOException {
        for (String setting : this.mSettings.keySet()) {
            ...
            if (setting.equals("autoBranch")) {
                ...
                } else if (value.equals(Parameters.ZSL_OFF)) {
