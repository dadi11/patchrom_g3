...
public class SyncRunner extends GraphRunner {
    ...
    class C01681 implements Runnable {
        ...
        C01681(Filter filter, ConditionVariable conditionVariable) {
    ...
    protected void scheduleFilterWake(Filter filter, int delay) {
        ...
        this.mWakeExecutor.schedule(new C01681(filter, this.mWakeCondition), (long) delay, TimeUnit.MILLISECONDS);
    }
