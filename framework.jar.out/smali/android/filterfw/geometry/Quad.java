...
public class Quad {
    ...
    public Rectangle boundingBox() {
        List<Float> xs = Arrays.asList(new Float[]{Float.valueOf(this.p0.f5x), Float.valueOf(this.p1.f5x), Float.valueOf(this.p2.f5x), Float.valueOf(this.p3.f5x)});
        List<Float> ys = Arrays.asList(new Float[]{Float.valueOf(this.p0.f6y), Float.valueOf(this.p1.f6y), Float.valueOf(this.p2.f6y), Float.valueOf(this.p3.f6y)});
