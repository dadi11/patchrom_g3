...
public class Rectangle extends Quad {
    ...
    public Rectangle(Point origin, Point size) {
        super(origin, origin.plus(size.f5x, 0.0f), origin.plus(0.0f, size.f6y), origin.plus(size.f5x, size.f6y));
    }

    public static Rectangle fromRotatedRect(Point center, Point size, float rotation) {
        return new Rectangle(new Point(center.f5x - (size.f5x / 2.0f), center.f6y - (size.f6y / 2.0f)).rotatedAround(center, rotation), new Point(center.f5x + (size.f5x / 2.0f), center.f6y - (size.f6y / 2.0f)).rotatedAround(center, rotation), new Point(center.f5x - (size.f5x / 2.0f), center.f6y + (size.f6y / 2.0f)).rotatedAround(center, rotation), new Point(center.f5x + (size.f5x / 2.0f), center.f6y + (size.f6y / 2.0f)).rotatedAround(center, rotation));
    }
    ...
    public static Rectangle fromCenterVerticalAxis(Point center, Point vAxis, Point size) {
        Point dy = vAxis.scaledTo(size.f6y / 2.0f);
        Point dx = vAxis.rotated90(1).scaledTo(size.f5x / 2.0f);
