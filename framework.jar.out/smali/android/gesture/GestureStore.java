    ...
    public void save(OutputStream stream, boolean closeStream) throws IOException {
        ...
        try {
            ...
            if (!(stream instanceof BufferedOutputStream)) {
                stream = new BufferedOutputStream(stream, AccessibilityNodeInfo.ACTION_PASTE);
            }
    ...
    public void load(InputStream stream, boolean closeStream) throws IOException {
        ...
        try {
            if (!(stream instanceof BufferedInputStream)) {
                stream = new BufferedInputStream(stream, AccessibilityNodeInfo.ACTION_PASTE);
            }
            DataInputStream in2 = new DataInputStream(stream);
            try {
                switch (in2.readShort()) {
