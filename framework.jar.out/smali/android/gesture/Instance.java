...
class Instance {
    ...
    static {
        ORIENTATIONS = new float[]{0.0f, 0.7853982f, 1.5707964f, 2.3561945f, 3.1415927f, 0.0f, -0.7853982f, -1.5707964f, -2.3561945f, -3.1415927f};
    }
    ...
    private static float[] spatialSampler(Gesture gesture) {
        return GestureUtils.spatialSampling(gesture, SEQUENCE_SAMPLE_SIZE, false);
    }

    private static float[] temporalSampler(int orientationType, Gesture gesture) {
        float[] pts = GestureUtils.temporalSampling((GestureStroke) gesture.getStrokes().get(0), SEQUENCE_SAMPLE_SIZE);
