...
public class Binder implements IBinder {
    ...
    class C05821 extends Thread {
        ...
        C05821(String x0, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    public void dumpAsync(FileDescriptor fd, String[] args) {
        new C05821("Binder.dumpAsync", fd, new FastPrintWriter(new FileOutputStream(fd)), args).start();
    }
