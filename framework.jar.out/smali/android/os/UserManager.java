...
public class UserManager {
    ...
    public static boolean supportsMultipleUsers() {
        return getMaxSupportedUsers() > 1 && SystemProperties.getBoolean("fw.show_multiuserui", Resources.getSystem().getBoolean(17956974));
    }
    ...
    public UserInfo createGuest(Context context, String name) {
        ...
        if (guest != null) {
            Secure.putStringForUser(context.getContentResolver(), "skip_first_use_hints", WifiEnterpriseConfig.ENGINE_ENABLE, guest.id);
            try {
    ...
    public static int getMaxSupportedUsers() {
        ...
        return SystemProperties.getInt("fw.max_users", Resources.getSystem().getInteger(17694840));
    }
    ...
    public boolean isUserSwitcherEnabled() {
        ...
        if (Global.getInt(this.mContext.getContentResolver(), "guest_user_enabled", 0) == 1) {
            guestEnabled = true;
        } else {
            guestEnabled = false;
        }
