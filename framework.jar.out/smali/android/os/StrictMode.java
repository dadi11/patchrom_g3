...
public final class StrictMode {
    ...
    static class C06091 extends ThreadLocal<ArrayList<ViolationInfo>> {
        C06091() {
        }
    ...
    static class C06102 extends ThreadLocal<ArrayList<ViolationInfo>> {
        C06102() {
        }
    ...
    static class C06113 extends ThreadLocal<Handler> {
        C06113() {
        }
    ...
    static class C06124 extends ThreadLocal<AndroidBlockGuardPolicy> {
        C06124() {
        }
    ...
    static class C06135 extends Thread {
        final /* synthetic */ ViolationInfo val$info;
        final /* synthetic */ int val$violationMaskSubset;

        C06135(String x0, int i, ViolationInfo violationInfo) {
    ...
    static class C06146 implements IdleHandler {
        C06146() {
        }
    ...
    static class C06157 extends Span {
        C06157() {
        }
    ...
    static class C06168 extends ThreadLocal<ThreadSpanState> {
        C06168() {
        }
    ...
    static class C06179 extends Singleton<IWindowManager> {
        C06179() {
        }
    ...
    private static class AndroidBlockGuardPolicy implements Policy {
        ...
        class C06181 implements Runnable {
            ...
            C06181(IWindowManager iWindowManager, ArrayList arrayList) {
        ...
        void handleViolationWithTimingAttempt(ViolationInfo info) {
            ...
            if (records.size() < StrictMode.MAX_OFFENSES_PER_LOOP) {
                ...
                if (records.size() <= StrictMode.DETECT_DISK_WRITE) {
                    ...
                    ((Handler) StrictMode.threadHandler.get()).postAtFrontOfQueue(new C06181(windowManager, records));
                }
            }
        }
    ...
    static {
        ...
        gatheredViolations = new C06091();
        violationsBeingTimed = new C06102();
        threadHandler = new C06113();
        threadAndroidPolicy = new C06124();
        sLastInstanceCountCheckMillis = 0;
        sIsIdlerRegistered = LOG_V;
        sProcessIdleHandler = new C06146();
        sLastVmViolationTime = new HashMap();
        NO_OP_SPAN = new C06157();
        sThisThreadSpanState = new C06168();
        sWindowManager = new C06179();
    ...
    private static void dropboxViolationAsync(int violationMaskSubset, ViolationInfo info) {
        ...
        new C06135("callActivityManagerForStrictModeDropbox", violationMaskSubset, info).start();
    }
