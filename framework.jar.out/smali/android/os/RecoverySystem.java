...
public class RecoverySystem {
    ...
    static class C06061 extends BroadcastReceiver {
        final /* synthetic */ ConditionVariable val$condition;

        C06061(ConditionVariable conditionVariable) {
    ...
    public static void rebootWipeUserData(Context context, boolean shutdown, String reason) throws IOException {
        ...
        context.sendOrderedBroadcastAsUser(intent, UserHandle.OWNER, "android.permission.MASTER_CLEAR", new C06061(condition), null, 0, null, null);
        condition.block();
