...
public interface IPowerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        static final int f22x6dae2973 = 21;
        ...
        private static class Proxy implements IPowerManager {
            ...
            public void setTemporaryScreenAutoBrightnessAdjustmentSettingOverride(float adj) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.f22x6dae2973, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void cpuBoost(int duration) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_cpuBoost, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
