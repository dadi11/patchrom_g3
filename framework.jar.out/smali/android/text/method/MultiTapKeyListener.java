...
public class MultiTapKeyListener extends BaseKeyListener implements SpanWatcher {
    ...
    public boolean onKeyDown(View view, Editable content, int keyCode, KeyEvent event) {
        ...
        int rec = (content.getSpanFlags(TextKeyListener.ACTIVE) & Spanned.SPAN_USER) >>> 24;
        ...
        if (content.getSpanStart(this) < 0) {
            for (KeyListener removeSpan : (KeyListener[]) content.getSpans(0, content.length(), KeyListener.class)) {
