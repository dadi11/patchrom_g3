...
public class Time {
    ...
    private static class TimeCalculator {
        ...
        public String format2445(boolean hasTime) {
            ...
            buf[Time.SUNDAY] = toChar(n / LayoutParams.TYPE_APPLICATION_PANEL);
            n %= LayoutParams.TYPE_APPLICATION_PANEL;
    ...
    static {
        ...
        sThursdayOffset = new int[]{-3, WEDNESDAY, TUESDAY, SECOND, SUNDAY, -1, -2};
    }
    ...
    public int getActualMaximum(int field) {
        ...
        switch (field) {
            ...
            case THURSDAY /*4*/:
                ...
                if (y % 100 != 0 || y % Voice.QUALITY_HIGH == 0) {
                    return 29;
                }
                return 28;
            case MONTH /*5*/:
            ...
            case YEAR_DAY /*8*/:
                y = this.year;
                return (y % THURSDAY != 0 || (y % 100 == 0 && y % Voice.QUALITY_HIGH != 0)) ? 364 : 365;
            case WEEK_NUM /*9*/:
    ...
    private boolean parseInternal(String s) {
        ...
        boolean inUtc = false;
        this.year = ((getChar(s, SUNDAY, LayoutParams.TYPE_APPLICATION_PANEL) + getChar(s, SECOND, 100)) + getChar(s, TUESDAY, 10)) + getChar(s, WEDNESDAY, SECOND);
    ...
    public static int getJulianMondayFromWeeksSinceEpoch(int week) {
        return MONDAY_BEFORE_JULIAN_EPOCH + (week * WEEK_DAY);
    }
}
