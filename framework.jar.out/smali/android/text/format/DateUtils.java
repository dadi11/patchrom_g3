...
public class DateUtils {
    ...
    private static void initFormatStringsLocked() {
        ...
        if (sLastConfig == null || !sLastConfig.equals(cfg)) {
            sLastConfig = cfg;
            sElapsedFormatMMSS = r.getString(17040494);
            sElapsedFormatHMMSS = r.getString(17040495);
        }
    }
    ...
    public static Formatter formatDateRange(Context context, Formatter formatter, long startMillis, long endMillis, int flags, String timeZone) {
        if ((flags & KeyEvent.META_SHIFT_MASK) == FORMAT_SHOW_TIME) {
