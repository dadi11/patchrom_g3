...
class TextLine {
    ...
    private static final TextLine[] sCached;
    ...
    static android.text.TextLine recycle(android.text.TextLine r4) {
        /*
        r3 = 0;
        r4.mText = r3;
        r4.mPaint = r3;
        ...
        r4.mTabs = r3;
        r4.mChars = r3;
        r1 = r4.mMetricAffectingSpanSpanSet;
        r1.recycle();
        r1 = r4.mCharacterStyleSpanSet;
        r1.recycle();
        r1 = r4.mReplacementSpanSpanSet;
        r1.recycle();
        r2 = sCached;
        monitor-enter(r2);
        r0 = 0;
    L_0x0020:
        r1 = sCached;	 Catch:{ all -> 0x0034 }
        r1 = r1.length;	 Catch:{ all -> 0x0034 }
        if (r0 >= r1) goto L_0x002f;
    L_0x0025:
        r1 = sCached;	 Catch:{ all -> 0x0034 }
        r1 = r1[r0];	 Catch:{ all -> 0x0034 }
        if (r1 != 0) goto L_0x0031;
    L_0x002b:
        r1 = sCached;	 Catch:{ all -> 0x0034 }
        r1[r0] = r4;	 Catch:{ all -> 0x0034 }
    L_0x002f:
            ...
            while (j <= runLimit) {
                ...
                if (this.mHasTabs && j < runLimit) {
                    ...
                    if (codept >= 55296 && codept < 56320 && j + 1 < runLimit) {
                        ...
                        } else if (codept > AppSecurityPermissions.WHICH_ALL) {
                            j++;
                            j++;
                        }
                    }
    ...
    private float handleRun(int start, int measureLimit, int limit, boolean runIsRtl, Canvas c, float x, int top, int y, int bottom, FontMetricsInt fmi, boolean needWidth) {
        ...
        if (start == measureLimit) {
            ...
            wp.set(this.mPaint);
            mlimit = measureLimit;
            boolean z = (needWidth || mlimit < measureLimit) ? true : DEBUG;
    ...
    private void drawTextRun(Canvas c, TextPaint wp, int start, int end, int contextStart, int contextEnd, boolean runIsRtl, float x, int y) {
        if (this.mCharsValid) {
            ...
            int i = start;
            int i2 = contextStart;
            canvas.drawTextRun(this.mChars, i, end - start, i2, contextEnd - contextStart, x, (float) y, runIsRtl, (Paint) wp);
            return;
        }
        int delta = this.mStart;
