...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    static class C08031 implements Creator<SuggestionSpan> {
        C08031() {
        }
    ...
    private void initStyle(Context context) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(null, R.styleable.SuggestionSpan, 18219013, 0);
        ...
        typedArray = context.obtainStyledAttributes(null, R.styleable.SuggestionSpan, 18219012, 0);
        ...
        typedArray = context.obtainStyledAttributes(null, R.styleable.SuggestionSpan, 18219014, 0);
