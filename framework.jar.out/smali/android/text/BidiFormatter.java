...
public final class BidiFormatter {
    ...
    public static final class Builder {
        ...
        public BidiFormatter build() {
            ...
            return new BidiFormatter(this.mFlags, this.mTextDirectionHeuristic, null);
        }
    }
    ...
    public boolean isRtl(String str) {
        return this.mDefaultTextDirectionHeuristic.isRtl((CharSequence) str, (int) DIR_UNKNOWN, str.length());
    }
