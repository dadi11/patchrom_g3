...
public class TextUtils {
    ...
    /* renamed from: android.text.TextUtils.1 */
    static class C08011 implements Creator<CharSequence> {
        C08011() {
        }
    ...
    static {
        ...
        CHAR_SEQUENCE_CREATOR = new C08011();
        sLock = new Object();
        sTemp = null;
    ...
    public static int indexOf(CharSequence s, char ch, int start, int end) {
        ...
        if ((s instanceof GetChars) || c == StringBuffer.class || c == StringBuilder.class || c == String.class) {
            char[] temp = obtain(AccessibilityEvent.MAX_TEXT_LENGTH);
            while (start < end) {
                int segend = start + AccessibilityEvent.MAX_TEXT_LENGTH;
                if (segend > end) {
                    segend = end;
                }
    ...
    public static CharSequence join(Iterable<CharSequence> list) {
        return join(Resources.getSystem().getText(17040854), (Iterable) list);
    }
