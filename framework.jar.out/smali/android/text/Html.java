...
public class Html {
    ...
    private static void withinBlockquote(StringBuilder out, Spanned text, int start, int end) {
        ...
        while (i < end) {
            ...
            withinParagraph(out, text, i, i2, nl, z);
            i = next;
        }
        out.append("</p>\n");
    }
        ...
        while (i < end) {
            ...
            while (j < style.length) {
                ...
                if (style[j] instanceof ForegroundColorSpan) {
                    ...
                    String color = Integer.toHexString(((ForegroundColorSpan) style[j]).getForegroundColor() + WindowManagerPolicy.FLAG_INJECTED);
    ...
    private static void withinStyle(StringBuilder out, CharSequence text, int start, int end) {
        ...
        while (i < end) {
            ...
            if (c == '<') {
                ...
                if (d >= '\udc00' && d <= '\udfff') {
                    i++;
                    out.append("&#").append((AccessibilityNodeInfo.ACTION_CUT | ((c - 55296) << 10)) | (d - 56320)).append(";");
                }
            }
            i++;
        }
