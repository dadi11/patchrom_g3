...
public final class BluetoothHealth implements BluetoothProfile {
    ...
    /* renamed from: android.bluetooth.BluetoothHealth.1 */
    class C00541 extends Stub {
        C00541() {
        }
    ...
    /* renamed from: android.bluetooth.BluetoothHealth.2 */
    class C00552 implements ServiceConnection {
        C00552() {
        }
    ...
    BluetoothHealth(Context context, ServiceListener l) {
        this.mBluetoothStateChangeCallback = new C00541();
        this.mConnection = new C00552();
    ...
    private boolean checkAppParam(String name, int role, int channelType, BluetoothHealthCallback callback) {
        ...
        if (role != STATE_CHANNEL_CONNECTING && role != STATE_CHANNEL_CONNECTED) {
            return false;
        }
        if ((channelType != CHANNEL_TYPE_RELIABLE && channelType != CHANNEL_TYPE_STREAMING && channelType != CHANNEL_TYPE_ANY) || callback == null) {
            return false;
        }
        if (role == STATE_CHANNEL_CONNECTING && channelType == CHANNEL_TYPE_ANY) {
            return false;
        }
        return DBG;
    }
