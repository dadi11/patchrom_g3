...
public final class BluetoothMasInstance implements Parcelable {
    public static final Creator<BluetoothMasInstance> CREATOR;
    private final int mChannel;
    private final int mId;
    private final int mMsgTypes;
    private final String mName;

    /* renamed from: android.bluetooth.BluetoothMasInstance.1 */
    static class C00661 implements Creator<BluetoothMasInstance> {
        C00661() {
        }
