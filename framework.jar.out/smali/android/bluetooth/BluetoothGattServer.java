...
public final class BluetoothGattServer implements BluetoothProfile {
    ...
    /* renamed from: android.bluetooth.BluetoothGattServer.1 */
    class C00471 extends Stub {
        C00471() {
        }
    ...
    BluetoothGattServer(Context context, IBluetoothGatt iGatt, int transport) {
        ...
        this.mBluetoothGattServerCallback = new C00471();
    ...
    public boolean connect(BluetoothDevice device, boolean autoConnect) {
        ...
        try {
            ...
            iBluetoothGatt.serverConnect(i, address, z, this.mTransport);
            return DBG;
        } catch (RemoteException e) {
            Log.e(TAG, ProxyInfo.LOCAL_EXCL_LIST, e);
            return false;
