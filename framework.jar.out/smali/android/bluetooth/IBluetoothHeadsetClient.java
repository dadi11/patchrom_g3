        ...
        private static class Proxy implements IBluetoothHeadsetClient {
            ...
            public List<BluetoothHeadsetClientCall> getCurrentCalls(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getCurrentCalls, _data, _reply, 0);
                    _reply.readException();
            ...
            public Bundle getCurrentAgEvents(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getCurrentAgEvents, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
            ...
            public boolean acceptCall(BluetoothDevice device, int flag) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(flag);
                    this.mRemote.transact(Stub.TRANSACTION_acceptCall, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean holdCall(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_holdCall, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean rejectCall(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_rejectCall, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean terminateCall(BluetoothDevice device, int index) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_terminateCall, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean enterPrivateMode(BluetoothDevice device, int index) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(index);
                    this.mRemote.transact(Stub.TRANSACTION_enterPrivateMode, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean explicitCallTransfer(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_explicitCallTransfer, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean redial(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_redial, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean dialMemory(BluetoothDevice device, int location) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_dialMemory, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean getLastVoiceTagNumber(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getLastVoiceTagNumber, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public Bundle getCurrentAgFeatures(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getCurrentAgFeatures, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
                    } else {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_disconnect /*2*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_acceptIncomingConnect /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_rejectIncomingConnect /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_getConnectionState /*7*/:
                    ...
                    return true;
                case TRANSACTION_setPriority /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getPriority /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result3);
                    return true;
                case TRANSACTION_startVoiceRecognition /*10*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_stopVoiceRecognition /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getCurrentCalls /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    return true;
                case TRANSACTION_getCurrentAgEvents /*13*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_acceptCall /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_holdCall /*15*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_rejectCall /*16*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_terminateCall /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_enterPrivateMode /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_explicitCallTransfer /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_dial /*21*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_dialMemory /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_sendDTMF /*23*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getLastVoiceTagNumber /*24*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getAudioState /*25*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result3);
                    return true;
                case TRANSACTION_connectAudio /*26*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_disconnectAudio /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getCurrentAgFeatures /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
