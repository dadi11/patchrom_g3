...
public class BluetoothGattCharacteristic {
    ...
    public boolean setValue(int mantissa, int exponent, int formatType, int offset) {
        ...
        switch (formatType) {
            case FORMAT_SFLOAT /*50*/:
                ...
                this.mValue[offset] = (byte) (mantissa & EditorInfo.IME_MASK_ACTION);
            ...
            case FORMAT_FLOAT /*52*/:
                ...
                this.mValue[offset2] = (byte) ((mantissa >> PROPERTY_WRITE) & EditorInfo.IME_MASK_ACTION);
                offset2 = offset + WRITE_TYPE_NO_RESPONSE;
                this.mValue[offset] = (byte) ((mantissa >> PROPERTY_NOTIFY) & EditorInfo.IME_MASK_ACTION);
                bArr = this.mValue;
                bArr[offset2] = (byte) (bArr[offset2] + ((byte) (exponent & EditorInfo.IME_MASK_ACTION)));
                offset = offset2;
                break;
            default:
                return false;
    ...
    private int unsignedByteToInt(byte b) {
        return b & EditorInfo.IME_MASK_ACTION;
    }
