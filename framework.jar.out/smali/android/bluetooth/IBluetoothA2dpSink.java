...
public interface IBluetoothA2dpSink extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothA2dpSink {
        ...
        static final int TRANSACTION_getAudioConfig = 9;
        ...
        private static class Proxy implements IBluetoothA2dpSink {
            ...
            public BluetoothAudioConfig getAudioConfig(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getAudioConfig, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (BluetoothAudioConfig) BluetoothAudioConfig.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_getPriority /*7*/:
                    ...
                    reply.writeInt(_result3);
                    return true;
                case TRANSACTION_isA2dpPlaying /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getAudioConfig /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
