...
public interface IBluetooth extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetooth {
        ...
        private static class Proxy implements IBluetooth {
            ...
            public boolean setRemoteTrust(BluetoothDevice device, boolean value) throws RemoteException {
                boolean _result = true;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(value ? Stub.TRANSACTION_isEnabled : 0);
                    this.mRemote.transact(Stub.TRANSACTION_setRemoteTrust, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public boolean getRemoteTrust(BluetoothDevice device) throws RemoteException {
                boolean _result = true;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getRemoteTrust, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
                    }
            ...
            public int setSocketOpt(int type, int port, int optionName, byte[] optionVal, int optionLen) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setSocketOpt, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getSocketOpt(int type, int port, int optionName, byte[] optionVal) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getSocketOpt, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
            ...
            public BluetoothRemoteDiRecord getRemoteDiRecord(BluetoothDevice device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    BluetoothRemoteDiRecord _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (device != null) {
                        _data.writeInt(Stub.TRANSACTION_isEnabled);
                        device.writeToParcel(_data, 0);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getRemoteDiRecord, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (BluetoothRemoteDiRecord) BluetoothRemoteDiRecord.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_setRemoteAlias /*28*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setRemoteTrust /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result = setRemoteTrust(_arg0, _arg1);
                    reply.writeNoException();
                    if (_result) {
                        i = TRANSACTION_isEnabled;
                    }
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getRemoteTrust /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getRemoteClass /*31*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getRemoteUuids /*32*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeTypedArray(_result4, TRANSACTION_isEnabled);
                    return true;
                case TRANSACTION_fetchRemoteUuids /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_fetchRemoteMasInstances /*34*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_setPin /*35*/:
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setPasskey /*36*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setPairingConfirmation /*37*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getPhonebookAccessPermission /*38*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setPhonebookAccessPermission /*39*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getMessageAccessPermission /*40*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setMessageAccessPermission /*41*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_sendConnectionStateChange /*42*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                ...
                case TRANSACTION_connectSocket /*45*/:
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_createSocketChannel /*46*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt();
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_configHciSnoopLog /*47*/:
                    boolean _arg03;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = true;
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isMultiAdvertisementSupported /*48*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isPeripheralModeSupported /*49*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isOffloadedFilteringSupported /*50*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isOffloadedScanBatchingSupported /*51*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isActivityAndEnergyReportingSupported /*52*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_getActivityEnergyInfoFromController /*53*/:
                    data.enforceInterface(DESCRIPTOR);
                    getActivityEnergyInfoFromController();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_reportActivityInfo /*54*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_setSocketOpt /*55*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setSocketOpt(data.readInt(), data.readInt(), data.readInt(), data.createByteArray(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getSocketOpt /*56*/:
                    byte[] _arg3;
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt();
                    _arg12 = data.readInt();
                    ...
                    _result2 = getSocketOpt(_arg02, _arg12, _arg22, _arg3);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    reply.writeByteArray(_arg3);
                    return true;
                case TRANSACTION_getRemoteDiRecord /*57*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    BluetoothRemoteDiRecord _result8 = getRemoteDiRecord(_arg0);
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(TRANSACTION_isEnabled);
                        _result8.writeToParcel(reply, TRANSACTION_isEnabled);
                        return true;
                    }
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_dump /*58*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = dump();
                    reply.writeNoException();
                    reply.writeString(_result3);
