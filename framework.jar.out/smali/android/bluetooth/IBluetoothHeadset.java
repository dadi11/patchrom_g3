        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_disconnectAudio /*18*/:
                    ...
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_startScoUsingVirtualVoiceCall /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result ? TRANSACTION_connect : 0);
                    return true;
                case TRANSACTION_stopScoUsingVirtualVoiceCall /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (BluetoothDevice) BluetoothDevice.CREATOR.createFromParcel(data);
                    } else {
