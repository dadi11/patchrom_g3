...
public final class BluetoothDevice implements Parcelable {
    ...
    /* renamed from: android.bluetooth.BluetoothDevice.1 */
    static class C00421 extends Stub {
        C00421() {
        }
    ...
    /* renamed from: android.bluetooth.BluetoothDevice.2 */
    static class C00432 implements Creator<BluetoothDevice> {
        C00432() {
        }
    ...
    static {
        mStateChangeCallback = new C00421();
        CREATOR = new C00432();
    }
    ...
    public boolean getTrustState() {
        ...
        if (sService == null) {
            ...
            try {
                z = sService.getRemoteTrust(this);
            } catch (RemoteException e) {
                Log.e(TAG, ProxyInfo.LOCAL_EXCL_LIST, e);
            }
        }
    ...
    public boolean setTrust(boolean trustValue) {
        ...
        if (sService == null) {
            ...
            try {
                z = sService.setRemoteTrust(this, trustValue);
            } catch (RemoteException e) {
                Log.e(TAG, ProxyInfo.LOCAL_EXCL_LIST, e);
            }
        }
    ...
    public BluetoothSocket createL2capSocketToServiceRecord(UUID uuid) throws IOException {
        return new BluetoothSocket(UNBOND_REASON_AUTH_CANCELED, -1, true, true, this, -1, new ParcelUuid(uuid));
    }
    ...
    public BluetoothSocket createInsecureL2capSocketToServiceRecord(UUID uuid) throws IOException {
        return new BluetoothSocket(UNBOND_REASON_AUTH_CANCELED, -1, DBG, DBG, this, -1, new ParcelUuid(uuid));
    }
    ...
    public BluetoothRemoteDiRecord getRemoteDiRecord() {
        BluetoothRemoteDiRecord bluetoothRemoteDiRecord = null;
        if (sService == null) {
            Log.e(TAG, "BT not enabled. Cannot get Remote Di record");
        } else {
            try {
                bluetoothRemoteDiRecord = sService.getRemoteDiRecord(this);
            } catch (RemoteException e) {
                Log.e(TAG, ProxyInfo.LOCAL_EXCL_LIST, e);
            }
        }
        return bluetoothRemoteDiRecord;
    }
}
