...
public final class BluetoothInputDevice implements BluetoothProfile {
    ...
    /* renamed from: android.bluetooth.BluetoothInputDevice.1 */
    class C00621 extends Stub {
        C00621() {
        }
    ...
    /* renamed from: android.bluetooth.BluetoothInputDevice.2 */
    class C00632 implements ServiceConnection {
        C00632() {
        }
    ...
    BluetoothInputDevice(Context context, ServiceListener l) {
        this.mBluetoothStateChangeCallback = new C00621();
        this.mConnection = new C00632();
    ...
    boolean doBind() {
        ...
        ComponentName comp = intent.resolveSystemService(this.mContext.getPackageManager(), PROTOCOL_REPORT_MODE);
        intent.setComponent(comp);
        if (comp != null && this.mContext.bindServiceAsUser(intent, this.mConnection, PROTOCOL_REPORT_MODE, Process.myUserHandle())) {
            return DBG;
        }
    ...
    public boolean getIdleTime(BluetoothDevice device) {
        ...
        if (this.mService != null && isEnabled() && isValidDevice(device)) {
            try {
                z = this.mService.getIdleTime(device);
            } catch (RemoteException e) {
                Log.e(TAG, "Stack:" + Log.getStackTraceString(new Throwable()));
            }
        } else if (this.mService == null) {
    ...
    public boolean setIdleTime(BluetoothDevice device, byte idleTime) {
        ...
        if (this.mService != null && isEnabled() && isValidDevice(device)) {
            try {
                z = this.mService.setIdleTime(device, idleTime);
            } catch (RemoteException e) {
                Log.e(TAG, "Stack:" + Log.getStackTraceString(new Throwable()));
            }
        } else if (this.mService == null) {
