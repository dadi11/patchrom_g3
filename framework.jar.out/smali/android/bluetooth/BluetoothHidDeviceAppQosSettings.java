...
public final class BluetoothHidDeviceAppQosSettings implements Parcelable {
    ...
    /* renamed from: android.bluetooth.BluetoothHidDeviceAppQosSettings.1 */
    static class C00601 implements Creator<BluetoothHidDeviceAppQosSettings> {
        C00601() {
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof BluetoothHidDeviceAppQosSettings) {
            BluetoothHidDeviceAppQosSettings bluetoothHidDeviceAppQosSettings = (BluetoothHidDeviceAppQosSettings) o;
        }
        return false;
    }
