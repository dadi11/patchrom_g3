...
public final class ScanFilter implements Parcelable {
    ...
    /* renamed from: android.bluetooth.le.ScanFilter.1 */
    static class C00851 implements Creator<ScanFilter> {
        C00851() {
        }
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.mDeviceName, this.mDeviceAddress, Integer.valueOf(this.mManufacturerId), this.mManufacturerData, this.mManufacturerDataMask, this.mServiceDataUuid, this.mServiceData, this.mServiceDataMask, this.mServiceUuid, this.mServiceUuidMask});
    }
