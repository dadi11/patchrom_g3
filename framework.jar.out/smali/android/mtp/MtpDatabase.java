...
*/
    ...
    static {
        ...
        PATH_PROJECTION = new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "_data"};
        FORMAT_PROJECTION = new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "format"};
        PATH_FORMAT_PROJECTION = new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "_data", "format"};
        OBJECT_INFO_PROJECTION = new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "storage_id", "format", "parent", "_data", "date_added", "date_modified"};
    ...
    public MtpDatabase(Context context, String volumeName, String storagePath, String[] subDirectories) {
        ...
        this.mBatteryReceiver = new C04711();
        native_setup();
    ...
    private void initDeviceProperties(Context context) {
        ...
        if (context.getDatabasePath("device-properties").exists()) {
            ...
            try {
                ...
                if (db != null) {
                    c = db.query("properties", new String[]{SubscriptionManager.UNIQUE_KEY_SUBSCRIPTION_ID, "code", "value"}, null, null, null, null, null);
                    if (c != null) {
            ...
            if (oldFile.renameTo(newFile)) {
                ...
                if (newFile.isDirectory()) {
                    if (oldFile.getName().startsWith(".") && !newPath.startsWith(".")) {
                        try {
                            this.mMediaProvider.call(this.mPackageName, "unhide", newPath, null);
                        } catch (RemoteException e2) {
                    ...
                    try {
                        this.mMediaProvider.call(this.mPackageName, "unhide", oldFile.getParent(), null);
            ...
            if (isStorageSubDirectory(path)) {
                ...
                if (this.mMediaProvider.delete(this.mPackageName, Files.getMtpObjectsUri(this.mVolumeName, (long) handle), null, null) > 0) {
                    if (format != GLES11.GL_CLIP_PLANE1 && path.toLowerCase(Locale.US).endsWith("/.nomedia")) {
                        try {
                            this.mMediaProvider.call(this.mPackageName, "unhide", path.substring(0, path.lastIndexOf("/")), null);
                        } catch (RemoteException e) {
