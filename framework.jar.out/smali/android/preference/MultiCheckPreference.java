...
public class MultiCheckPreference extends DialogPreference {
    ...
    class C06321 implements OnMultiChoiceClickListener {
        C06321() {
        }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        static class C06331 implements Creator<SavedState> {
            C06331() {
            }
    ...
    protected void onPrepareDialogBuilder(Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, this.mSetValues, new C06321());
    }
