...
class GLLogWrapper extends GLWrapperBase {
    ...
    private class PointerInfo {
        ...
        public int sizeof(int type) {
            switch (type) {
                case DateUtils.FORMAT_CAP_NOON_MIDNIGHT /*5120*/:
                case GLES20.GL_UNSIGNED_BYTE /*5121*/:
                    return GLLogWrapper.FORMAT_FLOAT;
                case GLES20.GL_SHORT /*5122*/:
                    return GLLogWrapper.FORMAT_FIXED;
                case GLES20.GL_FLOAT /*5126*/:
                    return 4;
                case GLES20.GL_FIXED /*5132*/:
                    return 4;
                default:
                    return 0;
            }
    ...
    private String toString(int n, int format, int[] arr, int offset) {
        ...
        for (int i = 0; i < n; i += FORMAT_FLOAT) {
            int index = offset + i;
            buf.append(" [" + index + "] = ");
    ...
    private void argPointer(int size, int type, int stride, Buffer pointer) {
        arg("size", size);
        arg(Channels.COLUMN_TYPE, getPointerTypeName(type));
    ...
    private String getClearBufferMask(int mask) {
        ...
        if ((mask & InputMethodManager.CONTROL_START_INITIAL) != 0) {
            b.append("GL_DEPTH_BUFFER_BIT");
            mask &= -257;
        }
        if ((mask & AccessibilityNodeInfo.ACTION_NEXT_HTML_ELEMENT) != 0) {
            if (b.length() > 0) {
                b.append(" | ");
            }
        ...
        if ((mask & AccessibilityNodeInfo.ACTION_COPY) != 0) {
            if (b.length() > 0) {
                b.append(" | ");
            }
    ...
    private String getFactor(int factor) {
        switch (factor) {
            ...
            case FORMAT_FLOAT /*1*/:
                return "GL_ONE";
            case GLES20.GL_SRC_COLOR /*768*/:
                return "GL_SRC_COLOR";
            case GLES20.GL_ONE_MINUS_SRC_COLOR /*769*/:
                return "GL_ONE_MINUS_SRC_COLOR";
            case GLES20.GL_SRC_ALPHA /*770*/:
                return "GL_SRC_ALPHA";
            case GLES20.GL_ONE_MINUS_SRC_ALPHA /*771*/:
                return "GL_ONE_MINUS_SRC_ALPHA";
            case GLES20.GL_DST_ALPHA /*772*/:
                return "GL_DST_ALPHA";
            case GLES20.GL_ONE_MINUS_DST_ALPHA /*773*/:
                return "GL_ONE_MINUS_DST_ALPHA";
            case GLES20.GL_DST_COLOR /*774*/:
                return "GL_DST_COLOR";
            case GLES20.GL_ONE_MINUS_DST_COLOR /*775*/:
                return "GL_ONE_MINUS_DST_COLOR";
            case GLES20.GL_SRC_ALPHA_SATURATE /*776*/:
    ...
    private String getTextureTarget(int target) {
        switch (target) {
            case GLES20.GL_TEXTURE_2D /*3553*/:
    ...
    private String getTextureEnvParamName(float param) {
        ...
        switch (iparam) {
            case GLES10.GL_ADD /*260*/:
                return "GL_ADD";
            case GLES20.GL_BLEND /*3042*/:
                return "GL_BLEND";
            case GLES20.GL_REPLACE /*7681*/:
                return "GL_REPLACE";
    ...
    private String getClientState(int clientState) {
        switch (clientState) {
            case GLES31Ext.GL_VERTEX_ARRAY_KHR /*32884*/:
    ...
    private String getCap(int cap) {
        switch (cap) {
            ...
            case GLES10.GL_FOG /*2912*/:
                return "GL_FOG";
            case GLES20.GL_DEPTH_TEST /*2929*/:
                return "GL_DEPTH_TEST";
            case GLES20.GL_STENCIL_TEST /*2960*/:
                return "GL_STENCIL_TEST";
            case GLES10.GL_NORMALIZE /*2977*/:
                return "GL_NORMALIZE";
            case GLES10.GL_ALPHA_TEST /*3008*/:
                return "GL_ALPHA_TEST";
            case GLES20.GL_DITHER /*3024*/:
                return "GL_DITHER";
            case GLES20.GL_BLEND /*3042*/:
                return "GL_BLEND";
            case GLES10.GL_COLOR_LOGIC_OP /*3058*/:
                return "GL_COLOR_LOGIC_OP";
            case GLES20.GL_SCISSOR_TEST /*3089*/:
                return "GL_SCISSOR_TEST";
            case GLES20.GL_TEXTURE_2D /*3553*/:
                return "GL_TEXTURE_2D";
            case AccessibilityNodeInfo.ACTION_COPY /*16384*/:
                return "GL_LIGHT0";
            case HistoryItem.EVENT_PROC_FINISH /*16385*/:
                return "GL_LIGHT1";
            case InputDevice.SOURCE_STYLUS /*16386*/:
                return "GL_LIGHT2";
            case HistoryItem.EVENT_TOP_FINISH /*16387*/:
                return "GL_LIGHT3";
            case HistoryItem.EVENT_SYNC_FINISH /*16388*/:
                return "GL_LIGHT4";
            case HistoryItem.EVENT_WAKE_LOCK_FINISH /*16389*/:
                return "GL_LIGHT5";
            case HistoryItem.EVENT_JOB_FINISH /*16390*/:
                return "GL_LIGHT6";
            case HistoryItem.EVENT_USER_RUNNING_FINISH /*16391*/:
                return "GL_LIGHT7";
            ...
            case GLES20.GL_SAMPLE_ALPHA_TO_COVERAGE /*32926*/:
                return "GL_SAMPLE_ALPHA_TO_COVERAGE";
            case GLES10.GL_SAMPLE_ALPHA_TO_ONE /*32927*/:
                return "GL_SAMPLE_ALPHA_TO_ONE";
            case GLES20.GL_SAMPLE_COVERAGE /*32928*/:
    ...
    private String getTexturePName(int pname) {
        switch (pname) {
            case GLES20.GL_TEXTURE_MAG_FILTER /*10240*/:
                return "GL_TEXTURE_MAG_FILTER";
            case GLES20.GL_TEXTURE_MIN_FILTER /*10241*/:
                return "GL_TEXTURE_MIN_FILTER";
            case GLES20.GL_TEXTURE_WRAP_S /*10242*/:
                return "GL_TEXTURE_WRAP_S";
            case GLES20.GL_TEXTURE_WRAP_T /*10243*/:
    ...
    private String getTextureParamName(float param) {
        ...
        switch (iparam) {
            case GLES20.GL_NEAREST /*9728*/:
                return "GL_NEAREST";
            case GLES20.GL_LINEAR /*9729*/:
                return "GL_LINEAR";
            case GLES20.GL_NEAREST_MIPMAP_NEAREST /*9984*/:
                return "GL_NEAREST_MIPMAP_NEAREST";
            case GLES20.GL_LINEAR_MIPMAP_NEAREST /*9985*/:
                return "GL_LINEAR_MIPMAP_NEAREST";
            case GLES20.GL_NEAREST_MIPMAP_LINEAR /*9986*/:
                return "GL_NEAREST_MIPMAP_LINEAR";
            case GLES20.GL_LINEAR_MIPMAP_LINEAR /*9987*/:
                return "GL_LINEAR_MIPMAP_LINEAR";
            case GLES20.GL_REPEAT /*10497*/:
                return "GL_REPEAT";
            case GLES20.GL_CLAMP_TO_EDGE /*33071*/:
    ...
    private String getIndexType(int type) {
        switch (type) {
            ...
            case GLES20.GL_UNSIGNED_SHORT /*5123*/:
    ...
    private String getIntegerStateName(int pname) {
        switch (pname) {
            ...
            case GLES20.GL_MAX_TEXTURE_SIZE /*3379*/:
            ...
            case GLES20.GL_MAX_VIEWPORT_DIMS /*3386*/:
                return "GL_MAX_VIEWPORT_DIMS";
            case GLES20.GL_SUBPIXEL_BITS /*3408*/:
                return "GL_SUBPIXEL_BITS";
            case GLES20.GL_RED_BITS /*3410*/:
                return "GL_RED_BITS";
            case GLES20.GL_GREEN_BITS /*3411*/:
                return "GL_GREEN_BITS";
            case GLES20.GL_BLUE_BITS /*3412*/:
                return "GL_BLUE_BITS";
            case GLES20.GL_ALPHA_BITS /*3413*/:
                return "GL_ALPHA_BITS";
            case GLES20.GL_DEPTH_BITS /*3414*/:
                return "GL_DEPTH_BITS";
            case GLES20.GL_STENCIL_BITS /*3415*/:
                return "GL_STENCIL_BITS";
            case GLES30.GL_MAX_ELEMENTS_VERTICES /*33000*/:
                return "GL_MAX_ELEMENTS_VERTICES";
            case GLES30.GL_MAX_ELEMENTS_INDICES /*33001*/:
                return "GL_MAX_ELEMENTS_INDICES";
            case GLES20.GL_ALIASED_POINT_SIZE_RANGE /*33901*/:
                return "GL_ALIASED_POINT_SIZE_RANGE";
            case GLES20.GL_ALIASED_LINE_WIDTH_RANGE /*33902*/:
                return "GL_ALIASED_LINE_WIDTH_RANGE";
            case GLES10.GL_MAX_TEXTURE_UNITS /*34018*/:
                return "GL_MAX_TEXTURE_UNITS";
            case GLES20.GL_NUM_COMPRESSED_TEXTURE_FORMATS /*34466*/:
                return "GL_NUM_COMPRESSED_TEXTURE_FORMATS";
            case GLES20.GL_COMPRESSED_TEXTURE_FORMATS /*34467*/:
                return "GL_COMPRESSED_TEXTURE_FORMATS";
            case GLES11Ext.GL_MODELVIEW_MATRIX_FLOAT_AS_INT_BITS_OES /*35213*/:
                return "GL_MODELVIEW_MATRIX_FLOAT_AS_INT_BITS_OES";
            case GLES11Ext.GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES /*35214*/:
                return "GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES";
            case GLES11Ext.GL_TEXTURE_MATRIX_FLOAT_AS_INT_BITS_OES /*35215*/:
    ...
    private int getIntegerStateSize(int pname) {
        switch (pname) {
            ...
            case GLES20.GL_ALIASED_LINE_WIDTH_RANGE /*33902*/:
                return FORMAT_FIXED;
            case GLES20.GL_COMPRESSED_TEXTURE_FORMATS /*34467*/:
                int[] buffer = new int[FORMAT_FLOAT];
                this.mgl.glGetIntegerv(GLES20.GL_NUM_COMPRESSED_TEXTURE_FORMATS, buffer, 0);
                return buffer[0];
            case GLES11Ext.GL_MODELVIEW_MATRIX_FLOAT_AS_INT_BITS_OES /*35213*/:
            case GLES11Ext.GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES /*35214*/:
            case GLES11Ext.GL_TEXTURE_MATRIX_FLOAT_AS_INT_BITS_OES /*35215*/:
    ...
    private String getHintTarget(int target) {
        switch (target) {
            ...
            case GLES10.GL_FOG_HINT /*3156*/:
                return "GL_FOG_HINT";
            case GLES20.GL_GENERATE_MIPMAP_HINT /*33170*/:
    ...
    private String getHintMode(int mode) {
        switch (mode) {
            case GLES20.GL_DONT_CARE /*4352*/:
                return "GL_DONT_CARE";
            case GLES20.GL_FASTEST /*4353*/:
                return "GL_FASTEST";
            case GLES20.GL_NICEST /*4354*/:
                return "GL_NICEST";
            default:
                return getHex(mode);
        }
    ...
    private String getLightName(int light) {
        if (light < AccessibilityNodeInfo.ACTION_COPY || light > HistoryItem.EVENT_USER_RUNNING_FINISH) {
            return getHex(light);
        }
    ...
    private ByteBuffer toByteBuffer(int byteCount, Buffer input) {
        ...
        if (input instanceof ByteBuffer) {
            ...
            for (i = 0; i < byteCount; i += FORMAT_FLOAT) {
            ...
            if (convertWholeBuffer) {
                byteCount = (input22.limit() - position) * FORMAT_FIXED;
            }
            result = ByteBuffer.allocate(byteCount).order(input22.order());
            CharBuffer result2 = result.asCharBuffer();
            for (i = 0; i < byteCount / FORMAT_FIXED; i += FORMAT_FLOAT) {
            ...
            if (convertWholeBuffer) {
                byteCount = (input23.limit() - position) * FORMAT_FIXED;
            }
            ...
            for (i = 0; i < byteCount / 4; i += FORMAT_FLOAT) {
            ...
            for (i = 0; i < byteCount / 8; i += FORMAT_FLOAT) {
    ...
    private char[] toCharIndices(int count, int type, Buffer indices) {
        ...
        switch (type) {
            case GLES20.GL_UNSIGNED_BYTE /*5121*/:
                ...
                for (int i = 0; i < count; i += FORMAT_FLOAT) {
                    result[i] = (char) (array[offset + i] & EditorInfo.IME_MASK_ACTION);
                }
                break;
            case GLES20.GL_UNSIGNED_SHORT /*5123*/:
                ...
                if (indices instanceof CharBuffer) {
                    ...
                    charBuffer = toByteBuffer(count * FORMAT_FIXED, indices).asCharBuffer();
                }
    ...
    private void doArrayElement(StringBuilder builder, boolean enabled, String name, PointerInfo pointer, int index) {
        if (enabled) {
            ...
            if (pointer == null || pointer.mTempByteBuffer == null) {
                ...
                for (int i = 0; i < size; i += FORMAT_FLOAT) {
                    if (i > 0) {
                        builder.append(", ");
                    }
                    switch (type) {
                        case DateUtils.FORMAT_CAP_NOON_MIDNIGHT /*5120*/:
                            ...
                            break;
                        case GLES20.GL_UNSIGNED_BYTE /*5121*/:
                            builder.append(Integer.toString(byteBuffer.get(byteOffset) & EditorInfo.IME_MASK_ACTION));
                            break;
                        case GLES20.GL_SHORT /*5122*/:
                            builder.append(Integer.toString(byteBuffer.asShortBuffer().get(byteOffset / FORMAT_FIXED)));
                            break;
                        case GLES20.GL_FLOAT /*5126*/:
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, int imageSize, Buffer data) {
        ...
        arg(HostApduService.KEY_DATA, data.toString());
        end();
    ...
    public void glDrawElements(int mode, int count, int type, Buffer indices) {
        ...
        arg("count", count);
        arg(Channels.COLUMN_TYPE, getIndexType(type));
        char[] indexArray = toCharIndices(count, type, indices);
        int indexArrayLength = indexArray.length;
        startLogIndices();
        for (int i = 0; i < indexArrayLength; i += FORMAT_FLOAT) {
    ...
    public int glQueryMatrixxOES(IntBuffer mantissa, IntBuffer exponent) {
        ...
        returns(toString(16, (int) FORMAT_FIXED, mantissa));
