...
public interface IConnectivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectivityManager {
        ...
        static final int TRANSACTION_addVpnAddress = 63;
        static final int TRANSACTION_captivePortalCheckCompleted = 45;
        static final int TRANSACTION_checkMobileProvisioning = 48;
        static final int TRANSACTION_establishVpn = 40;
        static final int TRANSACTION_findConnectionTypeForIface = 47;
        ...
        static final int TRANSACTION_getDefaultProxy = 36;
        static final int TRANSACTION_getGlobalProxy = 34;
        static final int TRANSACTION_getLastTetherError = 21;
        static final int TRANSACTION_getLegacyVpnInfo = 43;
        static final int TRANSACTION_getLinkProperties = 13;
        static final int TRANSACTION_getLinkPropertiesForType = 12;
        static final int TRANSACTION_getMobileProvisioningUrl = 49;
        static final int TRANSACTION_getMobileRedirectedProvisioningUrl = 50;
        ...
        static final int TRANSACTION_getRestoreDefaultNetworkDelay = 62;
        static final int TRANSACTION_getTetherConnectedSta = 31;
        ...
        static final int TRANSACTION_getVpnConfig = 41;
        ...
        static final int TRANSACTION_listenForNetwork = 59;
        static final int TRANSACTION_pendingListenForNetwork = 60;
        static final int TRANSACTION_pendingRequestForNetwork = 57;
        static final int TRANSACTION_prepareVpn = 38;
        static final int TRANSACTION_registerNetworkAgent = 55;
        static final int TRANSACTION_registerNetworkFactory = 53;
        static final int TRANSACTION_releaseNetworkRequest = 61;
        static final int TRANSACTION_releasePendingNetworkRequest = 58;
        static final int TRANSACTION_removeVpnAddress = 64;
        static final int TRANSACTION_reportBadNetwork = 33;
        static final int TRANSACTION_reportInetCondition = 32;
        static final int TRANSACTION_requestNetwork = 56;
        static final int TRANSACTION_requestRouteToHostAddress = 18;
        static final int TRANSACTION_setAirplaneMode = 52;
        static final int TRANSACTION_setDataDependency = 37;
        static final int TRANSACTION_setGlobalProxy = 35;
        static final int TRANSACTION_setProvisioningNotificationVisible = 51;
        static final int TRANSACTION_setUnderlyingNetworksForVpn = 65;
        static final int TRANSACTION_setUsbTethering = 30;
        static final int TRANSACTION_setVpnPackageAuthorization = 39;
        static final int TRANSACTION_startLegacyVpn = 42;
        static final int TRANSACTION_supplyMessenger = 46;
        static final int TRANSACTION_tether = 19;
        static final int TRANSACTION_unregisterNetworkFactory = 54;
        static final int TRANSACTION_untether = 20;
        static final int TRANSACTION_updateLockdownVpn = 44;
        ...
        private static class Proxy implements IConnectivityManager {
            ...
            public List<WifiDevice> getTetherConnectedSta() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getTetherConnectedSta, _data, _reply, 0);
                    _reply.readException();
                    List<WifiDevice> _result = _reply.createTypedArrayList(WifiDevice.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_setUsbTethering /*30*/:
                    ...
                    reply.writeInt(_result4);
                    return true;
                case TRANSACTION_getTetherConnectedSta /*31*/:
                    data.enforceInterface(DESCRIPTOR);
                    List<WifiDevice> _result16 = getTetherConnectedSta();
                    reply.writeNoException();
                    reply.writeTypedList(_result16);
                    return true;
                case TRANSACTION_reportInetCondition /*32*/:
                    data.enforceInterface(DESCRIPTOR);
                    reportInetCondition(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_reportBadNetwork /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (Network) Network.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getGlobalProxy /*34*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_setGlobalProxy /*35*/:
                    ProxyInfo _arg06;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getDefaultProxy /*36*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_setDataDependency /*37*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg1 = true;
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_prepareVpn /*38*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setVpnPackageAuthorization /*39*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = true;
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_establishVpn /*40*/:
                    VpnConfig _arg07;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    ParcelFileDescriptor _result17 = establishVpn(_arg07);
                    reply.writeNoException();
                    if (_result17 != null) {
                        reply.writeInt(TRANSACTION_getActiveNetworkInfo);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_getVpnConfig /*41*/:
                    data.enforceInterface(DESCRIPTOR);
                    VpnConfig _result18 = getVpnConfig();
                    reply.writeNoException();
                    if (_result18 != null) {
                        reply.writeInt(TRANSACTION_getActiveNetworkInfo);
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_startLegacyVpn /*42*/:
                    VpnProfile _arg08;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getLegacyVpnInfo /*43*/:
                    data.enforceInterface(DESCRIPTOR);
                    LegacyVpnInfo _result19 = getLegacyVpnInfo();
                    reply.writeNoException();
                    if (_result19 != null) {
                        reply.writeInt(TRANSACTION_getActiveNetworkInfo);
                        _result19.writeToParcel(reply, TRANSACTION_getActiveNetworkInfo);
                        return true;
                    }
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_updateLockdownVpn /*44*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_captivePortalCheckCompleted /*45*/:
                    NetworkInfo _arg09;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_supplyMessenger /*46*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt();
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_findConnectionTypeForIface /*47*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = findConnectionTypeForIface(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case TRANSACTION_checkMobileProvisioning /*48*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = checkMobileProvisioning(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case TRANSACTION_getMobileProvisioningUrl /*49*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result7 = getMobileProvisioningUrl();
                    reply.writeNoException();
                    reply.writeString(_result7);
                    return true;
                case TRANSACTION_getMobileRedirectedProvisioningUrl /*50*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_registerNetworkFactory /*53*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_unregisterNetworkFactory /*54*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (Messenger) Messenger.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_registerNetworkAgent /*55*/:
                    NetworkInfo _arg14;
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_requestNetwork /*56*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_pendingRequestForNetwork /*57*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (NetworkCapabilities) NetworkCapabilities.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_releasePendingNetworkRequest /*58*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_listenForNetwork /*59*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (NetworkCapabilities) NetworkCapabilities.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_pendingListenForNetwork /*60*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (NetworkCapabilities) NetworkCapabilities.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_releaseNetworkRequest /*61*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getRestoreDefaultNetworkDelay /*62*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getRestoreDefaultNetworkDelay(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case TRANSACTION_addVpnAddress /*63*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_removeVpnAddress /*64*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_setUnderlyingNetworksForVpn /*65*/:
                    data.enforceInterface(DESCRIPTOR);
