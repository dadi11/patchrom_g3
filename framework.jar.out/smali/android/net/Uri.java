...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    /* renamed from: android.net.Uri.1 */
    static class C05091 implements Creator<Uri> {
        C05091() {
        }
    ...
    private static boolean isAllowed(char c, String allow) {
        return (c >= DateFormat.CAPITAL_AM_PM && c <= 'Z') || ((c >= DateFormat.AM_PM && c <= DateFormat.TIME_ZONE) || !((c < '0' || c > '9') && "_-!.~'()*".indexOf(c) == NOT_FOUND && (allow == null || allow.indexOf(c) == NOT_FOUND)));
    }
