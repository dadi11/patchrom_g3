...
public class ProxyInfo implements Parcelable {
    ...
    /* renamed from: android.net.ProxyInfo.1 */
    static class C05021 implements Creator<ProxyInfo> {
        C05021() {
        }
        ...
        public ProxyInfo createFromParcel(Parcel in) {
            ...
            return new ProxyInfo(port, in.readString(), in.readStringArray(), null);
        }
    ...
    public static ProxyInfo buildDirectProxy(String host, int port, List<String> exclList) {
        Object[] array = (String[]) exclList.toArray(new String[exclList.size()]);
        return new ProxyInfo(host, port, TextUtils.join((CharSequence) ",", array), array);
    }
