...
public class WifiP2pGroup implements Parcelable {
    ...
    /* renamed from: android.net.wifi.p2p.WifiP2pGroup.1 */
    static class C05531 implements Creator<WifiP2pGroup> {
        C05531() {
        }
        ...
        if (tokens.length < 3) {
            ...
            if (match.find()) {
                ...
                if (match.group(6) != null) {
                    this.mNetId = PERSISTENT_NET_ID;
                } else {
                    this.mNetId = TEMPORARY_NET_ID;
                }
            }
