...
public class WifiP2pGroupList implements Parcelable {
    ...
    /* renamed from: android.net.wifi.p2p.WifiP2pGroupList.1 */
    class C05541 extends LruCache<Integer, WifiP2pGroup> {
        C05541(int x0) {
            super(x0);
        }
    ...
    static class C05552 implements Creator<WifiP2pGroupList> {
        C05552() {
        }
    ...
    public WifiP2pGroupList(WifiP2pGroupList source, GroupDeleteListener listener) {
        ...
        this.mGroups = new C05541(CREDENTIAL_MAX_NUM);
        if (source != null) {
