...
public enum SupplicantState implements Parcelable {
    ...
    /* renamed from: android.net.wifi.SupplicantState.1 */
    static class C05271 implements Creator<SupplicantState> {
        C05271() {
        }
    ...
    public static boolean isHandshakeState(SupplicantState state) {
        switch (C05282.$SwitchMap$android$net$wifi$SupplicantState[state.ordinal()]) {
