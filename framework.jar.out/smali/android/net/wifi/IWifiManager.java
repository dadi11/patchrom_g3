...
public interface IWifiManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWifiManager {
        ...
        static final int TRANSACTION_isIbssSupported = 24;
        ...
        private static class Proxy implements IWifiManager {
            ...
            public boolean isIbssSupported() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_isIbssSupported, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
                    }
            ...
            public WifiEapSimInfo getSimInfo() throws RemoteException {
                ...
                Parcel _reply = Parcel.obtain();
                try {
                    WifiEapSimInfo _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getSimInfo, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (WifiEapSimInfo) WifiEapSimInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_isDualBandSupported /*23*/:
                    ...
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_isIbssSupported /*24*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isIbssSupported();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_saveConfiguration /*25*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = saveConfiguration();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_getDhcpInfo /*26*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_isScanAlwaysAvailable /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isScanAlwaysAvailable();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_acquireWifiLock /*28*/:
                    WorkSource _arg3;
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_updateWifiLockWorkSource /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        _arg1 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_releaseWifiLock /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = releaseWifiLock(data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_initializeMulticastFiltering /*31*/:
                    data.enforceInterface(DESCRIPTOR);
                    initializeMulticastFiltering();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_isMulticastEnabled /*32*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isMulticastEnabled();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_acquireMulticastLock /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                    acquireMulticastLock(data.readStrongBinder(), data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_releaseMulticastLock /*34*/:
                    data.enforceInterface(DESCRIPTOR);
                    releaseMulticastLock();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setWifiApEnabled /*35*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (WifiConfiguration) WifiConfiguration.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getWifiApEnabledState /*36*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getWifiApEnabledState();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getWifiApConfiguration /*37*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_setWifiApConfiguration /*38*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (WifiConfiguration) WifiConfiguration.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_startWifi /*39*/:
                    data.enforceInterface(DESCRIPTOR);
                    startWifi();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_stopWifi /*40*/:
                    data.enforceInterface(DESCRIPTOR);
                    stopWifi();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_addToBlacklist /*41*/:
                    data.enforceInterface(DESCRIPTOR);
                    addToBlacklist(data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_clearBlacklist /*42*/:
                    data.enforceInterface(DESCRIPTOR);
                    clearBlacklist();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getWifiServiceMessenger /*43*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_getConfigFile /*44*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getConfigFile();
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case TRANSACTION_enableTdls /*45*/:
                    data.enforceInterface(DESCRIPTOR);
                    enableTdls(data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_enableTdlsWithMacAddress /*46*/:
                    data.enforceInterface(DESCRIPTOR);
                    enableTdlsWithMacAddress(data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_requestBatchedScan /*47*/:
                    WorkSource _arg22;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_stopBatchedScan /*48*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (BatchedScanSettings) BatchedScanSettings.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getBatchedScanResults /*49*/:
                    data.enforceInterface(DESCRIPTOR);
                    List<BatchedScanResult> _result12 = getBatchedScanResults(data.readString());
                    reply.writeNoException();
                    reply.writeTypedList(_result12);
                    return true;
                case TRANSACTION_isBatchedScanSupported /*50*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isBatchedScanSupported();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? TRANSACTION_getSupportedFeatures : 0);
                    return true;
                case TRANSACTION_pollBatchedScan /*51*/:
                    data.enforceInterface(DESCRIPTOR);
                    pollBatchedScan();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getWpsNfcConfigurationToken /*52*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getWpsNfcConfigurationToken(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case TRANSACTION_enableVerboseLogging /*53*/:
                    data.enforceInterface(DESCRIPTOR);
                    enableVerboseLogging(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getVerboseLoggingLevel /*54*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getVerboseLoggingLevel();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getAggressiveHandover /*55*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAggressiveHandover();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_enableAggressiveHandover /*56*/:
                    data.enforceInterface(DESCRIPTOR);
                    enableAggressiveHandover(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getAllowScansWithTraffic /*57*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAllowScansWithTraffic();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setAllowScansWithTraffic /*58*/:
                    data.enforceInterface(DESCRIPTOR);
                    setAllowScansWithTraffic(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getConnectionStatistics /*59*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case TRANSACTION_disableEphemeralNetwork /*60*/:
                    data.enforceInterface(DESCRIPTOR);
                    disableEphemeralNetwork(data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getSimInfo /*61*/:
                    data.enforceInterface(DESCRIPTOR);
                    WifiEapSimInfo _result14 = getSimInfo();
                    reply.writeNoException();
                    if (_result14 != null) {
                        reply.writeInt(TRANSACTION_getSupportedFeatures);
                        _result14.writeToParcel(reply, TRANSACTION_getSupportedFeatures);
                    } else {
                        reply.writeInt(0);
                    }
                    return true;
