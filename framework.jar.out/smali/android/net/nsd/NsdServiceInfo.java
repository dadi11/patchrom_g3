...
public final class NsdServiceInfo implements Parcelable {
    ...
    /* renamed from: android.net.nsd.NsdServiceInfo.1 */
    static class C05191 implements Creator<NsdServiceInfo> {
        C05191() {
        }
    ...
    public void setAttribute(String key, byte[] value) {
        ...
        if ((value == null ? 0 : value.length) + key.length() >= EditorInfo.IME_MASK_ACTION) {
