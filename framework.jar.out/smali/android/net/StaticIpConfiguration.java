...
public class StaticIpConfiguration implements Parcelable {
    ...
    /* renamed from: android.net.StaticIpConfiguration.1 */
    static class C05071 implements Creator<StaticIpConfiguration> {
        C05071() {
        }
    ...
    public LinkProperties toLinkProperties(String iface) {
        ...
        while (i$.hasNext()) {
            lp.addDnsServer((InetAddress) i$.next());
        }
    ...
    public String toString() {
        ...
        Iterator i$ = this.dnsServers.iterator();
        while (i$.hasNext()) {
            str.append(" ").append(((InetAddress) i$.next()).getHostAddress());
        }
        str.append(" ] Domains");
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        Iterator i$ = this.dnsServers.iterator();
        while (i$.hasNext()) {
            NetworkUtils.parcelInetAddress(dest, (InetAddress) i$.next(), flags);
        }
    }
