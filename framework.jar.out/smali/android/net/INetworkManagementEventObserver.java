...
public interface INetworkManagementEventObserver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkManagementEventObserver {
        ...
        private static class Proxy implements INetworkManagementEventObserver {
            ...
            public void interfaceMessageRecevied(String message) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(message);
                    this.mRemote.transact(Stub.TRANSACTION_interfaceMessageRecevied, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_interfaceClassDataActivityChanged /*8*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_interfaceMessageRecevied /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    interfaceMessageRecevied(data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_interfaceDnsServerInfo /*10*/:
                    data.enforceInterface(DESCRIPTOR);
                    interfaceDnsServerInfo(data.readString(), data.readLong(), data.createStringArray());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_routeUpdated /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_routeRemoved /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (RouteInfo) RouteInfo.CREATOR.createFromParcel(data);
                    } else {
