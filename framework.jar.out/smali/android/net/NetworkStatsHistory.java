...
public class NetworkStatsHistory implements Parcelable {
    ...
    /* renamed from: android.net.NetworkStatsHistory.1 */
    static class C04991 implements Creator<NetworkStatsHistory> {
        C04991() {
        }
    ...
    public static class DataStreamUtils {
        ...
        public static long readVarLong(DataInputStream in) throws IOException {
            ...
            for (int shift = 0; shift < 64; shift += 7) {
                byte b = in.readByte();
                result |= ((long) (b & KeyEvent.KEYCODE_MEDIA_PAUSE)) << shift;
                if ((b & AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS) == 0) {
                    return result;
                }
            }
        ...
        public static void writeVarLong(DataOutputStream out, long value) throws IOException {
            while ((-128 & value) != 0) {
                out.writeByte((((int) value) & KeyEvent.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfo.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
                value >>>= 7;
            }
