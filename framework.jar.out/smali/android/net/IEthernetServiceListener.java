...
public interface IEthernetServiceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IEthernetServiceListener {
        ...
        private static class Proxy implements IEthernetServiceListener {
            ...
            public void onAvailabilityChanged(boolean isAvailable) throws RemoteException {
                int i = Stub.TRANSACTION_onAvailabilityChanged;
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onAvailabilityChanged, _data, null, Stub.TRANSACTION_onAvailabilityChanged);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onAvailabilityChanged /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onAvailabilityChanged(data.readInt() != 0);
                    return true;
