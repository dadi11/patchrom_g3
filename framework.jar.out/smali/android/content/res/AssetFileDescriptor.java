...
public class AssetFileDescriptor implements Parcelable, Closeable {
    ...
    static class C01491 implements Creator<AssetFileDescriptor> {
        C01491() {
        }
    ...
    public static class AutoCloseInputStream extends android.os.ParcelFileDescriptor.AutoCloseInputStream {
        ...
        public int available() throws IOException {
            if (this.mRemaining >= 0) {
                return this.mRemaining < 2147483647L ? (int) this.mRemaining : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            } else {
        ...
        public int read() throws IOException {
            ...
            return buffer[0] & EditorInfo.IME_MASK_ACTION;
        }
