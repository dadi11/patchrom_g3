...
public class Intent implements Parcelable, Cloneable {
    ...
    static class C01021 implements Creator<Intent> {
        C01021() {
        }
    ...
    public static class ShortcutIconResource implements Parcelable {
        ...
        static class C01031 implements Creator<ShortcutIconResource> {
            C01031() {
            }
    ...
    public static Intent parseUri(String uri, int flags) throws URISyntaxException {
        ...
        try {
            ...
            while (i >= 0) {
                if (uri.startsWith(TtmlUtils.ATTR_END, i)) {
                    break;
                }
                String value;
            ...
            if (this.mData != null) {
                ...
                if ((flags & URI_INTENT_SCHEME) != 0) {
                    ...
                    while (i < N) {
                        ...
                        if ((c >= DateFormat.AM_PM && c <= DateFormat.TIME_ZONE) || ((c >= DateFormat.CAPITAL_AM_PM && c <= 'Z') || c == '.' || c == '-')) {
                            i += URI_INTENT_SCHEME;
                        } else if (c == ':' && i > 0) {
    ...
    private void toUriInner(StringBuilder uri, String scheme, String defAction, String defPackage, int flags) {
        ...
        if (this.mExtras != null) {
            for (String key : this.mExtras.keySet()) {
                ...
                char entryType = value instanceof String ? 'S' : value instanceof Boolean ? 'B' : value instanceof Byte ? 'b' : value instanceof Character ? 'c' : value instanceof Double ? DateFormat.DATE : value instanceof Float ? 'f' : value instanceof Integer ? 'i' : value instanceof Long ? 'l' : value instanceof Short ? DateFormat.SECONDS : '\u0000';
                if (entryType != '\u0000') {
