...
public class ContainerEncryptionParams implements Parcelable {
    public static final Creator<ContainerEncryptionParams> CREATOR;
    ...
    static class C01181 implements Creator<ContainerEncryptionParams> {
        C01181() {
        }

        public ContainerEncryptionParams createFromParcel(Parcel source) {
            try {
                return new ContainerEncryptionParams(null);
