...
public class VerifierDeviceIdentity implements Parcelable {
    ...
    static class C01471 implements Creator<VerifierDeviceIdentity> {
        C01471() {
        }
    ...
    static {
        ENCODE = new char[]{DateFormat.CAPITAL_AM_PM, 'B', 'C', 'D', DateFormat.DAY, 'F', 'G', 'H', 'I', 'J', 'K', DateFormat.STANDALONE_MONTH, DateFormat.MONTH, PhoneNumberUtils.WILD, 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', '2', '3', '4', '5', '6', '7'};
        CREATOR = new C01471();
    }
