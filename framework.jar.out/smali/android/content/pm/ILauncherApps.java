        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_resolveActivity /*4*/:
                    ...
                    reply.writeInt(0);
                    return true;
                case TRANSACTION_startActivityAsUser /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_showAppDetailsAsUser /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (ComponentName) ComponentName.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_isPackageEnabled /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readString();
                    if (data.readInt() != 0) {
                        _arg1 = (UserHandle) UserHandle.CREATOR.createFromParcel(data);
                    ...
                    reply.writeNoException();
                    if (_result) {
                        i = TRANSACTION_addOnAppsChangedListener;
                    }
                    reply.writeInt(i);
                    return true;
                case TRANSACTION_isActivityEnabled /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (ComponentName) ComponentName.CREATOR.createFromParcel(data);
                    } else {
