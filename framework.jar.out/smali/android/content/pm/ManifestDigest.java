...
public class ManifestDigest implements Parcelable {
    ...
    static class C01251 implements Creator<ManifestDigest> {
        C01251() {
        }

        public ManifestDigest createFromParcel(Parcel source) {
            return new ManifestDigest(null);
        }
    ...
    static ManifestDigest fromInputStream(InputStream fileIs) {
        ...
        try {
            ...
            try {
                byte[] readBuffer = new byte[AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD];
                while (true) {
