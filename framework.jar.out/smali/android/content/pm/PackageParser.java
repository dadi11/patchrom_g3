...
public class PackageParser {
    ...
    static {
        ...
        newPermissionInfoArr[SDK_VERSION] = new NewPermissionInfo("android.permission.WRITE_EXTERNAL_STORAGE", PARSE_MUST_BE_APK, SDK_VERSION);
        ...
        strArr[SDK_VERSION] = "android.permission.READ_EXTERNAL_STORAGE";
        r0[SDK_VERSION] = new SplitPermissionInfo("android.permission.WRITE_EXTERNAL_STORAGE", strArr, HapticFeedbackConstants.SAFE_MODE_ENABLED);
        strArr = new String[PARSE_IS_SYSTEM];
        strArr[SDK_VERSION] = "android.permission.READ_CALL_LOG";
        r0[PARSE_IS_SYSTEM] = new SplitPermissionInfo("android.permission.READ_CONTACTS", strArr, PARSE_FORWARD_LOCK);
        strArr = new String[PARSE_IS_SYSTEM];
        strArr[SDK_VERSION] = "android.permission.WRITE_CALL_LOG";
        r0[PARSE_CHATTY] = new SplitPermissionInfo("android.permission.WRITE_CONTACTS", strArr, PARSE_FORWARD_LOCK);
