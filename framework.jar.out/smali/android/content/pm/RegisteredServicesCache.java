...
public abstract class RegisteredServicesCache<V> {
    ...
    class C01391 extends BroadcastReceiver {
        C01391() {
        }
    ...
    class C01402 extends BroadcastReceiver {
        C01402() {
        }
    ...
    class C01413 implements Runnable {
        ...
        C01413(RegisteredServicesCacheListener registeredServicesCacheListener, Object obj, int i, boolean z) {
    ...
    public RegisteredServicesCache(Context context, String interfaceName, String metaDataName, String attributeName, XmlSerializerAndParser<V> serializerAndParser) {
        ...
        this.mPackageReceiver = new C01391();
        this.mExternalReceiver = new C01402();
    ...
    private void notifyListener(V type, int userId, boolean removed) {
        ...
        if (listener != null) {
            handler.post(new C01413(listener, type, userId, removed));
        }
    }
