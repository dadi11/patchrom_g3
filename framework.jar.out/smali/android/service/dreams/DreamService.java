...
public class DreamService extends Service implements Callback {
    ...
    class C06712 implements Dump {
        final /* synthetic */ String[] val$args;
        final /* synthetic */ FileDescriptor val$fd;

        C06712(FileDescriptor fileDescriptor, String[] strArr) {
    ...
    private final class DreamServiceWrapper extends Stub {
        ...
        class C06721 implements Runnable {
            ...
            C06721(IBinder iBinder, boolean z) {
        ...
        public void attach(IBinder windowToken, boolean canDoze) {
            DreamService.this.mHandler.post(new C06721(windowToken, canDoze));
        }

        public void detach() {
            DreamService.this.mHandler.post(new C06732());
        }

        public void wakeUp() {
            DreamService.this.mHandler.post(new C06743());
        }
    }
        ...
        if (this.mWindowToken != null) {
            ...
            if (!this.mWindowless || this.mCanDoze) {
                if (!this.mWindowless) {
                    ...
                    this.mWindow.setBackgroundDrawable(new ColorDrawable((int) Spanned.SPAN_USER));
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        DumpUtils.dumpAsync(this.mHandler, new C06712(fd, args), pw, 1000);
    }
