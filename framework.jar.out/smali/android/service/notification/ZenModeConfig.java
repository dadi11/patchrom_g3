...
public class ZenModeConfig implements Parcelable {
    ...
    static class C06911 implements Creator<ZenModeConfig> {
        C06911() {
        }
    ...
    public static class DowntimeInfo {
        ...
        public boolean equals(Object o) {
            ...
            if (this.startHour == other.startHour && this.startMinute == other.startMinute && this.endHour == other.endHour && this.endMinute == other.endMinute && Objects.equals(this.mode, other.mode) && this.none == other.none) {
                return ZenModeConfig.DEFAULT_ALLOW_EVENTS;
            }
            return false;
        }
    }
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes, long now, int userHandle) {
        ...
        return new Condition(toCountdownConditionId(time), summary, line1, res.getString(17041057, objArr2), SOURCE_ANYONE, XML_VERSION, XML_VERSION);
    }
    ...
    public static Uri toDowntimeConditionId(DowntimeInfo downtime) {
        return new Builder().scheme(CONDITION_TAG).authority(SYSTEM_AUTHORITY).appendPath(DOWNTIME_PATH).appendQueryParameter("start", downtime.startHour + "." + downtime.startMinute).appendQueryParameter(TtmlUtils.ATTR_END, downtime.endHour + "." + downtime.endMinute).appendQueryParameter(SLEEP_ATT_MODE, downtime.mode).appendQueryParameter(SLEEP_ATT_NONE, Boolean.toString(downtime.none)).build();
    }
    ...
    public static DowntimeInfo tryParseDowntimeConditionId(Uri conditionId) {
        ...
        int[] end = tryParseHourAndMinute(conditionId.getQueryParameter(TtmlUtils.ATTR_END));
