...
public interface IVoiceInteractionSessionService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractionSessionService {
        ...
        private static class Proxy implements IVoiceInteractionSessionService {
            ...
            public void newSession(IBinder token, Bundle args) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(token);
                    if (args != null) {
                        _data.writeInt(Stub.TRANSACTION_newSession);
                        args.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_newSession, _data, null, Stub.TRANSACTION_newSession);
                } finally {
                    _data.recycle();
                }
            }
