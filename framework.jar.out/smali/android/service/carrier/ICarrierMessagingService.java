        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_sendTextSms /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    sendTextSms(data.readString(), data.readInt(), data.readString(), android.service.carrier.ICarrierMessagingCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case TRANSACTION_sendDataSms /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    sendDataSms(data.createByteArray(), data.readInt(), data.readString(), data.readInt(), android.service.carrier.ICarrierMessagingCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case TRANSACTION_sendMultipartTextSms /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    sendMultipartTextSms(data.createStringArrayList(), data.readInt(), data.readString(), android.service.carrier.ICarrierMessagingCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
