    ...
    public static abstract class Stub extends Binder implements ICarrierMessagingCallback {
        ...
        private static class Proxy implements ICarrierMessagingCallback {
            ...
            public void onFilterComplete(boolean keepMessage) throws RemoteException {
                int i = Stub.TRANSACTION_onFilterComplete;
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onFilterComplete, _data, null, Stub.TRANSACTION_onFilterComplete);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSendSmsComplete(int result, int messageRef) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onSendSmsComplete, _data, null, Stub.TRANSACTION_onFilterComplete);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSendMultipartSmsComplete(int result, int[] messageRefs) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onSendMultipartSmsComplete, _data, null, Stub.TRANSACTION_onFilterComplete);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onSendMmsComplete(int result, byte[] sendConfPdu) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_onSendMmsComplete, _data, null, Stub.TRANSACTION_onFilterComplete);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void onDownloadMmsComplete(int result) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(result);
                    this.mRemote.transact(Stub.TRANSACTION_onDownloadMmsComplete, _data, null, Stub.TRANSACTION_onFilterComplete);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_onFilterComplete /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    onFilterComplete(data.readInt() != 0);
                    return true;
                case TRANSACTION_onSendSmsComplete /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    onSendSmsComplete(data.readInt(), data.readInt());
                    return true;
                case TRANSACTION_onSendMultipartSmsComplete /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    onSendMultipartSmsComplete(data.readInt(), data.createIntArray());
                    return true;
                case TRANSACTION_onSendMmsComplete /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    onSendMmsComplete(data.readInt(), data.createByteArray());
                    return true;
                case TRANSACTION_onDownloadMmsComplete /*5*/:
                    data.enforceInterface(DESCRIPTOR);
