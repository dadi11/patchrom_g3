    ...
    public static abstract class Stub extends Binder implements IPersistentDataBlockService {
        ...
        private static class Proxy implements IPersistentDataBlockService {
            ...
            public byte[] read() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_read, _data, _reply, 0);
                    _reply.readException();
            ...
            public void wipe() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_wipe, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getDataBlockSize() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getDataBlockSize, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public long getMaximumDataBlockSize() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMaximumDataBlockSize, _data, _reply, 0);
                    _reply.readException();
            ...
            public void setOemUnlockEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (enabled) {
                        i = Stub.TRANSACTION_write;
                    }
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setOemUnlockEnabled, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getOemUnlockEnabled() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getOemUnlockEnabled, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
                    }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            int _result;
            switch (code) {
                case TRANSACTION_write /*1*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = write(data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_read /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    byte[] _result2 = read();
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case TRANSACTION_wipe /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    wipe();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getDataBlockSize /*4*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getDataBlockSize();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getMaximumDataBlockSize /*5*/:
                    data.enforceInterface(DESCRIPTOR);
                    long _result3 = getMaximumDataBlockSize();
                    reply.writeNoException();
                    reply.writeLong(_result3);
                    return true;
                case TRANSACTION_setOemUnlockEnabled /*6*/:
                    boolean _arg02;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = true;
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getOemUnlockEnabled /*7*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = getOemUnlockEnabled();
                    reply.writeNoException();
                    if (_result4) {
                        _arg0 = TRANSACTION_write;
                    }
