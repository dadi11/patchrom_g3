...
public class PhoneStateListener {
    ...
    /* renamed from: android.telephony.PhoneStateListener.2 */
    class C07812 extends Stub {
        C07812() {
        }
    ...
    public PhoneStateListener(int subId, Looper looper) {
        this.mSubId = -1;
        this.callback = new C07812();
        this.mSubId = subId;
        this.mHandler = new C07801(looper);
    }
