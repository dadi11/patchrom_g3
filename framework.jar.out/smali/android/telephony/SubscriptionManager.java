...
public class SubscriptionManager {
    ...
    public static class OnSubscriptionsChangedListener {
        ...
        class C07892 extends Stub {
            C07892() {
            }

            public void onSubscriptionsChanged() {
                OnSubscriptionsChangedListener.this.mHandler.sendEmptyMessage(SubscriptionManager.NAME_SOURCE_DEFAULT_SOURCE);
            }
        }

        public OnSubscriptionsChangedListener() {
            this.mHandler = new C07881();
            this.callback = new C07892();
        }
        ...
        private void log(String s) {
            Rlog.m13d(SubscriptionManager.LOG_TAG, s);
        }
    }
    ...
    public static void putPhoneIdAndSubIdExtra(Intent intent, int phoneId, int subId) {
        ...
        intent.putExtra(Context.TELEPHONY_SERVICE, phoneId);
    ...
    public static int getSimStateForSubscriber(int subId) {
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
            if (iSub != null) {
                return iSub.getSimStateForSubscriber(subId);
            }
            return NAME_SOURCE_DEFAULT_SOURCE;
        } catch (RemoteException e) {
            return NAME_SOURCE_DEFAULT_SOURCE;
