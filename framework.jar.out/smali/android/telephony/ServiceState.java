...
public class ServiceState implements Parcelable {
    ...
    static class C07851 implements Creator<ServiceState> {
        C07851() {
        }
    ...
    public static String rilRadioTechnologyToString(int rt) {
        switch (rt) {
            ...
            default:
                ...
                Rlog.m21w(LOG_TAG, "Unexpected radioTechnology=" + rt);
                return rtString;
        }
    }
    ...
    private void setNullState(int state) {
        Rlog.m13d(LOG_TAG, "[ServiceState] setNullState=" + state);
    ...
    public void setState(int state) {
        ...
        Rlog.m15e(LOG_TAG, "[ServiceState] setState deprecated use setVoiceRegState()");
    }

    public void setVoiceRegState(int state) {
        this.mVoiceRegState = state;
        Rlog.m13d(LOG_TAG, "[ServiceState] setVoiceRegState=" + this.mVoiceRegState);
    }

    public void setDataRegState(int state) {
        this.mDataRegState = state;
        Rlog.m13d(LOG_TAG, "[ServiceState] setDataRegState=" + this.mDataRegState);
    }
    ...
    private void setFromNotifierBundle(Bundle m) {
        ...
        this.mIsManualNetworkSelection = m.getBoolean(Parameters.FOCUS_MODE_MANUAL_POSITION);
    ...
    public void fillInNotifierBundle(Bundle m) {
        ...
        m.putBoolean(Parameters.FOCUS_MODE_MANUAL_POSITION, Boolean.valueOf(this.mIsManualNetworkSelection).booleanValue());
    ...
    public void setRilDataRadioTechnology(int rt) {
        ...
        Rlog.m13d(LOG_TAG, "[ServiceState] setDataRadioTechnology=" + this.mRilDataRadioTechnology);
    }
    ...
    public int getRadioTechnology() {
        Rlog.m15e(LOG_TAG, "ServiceState.getRadioTechnology() DEPRECATED will be removed *******");
    ...
    public int getNetworkType() {
        Rlog.m15e(LOG_TAG, "ServiceState.getNetworkType() DEPRECATED will be removed *******");
