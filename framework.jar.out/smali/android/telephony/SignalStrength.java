...
public class SignalStrength implements Parcelable {
    ...
    public void validateInput() {
        ...
        this.mLteRssnr = i;
        if (this.mTdScdmaRscp >= 25 && this.mTdScdmaRscp <= KeyEvent.KEYCODE_SYSRQ) {
    ...
    public boolean needsOldRilFeature(String feature) {
        String[] arr$ = SystemProperties.get("ro.telephony.ril.config", ProxyInfo.LOCAL_EXCL_LIST).split(",");
        int len$ = arr$.length;
        for (int i$ = SIGNAL_STRENGTH_NONE_OR_UNKNOWN; i$ < len$; i$ += SIGNAL_STRENGTH_POOR) {
    ...
    public int getCdmaLevel() {
        ...
        } else if (cdmaEcio >= MediaPlayer.MEDIA_ERROR_TIMED_OUT) {
    ...
    public int getLteLevel() {
        ...
        int rsrpIconLevel = -1;
        int snrIconLevel = -1;
        if (Resources.getSystem().getInteger(17694848) == 0) {
    ...
    public int getTdScdmaAsuLevel() {
        ...
        return tdScdmaDbm + KeyEvent.KEYCODE_SYSRQ;
    }

    public int hashCode() {
        return (this.isGsm ? SIGNAL_STRENGTH_POOR : SIGNAL_STRENGTH_NONE_OR_UNKNOWN) + ((this.mTdScdmaRscp * 31) + ((((((((((((this.mGsmSignalStrength * 31) + (this.mGsmBitErrorRate * 31)) + (this.mCdmaDbm * 31)) + (this.mCdmaEcio * 31)) + (this.mEvdoDbm * 31)) + (this.mEvdoEcio * 31)) + (this.mEvdoSnr * 31)) + (this.mLteSignalStrength * 31)) + (this.mLteRsrp * 31)) + (this.mLteRsrq * 31)) + (this.mLteRssnr * 31)) + (this.mLteCqi * 31)));
    }
