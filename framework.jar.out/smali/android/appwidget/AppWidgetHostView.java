...
public class AppWidgetHostView extends FrameLayout {
    ...
    static final Filter sInflaterFilter;
    int mAppWidgetId;
    Context mContext;
    long mFadeStartTime;
    ...
    /* renamed from: android.appwidget.AppWidgetHostView.1 */
    static class C00281 implements Filter {
        C00281() {
        }
    ...
    private static class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
        ...
        static class C00291 implements Creator<ParcelableSparseArray> {
            C00291() {
            }
    ...
    static {
        sInflaterFilter = new C00281();
    }

    public AppWidgetHostView(Context context) {
        this(context, C0000R.anim.fade_in, C0000R.anim.fade_out);
    }
    ...
    public static Rect getDefaultPaddingForWidget(Context context, ComponentName component, Rect padding) {
        ...
        try {
            if (packageManager.getApplicationInfo(component.getPackageName(), 0).targetSdkVersion >= 14) {
                ...
                padding.bottom = r.getDimensionPixelSize(17104976);
            }
    ...
    public void updateAppWidget(RemoteViews remoteViews) {
        ...
        } else if (this.mViewMode != VIEW_MODE_DEFAULT) {
    ...
    protected View getDefaultView() {
        ...
        try {
            if (this.mInfo != null) {
                ...
                if (options.containsKey(AppWidgetManager.OPTION_APPWIDGET_HOST_CATEGORY) && options.getInt(AppWidgetManager.OPTION_APPWIDGET_HOST_CATEGORY) == VIEW_MODE_ERROR) {
                    int kgLayoutId = this.mInfo.initialKeyguardLayout;
                    if (kgLayoutId != 0) {
                        layoutId = kgLayoutId;
                    }
                }
                defaultView = inflater.inflate(layoutId, (ViewGroup) this, (boolean) LOGD);
            } else {
    ...
    protected View getErrorView() {
        ...
        tv.setText(17040704);
        tv.setBackgroundColor(Color.argb(KeyEvent.KEYCODE_MEDIA_PAUSE, 0, 0, 0));
        return tv;
    }
