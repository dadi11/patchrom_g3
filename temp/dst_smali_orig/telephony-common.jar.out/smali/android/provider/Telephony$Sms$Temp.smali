.class public final Landroid/provider/Telephony$Sms$Temp;
...
.method static constructor <clinit>()V
    ...
    .prologue
    const-string v0, "content://sms/temp"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/Telephony$Sms$Temp;->CONTENT_URI:Landroid/net/Uri;
...
.method public static addMessage(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v12}, Landroid/provider/Telephony$Sms$Temp;->addMessageEx(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;JIIJLjava/lang/String;)Landroid/net/Uri;
...
.method public static addMessageEx(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;JIIJLjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static/range {v3 .. v14}, Landroid/provider/Telephony$Sms$Temp;->addMessageExEx(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;JIIJ[B)Landroid/net/Uri;
...
.method public static addMessageExEx(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;JIIJ[B)Landroid/net/Uri;
    ...
    .prologue
    sget-object v1, Landroid/provider/Telephony$Sms$Temp;->CONTENT_URI:Landroid/net/Uri;
