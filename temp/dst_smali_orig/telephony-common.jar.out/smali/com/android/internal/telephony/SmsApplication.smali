...
.method private static getApplication(Landroid/content/Context;ZI)Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    const-string v13, "default_sms_change_to_operator_sms"

    move-object/from16 v0, p0

    invoke-static {v0, v13}, Lcom/android/internal/telephony/lgeautoprofiling/LgeAutoProfiling;->isSupportedFeature(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v14, "SMS getApplication() change defaultPackage = "
...
.method private static notifyChangingDefaultApp(Landroid/content/Context;)V
    .locals 2
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    const-string v1, "notifyChangingDefaultApp(), com.lge.message.action.CHANGE_DEFAULT_SMS"

    invoke-static {v1}, Lcom/android/internal/telephony/lgeautoprofiling/LGSmsLog;->d(Ljava/lang/String;)I

    new-instance v0, Landroid/content/Intent;

    const-string v1, "com.lge.message.action.CHANGE_DEFAULT_SMS"
...
.method private static replacePreferredActivity(Landroid/content/pm/PackageManager;Landroid/content/ComponentName;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v14, v2, v1}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/content/pm/PackageManager;->replacePreferredActivityAsUser(Landroid/content/IntentFilter;I[Landroid/content/ComponentName;Landroid/content/ComponentName;I)V

    const/4 v2, 0x0

    const-string v4, "vvm_intent_action_change"
    ...
    const-string v2, "VVM_INTENT_ACTION_CHANGE is enabled! addAction(Intent.ACTION_DEFAULT)"
    ...
    .local v7, "intentFilter1":Landroid/content/IntentFilter;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/content/pm/PackageManager;->replacePreferredActivityAsUser(Landroid/content/IntentFilter;I[Landroid/content/ComponentName;Landroid/content/ComponentName;I)V

    .end local v7    # "intentFilter1":Landroid/content/IntentFilter;
    :cond_1
    return-void
.end method
...
.method private static setDefaultApplicationInternal(Ljava/lang/String;Landroid/content/Context;I)V
    ...
    :cond_2
    :goto_4
    invoke-static {p1}, Lcom/android/internal/telephony/SmsApplication;->notifyChangingDefaultApp(Landroid/content/Context;)V
