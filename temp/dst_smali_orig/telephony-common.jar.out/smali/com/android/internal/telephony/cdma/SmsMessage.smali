...
.field static final RETURN_ACK:I = 0x1
...
.method public static createFromEfRecord(I[B)Lcom/android/internal/telephony/cdma/SmsMessage;
    ...
    const-string v9, "createFromEfRecord(), data total length = "
    ...
    const-string v9, "createFromEfRecord(), statusOnSim = "
    ...
    const-string v9, "SMS parsing failed: Trying to parse a free record"
    ...
    iput v8, v3, Lcom/android/internal/telephony/cdma/SmsMessage;->mStatusOnIcc:I
    ...
    invoke-static {p1, v8, v4, v9, v10}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    const-string v9, "SMS PDU parsing failed: "
...
.method public static newFromParcel(Landroid/os/Parcel;)Lcom/android/internal/telephony/cdma/SmsMessage;
    ...
    iput v9, v7, Lcom/android/internal/telephony/cdma/SmsMessage;->mIndexOnIcc:I
    ...
    iget v10, v7, Lcom/android/internal/telephony/cdma/SmsMessage;->mIndexOnIcc:I
...
.method private parsePdu([B)V
    ...
    const-string v8, "revise_invalid_cdma_wappush_pdu"
    ...
    const-string v8, "parsePdu(), createFromPdu: Invalid pdu : length: [ "
    ...
    const-string v8, "parsePdu() -createFromPdu: After modifying length: [ "
    ...
    const-string v8, "parsePdu() -createFromPdu: Invalid pdu : bearerDataLength: [ "
    ...
    const-string v8, "parsePdu() -createFromPdu: After modifying bearerDataLength: [ "
...
.method private parsePduFromEfRecord([B)V
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/internal/telephony/cdma/LGCdmaSmsMessage;->getParameterLength(B)I
    ...
    const-string v22, "parsePduFromEfRecord(), parameterLen = "
    ...
    const-string v21, "parsePduFromEfRecord(), addr.numberMode= NUMBER_MODE_DATA_NETWORK"

    invoke-static/range {v21 .. v21}, Lcom/android/internal/telephony/lgeautoprofiling/LGSmsLog;->i(Ljava/lang/String;)I
    ...
    const-string v21, "parsePduFromEfRecord(), addr.ton: Originating Addr is email id"
    ...
    const-string v22, "parsePduFromEfRecord(), index = "
    ...
    const-string v22, "parsePduFromEfRecord(), b = "
    ...
    const-string v22, "parsePduFromEfRecord(), data["
...
.method private static privateGetSubmitPdu(Ljava/lang/String;ZLcom/android/internal/telephony/cdma/sms/UserData;I)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    const-string v13, "cdma_priority_indicator"
    ...
    sget v12, Lcom/android/internal/telephony/cdma/SmsMessage;->mSubmitPriority:I
    ...
    iput v12, v3, Lcom/android/internal/telephony/cdma/sms/BearerData;->priority:I

    :cond_2
    const/4 v12, 0x0

    const-string v13, "lgu_userdata_encoding"
    ...
    invoke-static {v3, v0}, Lcom/android/internal/telephony/cdma/LGCdmaSmsMessage;->setUserBearerDataLguEncoding(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/telephony/cdma/sms/UserData;)Lcom/android/internal/telephony/cdma/sms/UserData;
    ...
    const-string v13, "SmsMessage : privateGetSubmitPdu() - MO (encoded) BearerData = "
    ...
    invoke-static {v12}, Lcom/android/internal/telephony/lgeautoprofiling/LGSmsLog;->p(Ljava/lang/String;)I

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "SmsMessage : privateGetSubmitPdu() - MO raw BearerData = \'"
...
.method protected parseSms()V
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/cdma/LGCdmaSmsMessage;->getDeliverPriority(Lcom/android/internal/telephony/cdma/sms/BearerData;)I
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/cdma/LGCdmaSmsMessage;->getPrivacyIndicator(Lcom/android/internal/telephony/cdma/sms/BearerData;)I
