.class public abstract Lcom/android/internal/telephony/ImsSMSDispatcher;
...
# instance fields
.field protected mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

.field protected mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

.field protected mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

.field protected mGsmInboundSmsHandler:Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

.field protected mIms:Z

.field private mImsSmsEnabled:Z

.field protected mImsSmsFormat:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/SmsUsageMonitor;)V
    ...
    invoke-direct {p0, p1, p3, v2}, Lcom/android/internal/telephony/SMSDispatcherEx;-><init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsUsageMonitor;Lcom/android/internal/telephony/ImsSMSDispatcher;)V
...
.method private isCdmaMo()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/ImsSMSDispatcher;->isCdmaFormat(Ljava/lang/String;)Z
...
.method public dispose()V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    invoke-virtual {v0}, Lcom/android/internal/telephony/SMSDispatcherEx;->dispose()V

    iget-object v0, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    invoke-virtual {v0}, Lcom/android/internal/telephony/SMSDispatcherEx;->dispose()V

    iget-object v0, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmInboundSmsHandler:Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;->dispose()V

    iget-object v0, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;->dispose()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-super {p0, p1}, Lcom/android/internal/telephony/SMSDispatcherEx;->handleMessage(Landroid/os/Message;)V
...
.method protected initDispatchers(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/SmsUsageMonitor;)V
    ...
    new-instance v1, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcherEx;

    invoke-direct {v1, p1, p3, p0}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcherEx;-><init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsUsageMonitor;Lcom/android/internal/telephony/ImsSMSDispatcher;)V

    iput-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    invoke-virtual {p1}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-static {v1, p2, p1}, Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;->makeInboundSmsHandler(Landroid/content/Context;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/PhoneBase;)Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmInboundSmsHandler:Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

    invoke-virtual {p1}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    check-cast v1, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcherEx;

    invoke-static {v2, p2, p1, v1}, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;->makeInboundSmsHandler(Landroid/content/Context;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;)Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

    new-instance v1, Lcom/android/internal/telephony/gsm/GsmSMSDispatcherEx;

    iget-object v2, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmInboundSmsHandler:Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

    invoke-direct {v1, p1, p3, p0, v2}, Lcom/android/internal/telephony/gsm/GsmSMSDispatcherEx;-><init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsUsageMonitor;Lcom/android/internal/telephony/ImsSMSDispatcher;Lcom/android/internal/telephony/gsm/GsmInboundSmsHandler;)V

    iput-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmInboundSmsHandler:Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;

    iget-object v4, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;
...
.method protected injectSmsPdu([BLjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v4, v0}, Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;->sendMessage(ILjava/lang/Object;)V
    :try_end_0
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

    const/16 v4, 0x8

    invoke-virtual {v3, v4, v0}, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;->sendMessage(ILjava/lang/Object;)V
...
.method protected isCdmaFormat(Ljava/lang/String;)Z
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/SMSDispatcherEx;->getFormat()Ljava/lang/String;
...
.method protected isDomainNotiMessage(Ljava/util/HashMap;)Z
    ...
    const-string v1, "Error! Not implemented for ImsSMSDispatcher."
...
.method public sendRetrySms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    invoke-virtual {v10}, Lcom/android/internal/telephony/SMSDispatcherEx;->getFormat()Ljava/lang/String;
    ...
    const-string v11, "check_radio_tech_for_msg_sending"
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/ImsSMSDispatcher;->isCdmaFormat(Ljava/lang/String;)Z
    ...
    invoke-virtual {v10, p1}, Lcom/android/internal/telephony/SMSDispatcherEx;->sendSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    :cond_2
    iget-object v10, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mContext:Landroid/content/Context;

    const-string v12, "sms_dan_send"
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/ImsSMSDispatcher;->isDomainNotiMessage(Ljava/util/HashMap;)Z
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;

    .local v3, "dispatcher":Lcom/android/internal/telephony/SMSDispatcherEx;
    :goto_5
    invoke-virtual {v3}, Lcom/android/internal/telephony/SMSDispatcherEx;->getFormat()Ljava/lang/String;

    move-result-object v10

    iput-object v10, p1, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mFormat:Ljava/lang/String;

    invoke-virtual {v3, p1}, Lcom/android/internal/telephony/SMSDispatcherEx;->sendSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V

    goto/16 :goto_2

    .end local v3    # "dispatcher":Lcom/android/internal/telephony/SMSDispatcherEx;
    ...
    :cond_11
    iget-object v3, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;
...
.method protected updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-super {p0, p1}, Lcom/android/internal/telephony/SMSDispatcherEx;->updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/gsm/GsmInboundSmsHandlerEx;->updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V

    iget-object v0, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mCdmaInboundSmsHandler:Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;

    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandlerEx;->updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V
...
.method protected updateSmsSendStatus(IZ)V
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/SMSDispatcherEx;->sendPendingList:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/ImsSMSDispatcher;->mGsmDispatcher:Lcom/android/internal/telephony/SMSDispatcherEx;
