...
.field public static final ELT_ID_SAFE_SMS_ELEMENT:I = 0xc0
...
.method public static fromByteArray([B)Lcom/android/internal/telephony/SmsHeader;
    ...
    invoke-virtual {v2, v8, v11, v3}, Ljava/io/ByteArrayInputStream;->read([BII)I
    ...
    :sswitch_7
    invoke-static {v2, v6, v3}, Lcom/android/internal/telephony/LGSmsHeader;->getReplyAddress(Ljava/io/ByteArrayInputStream;Lcom/android/internal/telephony/SmsHeader;I)V

    goto/16 :goto_0

    :sswitch_8
    invoke-static {v2, v6, v3}, Lcom/android/internal/telephony/LGSmsHeader;->getSafeSms(Ljava/io/ByteArrayInputStream;Lcom/android/internal/telephony/SmsHeader;I)V
    ...
    invoke-static {v2, v6, v3}, Lcom/android/internal/telephony/LGSmsHeader;->getSmsConfirmRead(Ljava/io/ByteArrayInputStream;Lcom/android/internal/telephony/SmsHeader;I)V
...
.method public static toByteArray(Lcom/android/internal/telephony/SmsHeader;)[B
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/SmsHeader;->replyAddress:Lcom/android/internal/telephony/SmsHeader$ReplyAddress;
    ...
    iget-byte v6, p0, Lcom/android/internal/telephony/SmsHeader;->safeSMS:B
    ...
    :cond_2
    :goto_2
    invoke-static {p0, v3}, Lcom/android/internal/telephony/LGSmsHeader;->writeSafeSmsonOutStream(Lcom/android/internal/telephony/SmsHeader;Ljava/io/ByteArrayOutputStream;)V

    invoke-static {p0, v3}, Lcom/android/internal/telephony/LGSmsHeader;->writeConfirmReadonOutStream(Lcom/android/internal/telephony/SmsHeader;Ljava/io/ByteArrayOutputStream;)V

    invoke-static {p0, v3}, Lcom/android/internal/telephony/LGSmsHeader;->writeReplyAddressonOutStream(Lcom/android/internal/telephony/SmsHeader;Ljava/io/ByteArrayOutputStream;)V
