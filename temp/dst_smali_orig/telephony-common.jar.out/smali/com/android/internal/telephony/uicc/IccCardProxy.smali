...
.method private broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, p1}, Lcom/lge/uicc/framework/LGUICC;->setConfig(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;Z)V
    ...
    invoke-static {v0, v2, v3}, Lcom/lge/uicc/framework/LGUICC;->setConfig(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private updateExternalState()V
    ...
    const-string v0, "mUiccCard is null. So, send not-ready intent."
...
.method private updateIccAvailability()V
    ...
    const-string v4, "newApp is null, and mCurrentAppType is 3GPP2. 3GPP application should be created to do.."
    ...
    const-string v5, "proxy.app_type"
    ...
    .restart local v3    # "state":Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    :cond_5
...
.method private updateQuietMode()V
    ...
    invoke-static {v4, v6, v7}, Lcom/lge/uicc/framework/LGUICC;->setConfig(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "spr.omadm_lock"

    invoke-static {v6}, Lcom/lge/uicc/framework/LGUICC;->getConfig(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "SIMLock is activated. do not handle message."
    ...
    sget-object v6, Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;->CARDSTATE_REMOVED:Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/uicc/UiccCard;->getCardState()Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;

    move-result-object v7

    if-ne v6, v7, :cond_0

    const-string v6, "SIM_REMOVED"

    invoke-direct {p0, v6, v12}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "TRF_ATT"

    aput-object v8, v6, v7

    invoke-static {v6}, Lcom/lge/uicc/framework/LGUICC;->targetOperator([Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_4

    iput-boolean v10, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mQuietMode:Z
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mQuietMode:Z

    invoke-static {v8}, Ljava/lang/String;->valueOf(Z)Ljava/lang/String;

    move-result-object v8

    invoke-static {v6, v7, v8}, Lcom/lge/uicc/framework/LGUICC;->setConfig(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "proxy.mcc_mnc"

    invoke-static {v6, v4, v3}, Lcom/lge/uicc/framework/LGUICC;->setConfig(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPersoSubState:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;

    invoke-direct {p0, v6}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastPersoSubState(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;)V
...
.method public setVoiceRadioTech(I)V
    ...
    .local v0, "bLteOnCdmaDevice":Ljava/lang/String;
    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Setting radio tech "
    ...
    iput v1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCurrentAppType:I
    ...
    .end local v0    # "bLteOnCdmaDevice":Ljava/lang/String;
    :catchall_0
    move-exception v1
