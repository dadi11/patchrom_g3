...
.method public onDestroyed(Landroid/telecom/Connection;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/ConnectionService;->access$3000(Landroid/telecom/ConnectionService;Landroid/telecom/Connection;)V
...
.method public onDisconnected(Landroid/telecom/Connection;Landroid/telecom/DisconnectCause;)V
    ...
    # getter for: Landroid/telecom/ConnectionService;->mSsNotificationType:I
    invoke-static {v0}, Landroid/telecom/ConnectionService;->access$2800(Landroid/telecom/ConnectionService;)I
    ...
    # getter for: Landroid/telecom/ConnectionService;->mSsNotificationCode:I
    invoke-static {v0}, Landroid/telecom/ConnectionService;->access$2900(Landroid/telecom/ConnectionService;)I
    ...
    invoke-virtual {v0, v1, p2}, Landroid/telecom/ConnectionServiceAdapter;->setDisconnected(Ljava/lang/String;Landroid/telecom/DisconnectCause;)V
    ...
    iget-object v4, p0, Landroid/telecom/ConnectionService$4;->this$0:Landroid/telecom/ConnectionService;

    # getter for: Landroid/telecom/ConnectionService;->mSsNotificationType:I
    invoke-static {v4}, Landroid/telecom/ConnectionService;->access$2800(Landroid/telecom/ConnectionService;)I

    move-result v4

    iget-object v5, p0, Landroid/telecom/ConnectionService$4;->this$0:Landroid/telecom/ConnectionService;

    # getter for: Landroid/telecom/ConnectionService;->mSsNotificationCode:I
    invoke-static {v5}, Landroid/telecom/ConnectionService;->access$2900(Landroid/telecom/ConnectionService;)I

    move-result v5

    invoke-virtual/range {v0 .. v5}, Landroid/telecom/ConnectionServiceAdapter;->setDisconnectedWithSsNotification(Ljava/lang/String;ILjava/lang/String;II)V

    iget-object v0, p0, Landroid/telecom/ConnectionService$4;->this$0:Landroid/telecom/ConnectionService;

    # setter for: Landroid/telecom/ConnectionService;->mSsNotificationType:I
    invoke-static {v0, v6}, Landroid/telecom/ConnectionService;->access$2802(Landroid/telecom/ConnectionService;I)I

    iget-object v0, p0, Landroid/telecom/ConnectionService$4;->this$0:Landroid/telecom/ConnectionService;

    # setter for: Landroid/telecom/ConnectionService;->mSsNotificationCode:I
    invoke-static {v0, v6}, Landroid/telecom/ConnectionService;->access$2902(Landroid/telecom/ConnectionService;I)I
...
.method public onSsNotificationData(II)V
    .locals 1
    .param p1, "type"    # I
    .param p2, "code"    # I
    ...
    # setter for: Landroid/telecom/ConnectionService;->mSsNotificationType:I
    invoke-static {v0, p1}, Landroid/telecom/ConnectionService;->access$2802(Landroid/telecom/ConnectionService;I)I

    iget-object v0, p0, Landroid/telecom/ConnectionService$4;->this$0:Landroid/telecom/ConnectionService;

    # setter for: Landroid/telecom/ConnectionService;->mSsNotificationCode:I
    invoke-static {v0, p2}, Landroid/telecom/ConnectionService;->access$2902(Landroid/telecom/ConnectionService;I)I
