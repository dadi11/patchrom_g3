...
.method public getDataEnabled()Z
    ...
    invoke-interface {v3}, Lcom/android/internal/telephony/ITelephony;->getDataEnabled()Z
    ...
    const-string v4, "ITelephony interface is not up yet, so reture false, temporary"
...
.method public getDmNodeHandlerDiagMonNetwork(ZII)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/lge/telephony/LGTelephonyManagerImpl;->getDmNodeHandlerDiagMonNetwork(ZII)Ljava/lang/String;
...
.method public setDataEnabledUsingSubId(JZ)V
    ...
    invoke-virtual {v0, v6}, Landroid/app/AppOpsManager;->noteOp(I)I
    ...
    const-string v7, "Permission denied by user."

    invoke-static {v6, v7}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    sget-object v6, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_CONNECTIVITYSERVICE_CTTL_CMCC:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    iget-object v6, p0, Landroid/telephony/TelephonyManager;->mLgDataUiManager:Lcom/lge/systemservice/core/LgDataUiManager;
    ...
    invoke-virtual {v6, v7}, Lcom/lge/systemservice/core/LgDataUiManager;->sendDataUiMessage(I)I
    ...
    .local v5, "uidname":Ljava/lang/String;
    const-string v6, "TelephonyManager"
    ...
    const-string v6, "CallingPackagesName"
    ...
    invoke-interface {v6, p1, p2, p3}, Lcom/android/internal/telephony/ITelephony;->setDataEnabledUsingSubId(JZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v4    # "uid":I
    .end local v5    # "uidname":Ljava/lang/String;
    :catch_0
    move-exception v1
    ...
    const-string v7, "Error calling setDataEnabled"
