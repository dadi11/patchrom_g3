...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .local v29, "qCursor":Landroid/database/Cursor;
    :try_start_0
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    ...
    .local v28, "e":Landroid/os/DeadObjectException;
    :try_start_2
    move-object/from16 v0, p0
    ...
    .end local v28    # "e":Landroid/os/DeadObjectException;
    :cond_a
    ...
    .local v27, "cursorFieldLog":Ljava/lang/String;
    ...
    :cond_b
    new-instance v15, Landroid/content/ContentResolver$CursorWrapperInnerForDebug;
    ...
    .end local v15    # "wrapper":Landroid/content/ContentResolver$CursorWrapperInnerForDebug;
    :cond_f
    :try_start_4
    invoke-virtual/range {p0 .. p1}, Landroid/content/ContentResolver;->acquireProvider(Landroid/net/Uri;)Landroid/content/IContentProvider;
    ...
    .end local v27    # "cursorFieldLog":Ljava/lang/String;
    :cond_10
    new-instance v15, Landroid/content/ContentResolver$CursorWrapperInner;
    ...
    invoke-direct {v15, v0, v1, v3}, Landroid/content/ContentResolver$CursorWrapperInner;-><init>(Landroid/content/ContentResolver;Landroid/database/Cursor;Landroid/content/IContentProvider;)V
    :try_end_4
    .catch Landroid/os/RemoteException; {:try_start_4 .. :try_end_4} :catch_1
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    .local v15, "wrapper":Landroid/content/ContentResolver$CursorWrapperInner;
    const/4 v10, 0x0
    ...
    .end local v15    # "wrapper":Landroid/content/ContentResolver$CursorWrapperInner;
    :cond_14
    :try_start_5
    invoke-virtual/range {p0 .. p1}, Landroid/content/ContentResolver;->acquireProvider(Landroid/net/Uri;)Landroid/content/IContentProvider;
    :try_end_5
