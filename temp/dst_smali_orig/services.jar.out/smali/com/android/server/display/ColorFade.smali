.class Lcom/android/server/display/ColorFade;
...
.field protected static final DEJANK_FRAMES:I = 0x3
...
.field protected mDisplayLayerStack:I

.field protected final mDisplayManagerInternal:Landroid/hardware/display/DisplayManagerInternal;
...
.field protected final mGLBuffers:[I
...
.field protected final mProjMatrix:[F
...
.field protected final mTexCoordBuffer:Ljava/nio/FloatBuffer;

.field private mTexCoordLoc:I

.field protected final mTexMatrix:[F

.field private mTexMatrixLoc:I

.field protected final mTexNames:[I

.field protected mTexNamesGenerated:Z

.field private mTexUnitLoc:I

.field protected final mVertexBuffer:Ljava/nio/FloatBuffer;
...
.method protected static createNativeFloatBuffer(I)Ljava/nio/FloatBuffer;
    .locals 2
    .param p0, "size"    # I
...
.method protected static logEglError(Ljava/lang/String;)V
    .locals 3
...
.method protected static setQuad(Ljava/nio/FloatBuffer;FFFF)V
    .locals 2
...
# virtual methods
.method protected attachEglContext()Z
    .locals 5
...
.method protected captureScreenshotTextureAndSetViewport()Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/display/ColorFade;->checkGlErrors(Ljava/lang/String;)Z
    :try_end_0
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/display/ColorFade;->ortho(FFFFFF)V
    :try_end_3
...
.method protected checkGlErrors(Ljava/lang/String;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/display/ColorFade;->checkGlErrors(Ljava/lang/String;Z)Z
...
.method protected createEglSurface()Z
    .locals 6
...
.method protected createSurface()Z
    .locals 8
...
.method protected destroyGLBuffers()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/display/ColorFade;->checkGlErrors(Ljava/lang/String;)Z

    return-void
.end method

.method protected destroyGLShaders()V
    .locals 1
...
.method protected destroySurface()V
    .locals 2
...
.method protected detachEglContext()V
    .locals 4
...
.method public draw(F)Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/server/display/ColorFade;->showSurface(F)Z
    ...
    invoke-virtual {p0, v3, v7, v4, v5}, Lcom/android/server/display/ColorFade;->drawFaded(FFFF)V

    const-string v7, "drawFrame"

    invoke-virtual {p0, v7}, Lcom/android/server/display/ColorFade;->checkGlErrors(Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected drawFaded(FFFF)V
    .locals 8
    .param p1, "opacity"    # F
    .param p2, "gamma"    # F
...
.method protected initGLShaders(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1, v3, v4}, Lcom/android/server/display/ColorFade;->loadShader(Landroid/content/Context;II)I
...
.method protected loadShader(Landroid/content/Context;II)I
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
...
.method protected ortho(FFFFFF)V
    .locals 5
    .param p1, "left"    # F
    .param p2, "right"    # F
    .param p3, "bottom"    # F
...
.method public prepare(Landroid/content/Context;I)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/display/ColorFade;->createSurface()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {p0}, Lcom/android/server/display/ColorFade;->createEglContext()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {p0}, Lcom/android/server/display/ColorFade;->createEglSurface()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {p0}, Lcom/android/server/display/ColorFade;->captureScreenshotTextureAndSetViewport()Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/display/ColorFade;->checkGlErrors(Ljava/lang/String;)Z
...
.method protected readFile(Landroid/content/Context;I)Ljava/lang/String;
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "resourceId"    # I
...
.method protected showSurface(F)Z
    .locals 3
    .param p1, "alpha"    # F
