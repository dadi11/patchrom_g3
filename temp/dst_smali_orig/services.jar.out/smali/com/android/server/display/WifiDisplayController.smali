...
.field private static final DEFAULT_CONTROL_PORT:I = 0x216a
...
.field private final mDummyP2pDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
...
.field private mRequestedFromLgFramework:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/WifiDisplayController$Listener;)V
    ...
    const-string v4, "P2P-DEVICE-FOUND 00:00:00:00:00:00 p2p_dev_addr=00:00:00:00:00:00 pri_dev_type=7-0050F204-1 name=\'Unknown\' config_methods=0x188 dev_capab=0x24 group_capab=0x4 wfd_dev_info=0x000006011100000000"

    invoke-direct {v3, v4}, Landroid/net/wifi/p2p/WifiP2pDevice;-><init>(Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mDummyP2pDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
...
.method static synthetic access$100(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pGroup;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method static synthetic access$102(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pGroup;)Landroid/net/wifi/p2p/WifiP2pGroup;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method static synthetic access$1200(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mDummyP2pDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
...
.method static synthetic access$2800(Lcom/android/server/display/WifiDisplayController;I)V
    ...
    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/display/WifiDisplayController;->handleDisplayStateChanged(I)V

    return-void
.end method

.method static synthetic access$2900(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
    .param p1, "x1"    # Ljava/lang/String;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/display/WifiDisplayController;->handleLgPeerInfoAvailable(Ljava/lang/String;)V
...
.method static synthetic access$3000(Landroid/net/wifi/p2p/WifiP2pGroup;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3200(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method static synthetic access$3202(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
    .param p1, "x1"    # Landroid/net/wifi/p2p/WifiP2pDevice;
...
.method static synthetic access$3400(Lcom/android/server/display/WifiDisplayController;)Landroid/media/RemoteDisplay;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method static synthetic access$3500(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method static synthetic access$3800(Lcom/android/server/display/WifiDisplayController;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
    .param p1, "x1"    # Z
...
.method static synthetic access$4000(Lcom/android/server/display/WifiDisplayController;Landroid/net/NetworkInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method private disconnect()V
    ...
    iput-boolean v0, p0, Lcom/android/server/display/WifiDisplayController;->mRequestedFromLgFramework:Z
...
.method private handleConnectionChanged(Landroid/net/NetworkInfo;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/display/WifiDisplayController;->mRequestedFromLgFramework:Z
...
.method private handleDisplayStateChanged(I)V
    .locals 3
    .param p1, "state"    # I
...
.method private handleLgPeerInfoAvailable(Ljava/lang/String;)V
    .locals 3
    ...
    .local v0, "peerInfo":Ljava/lang/String;
    iget-object v1, p0, Lcom/android/server/display/WifiDisplayController;->mHandler:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/display/WifiDisplayController$22;

    invoke-direct {v2, p0, v0}, Lcom/android/server/display/WifiDisplayController$22;-><init>(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;)V
...
.method private updateConnection()V
    ...
    invoke-direct {v3, p0, v11}, Lcom/android/server/display/WifiDisplayController$13;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-direct {v3, p0, v10}, Lcom/android/server/display/WifiDisplayController$14;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    new-instance v9, Lcom/android/server/display/WifiDisplayController$15;

    invoke-direct {v9, p0, v11}, Lcom/android/server/display/WifiDisplayController$15;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
...
.method public requestConnect(Ljava/lang/String;)V
    ...
    :cond_1
    iput-boolean v5, p0, Lcom/android/server/display/WifiDisplayController;->mRequestedFromLgFramework:Z

    const-string v0, "\u200b"

    invoke-virtual {p1, v0, v5}, Ljava/lang/String;->startsWith(Ljava/lang/String;I)Z
    ...
    .local v7, "dummy_device":Ljava/lang/StringBuilder;
    const-string v0, "P2P-DEVICE-FOUND "
    ...
    const-string v0, "p2p_dev_addr=00:00:00:00:00:00 "

    invoke-virtual {v7, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "pri_dev_type=7-0050F204-1 "
    ...
    const-string v0, "\' config_methods=0x188 "

    invoke-virtual {v7, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "dev_capab=0x24 group_capab=0x4 "

    invoke-virtual {v7, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "wfd_dev_info=0x000006011100000000"
    ...
    invoke-direct {v6, v0}, Landroid/net/wifi/p2p/WifiP2pDevice;-><init>(Ljava/lang/String;)V
    ...
    new-instance v10, Landroid/net/wifi/p2p/WifiP2pGroup;
    ...
    const-string v2, "ssid=\"AP_connected\" "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, "freq=0000 "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, "passphrase=\"not_available\" "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, "go_dev_addr=00:00:00:00:00:00"
    ...
    invoke-direct {v10, v0}, Landroid/net/wifi/p2p/WifiP2pGroup;-><init>(Ljava/lang/String;)V

    .local v10, "info":Landroid/net/wifi/p2p/WifiP2pGroup;
    iput-object v6, p0, Lcom/android/server/display/WifiDisplayController;->mDesiredDevice:Landroid/net/wifi/p2p/WifiP2pDevice;

    iput-object v6, p0, Lcom/android/server/display/WifiDisplayController;->mConnectedDevice:Landroid/net/wifi/p2p/WifiP2pDevice;

    iput-object v10, p0, Lcom/android/server/display/WifiDisplayController;->mConnectedDeviceGroupInfo:Landroid/net/wifi/p2p/WifiP2pGroup;
    ...
    const-string v3, "requestConnect info : "
    ...
    .end local v7    # "dummy_device":Ljava/lang/StringBuilder;
    .end local v9    # "iface_index":I
    .end local v10    # "info":Landroid/net/wifi/p2p/WifiP2pGroup;
    :cond_2
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mAvailableWifiDisplayPeers:Ljava/util/ArrayList;
...
.method public requestPauseTransitDlna()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/media/RemoteDisplay;->pauseTransitDlna()V

    :cond_0
    return-void
.end method

.method public requestPauseTransitWhrz()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/media/RemoteDisplay;->pauseTransitWhrz()V

    :cond_0
    return-void
.end method

.method public requestPlayTransitWfd()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/media/RemoteDisplay;->playTransitWfd()V
...
.method public requestSetUibcEnabled(Z)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/media/RemoteDisplay;->setUibcEnabled(Z)V
