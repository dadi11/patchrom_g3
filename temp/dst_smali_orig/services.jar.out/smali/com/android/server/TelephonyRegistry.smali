...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput v6, p0, Lcom/android/server/TelephonyRegistry;->mOtaspMode:I
    ...
    iput-object v3, p0, Lcom/android/server/TelephonyRegistry;->mtotalstatus:[I

    iput-boolean v5, p0, Lcom/android/server/TelephonyRegistry;->isEPDGUse:Z

    new-array v3, v8, [Z

    fill-array-data v3, :array_1

    iput-object v3, p0, Lcom/android/server/TelephonyRegistry;->ePDGcontrol:[Z

    iput v5, p0, Lcom/android/server/TelephonyRegistry;->myfeature:I
    ...
    invoke-virtual {v3, v0, v9}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V
    ...
    iput v3, p0, Lcom/android/server/TelephonyRegistry;->myfeature:I

    iget v3, p0, Lcom/android/server/TelephonyRegistry;->myfeature:I

    if-ne v3, v6, :cond_2

    iput-boolean v6, p0, Lcom/android/server/TelephonyRegistry;->isEPDGUse:Z
    ...
    :cond_3
    sget-object v3, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_ENV_MODIFICATION_BY_MTK:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
...
.method private broadcastPreciseDataConnectionStateChanged(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Ljava/lang/String;)V
    ...
    invoke-static {p7}, Lcom/android/internal/telephony/dataconnection/DcFailCause;->fromText(Ljava/lang/String;)I
...
.method public isePDGPDN(Ljava/lang/String;)Z
    ...
    :cond_1
    iget v2, p0, Lcom/android/server/TelephonyRegistry;->myfeature:I
...
.method public notifyCallStateForSubscriber(JILjava/lang/String;)V
    ...
    iget v4, v3, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I
...
.method public notifyDataConnectionFailedForSubscriber(JLjava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    const-string v6, "notifyDataConnectionFailed()"

    move-object/from16 v0, p0

    invoke-direct {v0, v6}, Lcom/android/server/TelephonyRegistry;->checkNotifyPermission(Ljava/lang/String;)Z
    ...
    invoke-direct/range {v6 .. v13}, Landroid/telephony/PreciseDataConnectionState;-><init>(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v6, v0, Lcom/android/server/TelephonyRegistry;->mPreciseDataConnectionState:Landroid/telephony/PreciseDataConnectionState;
    ...
    iget v6, v0, Lcom/android/server/TelephonyRegistry$Record;->events:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v6, v0, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;

    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/TelephonyRegistry;->mPreciseDataConnectionState:Landroid/telephony/PreciseDataConnectionState;
    ...
    invoke-virtual {v6, v0}, Landroid/telephony/TelephonyManager;->getDataStateType(Ljava/lang/String;)I
    ...
    invoke-virtual {v6, v8, v9}, Landroid/telephony/TelephonyManager;->getNetworkType(J)I
    ...
    invoke-direct/range {v6 .. v13}, Lcom/android/server/TelephonyRegistry;->broadcastPreciseDataConnectionStateChanged(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Ljava/lang/String;)V
...
.method public notifyEPDGControl(Ljava/lang/String;Z)V
    ...
    const-string v1, "notifyEPDGControl "
...
.method public notifyErrorcheck(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string v1, "notification will be ignored!! apntype="
...
.method public notifyMessageWaitingChangedForPhoneId(IJZ)V
    ...
    iget v3, v2, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I
...
.method public notifyPreciseDataConnectionFailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Landroid/telephony/TelephonyManager;->getDataStateType(Ljava/lang/String;)I
