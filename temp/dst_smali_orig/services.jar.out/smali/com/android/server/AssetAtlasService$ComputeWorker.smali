...
.method constructor <init>(IIILjava/util/List;ILjava/util/List;Ljava/util/concurrent/CountDownLatch;)V
    ...
    :goto_0
    iget v1, p0, Lcom/android/server/AssetAtlasService$ComputeWorker;->mStep:I

    rsub-int v1, v1, 0x800

    mul-int/lit16 v1, v1, 0x7c0
...
.method public run()V
    ...
    const-string v10, "[ComputeWorker] mThreshold = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v10, p0, Lcom/android/server/AssetAtlasService$ComputeWorker;->mThreshold:I
