...
.method public finishReceiverLocked(Lcom/android/server/am/BroadcastRecord;ILjava/lang/String;Landroid/os/Bundle;ZZ)Z
    ...
    .prologue
    iget v9, p1, Lcom/android/server/am/BroadcastRecord;->state:I

    .local v9, "state":I
    iget-object v8, p1, Lcom/android/server/am/BroadcastRecord;->curReceiver:Landroid/content/pm/ActivityInfo;

    .local v8, "receiver":Landroid/content/pm/ActivityInfo;
    const/4 v10, 0x0

    iput v10, p1, Lcom/android/server/am/BroadcastRecord;->state:I

    sget-boolean v10, Lcom/android/server/am/BroadcastQueue;->DEBUG_NOT_USER:Z

    if-eqz v10, :cond_0

    iget-boolean v10, p1, Lcom/android/server/am/BroadcastRecord;->ordered:Z
    ...
    iget-object v11, p1, Lcom/android/server/am/BroadcastRecord;->receivers:Ljava/util/List;
    ...
    instance-of v10, v2, Lcom/android/server/am/BroadcastFilter;
    ...
    const-string v12, "[Ordered Broadcast] "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, v3, Lcom/android/server/am/BroadcastFilter;->packageName:Ljava/lang/String;
    ...
    const-string v12, " ms for handling"

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p1, Lcom/android/server/am/BroadcastRecord;->intent:Landroid/content/Intent;
    ...
    iget-object v12, p0, Lcom/android/server/am/BroadcastQueue;->mQueueName:Ljava/lang/String;
    ...
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;
    ...
    iput-object v11, v10, Lcom/android/server/am/ProcessRecord;->curReceiver:Lcom/android/server/am/BroadcastRecord;

    :cond_2
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curFilter:Lcom/android/server/am/BroadcastFilter;

    if-eqz v10, :cond_3

    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curFilter:Lcom/android/server/am/BroadcastFilter;

    iget-object v10, v10, Lcom/android/server/am/BroadcastFilter;->receiverList:Lcom/android/server/am/ReceiverList;

    const/4 v11, 0x0

    iput-object v11, v10, Lcom/android/server/am/ReceiverList;->curBroadcast:Lcom/android/server/am/BroadcastRecord;
    ...
    iput-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curReceiver:Landroid/content/pm/ActivityInfo;
    ...
    iput-object v10, p0, Lcom/android/server/am/BroadcastQueue;->mPendingBroadcast:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-boolean v10, v10, Lcom/android/server/am/BroadcastQueue;->mDelayBehindServices:Z

    if-eqz v10, :cond_8

    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->queue:Lcom/android/server/am/BroadcastQueue;

    iget-object v10, v10, Lcom/android/server/am/BroadcastQueue;->mOrderedBroadcasts:Ljava/util/ArrayList;
    ...
    instance-of v10, v7, Landroid/content/pm/ActivityInfo;
    ...
    .local v6, "nextReceiver":Landroid/content/pm/ActivityInfo;
    :goto_1
    if-eqz v8, :cond_4
    ...
    iget-object v11, v6, Landroid/content/pm/ActivityInfo;->processName:Ljava/lang/String;
    ...
    :cond_4
    iget-object v10, p0, Lcom/android/server/am/BroadcastQueue;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v10, v10, Lcom/android/server/am/ActivityManagerService;->mServices:Lcom/android/server/am/ActiveServices;

    iget v11, p1, Lcom/android/server/am/BroadcastRecord;->userId:I

    invoke-virtual {v10, v11}, Lcom/android/server/am/ActiveServices;->hasBackgroundServices(I)Z
    ...
    iget-object v12, p1, Lcom/android/server/am/BroadcastRecord;->curComponent:Landroid/content/ComponentName;
    ...
    .end local v6    # "nextReceiver":Landroid/content/pm/ActivityInfo;
    :goto_2
    return v10
    ...
    iput-boolean v10, p1, Lcom/android/server/am/BroadcastRecord;->resultAbort:Z
    ...
    .restart local v6    # "nextReceiver":Landroid/content/pm/ActivityInfo;
    goto :goto_1
    ...
    iput-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curComponent:Landroid/content/ComponentName;
...
.method final processNextBroadcast(Z)V
    ...
    check-cast v34, Lcom/android/server/am/BroadcastRecord;

    .local v34, "r":Lcom/android/server/am/BroadcastRecord;
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    ...
    .end local v14    # "N":I
    .end local v21    # "i":I
    .end local v34    # "r":Lcom/android/server/am/BroadcastRecord;
    :catchall_0
    move-exception v4
    ...
    .restart local v34    # "r":Lcom/android/server/am/BroadcastRecord;
    const/16 v20, 0x0
