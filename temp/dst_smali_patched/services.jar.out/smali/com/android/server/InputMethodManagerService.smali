...
.field private mLGMDMReceiver:Landroid/content/BroadcastReceiver;
...
.field private mTouchDrumEffect:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/InputMethodManagerService;->mLGMDMReceiver:Landroid/content/BroadcastReceiver;
    ...
    sget v1, Lcom/lge/internal/R$bool;->config_touch_drum_effect_available:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mTouchDrumEffect:Z
    ...
    invoke-interface {v0, v10}, Lcom/lge/cappuccino/IMdm;->addFilterIMEServiceReceiver(Landroid/content/IntentFilter;)V

    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->mLGMDMReceiver:Landroid/content/BroadcastReceiver;
...
.method private setImeState(Ljava/lang/String;)V
    .locals 8
    ...
    const-string v2, "/sys/devices/virtual/input/lge_touch/ime_status"
    ...
    invoke-virtual {v4, p1, v5, v6}, Ljava/io/FileWriter;->write(Ljava/lang/String;II)V
    ...
    const-string v6, "setImestate : exception occurs"
...
.method private showInputMethodMenuInternal(Z)V
    ...
    .local v24, "themedContext":Landroid/content/Context;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/WindowManagerService;->isHardKeyboardAvailable()Z
    ...
    invoke-direct {v9, v0, v7}, Lcom/android/server/InputMethodManagerService$8;-><init>(Lcom/android/server/InputMethodManagerService;Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;)V
    ...
    .local v22, "positiveListener":Landroid/content/DialogInterface$OnClickListener;
    move-object/from16 v0, p0
    ...
    .end local v22    # "positiveListener":Landroid/content/DialogInterface$OnClickListener;
    :cond_7
    move-object/from16 v0, p0
    ...
    .end local v24    # "themedContext":Landroid/content/Context;
    ...
    .restart local v24    # "themedContext":Landroid/content/Context;
    .restart local v25    # "tv":Landroid/view/View;
    :cond_8
    const/16 v26, 0x8
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :cond_5
    invoke-interface {v9, v10}, Lcom/android/internal/view/IInputMethodClient;->setScreenOnOff(Z)V
    :try_end_c
    ...
    const-string v12, "Got RemoteException sending setScreenOnOff() notification to pid "
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    invoke-interface {v1, v2}, Lcom/lge/cappuccino/IMdm;->setCurrIMEpackage(Ljava/lang/String;)V

    :cond_5
    iget-boolean v1, p0, Lcom/android/server/InputMethodManagerService;->mTouchDrumEffect:Z

    if-eqz v1, :cond_1

    const-string v1, "0"

    invoke-direct {p0, v1}, Lcom/android/server/InputMethodManagerService;->setImeState(Ljava/lang/String;)V
