...
.method private handleLocationChanged(Landroid/location/Location;Z)V
    ...
    invoke-virtual {v0, v6}, Landroid/location/Location;->setIsFromMockProvider(Z)V
    ...
    invoke-interface {v2, v6, v3, v4, v5}, Lcom/lge/cappuccino/IMdm;->getMDMLocationPolicy(IZILjava/lang/String;)Z
    ...
    const-string v3, "MDM Block PassiveProvider"
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    const-string v31, "MDM"

    new-instance v34, Ljava/lang/StringBuilder;

    invoke-direct/range {v34 .. v34}, Ljava/lang/StringBuilder;-><init>()V

    const-string v35, "MDM Control LocationManager Service, receiver.packageName :"
...
.method private loadProvidersLocked()V
    ...
    .prologue
    new-instance v25, Lcom/android/server/location/PassiveProvider;
    ...
    .local v25, "passiveProvider":Lcom/android/server/location/PassiveProvider;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    :try_start_0
    const-string v3, "com.android.server.location.LgeGpsLocationProvider"
    ...
    const-class v5, Landroid/location/ILocationManager;
    ...
    check-cast v20, Lcom/android/server/location/GpsLocationProvider;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .end local v13    # "c":Ljava/lang/Class;
    .end local v14    # "constructor":Ljava/lang/reflect/Constructor;
    .restart local v20    # "gpsProvider":Lcom/android/server/location/GpsLocationProvider;
    :cond_0
    :goto_0
    if-nez v20, :cond_1
    ...
    .local v28, "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    const v3, 0x107002f
    ...
    .local v24, "networkProvider":Lcom/android/server/location/LocationProviderProxy;
    if-eqz v24, :cond_a
    ...
    .local v27, "provider":Lcom/android/server/location/GeofenceProxy;
    if-nez v27, :cond_8
    ...
    .local v29, "proxy":Lcom/android/server/location/ActivityRecognitionProxy;
    if-nez v29, :cond_9
    ...
    .end local v29    # "proxy":Lcom/android/server/location/ActivityRecognitionProxy;
    :cond_9
    :goto_6
    const v3, 0x1070030
    ...
    .local v32, "testProviderStrings":[Ljava/lang/String;
    ...
    aget-object v31, v12, v21

    .local v31, "testProviderString":Ljava/lang/String;
    const-string v3, ","
    ...
    .end local v24    # "networkProvider":Lcom/android/server/location/LocationProviderProxy;
    .end local v26    # "pkgs":[Ljava/lang/String;
    .end local v27    # "provider":Lcom/android/server/location/GeofenceProxy;
    .end local v28    # "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v30    # "resources":Landroid/content/res/Resources;
    .end local v31    # "testProviderString":Ljava/lang/String;
    .end local v32    # "testProviderStrings":[Ljava/lang/String;
    :catch_0
    move-exception v15
    ...
    const-string v4, "Error while loading LgeGpsLocationProvider."
    ...
    .restart local v24    # "networkProvider":Lcom/android/server/location/LocationProviderProxy;
    .restart local v26    # "pkgs":[Ljava/lang/String;
    .restart local v28    # "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .restart local v16    # "flpHardwareProvider":Lcom/android/server/location/FlpHardwareProvider;
    const-string v3, "LocationManagerService"
    ...
    .restart local v27    # "provider":Lcom/android/server/location/GeofenceProxy;
    :cond_f
    const-string v3, "LocationManagerService"
    ...
    .restart local v31    # "testProviderString":Ljava/lang/String;
    .restart local v32    # "testProviderStrings":[Ljava/lang/String;
    :cond_10
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    const-string v10, "not returning last loc for no op app: "
    ...
    invoke-interface {v8, v9, v10, v11, p2}, Lcom/lge/cappuccino/IMdm;->getMDMLocationPolicy(IZILjava/lang/String;)Z
    ...
    const-string v10, "MDM Control LocationManager Service packageName:"
    ...
    const-string v8, "noGPSLocation"

    invoke-virtual {v1, v8}, Landroid/location/Location;->getExtraLocation(Ljava/lang/String;)Landroid/location/Location;
