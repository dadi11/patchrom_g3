...
.field public static mTetherIface:Ljava/lang/String;
...
.field private mTetheringIALock:Ljava/lang/Object;

.field private mTetheringIAs:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mTetheringIALock:Ljava/lang/Object;

    invoke-static {}, Lcom/google/android/collect/Maps;->newHashMap()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mTetheringIAs:Ljava/util/HashMap;
...
.method static synthetic access$1600(Lcom/android/server/NetworkManagementService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NetworkManagementService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Ljava/lang/String;
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/NetworkManagementService;->notifyGeneralEventfromLDL(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$1700(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NetworkManagementService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method static synthetic access$1800(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NetworkManagementService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/NetworkManagementService;->notifyDSQN(Ljava/lang/String;I)V

    return-void
.end method

.method static synthetic access$1900(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NetworkManagementService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/NetworkManagementService;->notifyPlayerEV(Ljava/lang/String;I)V
...
.method static synthetic access$500(Lcom/android/server/NetworkManagementService;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/server/NetworkManagementService;->notifyNetdConnected()V
...
.method private modifyNat(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/android/server/NetworkManagementService;->mTetheringIALock:Ljava/lang/Object;

    monitor-enter v9

    :try_start_0
    iget-object v8, p0, Lcom/android/server/NetworkManagementService;->mTetheringIAs:Ljava/util/HashMap;
    ...
    const-string v11, "[LGE_DATA] modifyNat() LGP_DATA_TETHER_CLEAR_IPRULE_FOR_UNTETHERING-disable: "
    ...
    .restart local v6    # "interfaceAddresses":Ljava/util/List;, "Ljava/util/List<Ljava/net/InterfaceAddress;>;"
    iget-object v9, p0, Lcom/android/server/NetworkManagementService;->mTetheringIALock:Ljava/lang/Object;
...
.method private modifyRoute(Ljava/lang/String;Ljava/lang/String;Landroid/net/RouteInfo;)V
    ...
    const-string v4, " is already down, so modifyRoute is faild. error = "
...
.method private notifyDSQN(Ljava/lang/String;I)V
    .locals 3
    ...
    invoke-interface {v2, p1, p2}, Landroid/net/INetworkManagementEventObserverEx;->DsqnNotification(Ljava/lang/String;I)V
    :try_end_0
...
.method private notifyGeneralEventfromLDL(Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-interface {v2, p1, p2}, Landroid/net/INetworkManagementEventObserverEx;->GeneralNotification(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private notifyNetdConnected()V
    .locals 3
    ...
    invoke-interface {v2}, Landroid/net/INetworkManagementEventObserverEx;->netdConnected()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private notifyPlayerEV(Ljava/lang/String;I)V
    .locals 3
    .param p1, "event"    # Ljava/lang/String;
    .param p2, "num"    # I
    ...
    invoke-interface {v2, p1, p2}, Landroid/net/INetworkManagementEventObserverEx;->PlayerEvNotification(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public acceptPacket(Ljava/lang/String;)V
    ...
    .local v0, "cmd2":Lcom/android/server/NativeDaemonConnector$Command;
    const-string v3, "NetworkManagementService"
    ...
    const-string v5, "[LGE_DATA] dropCnt = "
...
.method public appendRouteWithMetric(Ljava/lang/String;ILandroid/net/RouteInfo;)Z
    ...
    const-string v8, "[LGE_DATA]isHostRoute = "
    ...
    const-string v8, " isDefaultRoute = "
    ...
    const-string v7, "[LGE_DATA] Skip destination addr"
...
.method public dropPacket(Ljava/lang/String;)V
    ...
    const-string v4, "drop Packet if only flag false and now is_dropping_packet = "
    ...
    const-string v3, "Unable to communicate to native daemon for dropPacket"
...
.method public enableNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object p2, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;
...
.method public getMtu(Ljava/lang/String;)I
    ...
    const-string v5, "[lge_data] getMtu"
    ...
    const-string v5, "Too many arguments"
    ...
    .restart local v3    # "parsed":[Ljava/lang/String;
    :cond_0
    const/4 v4, 0x2
    ...
    const-string v6, "[lge_data] getMtu : "
    ...
    const-string v5, "problem parsing mtu :"
...
.method public getNetworkStatsTethering()Landroid/net/NetworkStats;
    ...
    const-string v14, "[LGE_DATA] ifaceIn %s"
    ...
    const-string v14, "[LGE_DATA] ifaceOut %s"
    ...
    sget-object v13, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;

    if-eqz v13, :cond_1

    sget-object v9, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;

    const-string v13, "NetworkManagementService"

    const-string v14, "[LGE_DATA] Changed ifaceOut %s"
...
.method public packetList_Indrop()Z
    ...
    const-string v5, "Unable to communicate to native daemon for acceptPacket"
    ...
    const-string v7, "[LGE_DATA] Packetdrop list was lefted ~!!! ("
...
.method public removeImsRoute(Ljava/lang/String;Ljava/lang/String;Landroid/net/RouteInfo;)V
    .locals 6
    .param p1, "pcscfaddress"    # Ljava/lang/String;
    ...
    const-string v3, "NetworkManagementService removeImsRoute IN"
    ...
    const-string v5, "removeImsRoute"
...
.method public resetPacketDrop()V
    ...
    const-string v3, "Unable to communicate to native daemon for resetPacketDrop"
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    const-string v3, "setAccessPoint "
    ...
    const-string v3, "useMobileHotspot "
    ...
    :cond_2
    invoke-virtual {p0, p1, p2}, Lcom/android/server/NetworkManagementService;->startLGAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setInterfaceAlias(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "Unable to communicate to native daemon for setting interface alias"
...
.method public setTcpWindowScaling(Z)V
    ...
    .local v1, "str_enable":Ljava/lang/String;
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/android/server/NetworkManagementService;->mConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    const-string v6, "setTcpWindowScaling"
    ...
    .end local v1    # "str_enable":Ljava/lang/String;
    :cond_0
    const-string v1, "disable"

    goto :goto_0

    .restart local v1    # "str_enable":Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    const-string v4, "Error communicating with native daemon to setTcpWindowScaling("
...
.method public setWifiHighTrafficMode(ZZ)V
    ...
    const-string v5, "hightrafficmode"
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    const-string v2, "startAccessPoint  start"
    ...
    invoke-interface {v1, v4, p1, v5, v5}, Lcom/lge/wifi/extension/IWifiSoftAP;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z
    ...
    const-string v2, "[startAccessPoint] wifiConfig is null"
    ...
    const-string v2, "Not supported operator for HotspotList"
...
.method public startClatd(Ljava/lang/String;)V
    ...
    .local v1, "simNetworkOperator":Ljava/lang/String;
    iget-object v3, p0, Lcom/android/server/NetworkManagementService;->mContext:Landroid/content/Context;
    ...
    sget-object v3, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_NETD_CLATD_RECONFIGURATION:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
...
.method public startLGAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    .locals 35
    .param p1, "wifiConfig"    # Landroid/net/wifi/WifiConfiguration;
    .param p2, "wlanIface"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
    ...
    const-string v31, "android.permission.CONNECTIVITY_INTERNAL"

    const-string v32, "NetworkManagementService"

    invoke-virtual/range {v30 .. v32}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v31, "android.permission.CHANGE_NETWORK_STATE"
    ...
    const-string v31, "android.permission.CHANGE_WIFI_STATE"
    ...
    .local v29, "wep_key_index":I
    const/16 v27, 0x0

    .local v27, "wep_key":Ljava/lang/String;
    const/16 v20, 0x0

    .local v20, "presharedkey":Ljava/lang/String;
    const/4 v7, 0x0

    .local v7, "basic_rates":Ljava/lang/String;
    const/16 v22, 0x0

    .local v22, "securitytype":Ljava/lang/String;
    const/4 v6, 0x0

    .local v6, "authtype":Ljava/lang/String;
    const/16 v21, 0x0

    .local v21, "protocoltype":Ljava/lang/String;
    const/4 v12, 0x0

    .local v12, "enctype":Ljava/lang/String;
    const/4 v4, -0x1

    .local v4, "ap5Gchannel":I
    const/4 v3, -0x1

    .local v3, "ap2Gchannel":I
    const/4 v8, -0x1
    ...
    const-string v31, "mhs_native_softap"
    ...
    .local v25, "ssid_db":Ljava/lang/String;
    const-string v30, "NetworkManagementService"

    new-instance v31, Ljava/lang/StringBuilder;

    invoke-direct/range {v31 .. v31}, Ljava/lang/StringBuilder;-><init>()V

    const-string v32, "[startLGAccessPoint] ssid: "
    ...
    const-string v32, "[startLGAccessPoint] getSecurityType: "
    ...
    const-string v32, "[startLGAccessPoint] iface "
    ...
    const-string v32, "[startLGAccessPoint] securitytype "
    ...
    const-string v32, "[startLGAccessPoint] authtype "
    ...
    const-string v32, "[startLGAccessPoint] protocoltype "
    ...
    const-string v32, "[startLGAccessPoint] enctype "
    ...
    const-string v32, "[startLGAccessPoint] presharedkey "
    ...
    const-string v31, "mhs_max_client"
    ...
    .local v13, "hiddenssid":I
    const/4 v14, 0x0

    .local v14, "hiddenssid_db":I
    move-object/from16 v0, p0
    ...
    const-string v31, "mhs_hidden_ssid"
    ...
    const-string v32, "[startLGAccessPoint] hiddenssid: "
    ...
    const-string v32, "hiddenssid_db: "
    ...
    const-string v31, "mhs_frequency"
    ...
    const-string v32, "[startLGAccessPoint] selectBand "
    ...
    const-string v31, "mhs_hw_mode"

    invoke-static/range {v30 .. v31}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    .local v15, "hw_mode":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v31, "mhs_ieee_80211n"
    ...
    const-string v31, "mhs_5g_chanel"
    ...
    const-string v32, "[startLGAccessPoint] 5G Band Selected, Channel Number is "
    ...
    .local v17, "isWpsSupported":I
    const-string v30, "true"

    const-string v31, "wlan.lge.softapwps"
    ...
    const-string v31, "[startLGAccessPoint] WPS: softap WPS set to true "
    ...
    const-string v32, "[startLGAccessPoint] hw_mode "
    ...
    const-string v32, "[startLGAccessPoint] ieee_mode "
    ...
    const-string v31, "mhs_accept_file"

    invoke-static/range {v30 .. v31}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .local v2, "accept_mac_file":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v31, "mhs_deny_file"

    invoke-static/range {v30 .. v31}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    .local v10, "deny_mac_file":Ljava/lang/String;
    const/16 v28, 0x0

    .local v28, "wep_key_default":I
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v30 .. v32}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    ...
    const-string v32, "wep_key_default = "
    ...
    const-string v32, "wep_key_index = "
    ...
    const-string v32, "mhs_max_client = "
    ...
    .end local v2    # "accept_mac_file":Ljava/lang/String;
    .end local v5    # "ap_isolate":I
    .end local v9    # "countrycode":Ljava/lang/String;
    .end local v10    # "deny_mac_file":Ljava/lang/String;
    .end local v13    # "hiddenssid":I
    .end local v14    # "hiddenssid_db":I
    .end local v15    # "hw_mode":Ljava/lang/String;
    .end local v16    # "ieee_mode":I
    .end local v17    # "isWpsSupported":I
    .end local v18    # "macaddr_acl":I
    .end local v19    # "mhs_max_client":I
    .end local v23    # "selectBand":I
    .end local v28    # "wep_key_default":I
    :cond_4
    ...
    const-string v6, "auth_shared"

    const-string v21, "WPA"

    const-string v12, "TKIP"

    goto/16 :goto_1

    :cond_6
    const-string v30, "WPA2_PSK"
    ...
    const-string v21, "RSN"

    const-string v12, "CCMP"

    goto/16 :goto_1

    :cond_7
    const-string v30, "WPA_WPA2_MIXED"
    ...
    const-string v21, "WPA RSN"

    const-string v12, "TKIP CCMP"
    ...
    .restart local v19    # "mhs_max_client":I
    :cond_9
    invoke-static {}, Lcom/lge/wifi/config/LgeWifiConfig;->getOperator()Ljava/lang/String;
    ...
    sget-boolean v30, Lcom/lge/wifi/config/LgeWifiConfig;->CONFIG_LGE_WLAN_PATCH:Z
    ...
    const-string v31, "[startLGAccessPoint] here0: "
    ...
    .local v26, "wem":Lcom/lge/wifi/impl/WifiExtManager;
    if-eqz v26, :cond_a

    const-string v30, "NetworkManagementService"

    const-string v31, "[startLGAccessPoint] here1: "

    invoke-static/range {v30 .. v31}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static/range {v19 .. v19}, Lcom/lge/wifi/impl/WifiExtManager;->getSoftApMaxScb(I)I
    ...
    const-string v31, "[startLGAccessPoint] here2: "
    ...
    .end local v25    # "ssid_db":Ljava/lang/String;
    .end local v26    # "wem":Lcom/lge/wifi/impl/WifiExtManager;
    :catch_0
    move-exception v11
    ...
    .restart local v25    # "ssid_db":Ljava/lang/String;
    :cond_b
    :try_start_1
    move-object/from16 v0, p0
    ...
    .restart local v13    # "hiddenssid":I
    .restart local v14    # "hiddenssid_db":I
    :cond_c
    const/4 v13, 0x0

    goto/16 :goto_3

    .restart local v15    # "hw_mode":Ljava/lang/String;
    .restart local v16    # "ieee_mode":I
    .restart local v23    # "selectBand":I
    :cond_d
    move-object/from16 v0, p0
    ...
    const-string v31, "mhs_2g_channel"
    ...
    const-string v32, "[startLGAccessPoint] 2.4G Band Selected, Channel Number is "
    ...
    .restart local v17    # "isWpsSupported":I
    :cond_e
    const-string v30, "NetworkManagementService"

    const-string v31, "[startLGAccessPoint] WPS: softap WPS set to false "
    ...
    const-string v7, "10 20 55 60 90 110 120 180 240 360 480 540"
    ...
    const-string v7, "10 20 55 110 60 90 120 180 240 360 480 540"
    ...
    const-string v7, "60 90 120 180 240 360 480 540"
...
.method public stopAccessPoint(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v5, v2, v4, v4}, Lcom/lge/wifi/extension/IWifiSoftAP;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z

    :cond_1
    :try_start_0
    const-string v1, "NetworkManagementService"

    const-string v2, "stopAccessPoint()"
...
.method public unblockIPv6Interface(Ljava/lang/String;)V
    ...
    const-string v5, "clearIp6Tables"
