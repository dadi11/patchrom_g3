...
.method public setPrimaryClip(Landroid/content/ClipData;Ljava/lang/String;)V
    ...
    invoke-interface {v11, v10}, Lcom/lge/cappuccino/IMdm;->checkDisabledClipboard(Z)Z
    ...
    iget-object v11, p0, Lcom/android/server/clipboard/ClipboardService;->mAppOps:Landroid/app/AppOpsManager;

    const/16 v12, 0x1e

    invoke-virtual {v11, v12, v0, p2}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
    ...
    const-string v11, "com.lge.cliptray.InitClipboard"
    ...
    iput-object v10, v2, Lcom/android/server/clipboard/ClipboardService$PerUserClipboard;->primaryClip:Landroid/content/ClipData;
    ...
    iget-object v11, p0, Lcom/android/server/clipboard/ClipboardService;->mSecurityBridge:Lcom/android/services/SecurityBridge/api/ClipboardManagerMonitor;

    invoke-static {}, Landroid/os/Binder;->getCallingUid()I

    move-result v12

    invoke-virtual {v11, v12, p1}, Lcom/android/services/SecurityBridge/api/ClipboardManagerMonitor;->notifyCopy(ILandroid/content/ClipData;)V
    ...
    .local v1, "canCopy":Z
    :try_start_2
    iget-object v11, p0, Lcom/android/server/clipboard/ClipboardService;->mUm:Landroid/os/IUserManager;

    invoke-interface {v11, v9}, Landroid/os/IUserManager;->getUserRestrictions(I)Landroid/os/Bundle;

    move-result-object v11

    const-string v12, "no_cross_profile_copy_paste"
    ...
    const-string v10, "ClipboardService"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Remote Exception calling UserManager: "
    ...
    :cond_6
    invoke-virtual {p1, v9}, Landroid/content/ClipData;->fixUrisLight(I)V
