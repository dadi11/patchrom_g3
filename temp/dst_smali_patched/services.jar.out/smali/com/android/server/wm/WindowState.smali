...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput-boolean v10, p0, Lcom/android/server/wm/WindowState;->mIgnoreExitAnimation:Z
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/wm/WindowManagerService;->checkIsSplitFullscreen(Lcom/android/server/wm/WindowState;)Z
    ...
    .local v15, "isSplitFullScreen":Z
    :goto_1
    if-eqz v18, :cond_a

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/wm/TaskStack;->isFullscreen()Z
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/android/server/wm/WindowManagerService;->modifyFramesForSplitWindow(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/WindowManager$LayoutParams;)V
    ...
    .end local v13    # "fh":I
    .end local v14    # "fw":I
    .end local v15    # "isSplitFullScreen":Z
    .end local v16    # "ph":I
    .end local v17    # "pw":I
    ...
    .restart local v15    # "isSplitFullScreen":Z
    :cond_a
    move-object/from16 v0, p0
...
.method public getColorNavigationBar()I
    .locals 1
    ...
    iget v0, v0, Landroid/view/WindowManager$LayoutParams;->colorNavigationBar:I
...
.method public getSystemUiVisibilityLG()I
    ...
    .prologue
    iget v0, p0, Lcom/android/server/wm/WindowState;->mSystemUiVisibilityLG:I
...
.method public requestHideIme()V
    .locals 3
    ...
    invoke-interface {v1, v2}, Landroid/view/IWindow;->hideInputMethodWindow(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
