...
.field protected mNotificationDelegate:Lcom/android/server/notification/NotificationDelegate;

.field private mShowImeSwitcher:Z

.field protected mSysUiVisToken:Landroid/os/IBinder;
...
.method private dumpDisabled()V
    ...
    const-string v6, "StatusBar disabled: mDisabled=0x"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisabled:I
    ...
    const-string v6, ",  mDisableRecords.size="
    ...
    const-string v6, "StatusBar disabled: ["
    ...
    iget v6, v2, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->userId:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, ", what=0x"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v2, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->what:I
    ...
    iget-object v6, v2, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->pkg:Ljava/lang/String;
    ...
    iget-object v6, v2, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->token:Landroid/os/IBinder;
...
.method public disable(ILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    const-string v0, "SystemUI[Framework]"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "==>disabled() what=0x"
    ...
    invoke-direct {p0}, Lcom/android/server/statusbar/StatusBarManagerService;->dumpDisabled()V
...
.method protected enforceStatusBar()V
    .locals 3
