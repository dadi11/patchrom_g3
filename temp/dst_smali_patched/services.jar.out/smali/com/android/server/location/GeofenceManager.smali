...
.method private updateFences()V
    ...
    .local v6, "enterIntents":Ljava/util/List;, "Ljava/util/List<Landroid/app/PendingIntent;>;"
    new-instance v8, Ljava/util/LinkedList;

    invoke-direct {v8}, Ljava/util/LinkedList;-><init>()V

    .local v8, "exitIntents":Ljava/util/List;, "Ljava/util/List<Landroid/app/PendingIntent;>;"
    ...
    .local v16, "minFenceDistance":D
    const/16 v18, 0x0

    .local v18, "needUpdates":Z
    move-object/from16 v0, p0
    ...
    check-cast v21, Lcom/android/server/location/GeofenceState;

    .local v21, "state":Lcom/android/server/location/GeofenceState;
    move-object/from16 v0, p0
    ...
    sget-boolean v22, Lcom/android/server/location/GeofenceManager;->D:Z

    if-eqz v22, :cond_0

    const-string v22, "GeofenceManager"

    new-instance v24, Ljava/lang/StringBuilder;

    invoke-direct/range {v24 .. v24}, Ljava/lang/StringBuilder;-><init>()V

    const-string v25, "skipping geofence processing for blacklisted app: "
    ...
    .end local v16    # "minFenceDistance":D
    .end local v18    # "needUpdates":Z
    .end local v21    # "state":Lcom/android/server/location/GeofenceState;
    :catchall_0
    move-exception v22
    ...
    .restart local v16    # "minFenceDistance":D
    .restart local v18    # "needUpdates":Z
    .restart local v21    # "state":Lcom/android/server/location/GeofenceState;
    :cond_1
    :try_start_1
    move-object/from16 v0, v21
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/LocationManagerService;->resolutionLevelToOp(I)I
    ...
    const-string v25, "skipping geofence processing for no op app: "
    ...
    const-string v25, "MDM Control GeofenceManager, state.packageName :"
    ...
    :cond_5
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/location/GeofenceState;->getDistanceToBoundary()D

    move-result-wide v10

    .local v10, "fenceDistance":D
    cmpg-double v22, v10, v16
    ...
    iput-wide v14, v0, Lcom/android/server/location/GeofenceManager;->mLocationUpdateInterval:J

    move-object/from16 v0, p0

    iput-object v13, v0, Lcom/android/server/location/GeofenceManager;->mLastLocationUpdate:Landroid/location/Location;

    new-instance v20, Landroid/location/LocationRequest;

    invoke-direct/range {v20 .. v20}, Landroid/location/LocationRequest;-><init>()V

    .local v20, "request":Landroid/location/LocationRequest;
    move-object/from16 v0, v20

    invoke-virtual {v0, v14, v15}, Landroid/location/LocationRequest;->setInterval(J)Landroid/location/LocationRequest;
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/location/GeofenceManager$GeofenceHandler;->getLooper()Landroid/os/Looper;
    ...
    .end local v14    # "intervalMs":J
    .end local v20    # "request":Landroid/location/LocationRequest;
    :cond_8
    :goto_2
    sget-boolean v22, Lcom/android/server/location/GeofenceManager;->D:Z
    ...
    const-string v25, "updateFences: location="
    ...
    const-string v25, ", mReceivingLocationUpdates="
    ...
    const-string v25, ", mLocationUpdateInterval="
    ...
    const-string v25, ", mLastLocationUpdate="
    ...
    invoke-direct {v0, v12}, Lcom/android/server/location/GeofenceManager;->sendIntentExit(Landroid/app/PendingIntent;)V
    ...
    .restart local v14    # "intervalMs":J
    goto/16 :goto_1
    ...
    .restart local v12    # "intent":Landroid/app/PendingIntent;
    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lcom/android/server/location/GeofenceManager;->sendIntentEnter(Landroid/app/PendingIntent;)V
