...
.field public mAssistDialPhoneNumberUtils:Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;
...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mAssistDialPhoneNumberUtils:Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;
...
.method private disableDataCallInEmergencyCall(Ljava/lang/String;)V
    ...
    const-string v2, "NotDisableDataCallInEmergencyCall"
    ...
    iget-object v2, v2, Lcom/android/internal/telephony/cdma/CDMAPhone;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    invoke-virtual {v2, v4}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setInternalDataEnabled(Z)Z
    ...
    invoke-static {}, Lcom/lge/wifi/impl/WifiExtManager;->isVZWMobileHotspotEnabled()Z
    ...
    const-string v3, "E911 WiFi : disable MobileHotspot"

    invoke-static {v2, v3}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v1, Landroid/content/Intent;

    const-string v2, "com.lge.mobilehotspot.action.MOBILEHOTSPOT_EMC_EVENT"
    ...
    invoke-virtual {v0, v1, v6}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    const-string v3, "Emergency Sleep 500ms start"
    ...
    const-string v3, "Emergency Sleep 500ms end"
    ...
    const-string v3, "E911 WiFi : could not send intent because context is null"
    ...
    const-string v3, "E911 WiFi : do not disable MobileHotspot because MHP is not enabled"
    ...
    const-string v3, "E911 WiFi : Enctyption boot mode, so skip!!!"
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .local v20, "newUnknown":Lcom/android/internal/telephony/Connection;
    const/4 v14, 0x0
    ...
    .end local v20    # "newUnknown":Lcom/android/internal/telephony/Connection;
    ...
    .restart local v20    # "newUnknown":Lcom/android/internal/telephony/Connection;
    .restart local v21    # "polledCalls":Ljava/util/List;
    ...
    const-string v23, "CdmaCallTracker"
    ...
    new-instance v24, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v24, "adding fgCall cn "
    ...
    const-string v24, " to droppedDuringPoll"
    ...
    const-string v24, "adding rgCall cn "
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/internal/telephony/cdma/CdmaCall;->setGeneric(Z)V
    ...
    const-string v25, "Error in RIL, Phantom call appeared "
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/cdma/CdmaCall;->getState()Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyPreciseCallStateChanged()V
