...
.field protected mCTCPreferredNetwork:Lcom/lge/telephony/CTCPreferredNetwork;
...
.field private mIccSmsInterfaceManager:Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;

.field private mKDDITddReceiver:Landroid/content/BroadcastReceiver;

.field protected mKddiPreferredNetwork:Lcom/lge/telephony/KDDIPreferredNetwork;

.field private mLteTddInfo:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mKDDITddReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mKDDITddReceiver:Landroid/content/BroadcastReceiver;
    ...
    new-instance v2, Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;

    iget-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    check-cast v1, Lcom/android/internal/telephony/PhoneBase;

    invoke-direct {v2, v1}, Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccSmsInterfaceManager:Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;
    ...
    new-instance v1, Lcom/lge/telephony/KDDIPreferredNetwork;

    iget-object v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-direct {v1, v2}, Lcom/lge/telephony/KDDIPreferredNetwork;-><init>(Lcom/android/internal/telephony/Phone;)V

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mKddiPreferredNetwork:Lcom/lge/telephony/KDDIPreferredNetwork;
    ...
    new-instance v1, Lcom/lge/telephony/CTCPreferredNetwork;

    iget-object v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-direct {v1, v2}, Lcom/lge/telephony/CTCPreferredNetwork;-><init>(Lcom/android/internal/telephony/Phone;)V

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mCTCPreferredNetwork:Lcom/lge/telephony/CTCPreferredNetwork;
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mKDDITddReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$002(Lcom/android/internal/telephony/PhoneProxy;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/PhoneProxy;
    .param p1, "x1"    # Ljava/lang/String;

    .prologue
    iput-object p1, p0, Lcom/android/internal/telephony/PhoneProxy;->mLteTddInfo:Ljava/lang/String;
...
.method private deleteAndCreatePhone(I)V
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/PhoneFactory;->getCdmaPhone(I)Lcom/android/internal/telephony/Phone;
    ...
    invoke-interface {v4, v0}, Lcom/android/internal/telephony/Phone;->acquireOwnershipOfImsPhone(Lcom/android/internal/telephony/imsphone/ImsPhone;)V
    ...
    invoke-virtual {v4, v1}, Lcom/android/internal/telephony/CallManager;->unregisterPhone(Lcom/android/internal/telephony/Phone;)V
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mCTCPreferredNetwork:Lcom/lge/telephony/CTCPreferredNetwork;
    ...
    invoke-virtual {v4, v5}, Lcom/lge/telephony/CTCPreferredNetwork;->reRegister(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/PhoneFactory;->getGsmPhone(I)Lcom/android/internal/telephony/Phone;
...
.method private phoneObjectUpdater(I)V
    ...
    iget v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneId:I

    if-eqz v6, :cond_2

    const-string v6, "CTC : sim2 is not supported CDMA, do not change"
    ...
    const-string v7, "KDDI Ignoring voice radio technology changed message. newVoiceRadioTech = RIL_RADIO_TECHNOLOGY_LTE Active Phone = "
    ...
    .restart local v5    # "volteReplacementRat":I
    :cond_2
    if-eqz v5, :cond_1
    ...
    const-string v7, "use_4g_network_onoff"

    invoke-static {v6, v7, v10}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v1

    .local v1, "lteStatus":I
    if-ne v4, v8, :cond_1
    ...
    const-string v7, "CTC : TDD On but no LTE tech, something wrong !! newVoiceRadioTech "
    ...
    .end local v1    # "lteStatus":I
    .end local v4    # "tddStatus":I
    .end local v5    # "volteReplacementRat":I
    .restart local v3    # "phoneType":I
    :cond_4
    new-instance v6, Ljava/lang/StringBuilder;
    ...
    const-string v7, "KDDI update phone object newVoiceRadioTech = RIL_RADIO_TECHNOLOGY_LTE current Active Phone is "
    ...
    const-string v7, "Phone Switching : newVoiceRadioTech "
    ...
    const-string v7, ", but Call State="
    ...
    invoke-virtual {p0, v12}, Lcom/android/internal/telephony/PhoneProxy;->removeMessages(I)V
    ...
    invoke-virtual {p0, v6, v8, v9}, Lcom/android/internal/telephony/PhoneProxy;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-interface {v6, v10, v9}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-interface {v6, v2, v9}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V

    :cond_f
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccSmsInterfaceManager:Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;

    iget-object v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    check-cast v6, Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v7, v6}, Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;->updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-static {v0, v6}, Landroid/telephony/SubscriptionManager;->putPhoneIdAndSubIdExtra(Landroid/content/Intent;I)V

    const/4 v6, -0x1

    invoke-static {v0, v9, v6}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
...
.method public changePlmnNameForSwedish(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->changePlmnNameForSwedish(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mKddiPreferredNetwork:Lcom/lge/telephony/KDDIPreferredNetwork;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mKddiPreferredNetwork:Lcom/lge/telephony/KDDIPreferredNetwork;

    invoke-virtual {v0}, Lcom/lge/telephony/KDDIPreferredNetwork;->dispose()V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mCTCPreferredNetwork:Lcom/lge/telephony/CTCPreferredNetwork;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mCTCPreferredNetwork:Lcom/lge/telephony/CTCPreferredNetwork;

    invoke-virtual {v0}, Lcom/lge/telephony/CTCPreferredNetwork;->dispose()V

    :cond_1
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mKDDITddReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mKDDITddReceiver:Landroid/content/BroadcastReceiver;
...
.method public getDmNodeHandlerDiagMonNetwork(ZII)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->getDmNodeHandlerDiagMonNetwork(ZII)Ljava/lang/String;
...
.method public getIMSPrefState()V
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getIMSPrefState()V
...
.method public getIccSmsInterfaceManager()Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;
    .locals 1

    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccSmsInterfaceManager:Lcom/android/internal/telephony/IccSmsInterfaceManagerEx;
...
.method public getLteTddInfo()Ljava/lang/String;
    .locals 1

    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mLteTddInfo:Ljava/lang/String;
...
.method public getVoiceDomainPref()V
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getVoiceDomainPref()V
...
.method public isSystemInPrl()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->isSystemInPrl()Z
...
.method public isUiccInserted()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->isUiccInserted()Z
...
.method public lgeResetEPSLOCI(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->lgeResetEPSLOCI(Landroid/os/Message;)V
...
.method public mocaGetMisc(IILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->mocaGetMisc(IILandroid/os/Message;)V
...
.method public mocaGetRFParameter(IILandroid/os/Message;)V
    ...
    :cond_0
    const-string v0, "mocaGetRFParameter"
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->mocaGetRFParameter(IILandroid/os/Message;)V
...
.method public oemSsaHdvAlarmEvent([BLandroid/os/Message;)V
    ...
    .prologue
    const-string v0, "oemSsaHdvAlarmEvent"

    invoke-static {v0}, Lcom/android/internal/telephony/PhoneProxy;->logd(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->oemSsaHdvAlarmEvent([BLandroid/os/Message;)V
...
.method public registerIMSPrefStatusInd(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerIMSPrefStatusInd(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public registerLGERACInd(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerLGERACInd(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public registerSsacChangeInfoInd(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerSsacChangeInfoInd(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public setUeMode(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->setUeMode(ILandroid/os/Message;)V
...
.method public setVoiceDomainPref(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->setVoiceDomainPref(I)V
...
.method public setVolteCallStatus(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->setVolteCallStatus(I)V
...
.method public unregisterIMSPrefStatusInd(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterIMSPrefStatusInd(Landroid/os/Handler;)V
...
.method public unregisterLGERACInd(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterLGERACInd(Landroid/os/Handler;)V
...
.method public unregisterSsacChangeInfoInd(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterSsacChangeInfoInd(Landroid/os/Handler;)V
...
.method public updateIMSStateReq(II[I[I)V
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/android/internal/telephony/Phone;->updateIMSStateReq(II[I[I)V
