...
.method private pullFixedProc(Landroid/util/ArrayMap;I)Lcom/android/internal/app/ProcessStats$ProcessState;
    ...
    iget-boolean v5, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mDead:Z

    if-eqz v5, :cond_0

    iget-object v5, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mCommonProcess:Lcom/android/internal/app/ProcessStats$ProcessState;
    ...
    const-string v7, "Pulling dead proc: name="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mName:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mPackage:Ljava/lang/String;
    ...
    iget v7, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mUid:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " common.name="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mCommonProcess:Lcom/android/internal/app/ProcessStats$ProcessState;

    iget-object v7, v7, Lcom/android/internal/app/ProcessStats$ProcessState;->mName:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mStats:Lcom/android/internal/app/ProcessStats;

    iget-object v6, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mPackage:Ljava/lang/String;

    iget v7, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mUid:I

    iget v8, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mVersion:I

    iget-object v9, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mName:Ljava/lang/String;

    invoke-virtual {v5, v6, v7, v8, v9}, Lcom/android/internal/app/ProcessStats;->getProcessStateLocked(Ljava/lang/String;IILjava/lang/String;)Lcom/android/internal/app/ProcessStats$ProcessState;

    move-result-object v2

    :cond_0
    iget-boolean v5, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mMultiPackage:Z

    if-eqz v5, :cond_4

    iget-object v5, p0, Lcom/android/internal/app/ProcessStats$ProcessState;->mStats:Lcom/android/internal/app/ProcessStats;

    iget-object v6, v5, Lcom/android/internal/app/ProcessStats;->mPackages:Lcom/android/internal/app/ProcessMap;
    ...
    .local v4, "vpkg":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/internal/app/ProcessStats$PackageState;>;"
    if-nez v4, :cond_1
    ...
    const-string v7, "No existing package "
    ...
    const-string v7, " for multi-proc "

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v7, v2, Lcom/android/internal/app/ProcessStats$ProcessState;->mName:Ljava/lang/String;
    ...
    iget-object v5, v1, Lcom/android/internal/app/ProcessStats$PackageState;->mProcesses:Landroid/util/ArrayMap;
    ...
    iget-object v7, v1, Lcom/android/internal/app/ProcessStats$PackageState;->mPackageName:Ljava/lang/String;
    ...
    iget v7, v1, Lcom/android/internal/app/ProcessStats$PackageState;->mUid:I
    ...
    .end local v4    # "vpkg":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/internal/app/ProcessStats$PackageState;>;"
    :cond_4
    return-object v2
.end method
