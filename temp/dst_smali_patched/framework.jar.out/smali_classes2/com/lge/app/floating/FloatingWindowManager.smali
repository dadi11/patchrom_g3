...
.method static constructor <clinit>()V
    ...
    const-class v4, Lcom/lge/app/floating/FloatingWindowManager;

    invoke-virtual {v4}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v4

    sput-object v4, Lcom/lge/app/floating/FloatingWindowManager;->TAG:Ljava/lang/String;

    sput-object v5, Lcom/lge/app/floating/FloatingWindowManager;->sDefault:Lcom/lge/app/floating/FloatingWindowManager;

    const/4 v4, 0x2

    sput v4, Lcom/lge/app/floating/FloatingWindowManager;->sMaxFloating:I

    sput-object v5, Lcom/lge/app/floating/FloatingWindowManager;->sGetSystemPropertiesMethod:Ljava/lang/reflect/Method;
    ...
    sput-object v4, Lcom/lge/app/floating/FloatingWindowManager;->sGetSystemPropertiesMethod:Ljava/lang/reflect/Method;

    sget-object v4, Lcom/lge/app/floating/FloatingWindowManager;->sGetSystemPropertiesMethod:Ljava/lang/reflect/Method;
    ...
    const-string v8, "ro.lge.qslide.max_window"
    ...
    sget-object v4, Lcom/lge/app/floating/FloatingWindowManager;->TAG:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "read ro.lge.qslide.max_window = "
    ...
    const-string v8, "com.lge.qslide.max_window_test"
    ...
    const-string v6, "read com.lge.qslide.max_window_test = "
    ...
    .end local v2    # "maxFloatingTest":I
    :cond_1
    :goto_0
    return-void
    ...
    const-string v6, "reflection for android.os.SystemProperties.get() failed. reason = "
    ...
    const-string v6, "reflection to get ro.lge.qslide.max_window failed. reason = "
...
.method private createDummyWindow()V
    .locals 9
    ...
    const-string v4, "Create DummyWindow"

    invoke-static {v2, v4}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v2, Landroid/view/View;

    iget-object v4, p0, Lcom/lge/app/floating/FloatingWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v2, v4}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/lge/app/floating/FloatingWindowManager;->mDummyView:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/lge/app/floating/FloatingWindowManager;->mDummyView:Landroid/view/View;
    ...
    const-string v3, "Exception in createDummyWindow : "
...
.method public static isTooManyFloatingWindows(Landroid/content/Context;Z)Z
    ...
    const-string v11, "show toast that we have maximum number of floating windows"
...
.method clearLowProfileRequestList()V
    ...
    const-string v1, "clearLowProfileList"
...
.method public getActivityNameForPackageName(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
...
.method public getFloatingWindows()Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public isQSlideModeEnabled(Z)Z
    .locals 1
    .param p1, "showToast"    # Z
...
.method onTopWindowChanged(Ljava/lang/String;)V
    ...
    const-string v4, "top window is changed to "
...
.method removeDummyWindow()V
    .locals 2

    .prologue
    sget-object v0, Lcom/lge/app/floating/FloatingWindowManager;->TAG:Ljava/lang/String;

    const-string v1, "Remove DummyWindow"
    ...
    iget-object v1, p0, Lcom/lge/app/floating/FloatingWindowManager;->mDummyView:Landroid/view/View;
...
.method removeFloatingWindow(Lcom/lge/app/floating/FloatingWindow;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/lge/app/floating/FloatingWindowManager;->removeDummyWindow()V
