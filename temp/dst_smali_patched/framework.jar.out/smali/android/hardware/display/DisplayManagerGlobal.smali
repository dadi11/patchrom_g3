...
.method public pauseTransitDlna()V
    ...
    invoke-interface {v1}, Landroid/hardware/display/IDisplayManager;->pauseTransitDlna()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to transit to DLNA."
...
.method public pauseTransitWhrz()V
    ...
    invoke-interface {v1}, Landroid/hardware/display/IDisplayManager;->pauseTransitWhrz()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to transit to WHRZ."
...
.method public playTransitWfd()V
    ...
    invoke-interface {v1}, Landroid/hardware/display/IDisplayManager;->playTransitWfd()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to transit to Wifi display."
...
.method public setUibcEnabled(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/hardware/display/IDisplayManager;->setUibcEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to set Uibc Enabled."
