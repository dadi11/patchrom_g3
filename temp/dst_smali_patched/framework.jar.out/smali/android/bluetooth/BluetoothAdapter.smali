...
.method private createNewRfcommSocketAndRecord(Ljava/lang/String;Ljava/util/UUID;ZZ)Landroid/bluetooth/BluetoothServerSocket;
    ...
    const-string v4, "00001103-0000-1000-8000-00805f9b34fb"
    ...
    const-string v4, "Error: Not allowed"
    ...
    const-string v4, "00002a0b-0000-1000-8000-00805f9b34fb"
    ...
    const-string v4, "ecf54791-1658-403b-b022-2b202c50c8fa"
    ...
    const-string v4, "Error:EasyTether Not allowed"
    ...
    :cond_3
    new-instance v2, Landroid/bluetooth/BluetoothServerSocket;

    const/4 v3, 0x1

    new-instance v4, Landroid/os/ParcelUuid;

    invoke-direct {v4, p2}, Landroid/os/ParcelUuid;-><init>(Ljava/util/UUID;)V

    invoke-direct {v2, v3, p3, p4, v4}, Landroid/bluetooth/BluetoothServerSocket;-><init>(IZZLandroid/os/ParcelUuid;)V

    .local v2, "socket":Landroid/bluetooth/BluetoothServerSocket;
    invoke-virtual {v2, p1}, Landroid/bluetooth/BluetoothServerSocket;->setServiceName(Ljava/lang/String;)V

    iget-object v3, v2, Landroid/bluetooth/BluetoothServerSocket;->mSocket:Landroid/bluetooth/BluetoothSocket;

    invoke-virtual {v3}, Landroid/bluetooth/BluetoothSocket;->bindListen()I
...
.method public getState()I
    ...
    const-string v3, "[BTUI] getState() : SecurityException handled"
