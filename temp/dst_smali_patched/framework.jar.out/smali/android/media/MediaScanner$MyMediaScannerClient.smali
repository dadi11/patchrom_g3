...
.field protected mAlbumArtist:Ljava/lang/String;

.field protected mArtist:Ljava/lang/String;

.field protected mCompilation:I

.field protected mComposer:Ljava/lang/String;
...
.field protected mGenre:Ljava/lang/String;

.field protected mHeight:I

.field protected mIsDrm:Z

.field protected mLastModified:J

.field protected mMimeType:Ljava/lang/String;

.field protected mNoMedia:Z
...
.field protected mWriter:Ljava/lang/String;
...
# direct methods
.method protected constructor <init>(Landroid/media/MediaScanner;)V
    .locals 0
...
.method private processImageFile(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Landroid/media/MediaScanner;->access$800(Landroid/media/MediaScanner;)Landroid/graphics/BitmapFactory$Options;
...
.method public beginFile(Ljava/lang/String;Ljava/lang/String;JJZZ)Landroid/media/MediaScanner$FileEntry;
    ...
    invoke-static {p1}, Landroid/media/MediaScanner;->access$000(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3}, Landroid/media/MediaScanner;->isDrmEnabled()Z
    ...
    invoke-virtual {p0, p1}, Landroid/media/MediaScanner$MyMediaScannerClient;->getFileTypeFromDrm(Ljava/lang/String;)I
    ...
    invoke-static {v3}, Landroid/media/MediaScanner;->access$200(Landroid/media/MediaScanner;)Ljava/util/ArrayList;
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->access$300(Landroid/media/MediaScanner;)I
    ...
    invoke-virtual/range {v4 .. v10}, Landroid/media/MediaScanner$MyMediaScannerClient;->endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mExternalStoragePath:Ljava/lang/String;
    ...
    iget-object v11, v11, Landroid/media/MediaScanner;->mExternalStoragePath:Ljava/lang/String;
    ...
    invoke-static {v4, v0, v1, v2}, Landroid/media/MediaScanner;->access$500(Landroid/media/MediaScanner;Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaScannerClient;)V
...
.method protected doesPathHaveFilename(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
    .param p1, "path"    # Ljava/lang/String;
...
.method protected endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/media/MediaScanner$MyMediaScannerClient;->toValues()Landroid/content/ContentValues;
    ...
    iget-object v0, v4, Landroid/media/MediaScanner;->mFilesUri:Landroid/net/Uri;
    ...
    iget-object v0, v4, Landroid/media/MediaScanner;->mMediaInserter:Landroid/media/MediaInserter;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->access$900(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    # getter for: Landroid/media/MediaScanner;->mMtpObjectHandle:I
    invoke-static {v5}, Landroid/media/MediaScanner;->access$300(Landroid/media/MediaScanner;)I
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mFilesUri:Landroid/net/Uri;
    ...
    iget-boolean v4, v4, Landroid/media/MediaScanner;->mWasEmptyPriorToScan:Z
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mDefaultNotificationFilename:Ljava/lang/String;
    ...
    iget-object v5, v5, Landroid/media/MediaScanner;->mDefaultNotificationFilename:Ljava/lang/String;

    move-object/from16 v0, p0

    invoke-virtual {v0, v4, v5}, Landroid/media/MediaScanner$MyMediaScannerClient;->doesPathHaveFilename(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;

    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/MediaScanner$MyMediaScannerClient;->this$0:Landroid/media/MediaScanner;

    iget-object v5, v5, Landroid/media/MediaScanner;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v1, v2, v3}, Landroid/media/MediaScanner$MyMediaScannerClient;->setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    invoke-static {v4, v5}, Landroid/media/MediaScanner;->access$1102(Landroid/media/MediaScanner;Z)Z
    ...
    iget-object v0, v4, Landroid/media/MediaScanner;->mAudioUri:Landroid/net/Uri;
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mDefaultRingtoneFilename:Ljava/lang/String;
    ...
    iget-object v5, v5, Landroid/media/MediaScanner;->mDefaultRingtoneFilename:Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Landroid/media/MediaScanner;->access$1202(Landroid/media/MediaScanner;Z)Z
    ...
    invoke-static {v4, v5}, Landroid/media/MediaScanner;->access$1302(Landroid/media/MediaScanner;Z)Z
...
.method protected getFileTypeFromDrm(Ljava/lang/String;)I
    ...
    invoke-virtual {v2}, Landroid/media/MediaScanner;->isDrmEnabled()Z
    ...
    invoke-static {v2}, Landroid/media/MediaScanner;->access$1500(Landroid/media/MediaScanner;)Landroid/drm/DrmManagerClient;
    ...
    iget-object v4, v4, Landroid/media/MediaScanner;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Landroid/drm/DrmManagerClient;-><init>(Landroid/content/Context;)V

    # setter for: Landroid/media/MediaScanner;->mDrmManagerClient:Landroid/drm/DrmManagerClient;
    invoke-static {v2, v3}, Landroid/media/MediaScanner;->access$1502(Landroid/media/MediaScanner;Landroid/drm/DrmManagerClient;)Landroid/drm/DrmManagerClient;
...
.method public handleStringTag(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_d
    invoke-virtual {p0, p2, v2, v2}, Landroid/media/MediaScanner$MyMediaScannerClient;->parseSubstring(Ljava/lang/String;II)I
...
.method protected parseSubstring(Ljava/lang/String;II)I
    .locals 8
...
.method protected setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    .locals 3
