...
public class PhoneWindow extends Window implements Callback {
    ...
    /* renamed from: com.android.internal.policy.impl.PhoneWindow.1 */
    ...
    /* renamed from: com.android.internal.policy.impl.PhoneWindow.2 */
    class C00222 implements OnDismissedListener {
        C00222() {
        }
    ...
    /* renamed from: com.android.internal.policy.impl.PhoneWindow.3 */
    class C00233 implements OnSwipeProgressChangedListener {
    ...
    private static class ColorViewState {
        ...
        ColorViewState(int systemUiHideFlag, int translucentFlag, int verticalGravity, String transitionName, int id, int hideWindowFlag) {
            this.view = null;
            this.targetVisibility = PhoneWindow.FLAG_RESOURCE_SET_ICON_FALLBACK;
            this.id = id;
    ...
    private final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        class C00252 implements Runnable {
            ...
            C00252(ColorViewState colorViewState) {
                this.val$state = colorViewState;
            }

            public void run() {
                this.val$state.view.setAlpha(1.0f);
                this.val$state.view.setVisibility(PhoneWindow.FLAG_RESOURCE_SET_ICON_FALLBACK);
            }
        }
        ...
        public DecorView(Context context, int featureId) {
            ...
            this.mBarEnterExitDuration = context.getResources().getInteger(17694880);
        }
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            ...
            if (isDown) {
                return PhoneWindow.this.onKeyDown(this.mFeatureId, event.getKeyCode(), event);
            }
            return PhoneWindow.this.onKeyUp(this.mFeatureId, event.getKeyCode(), event);
        }

        public boolean dispatchKeyShortcutEvent(KeyEvent ev) {
            if (PhoneWindow.this.mPreparedPanel == null || !PhoneWindow.this.performPanelShortcut(PhoneWindow.this.mPreparedPanel, ev.getKeyCode(), ev, (int) PhoneWindow.FLAG_RESOURCE_SET_ICON)) {
                Window.Callback cb = PhoneWindow.this.getCallback();
                ...
                if (st != null && PhoneWindow.this.mPreparedPanel == null) {
                    ...
                    handled = PhoneWindow.this.performPanelShortcut(st, ev.getKeyCode(), ev, (int) PhoneWindow.FLAG_RESOURCE_SET_ICON);
        ...
        public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
            ...
            return super.dispatchApplyWindowInsets(insets.replaceSystemWindowInsets(insets.getSystemWindowInsetLeft(), insets.getSystemWindowInsetTop(), insets.getSystemWindowInsetRight(), (int) PhoneWindow.this.mOutsetBottom.getDimension(getContext().getResources().getDisplayMetrics())));
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (PhoneWindow.this.mOutsetBottom != null) {
                ...
                if (mode != 0) {
                    heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec) + ((int) PhoneWindow.this.mOutsetBottom.getDimension(metrics)), mode);
                }
            }
            ...
            if (mode != null) {
                ...
                if (this.mActionModeView == null) {
                    if (PhoneWindow.this.isFloating()) {
                        ...
                        this.mShowActionModePopup = new C00241();
                    } else {
                        ViewStub stub = (ViewStub) findViewById(16909175);
                        if (stub != null) {
        ...
        private WindowInsets updateColorViews(WindowInsets insets, boolean animate) {
            ...
            if (!PhoneWindow.this.mIsFloating && ActivityManager.isHighEndGfx()) {
                ...
                int access$1700 = PhoneWindow.this.mStatusBarColor;
                ...
                access$1700 = PhoneWindow.this.mNavigationBarColor;
            ...
            if (PhoneWindow.this.mContentRoot != null && (PhoneWindow.this.mContentRoot.getLayoutParams() instanceof MarginLayoutParams)) {
                MarginLayoutParams lp = (MarginLayoutParams) PhoneWindow.this.mContentRoot.getLayoutParams();
        ...
        private void updateColorViewInt(ColorViewState state, int sysUiVis, int color, int height, boolean animate) {
            ...
            if (visibilityChanged) {
                ...
                if (!animate) {
                    ...
                    view.animate().alpha(0.0f).setInterpolator(this.mHideInterpolator).setDuration((long) this.mBarEnterExitDuration).withEndAction(new C00252(state));
                }
            }
        }
        ...
        private WindowInsets updateStatusGuard(WindowInsets insets) {
            ...
            if (this.mActionModeView != null && (this.mActionModeView.getLayoutParams() instanceof MarginLayoutParams)) {
                ...
                if (this.mActionModeView.isShown()) {
                    ...
                    boolean z = (((PhoneWindow.this.getLocalFeatures() & 1024) == 0 ? true : PhoneWindow.SWEEP_OPEN_MENU) && showStatusGuard) ? true : PhoneWindow.SWEEP_OPEN_MENU;
    ...
    private final class DialogMenuCallback implements Callback, MenuPresenter.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            Window.Callback callback = PhoneWindow.this.getCallback();
            return (callback == null || PhoneWindow.this.isDestroyed() || !callback.onMenuItemSelected(this.mFeatureId, item)) ? PhoneWindow.SWEEP_OPEN_MENU : true;
        }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C00261 implements Creator<SavedState> {
                C00261() {
                }
    ...
    static class RotationWatcher extends Stub {
        ...
        RotationWatcher() {
            this.mRotationChanged = new C00271();
    ...
    public PhoneWindow(Context context) {
        ...
        this.mUiOptions = 0;
        this.mInvalidatePanelMenuRunnable = new C00211();
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = SWEEP_OPEN_MENU;
                    lp = new LayoutParams(width, -2, st.f0x, st.f1y, 1003, 8519680, st.decorView.mDefaultOpacity);
                    if (st.isCompact) {
    ...
    L_0x058f:
        ...
        goto L_0x04d5;
    L_0x059a:
        r13 = 17367228; // 0x10900bc float:2.5163453E-38 double:8.5805507E-317;
        goto L_0x058f;
    L_0x059e:
        r25 = r9 & 36;
        if (r25 == 0) goto L_0x05ad;
    L_0x05a2:
        r0 = r9 & 256;
        r25 = r0;
        if (r25 != 0) goto L_0x05ad;
    ...
    L_0x061a:
        r0 = r9 & 256;
        r25 = r0;
        if (r25 == 0) goto L_0x062f;
    L_0x0620:
        r25 = 47;
        r26 = 17367221; // 0x10900b5 float:2.5163433E-38 double:8.5805473E-317;
        r0 = r25;
        r1 = r26;
    ...
    L_0x0644:
        r25 = r9 & 32;
        if (r25 == 0) goto L_0x065d;
    L_0x0648:
        r25 = 0;
        r0 = r28;
        r1 = r25;
        r16 = r0.getCircularProgressBar(r1);
        if (r16 == 0) goto L_0x065d;
    L_0x0654:
        r25 = 1;
        r0 = r16;
        r1 = r25;
    ...
    L_0x065d:
        r0 = r9 & 2048;
        r25 = r0;
        if (r25 == 0) goto L_0x0666;
    L_0x0663:
        r28.registerSwipeCallbacks();
    L_0x0666:
        r25 = r28.getContainer();
        if (r25 != 0) goto L_0x0702;
    L_0x066c:
        r0 = r28;
        r0 = r0.mBackgroundResource;
        r25 = r0;
        if (r25 == 0) goto L_0x070c;
    L_0x0674:
        r25 = r28.getContext();
        r0 = r28;
        r0 = r0.mBackgroundResource;
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            DecorContentParent decorContentParent = (DecorContentParent) this.mDecor.findViewById(16909180);
    ...
    private ProgressBar getCircularProgressBar(boolean shouldInstallDecor) {
        ...
        this.mCircularProgressBar = (ProgressBar) findViewById(16909178);
        if (this.mCircularProgressBar != null) {
    ...
    private ProgressBar getHorizontalProgressBar(boolean shouldInstallDecor) {
        ...
        this.mHorizontalProgressBar = (ProgressBar) findViewById(16909179);
        if (this.mHorizontalProgressBar != null) {
    ...
    private void registerSwipeCallbacks() {
        ...
        swipeDismiss.setOnDismissedListener(new C00222());
        swipeDismiss.setOnSwipeProgressChangedListener(new C00233());
    }
