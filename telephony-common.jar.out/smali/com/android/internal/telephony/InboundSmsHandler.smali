...
.field protected static final EVENT_DAN_SMS_COMPLETE:I = 0xb
...
.field static final INCOMPLETE_SELECT_DSDA:Ljava/lang/String; = "reference_number=? AND time=? AND sub_id=?"

.field static final PDU_COLUMN:I = 0x0

.field protected static final PDU_PROJECTION:[Ljava/lang/String;

.field protected static final PDU_SEQUENCE_PORT_ICC_PROJECTION:[Ljava/lang/String;
...
.field static final SELECT_BY_REFERENCE_DSDA:Ljava/lang/String; = "address=? AND reference_number=? AND count=? AND sub_id=?"

.field static final SEQUENCE_COLUMN:I = 0x1

.field static final SUBID_DSDA_COLUMN_NAME:Ljava/lang/String; = "sub_id"
...
.field final mSmsReceiveDisabled:Z
...
.field final mWapPush:Lcom/android/internal/telephony/WapPushOverSmsEx;
...
.method protected constructor <init>(Ljava/lang/String;Landroid/content/Context;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CellBroadcastHandler;)V
    ...
    .line 235
    new-instance v2, Lcom/android/internal/telephony/WapPushOverSmsEx;

    invoke-direct {v2, p2}, Lcom/android/internal/telephony/WapPushOverSmsEx;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/internal/telephony/InboundSmsHandler;->mWapPush:Lcom/android/internal/telephony/WapPushOverSmsEx;
...
.method addTrackerToRawTable(Lcom/android/internal/telephony/InboundSmsTracker;)I
    ...
    .line 1013
    .local v23, "subId":Ljava/lang/String;
    const/4 v2, 0x4
    ...
    .line 1014
    .local v12, "deleteWhereArgsInDSDA":[Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v12    # "deleteWhereArgsInDSDA":[Ljava/lang/String;
    ...
    .end local v23    # "subId":Ljava/lang/String;
    :cond_1
    :goto_2
    return v2
...
.method protected addTrackerToRawTableAndSendMessage(Lcom/android/internal/telephony/InboundSmsTracker;)I
    ...
    .line 744
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/InboundSmsHandler;->addTrackerToRawTable(Lcom/android/internal/telephony/InboundSmsTracker;)I
...
.method public abstract dispatchEx(Landroid/content/Intent;Ljava/lang/String;)V
.end method

.method public abstract dispatchEx(Landroid/content/Intent;Ljava/lang/String;Landroid/content/BroadcastReceiver;)V
.end method
...
.method public dispatchMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    .prologue
    .line 610
    const-string v0, "[sms.mt] dispatchMessage start ["
...
.method protected dispatchNormalMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    iput v1, v0, Lcom/android/internal/telephony/InboundSmsTracker;->mLgeSubId:I
    ...
    const-string v2, "dispatchNormalMessage(), [RED] tracker.mLgeSubId = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, v0, Lcom/android/internal/telephony/InboundSmsTracker;->mLgeSubId:I
...
.method protected abstract getStrMsgWhat(I)Ljava/lang/String;
.end method
...
.method protected onQuitting()V
    ...
    .prologue
    .line 277
    iget-object v0, p0, Lcom/android/internal/telephony/InboundSmsHandler;->mWapPush:Lcom/android/internal/telephony/WapPushOverSmsEx;

    invoke-virtual {v0}, Lcom/android/internal/telephony/WapPushOverSmsEx;->dispose()V
...
.method processMessagePart(Lcom/android/internal/telephony/InboundSmsTracker;)Z
    ...
    const-string v3, "[sms.mt] processMessagePart messageCount = ["
    ...
    .line 775
    const-string v2, "[sms.mt] single-part message"
    ...
    .line 836
    .local v9, "resultReceiver":Landroid/content/BroadcastReceiver;
    const/16 v2, 0xb84
    ...
    .line 839
    .local v11, "smscAddress":Ljava/lang/String;
    const-string v12, ""

    .line 840
    .local v12, "originatingAddress":Ljava/lang/String;
    const/16 v38, -0x1
    ...
    .line 851
    invoke-virtual/range {v32 .. v32}, Landroid/telephony/SmsMessage;->getOriginatingAddress()Ljava/lang/String;
    ...
    .line 778
    .end local v9    # "resultReceiver":Landroid/content/BroadcastReceiver;
    .end local v11    # "smscAddress":Ljava/lang/String;
    .end local v12    # "originatingAddress":Ljava/lang/String;
    .end local v20    # "arr$":[[B
    .end local v28    # "i$":I
    .end local v30    # "len$":I
    .end local v33    # "output":Ljava/io/ByteArrayOutputStream;
    .end local v34    # "pdu":[B
    .end local v35    # "pdus":[[B
    .end local v38    # "result":I
    :cond_2
    const-string v2, "[sms.mt] not single-part message"
    ...
    aput-object v19, v40, v2

    const/4 v2, 0x1

    aput-object v37, v40, v2

    const/4 v2, 0x2

    aput-object v23, v40, v2

    const/4 v2, 0x3

    aput-object v39, v40, v2

    .line 793
    .local v40, "whereArgsInDSDA":[Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v40    # "whereArgsInDSDA":[Ljava/lang/String;
    :cond_3
    :goto_3
    return v2
    ...
    .restart local v40    # "whereArgsInDSDA":[Ljava/lang/String;
    :cond_4
    :try_start_1
    move/from16 v0, v31
    ...
    .line 852
    .end local v24    # "cursor":Landroid/database/Cursor;
    .restart local v9    # "resultReceiver":Landroid/content/BroadcastReceiver;
    .restart local v11    # "smscAddress":Ljava/lang/String;
    .restart local v12    # "originatingAddress":Ljava/lang/String;
    .restart local v20    # "arr$":[[B
    .restart local v28    # "i$":I
    .restart local v30    # "len$":I
    .restart local v32    # "msg":Landroid/telephony/SmsMessage;
    .restart local v33    # "output":Ljava/io/ByteArrayOutputStream;
    .restart local v34    # "pdu":[B
    .restart local v35    # "pdus":[[B
    ...
    iget-object v7, v0, Lcom/android/internal/telephony/InboundSmsHandler;->mWapPush:Lcom/android/internal/telephony/WapPushOverSmsEx;
    ...
    invoke-virtual/range {v7 .. v12}, Lcom/android/internal/telephony/WapPushOverSmsEx;->dispatchWapPdu([BLandroid/content/BroadcastReceiver;Lcom/android/internal/telephony/InboundSmsHandler;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v2, v14}, Lcom/android/internal/telephony/uicc/UiccCard;->getCarrierPackageNamesForIntent(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {v0, v14, v1}, Lcom/android/internal/telephony/InboundSmsHandler;->setAndDirectIntent(Landroid/content/Intent;I)V
