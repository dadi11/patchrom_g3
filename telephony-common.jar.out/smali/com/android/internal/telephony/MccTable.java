...
public final class MccTable {
    ...
    private static boolean isDebuggingMccOverride() {
        if (!Build.IS_DEBUGGABLE || SystemProperties.get("persist.sys.override_mcc", "").isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    static {
        ...
        sTable.add(new MccEntry(PduHeaders.f15x6c1c9f85, "cz", 2));
        ...
        sTable.add(new MccEntry(630, Part.CONTENT_DISPOSITION, 2));
