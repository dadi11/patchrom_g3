...
public class Sms7BitEncodingTranslator {
    ...
    static {
        ...
        mIs7BitTranslationTableLoaded = DBG;
    ...
    private static boolean noTranslationNeeded(char c, boolean isCdmaFormat) {
        if (isCdmaFormat) {
            return (!GsmAlphabet.isGsmSeptets(c) || UserData.charToAscii.get(c, -1) == -1) ? DBG : true;
        } else {
    ...
    L_0x0013:
        r7 = 17891344; // 0x1110010 float:2.663234E-38 double:8.8394984E-317;
        r2 = r3.getXml(r7);
    L_0x001a:
        r7 = "SmsEnforce7BitTranslationTable";
        com.android.internal.util.XmlUtils.beginDocument(r2, r7);	 Catch:{ Exception -> 0x007a }
    L_0x001f:
        com.android.internal.util.XmlUtils.nextElement(r2);	 Catch:{ Exception -> 0x007a }
        r4 = r2.getName();	 Catch:{ Exception -> 0x007a }
        r7 = DBG;	 Catch:{ Exception -> 0x007a }
        if (r7 == 0) goto L_0x0042;
    L_0x002a:
        r7 = "Sms7BitEncodingTranslator";
        r8 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x007a }
        r8.<init>();	 Catch:{ Exception -> 0x007a }
        r9 = "tag: ";
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r8 = r8.append(r4);	 Catch:{ Exception -> 0x007a }
        r8 = r8.toString();	 Catch:{ Exception -> 0x007a }
        android.telephony.Rlog.d(r7, r8);	 Catch:{ Exception -> 0x007a }
    L_0x0042:
        r7 = "TranslationType";
        r7 = r7.equals(r4);	 Catch:{ Exception -> 0x007a }
        if (r7 == 0) goto L_0x00c8;
    L_0x004a:
        r7 = 0;
        r8 = "Type";
        r6 = r2.getAttributeValue(r7, r8);	 Catch:{ Exception -> 0x007a }
        r7 = DBG;	 Catch:{ Exception -> 0x007a }
    ...
    L_0x0055:
        ...
        r9 = "type: ";
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r8 = r8.append(r6);	 Catch:{ Exception -> 0x007a }
        r8 = r8.toString();	 Catch:{ Exception -> 0x007a }
        android.telephony.Rlog.d(r7, r8);	 Catch:{ Exception -> 0x007a }
    L_0x006d:
        r7 = "common";
        r7 = r6.equals(r7);	 Catch:{ Exception -> 0x007a }
        if (r7 == 0) goto L_0x008a;
    L_0x0075:
        r7 = mTranslationTableCommon;	 Catch:{ Exception -> 0x007a }
        mTranslationTable = r7;	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x007a:
        r0 = move-exception;
        r7 = "Sms7BitEncodingTranslator";
        r8 = "Got exception while loading 7BitTranslationTable file.";
        android.telephony.Rlog.e(r7, r8, r0);	 Catch:{ all -> 0x0097 }
    ...
    L_0x0092:
        r7 = mTranslationTableGSM;	 Catch:{ Exception -> 0x007a }
        mTranslationTable = r7;	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x0097:
        r7 = move-exception;
    ...
    L_0x00a8:
        r7 = mTranslationTableCDMA;	 Catch:{ Exception -> 0x007a }
        mTranslationTable = r7;	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x00ae:
        r7 = "Sms7BitEncodingTranslator";
        r8 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x007a }
        r8.<init>();	 Catch:{ Exception -> 0x007a }
        r9 = "Error Parsing 7BitTranslationTable: found incorrect type";
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r8 = r8.append(r6);	 Catch:{ Exception -> 0x007a }
        r8 = r8.toString();	 Catch:{ Exception -> 0x007a }
        android.telephony.Rlog.e(r7, r8);	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x00c8:
        r7 = "Character";
        r7 = r7.equals(r4);	 Catch:{ Exception -> 0x007a }
    ...
    L_0x00d0:
        r7 = mTranslationTable;	 Catch:{ Exception -> 0x007a }
        if (r7 == 0) goto L_0x012e;
    L_0x00d4:
        r7 = 0;
        r8 = "from";
        r9 = -1;
        r1 = r2.getAttributeUnsignedIntValue(r7, r8, r9);	 Catch:{ Exception -> 0x007a }
        r7 = 0;
        r8 = "to";
        r9 = -1;
        r5 = r2.getAttributeUnsignedIntValue(r7, r8, r9);	 Catch:{ Exception -> 0x007a }
    ...
    L_0x00ec:
        ...
        r9 = "Loading mapping ";
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r9 = java.lang.Integer.toHexString(r1);	 Catch:{ Exception -> 0x007a }
        r9 = r9.toUpperCase();	 Catch:{ Exception -> 0x007a }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r9 = " -> ";
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r9 = java.lang.Integer.toHexString(r5);	 Catch:{ Exception -> 0x007a }
        r9 = r9.toUpperCase();	 Catch:{ Exception -> 0x007a }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x007a }
        r8 = r8.toString();	 Catch:{ Exception -> 0x007a }
        android.telephony.Rlog.d(r7, r8);	 Catch:{ Exception -> 0x007a }
    L_0x011e:
        r7 = mTranslationTable;	 Catch:{ Exception -> 0x007a }
        r7.put(r1, r5);	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x0125:
        r7 = "Sms7BitEncodingTranslator";
        r8 = "Invalid translation table file format";
        android.telephony.Rlog.d(r7, r8);	 Catch:{ Exception -> 0x007a }
        goto L_0x001f;
    L_0x012e:
        r7 = DBG;	 Catch:{ Exception -> 0x007a }
    ...
    L_0x0132:
        r7 = "Sms7BitEncodingTranslator";
        r8 = "load7BitTranslationTableFromXml: parsing successful, file loaded";
        android.telephony.Rlog.d(r7, r8);	 Catch:{ Exception -> 0x007a }
    L_0x0139:
        r7 = r2 instanceof android.content.res.XmlResourceParser;
        if (r7 == 0) goto L_0x0089;
