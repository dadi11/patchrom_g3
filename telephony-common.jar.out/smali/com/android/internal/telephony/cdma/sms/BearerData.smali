...
.method public static calcTextEncodingDetails(Ljava/lang/CharSequence;Z)Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;
    ...
    const-string v5, "[BearerData] (2) ted="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    invoke-virtual {v3}, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->toString()Ljava/lang/String;
...
.method public static decode([BI)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    .end local v1    # "decodeSuccess":Z
    :sswitch_13
    invoke-static {v0, v4}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->decodeSessionInfo(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    ...
    .end local v1    # "decodeSuccess":Z
    :sswitch_14
    invoke-static {v0, v4}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->decodeResponseType(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
...
.method private static decodeCmasUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;I)V
    ...
    .line 2020
    .local v19, "inStream":Lcom/android/internal/util/BitwiseInputStream;
    ...
    const-string v24, "emergency CB with no CMAE_protocol_version"
    ...
    const-string v25, "unsupported CMAE_protocol_version "
    ...
    const-string v25, "skipping unsupported CMAS record type "
    ...
    .line 2051
    .local v18, "alertUserData":Lcom/android/internal/telephony/cdma/sms/UserData;
    const/4 v9, 0x5
    ...
    const-string v25, "unsupported CMAE character set.  "
    ...
    .line 2059
    .end local v20    # "numFields":I
    :pswitch_2
    add-int/lit8 v20, v22, -0x1

    .line 2060
    .restart local v20    # "numFields":I
    goto :goto_1
    ...
    .line 2090
    .end local v18    # "alertUserData":Lcom/android/internal/telephony/cdma/sms/UserData;
    .end local v20    # "numFields":I
    :pswitch_5
    const/16 v9, 0x8
    ...
    .line 2110
    invoke-static/range {v3 .. v8}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->decodeCmasExpires(IIIIII)J
    ...
    .line 2126
    .end local v22    # "recordLen":I
    .end local v23    # "recordType":I
    :cond_4
    ...
    invoke-direct/range {v9 .. v17}, Landroid/telephony/SmsCbCmasInfo;-><init>(IIIIIIJ)V
...
.method private static decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    ...
    invoke-static {v6, v3, v7}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->decodeKsc5601([BII)Ljava/lang/String;
...
.method public static encode(Lcom/android/internal/telephony/cdma/sms/BearerData;)[B
    ...
    .line 1100
    invoke-static {p0, v1}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->encodeMsgCenterTimeStamp(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseOutputStream;)V
...
.method private static encodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
    ...
    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/LGCdmaSmsBearerData;->encodeKsc5601(Ljava/lang/String;)[B
