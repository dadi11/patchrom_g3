...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SmsMessage newFromParcel(Parcel p) {
        ...
        for (index = (byte) 0; index < count; index += RETURN_ACK) {
        ...
        for (int index2 = RETURN_NO_ACK; index2 < countInt; index2 += RETURN_ACK) {
    ...
    protected void parseSms() {
        ...
        } else if (this.mBearerData.messageType != RETURN_ACK) {
