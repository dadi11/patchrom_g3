...
.method public isPermanentFail()Z
    ...
    .line 236
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->OPERATOR_BARRED:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->UNKNOWN_PDP_ADDRESS_TYPE:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->USER_AUTHENTICATION:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->ACTIVATION_REJECT_GGSN:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->SERVICE_OPTION_NOT_SUPPORTED:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->SERVICE_OPTION_NOT_SUBSCRIBED:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->NSAPI_IN_USE:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_3

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->PROTOCOL_ERRORS:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    .line 259
    iget-object v7, p0, Lcom/android/internal/telephony/dataconnection/DcFailCause;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->ONLY_IPV4_ALLOWED:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_5

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->ONLY_IPV6_ALLOWED:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->RADIO_POWER_OFF:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_5

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->TETHERED_CALL_ACTIVE:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_5

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->RADIO_NOT_AVAILABLE:Lcom/android/internal/telephony/dataconnection/DcFailCause;

    if-eq p0, v7, :cond_5

    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->UNACCEPTABLE_NETWORK_PARAMETER:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    :cond_7
    sget-object v7, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_FDN_DATA_CALL_BLOCK:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->ACTIVATION_REJECT_BY_FDN:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    .line 281
    :cond_8
    sget-object v7, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_PERMANENT_FAIL_TEL_AU:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->SIGNAL_LOST:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    sget-object v7, Lcom/android/internal/telephony/dataconnection/DcFailCause;->SM_NETWORK_FAILURE:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    .line 293
    :cond_a
    sget-object v7, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_REDEFINE_PERMANENT_CAUSE_EU:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 305
    :cond_c
    sget-object v7, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_IMS_RETRY_NO_USE_PERMANENTFAIL_ON_AFW:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 306
    const-string v7, "persist.data.lastused.numeric"
    ...
    const-string v7, "ril.current.datatech"
    ...
    .line 313
    const-string v6, "DcFailCause"

    const-string v7, "VZW has no permanent Fail on AP in LTE network. Throttling will be handle by Modem"
