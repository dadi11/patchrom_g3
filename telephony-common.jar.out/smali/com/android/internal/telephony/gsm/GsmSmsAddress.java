...
public class GsmSmsAddress extends SmsAddress {
    ...
    public boolean isCphsVoiceMessageIndicatorAddress() {
        return (this.origBytes[OFFSET_ADDRESS_LENGTH] & PduHeaders.STORE_STATUS_ERROR_END) == 4 && isAlphanumeric() && (this.origBytes[OFFSET_TOA] & 15) == 0;
    }

    public boolean isCphsVoiceMessageSet() {
        return isCphsVoiceMessageIndicatorAddress() && (this.origBytes[OFFSET_ADDRESS_VALUE] & PduHeaders.STORE_STATUS_ERROR_END) == 17;
    }

    public boolean isCphsVoiceMessageClear() {
        return isCphsVoiceMessageIndicatorAddress() && (this.origBytes[OFFSET_ADDRESS_VALUE] & PduHeaders.STORE_STATUS_ERROR_END) == 16;
    }
}
