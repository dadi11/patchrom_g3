...
class SmsCbHeader {
        ...
        if (pdu.length <= PDU_LENGTH_GSM) {
            ...
            if (!isEtwsMessage() || pdu.length > PDU_LENGTH_ETWS) {
                ...
                if (pdu.length > PDU_HEADER_LENGTH) {
                    warningSecurityInfo = Arrays.copyOfRange(pdu, PDU_HEADER_LENGTH, pdu.length);
                } else {
    ...
    boolean isEmergencyMessage() {
        return this.mMessageIdentifier >= SmsCbConstants.MESSAGE_ID_PWS_FIRST_IDENTIFIER && this.mMessageIdentifier <= SmsCbConstants.MESSAGE_ID_PWS_LAST_IDENTIFIER;
    }
    ...
    private boolean isCmasMessage() {
        return this.mMessageIdentifier >= SmsCbConstants.MESSAGE_ID_CMAS_FIRST_IDENTIFIER && this.mMessageIdentifier <= SmsCbConstants.MESSAGE_ID_CMAS_LAST_IDENTIFIER;
    }
