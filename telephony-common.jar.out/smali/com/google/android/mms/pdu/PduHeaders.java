...
public class PduHeaders {
    ...
    protected void setOctet(int value, int field) throws InvalidHeaderValueException {
        switch (field) {
            case STATUS_FORWARDED /*134*/:
            case READ_REPORT /*144*/:
            case REPORT_ALLOWED /*145*/:
            case SENDER_VISIBILITY /*148*/:
            case STORE /*162*/:
            case STORED /*167*/:
            case TOTALS /*169*/:
            case QUOTAS /*171*/:
            ...
            case ADAPTATION_ALLOWED /*188*/:
                if (!(VALUE_YES == value || VALUE_RELATIVE_TOKEN == value)) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case MESSAGE_TYPE_MBOX_STORE_CONF /*140*/:
                if (value < VALUE_YES || value > TO) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case MMS_VERSION /*141*/:
                if (value < MMS_VERSION_1_0 || value > MMS_VERSION_1_3) {
                    value = MMS_VERSION_1_2;
                    break;
                }
            case PRIORITY /*143*/:
                if (value < VALUE_YES || value > STATUS_REJECTED) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case RESPONSE_STATUS /*146*/:
                if (value <= RESPONSE_STATUS_ERROR_TRANSIENT_PARTIAL_SUCCESS || value >= STORE_STATUS_ERROR_PERMANENT_FAILURE) {
                    if ((value > RESPONSE_STATUS_ERROR_PERMANENT_LACK_OF_PREPAID && value <= STORE_STATUS_ERROR_END) || value < VALUE_YES || ((value > RESPONSE_STATUS_ERROR_UNSUPPORTED_MESSAGE && value < STORE_STATUS_ERROR_TRANSIENT_FAILURE) || value > STORE_STATUS_ERROR_END)) {
                ...
                break;
            case STATUS /*149*/:
                if (value < VALUE_YES || value > STATUS_UNREACHABLE) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case RETRIEVE_STATUS /*153*/:
                if (value <= RETRIEVE_STATUS_ERROR_TRANSIENT_NETWORK_PROBLEM || value >= STORE_STATUS_ERROR_PERMANENT_FAILURE) {
                    if (value <= STORE_STATUS_ERROR_PERMANENT_MESSAGE_NOT_FOUND || value > STORE_STATUS_ERROR_END) {
                        if (value < VALUE_YES || ((value > VALUE_YES && value < STORE_STATUS_ERROR_TRANSIENT_FAILURE) || value > STORE_STATUS_ERROR_END)) {
                            value = STORE_STATUS_ERROR_PERMANENT_FAILURE;
                            break;
                        }
                    }
            ...
            case REPLY_CHARGING /*156*/:
                if (value < VALUE_YES || value > STATUS_DEFERRED) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case MM_STATE /*163*/:
                if (value < VALUE_YES || value > STATUS_UNRECOGNIZED) {
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
            case STORE_STATUS /*165*/:
                if (value <= STORE_STATUS_ERROR_TRANSIENT_NETWORK_PROBLEM || value >= STORE_STATUS_ERROR_PERMANENT_FAILURE) {
                    if (value <= STORE_STATUS_ERROR_PERMANENT_MMBOX_FULL || value > STORE_STATUS_ERROR_END) {
                        if (value < VALUE_YES || ((value > VALUE_YES && value < STORE_STATUS_ERROR_TRANSIENT_FAILURE) || value > STORE_STATUS_ERROR_END)) {
                            value = STORE_STATUS_ERROR_PERMANENT_FAILURE;
                            break;
                        }
    ...
    protected void setTextString(byte[] value, int field) {
        ...
        switch (field) {
            case STATUS_DEFERRED /*131*/:
            case STATUS_UNRECOGNIZED /*132*/:
            case MESSAGE_TYPE_FORWARD_CONF /*138*/:
            case MESSAGE_TYPE_MBOX_STORE_REQ /*139*/:
    ...
    protected void setEncodedStringValue(EncodedStringValue value, int field) {
        ...
        switch (field) {
            case MESSAGE_TYPE_FORWARD_REQ /*137*/:
            case RESPONSE_TEXT /*147*/:
            case SUBJECT /*150*/:
    ...
    protected void setEncodedStringValues(EncodedStringValue[] value, int field) {
        ...
        switch (field) {
            case VALUE_RELATIVE_TOKEN /*129*/:
            case STATUS_REJECTED /*130*/:
            case TO /*151*/:
    ...
    protected void setLongInteger(long value, int field) {
        switch (field) {
            case STATUS_INDETERMINATE /*133*/:
            case STATUS_UNREACHABLE /*135*/:
            case RESPONSE_STATUS_ERROR_UNSUPPORTED_MESSAGE /*136*/:
            case MESSAGE_TYPE_MBOX_VIEW_CONF /*142*/:
