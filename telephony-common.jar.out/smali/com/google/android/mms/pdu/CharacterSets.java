...
public class CharacterSets {
    ...
    static {
        ...
        MIBENUM_NUMBERS = new int[]{ANY_CHARSET, US_ASCII, ISO_8859_1, ISO_8859_2, ISO_8859_3, ISO_8859_4, ISO_8859_5, ISO_8859_6, ISO_8859_7, ISO_8859_8, ISO_8859_9, SHIFT_JIS, UTF_8, BIG5, UCS2, UTF_16};
        ...
        if ($assertionsDisabled || MIBENUM_NUMBERS.length == MIME_NAMES.length) {
            ...
            for (int i = ANY_CHARSET; i <= count; i++) {
