...
public class PduComposer {
    ...
    static {
        ...
        for (int i = PDU_COMPOSE_SUCCESS; i < PduContentTypes.contentTypes.length; i += PDU_PHONE_NUMBER_ADDRESS_TYPE) {
    ...
    private int makeReadRecInd() {
        ...
        if (appendHeader(PduPart.P_COMMENT) == 0) {
            return PDU_COMPOSE_SUCCESS;
        }
        return PDU_PHONE_NUMBER_ADDRESS_TYPE;
    }
    ...
    private int makeMessageBody() {
        ...
        String contentType = new String(this.mPduHeader.getTextString(PduHeaders.STATUS_UNRECOGNIZED));
