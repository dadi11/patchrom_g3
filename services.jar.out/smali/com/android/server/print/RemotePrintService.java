...
final class RemotePrintService implements DeathRecipient {
    ...
    class AnonymousClass10 implements Runnable {
        ...
        AnonymousClass10(PrinterId printerId) {
    ...
    /* renamed from: com.android.server.print.RemotePrintService.1 */
    ...
    class C04862 implements Runnable {
        ...
        C04862(PrintJobInfo printJobInfo) {
    ...
    class C04873 implements Runnable {
        ...
        C04873(PrintJobInfo printJobInfo) {
            this.val$printJob = printJobInfo;
        }
    ...
    /* renamed from: com.android.server.print.RemotePrintService.4 */
    ...
    /* renamed from: com.android.server.print.RemotePrintService.5 */
    ...
    class C04906 implements Runnable {
    ...
    /* renamed from: com.android.server.print.RemotePrintService.7 */
    ...
    class C04928 implements Runnable {
        final /* synthetic */ List val$printerIds;

        C04928(List list) {
            this.val$printerIds = list;
        }
    ...
    class C04939 implements Runnable {
        final /* synthetic */ PrinterId val$printerId;

        C04939(PrinterId printerId) {
            this.val$printerId = printerId;
        }
    ...
    private void handleOnAllPrintJobsHandled() {
        ...
        if (isBound()) {
            ...
            ensureBound();
            this.mPendingCommands.add(new C04851());
        } else {
            ensureUnbound();
        }
    }
    ...
    private void handleRequestCancelPrintJob(PrintJobInfo printJob) {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04862(printJob));
    }
    ...
    private void handleOnPrintJobQueued(PrintJobInfo printJob) {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04873(printJob));
    }
    ...
    private void handleCreatePrinterDiscoverySession() {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04884());
    }
    ...
    private void handleDestroyPrinterDiscoverySession() {
        ...
        if (isBound()) {
            ...
            ensureBound();
            this.mPendingCommands.add(new C04895());
        } else {
            ensureUnbound();
        }
    }
    ...
    private void handleStartPrinterDiscovery(List<PrinterId> priorityList) {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04906(priorityList));
    }
    ...
    private void handleStopPrinterDiscovery() {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04917());
    }
    ...
    private void handleValidatePrinters(List<PrinterId> printerIds) {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04928(printerIds));
    }
    ...
    private void handleStartPrinterStateTracking(PrinterId printerId) {
        ...
        ensureBound();
        this.mPendingCommands.add(new C04939(printerId));
    }
