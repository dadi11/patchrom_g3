...
public final class RemoteDisplayProviderWatcher {
    ...
    /* renamed from: com.android.server.media.RemoteDisplayProviderWatcher.1 */
    class C03831 extends BroadcastReceiver {
        C03831() {
        }
    ...
    /* renamed from: com.android.server.media.RemoteDisplayProviderWatcher.2 */
    ...
    public RemoteDisplayProviderWatcher(Context context, Callback callback, Handler handler, int userId) {
        ...
        this.mScanPackagesReceiver = new C03831();
        this.mScanPackagesRunnable = new C03842();
