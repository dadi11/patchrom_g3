...
public final class MediaRouterService extends Stub implements Monitor {
    ...
    /* renamed from: com.android.server.media.MediaRouterService.1 */
    ...
    static final class UserHandler extends Handler implements Callback, RemoteDisplayProviderProxy.Callback {
        ...
        private void updateDiscoveryRequest() {
            ...
            boolean activeScan = MediaRouterService.DEBUG;
    ...
    final class UserRecord {
        ...
        class C03751 implements Runnable {
            ...
            C03751(PrintWriter printWriter, String str) {
        ...
        public void dump(PrintWriter pw, String prefix) {
            ...
            if (!this.mHandler.runWithScissors(new C03751(pw, indent), 1000)) {
    ...
    public void systemRunning() {
        this.mContext.registerReceiver(new C03741(), new IntentFilter("android.intent.action.USER_SWITCHED"));
        switchUser();
    }
