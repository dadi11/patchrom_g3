...
public final class MediaProjectionManagerService extends SystemService implements Monitor {
    ...
    class C03851 implements DeathRecipient {
        final /* synthetic */ IMediaProjectionWatcherCallback val$callback;

        C03851(IMediaProjectionWatcherCallback iMediaProjectionWatcherCallback) {
            this.val$callback = iMediaProjectionWatcherCallback;
        }
    ...
    private final class BinderService extends Stub {
        ...
        public boolean hasProjectionPermission(int uid, String packageName) {
            ...
            try {
                int i = (checkPermission(packageName, "android.permission.CAPTURE_VIDEO_OUTPUT") || MediaProjectionManagerService.this.mAppOps.noteOpNoThrow(46, uid, packageName) == 0) ? 1 : 0;
                boolean hasPermission = false | i;
        ...
        public MediaProjectionInfo getActiveProjectionInfo() {
            ...
            long token = Binder.clearCallingIdentity();
            try {
                MediaProjectionInfo access$700 = MediaProjectionManagerService.this.getActiveProjectionInfo();
                return access$700;
            } finally {
                Binder.restoreCallingIdentity(token);
            }
    ...
    private final class MediaProjection extends IMediaProjection.Stub {
        ...
        class C03861 implements DeathRecipient {
            final /* synthetic */ IMediaProjectionCallback val$callback;

            C03861(IMediaProjectionCallback iMediaProjectionCallback) {
                this.val$callback = iMediaProjectionCallback;
            }
        ...
        public void start(IMediaProjectionCallback callback) {
            ...
            synchronized (MediaProjectionManagerService.this.mLock) {
                ...
                try {
                    ...
                    this.mDeathEater = new C03861(callback);
    ...
    private void addCallback(IMediaProjectionWatcherCallback callback) {
        DeathRecipient deathRecipient = new C03851(callback);
        synchronized (this.mLock) {
    ...
    private MediaProjectionInfo getActiveProjectionInfo() {
        ...
        synchronized (this.mLock) {
            if (this.mProjectionGrant == null) {
                ...
                mediaProjectionInfo = this.mProjectionGrant.getProjectionInfo();
            }
        }
