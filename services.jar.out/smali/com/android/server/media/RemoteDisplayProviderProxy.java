...
final class RemoteDisplayProviderProxy implements ServiceConnection {
    ...
    /* renamed from: com.android.server.media.RemoteDisplayProviderProxy.1 */
    ...
    private final class Connection implements DeathRecipient {
        ...
        /* renamed from: com.android.server.media.RemoteDisplayProviderProxy.Connection.1 */
        ...
        /* renamed from: com.android.server.media.RemoteDisplayProviderProxy.Connection.2 */
        ...
        class C03823 implements Runnable {
            final /* synthetic */ RemoteDisplayState val$state;

            C03823(RemoteDisplayState remoteDisplayState) {
                this.val$state = remoteDisplayState;
            }
        ...
        public boolean register() {
            try {
                ...
                RemoteDisplayProviderProxy.this.mHandler.post(new C03801());
                return true;
        ...
        public void binderDied() {
            RemoteDisplayProviderProxy.this.mHandler.post(new C03812());
        }

        void postStateChanged(RemoteDisplayState state) {
            RemoteDisplayProviderProxy.this.mHandler.post(new C03823(state));
        }
    }
    ...
    public RemoteDisplayProviderProxy(Context context, ComponentName componentName, int userId) {
        this.mDisplayStateChanged = new C03791();
    ...
    private void bind() {
        if (!this.mBound) {
            ...
            try {
                this.mBound = this.mContext.bindServiceAsUser(service, this, 1, new UserHandle(this.mUserId));
