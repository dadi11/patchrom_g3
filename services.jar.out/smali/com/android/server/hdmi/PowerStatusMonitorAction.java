...
public class PowerStatusMonitorAction extends HdmiCecFeatureAction {
    ...
    class C03121 implements SendMessageCallback {
    ...
    private void queryPowerStatus() {
        ...
        for (HdmiDeviceInfo info : deviceInfos) {
            ...
            sendCommand(HdmiCecMessageBuilder.buildGiveDevicePowerStatus(getSourceAddress(), logicalAddress), new C03121(logicalAddress));
        }
