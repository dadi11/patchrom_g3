...
final class HdmiLogger {
    ...
    private static final ThreadLocal<HdmiLogger> sLogger;
    ...
    private static void increaseLogCount(HashMap<String, Pair<Long, Integer>> cache, String message) {
        ...
        if (timing != null) {
            cache.put(message, new Pair(timing.first, Integer.valueOf(((Integer) timing.second).intValue() + 1)));
        }
    }
