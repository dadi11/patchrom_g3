...
final class DeviceDiscoveryAction extends HdmiCecFeatureAction {
    ...
    class C02731 implements DevicePollingCallback {
        C02731() {
        }
    ...
    boolean start() {
        ...
        pollDevices(new C02731(), 131073, STATE_WAITING_FOR_DEVICE_POLLING);
        return true;
    }
    ...
    private void handleReportPhysicalAddress(HdmiCecMessage cmd) {
        ...
        current.mDeviceType = params[STATE_WAITING_FOR_PHYSICAL_ADDRESS] & 255;
    ...
    private void wrapUpAndFinish() {
        ...
        while (i$.hasNext()) {
            HdmiDeviceInfo cecDeviceInfo = ((DeviceInfo) i$.next()).toHdmiDeviceInfo();
