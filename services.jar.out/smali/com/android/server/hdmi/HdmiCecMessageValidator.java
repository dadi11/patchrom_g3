...
public final class HdmiCecMessageValidator {
    ...
    private class ReportPhysicalAddressValidator implements ParameterValidator {
        ...
        public int isValid(byte[] params) {
            ...
            if (HdmiCecMessageValidator.this.isValidPhysicalAddress(params, HdmiCecMessageValidator.OK) && HdmiCecMessageValidator.isValidType(params[HdmiCecMessageValidator.ERROR_DESTINATION])) {
                z = true;
            }
    ...
    private class RoutingChangeValidator implements ParameterValidator {
        ...
        public int isValid(byte[] params) {
            ...
            if (HdmiCecMessageValidator.this.isValidPhysicalAddress(params, HdmiCecMessageValidator.OK) && HdmiCecMessageValidator.this.isValidPhysicalAddress(params, HdmiCecMessageValidator.ERROR_DESTINATION)) {
                z = true;
            }
            return HdmiCecMessageValidator.toErrorCode(z);
        }
    ...
    public HdmiCecMessageValidator(HdmiControlService service) {
        ...
        addValidationInfo(DumpState.DUMP_PROVIDERS, new RoutingChangeValidator(), 6);
        ...
        addValidationInfo(255, noneValidator, ERROR_SOURCE);
        ...
        addValidationInfo(137, maxLengthValidator, 5);
    ...
    static boolean isValidType(int type) {
        return type >= 0 && type <= 7 && type != ERROR_DESTINATION;
    }
