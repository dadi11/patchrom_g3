...
public class NativeDaemonEvent {
    ...
    private NativeDaemonEvent(int cmdNumber, int code, String message, String rawEvent, String logMessage) {
    ...
    private static boolean isClassUnsolicited(int code) {
        return code >= NetdResponseCode.InterfaceChange && code < VoldResponseCode.FstrimCompleted;
    }
    ...
    public static NativeDaemonEvent parseRawEvent(String rawEvent) {
        ...
        try {
            ...
            return new NativeDaemonEvent(cmdNumber, code, rawEvent.substring(skiplength), rawEvent, logMessage);
