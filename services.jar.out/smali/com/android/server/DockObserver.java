...
final class DockObserver extends SystemService {
    ...
    /* renamed from: com.android.server.DockObserver.2 */
    class C00342 extends UEventObserver {
        C00342() {
        }
    ...
    private final class BinderService extends Binder {
        ...
        protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            ...
            try {
                synchronized (DockObserver.this.mLock) {
                    if (args != null) {
                        if (!(args.length == 0 || "-a".equals(args[DockObserver.MSG_DOCK_STATE_CHANGED]))) {
    ...
    public DockObserver(Context context) {
        ...
        this.mHandler = new C00331(true);
        this.mObserver = new C00342();
        this.mPowerManager = (PowerManager) context.getSystemService("power");
        this.mWakeLock = this.mPowerManager.newWakeLock(1, TAG);
        this.mAllowTheaterModeWakeFromDock = context.getResources().getBoolean(17956911);
        init();
    ...
    private void init() {
        ...
        synchronized (this.mLock) {
            try {
                ...
                setActualDockStateLocked(Integer.valueOf(new String(buffer, MSG_DOCK_STATE_CHANGED, file.read(buffer, MSG_DOCK_STATE_CHANGED, DumpState.DUMP_PREFERRED_XML)).trim()).intValue());
