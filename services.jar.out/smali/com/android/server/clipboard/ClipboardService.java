...
public class ClipboardService extends Stub {
    ...
    /* renamed from: com.android.server.clipboard.ClipboardService.1 */
...
*/
        ...
        r4 = r7.mUm;	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5 = 1;	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r1 = r4.getProfiles(r8, r5);	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        android.os.Binder.restoreCallingIdentity(r2);
    L_0x000e:
        return r1;
    L_0x000f:
        r0 = move-exception;
        r4 = "ClipboardService";	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5 = new java.lang.StringBuilder;	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5.<init>();	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r6 = "Remote Exception calling UserManager: ";	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5 = r5.append(r6);	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5 = r5.append(r0);	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r5 = r5.toString();	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        android.util.Slog.e(r4, r5);	 Catch:{ RemoteException -> 0x000f, all -> 0x002d }
        r1 = 0;
        android.os.Binder.restoreCallingIdentity(r2);
        goto L_0x000e;
    L_0x002d:
    ...
    public ClipboardService(Context context) {
        ...
        this.mContext.registerReceiver(new C01621(), userFilter);
        try {
            this.mSecurityBridge = (ClipboardManagerMonitor) getClass().getClassLoader().loadClass(SECURITY_BRIDGE_NAME).newInstance();
        } catch (Exception e2) {
            Slog.w(TAG, "No security bridge jar found, using default");
            this.mSecurityBridge = new ClipboardManagerMonitor();
        }
    }
    ...
    public void setPrimaryClip(ClipData clip, String callingPackage) {
        synchronized (this) {
            ...
            this.mSecurityBridge.notifyCopy(Binder.getCallingUid(), clip);
    ...
    public ClipData getPrimaryClip(String pkg) {
        ...
        synchronized (this) {
            if (this.mAppOps.noteOp(29, Binder.getCallingUid(), pkg) != 0) {
                ...
                if (!(clipData == null || true == this.mSecurityBridge.approvePasteRequest(Binder.getCallingUid(), clipData))) {
                    clipData = null;
                }
            }
        }
        ...
        synchronized (this) {
            if (this.mAppOps.checkOp(29, Binder.getCallingUid(), callingPackage) != 0) {
                ...
                if (getClipboard().primaryClip != null) {
                    z = this.mSecurityBridge.approvePasteRequest(Binder.getCallingUid(), getClipboard().primaryClip);
                }
            }
        }
        return z;
