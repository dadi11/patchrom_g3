...
public class AppWindowAnimator {
    ...
    static final Animation sDummyAnimation;
    boolean allDrawn;
    ...
    static {
        sDummyAnimation = new DummyAnimation();
    }
    ...
    private void stepThumbnailAnimation(long currentTime) {
        ...
        this.thumbnailTransformation.getMatrix().preTranslate((float) this.thumbnailX, (float) this.thumbnailY);
