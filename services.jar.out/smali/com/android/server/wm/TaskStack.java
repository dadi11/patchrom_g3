...
public class TaskStack {
    ...
    TaskStack(WindowManagerService service, int stackId) {
        ...
        EventLog.writeEvent(EventLogTags.WM_STACK_CREATED, new Object[]{Integer.valueOf(stackId), Integer.valueOf(this.mBounds.left), Integer.valueOf(this.mBounds.top), Integer.valueOf(this.mBounds.right), Integer.valueOf(this.mBounds.bottom)});
    }
    ...
    void addTask(Task task, boolean toTop) {
        ...
        if (toTop) {
            ...
            if (!this.mService.isCurrentProfileLocked(task.mUserId)) {
                ...
                } while (this.mService.isCurrentProfileLocked(((Task) this.mTasks.get(stackNdx)).mUserId));
                stackNdx++;
            }
        } else {
            stackNdx = 0;
    ...
    private long getDimBehindFadeDuration(long duration) {
        ...
        this.mService.mContext.getResources().getValue(18022400, tv, true);
        if (tv.type == 6) {
    ...
    void setAnimationBackground(WindowStateAnimator winAnimator, int color) {
        ...
        if (this.mAnimationBackgroundAnimator == null || animLayer < this.mAnimationBackgroundAnimator.mAnimLayer) {
            ...
            this.mAnimationBackgroundSurface.show(this.mService.adjustAnimationBackground(winAnimator) - 1, ((float) ((color >> 24) & 255)) / 255.0f, 0);
        }
    }
