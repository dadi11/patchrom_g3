...
public final class FakeWindowImpl implements FakeWindow {
    ...
    public FakeWindowImpl(WindowManagerService service, Looper looper, Factory inputEventReceiverFactory, String name, int windowType, int layoutParamsFlags, boolean canReceiveKeys, boolean hasFocus, boolean touchFullscreen) {
    ...
    private int getLayerLw(int windowType) {
        return (this.mService.mPolicy.windowTypeToLayerLw(windowType) * ProcessList.PSS_TEST_MIN_TIME_FROM_STATE_CHANGE) + ProcessList.PSS_SAFE_TIME_FROM_STATE_CHANGE;
    }
}
