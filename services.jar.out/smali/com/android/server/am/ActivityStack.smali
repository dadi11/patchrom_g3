...
.field static final NOTIFY_TASK_VZW_OFFLOADING_START_MSG:I = 0x6d
...
.field static final SCHEDULE_TO_SLEEP_ACTIVITY_MSG:I = 0x6c
...
.field protected mLastScreenshotActivity:Lcom/android/server/am/ActivityRecord;

.field protected mLastScreenshotBitmap:Landroid/graphics/Bitmap;
...
.field final mSplitMngr:Lcom/android/server/am/SplitWindowManager;
...
.field protected mUndrawnActivitiesBelowTopTranslucent:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    .line 288
    sput-object v1, Lcom/android/server/am/ActivityStack;->sAMExtASNotiMethod:Ljava/lang/reflect/Method;

    .line 289
    sput-object v1, Lcom/android/server/am/ActivityStack;->sAMExtARNotiMethod:Ljava/lang/reflect/Method;
...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;)V
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v2, p0, v3}, Lcom/android/server/am/ActivityStack$ActivityStackHandler;-><init>(Lcom/android/server/am/ActivityStack;Landroid/os/Looper;)V
    ...
    .line 410
    iget v2, p1, Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;->mStackId:I

    iput v2, p0, Lcom/android/server/am/ActivityStack;->mStackId:I

    .line 411
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget v2, v2, Lcom/android/server/am/ActivityManagerService;->mCurrentUserId:I
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ActivityStackSupervisor;->getSplitMngr()Lcom/android/server/am/SplitWindowManager;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityStack;->mPowerManager:Landroid/os/PowerManager;
...
.method private adjustFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 2748
    sget-boolean v3, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;

    invoke-virtual {v3, p1}, Lcom/android/server/am/SplitWindowManager;->adjustFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v4, "adjustFocusedActivityLocked set focus to opposite stack"
...
.method private completePauseLocked(Z)V
    ...
    :cond_0
    :goto_0
    sget-boolean v7, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v7, :cond_1

    iget-object v7, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v7, v8}, Lcom/android/server/am/SplitWindowManager;->completePause(Lcom/android/server/am/ActivityRecord;)V
...
.method private completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/am/ActivityStack;->sendApplicationFocusGain(Ljava/lang/String;)V
...
.method private isStackVisible()Z
    ...
    invoke-virtual {v7, p0}, Lcom/android/server/am/SplitWindowManager;->isStackVisible(Lcom/android/server/am/ActivityStack;)Z
...
.method private removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 3301
    .local v0, "hay2":Ljava/lang/String;
    const-string v2, "user.WelcomeActivity"
    ...
    invoke-direct {p0, v2}, Lcom/android/server/am/ActivityStack;->triggerApkDelete(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackTaskToTop(I)V

    .line 3319
    :cond_2
    invoke-virtual {p0, v1}, Lcom/android/server/am/ActivityStack;->removeTask(Lcom/android/server/am/TaskRecord;)V
...
.method private triggerApkDelete(Ljava/lang/String;)V
    .locals 4
    ...
    const-string v3, "[LGE][SBP] ActivityStack:: user.WelcomeActivity is "
    ...
    .line 1014
    .local v0, "triggerProp":Ljava/lang/String;
    const-string v1, "0"
    ...
    const-string v2, "[LGE][SBP] ActivityStack:: Check sleep or not"
    ...
    const-string v3, "[LGE][SBP] ActivityStack:: WelcomeActivity ["
    ...
    const-string v3, "]. set prop as 1 ApkDelete triggerd"
    ...
    const-string v2, "[LGE][SBP] ActivityStack:: Sleep. Do Nothing"
    ...
    const-string v3, "[LGE][SBP] ActivityStack:: prop is ["
...
.method final activityStoppedLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Landroid/os/PersistableBundle;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v7, p1}, Landroid/os/Handler;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v3, v5}, Lcom/android/server/am/ActivityManagerService;->notifyTaskPersisterLocked(Lcom/android/server/am/TaskRecord;Z)V
    ...
    invoke-virtual {p1, v2, p4}, Lcom/android/server/am/ActivityRecord;->updateThumbnail(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V

    .line 1047
    :cond_2
    iget-boolean v2, p1, Lcom/android/server/am/ActivityRecord;->stopped:Z
    ...
    iget-object v2, v2, Lcom/android/server/am/ActivityStackSupervisor$ActivityDisplay;->mVisibleBehindActivity:Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v2, p1, v5}, Lcom/android/server/am/ActivityStackSupervisor;->requestVisibleBehindLocked(Lcom/android/server/am/ActivityRecord;Z)Z
    ...
    :goto_1
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-virtual {v2, v3, v4, v5}, Landroid/os/PowerManager;->notifyActivityState(III)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Exception thrown during send state to powermanager : "
    ...
    invoke-virtual {p0, p1, v6, v2}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/am/ActivityStackSupervisor;->updatePreviousProcessLocked(Lcom/android/server/am/ActivityRecord;)V
...
.method checkAllActivityIsFinishingInTask(Lcom/android/server/am/TaskRecord;)Z
    .locals 4
    .param p1, "task"    # Lcom/android/server/am/TaskRecord;
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)V
    ...
    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mTranslucentActivityWaiting:Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mUndrawnActivitiesBelowTopTranslucent:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/am/ActivityStack;->notifyActivityDrawnLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-object v14, v0, Lcom/android/server/am/ActivityStack;->mTranslucentActivityWaiting:Lcom/android/server/am/ActivityRecord;

    .line 1348
    :cond_2
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mHandler:Landroid/os/Handler;
    ...
    :goto_1
    sget-boolean v14, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v14, :cond_4

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v14, v13, v0, v1}, Lcom/android/server/am/SplitWindowManager;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;I)V
    ...
    iget-object v3, v11, Lcom/android/server/am/TaskRecord;->mActivities:Ljava/util/ArrayList;
    ...
    iget-boolean v14, v10, Lcom/android/server/am/ActivityRecord;->mLaunchTaskBehind:Z
    ...
    invoke-virtual {v0, v10, v14}, Lcom/android/server/am/ActivityStack;->ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    invoke-virtual {v10, v14, v0}, Lcom/android/server/am/ActivityRecord;->startFreezingScreenLocked(Lcom/android/server/am/ProcessRecord;I)V
    ...
    invoke-direct {v0, v10, v14}, Lcom/android/server/am/ActivityStack;->setVisibile(Lcom/android/server/am/ActivityRecord;Z)V
    ...
    invoke-virtual {v14, v10, v15, v0}, Lcom/android/server/am/ActivityStackSupervisor;->startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V

    .line 1470
    :cond_f
    :goto_5
    iget v14, v10, Lcom/android/server/am/ActivityRecord;->configChangeFlags:I

    or-int p2, p2, v14

    .line 1472
    iget-boolean v14, v10, Lcom/android/server/am/ActivityRecord;->fullscreen:Z
    ...
    invoke-virtual {v14}, Lcom/android/server/am/ActivityManagerService;->isSleeping()Z
    ...
    invoke-virtual {v14}, Lcom/android/server/am/ActivityManagerService;->isGoingToSleep()Z
    ...
    .line 1411
    const-string v14, "service.keyguard.status"
    ...
    const-string v16, "force to schedule visibility for update layout when sleeping... "
    ...
    iget-object v15, v10, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;
    ...
    iput-boolean v15, v14, Lcom/android/server/am/ProcessRecord;->pendingUiClean:Z
    ...
    invoke-interface/range {v14 .. v16}, Landroid/app/IApplicationThread;->scheduleWindowVisibility(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v14, v8, v0, v1}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z
    :try_end_0
    ...
    invoke-virtual {v10, v14}, Lcom/android/server/am/ActivityRecord;->stopFreezingScreenLocked(Z)V

    .line 1435
    :try_start_1
    iget-object v14, v10, Lcom/android/server/am/ActivityRecord;->returningOptions:Landroid/app/ActivityOptions;
    ...
    iget-object v0, v10, Lcom/android/server/am/ActivityRecord;->returningOptions:Landroid/app/ActivityOptions;

    move-object/from16 v16, v0

    invoke-interface/range {v14 .. v16}, Landroid/app/IApplicationThread;->scheduleOnNewActivityOptions(Landroid/os/IBinder;Landroid/app/ActivityOptions;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    const-string v16, "Exception thrown making visibile."
    ...
    iput-boolean v14, v10, Lcom/android/server/am/ActivityRecord;->visible:Z
    ...
    invoke-virtual {v10, v14}, Lcom/android/server/am/ActivityRecord;->updateOptionsLocked(Landroid/app/ActivityOptions;)V
    ...
    iput-boolean v14, v10, Lcom/android/server/am/ActivityRecord;->sleeping:Z
    ...
    iget-boolean v14, v10, Lcom/android/server/am/ActivityRecord;->frontOfTask:Z
    ...
    .line 1491
    sget-object v14, Lcom/android/server/am/ActivityStack$1;->$SwitchMap$com$android$server$am$ActivityStack$ActivityState:[I

    iget-object v15, v10, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;

    invoke-virtual {v15}, Lcom/android/server/am/ActivityStack$ActivityState;->ordinal()I
    ...
    const-string v16, "Exception thrown making hidden: "
    ...
    invoke-virtual {v14}, Lcom/android/server/am/ActivityStackSupervisor;->scheduleIdleLocked()V
    :try_end_4
...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    .line 4010
    :cond_6
    sget-boolean v5, Lcom/lge/config/ConfigBuildFlags;->CAPP_HIDENAV:Z
...
.method findActivityLocked(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v8, v4}, Lcom/android/server/am/ActivityManagerService;->checkCallMultiuserEnablePackage(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8}, Lcom/android/server/am/ActivityManagerService;->getCurrentUserIdLocked()I
...
.method findTaskLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .restart local v2    # "cls":Landroid/content/ComponentName;
    :cond_0
    iget-object v15, v4, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 579
    .local v8, "recordAffinity":Ljava/lang/String;
    if-eqz v8, :cond_1
    ...
    invoke-virtual {v15, v8}, Lcom/android/server/am/ActivityManagerService;->checkCallMultiuserEnablePackage(Ljava/lang/String;)Z
    ...
    invoke-virtual {v15}, Lcom/android/server/am/ActivityManagerService;->getCurrentUserIdLocked()I
    ...
    iget-object v15, v9, Lcom/android/server/am/TaskRecord;->voiceSession:Landroid/service/voice/IVoiceInteractionSession;
    ...
    iget-boolean v15, v7, Lcom/android/server/am/ActivityRecord;->finishing:Z

    if-nez v15, :cond_2

    iget v15, v7, Lcom/android/server/am/ActivityRecord;->userId:I

    if-ne v15, v14, :cond_2

    iget v15, v7, Lcom/android/server/am/ActivityRecord;->launchMode:I
    ...
    iget-object v1, v9, Lcom/android/server/am/TaskRecord;->affinityIntent:Landroid/content/Intent;
    ...
    .line 625
    .local v10, "taskDocumentData":Landroid/net/Uri;
    :goto_3
    if-nez v6, :cond_9

    if-nez v12, :cond_9

    iget-object v15, v9, Lcom/android/server/am/TaskRecord;->rootAffinity:Ljava/lang/String;
    ...
    .end local v9    # "task":Lcom/android/server/am/TaskRecord;
    .end local v10    # "taskDocumentData":Landroid/net/Uri;
    ...
    .restart local v9    # "task":Lcom/android/server/am/TaskRecord;
    .restart local v11    # "taskIntent":Landroid/content/Intent;
    :cond_7
    if-eqz v1, :cond_8
    ...
    .restart local v10    # "taskDocumentData":Landroid/net/Uri;
    goto :goto_3
    ...
    invoke-virtual {v15, v2}, Landroid/content/ComponentName;->compareTo(Landroid/content/ComponentName;)I
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v17, "moveTaskToBack: bad taskId="
    ...
    invoke-virtual {v15, v14}, Lcom/android/server/am/ActivityStackSupervisor;->endLockTaskModeIfTaskEnding(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v14}, Lcom/android/server/am/TaskRecord;->getTaskToReturnTo()I
    ...
    .line 3852
    .local v8, "prevTask":Lcom/android/server/am/TaskRecord;
    invoke-virtual {v14}, Lcom/android/server/am/TaskRecord;->getTaskToReturnTo()I

    move-result v15

    invoke-virtual {v8, v15}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V

    .line 3856
    .end local v8    # "prevTask":Lcom/android/server/am/TaskRecord;
    .end local v12    # "taskNdx":I
    :cond_3
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v14, v15}, Lcom/android/server/am/ActivityStack;->updateTaskMovement(Lcom/android/server/am/TaskRecord;Z)V
    ...
    iget-object v15, v11, Lcom/android/server/am/TaskRecord;->mActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11, v15}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    .restart local v10    # "runningTasks":I
    :cond_a
    move v7, v10
    ...
    iget-object v11, v15, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    iget-object v15, v15, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual {v15}, Lcom/android/server/am/ActivityManagerService;->isSleepingOrShuttingDown()Z
    ...
    iget-object v15, v0, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    .line 3915
    :cond_10
    sget-boolean v15, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v15, :cond_12

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v15, v0, v14}, Lcom/android/server/am/SplitWindowManager;->shouldResumeHome(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)Z
    ...
    const-string v16, "move this stack to back instead home rising."
    ...
    invoke-virtual {v15, v13, v0}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeStackTask(ILcom/android/server/am/ActivityRecord;)Z
...
.method moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V
    ...
    :cond_4
    invoke-virtual {p0, p1, v0, v8}, Lcom/android/server/am/ActivityStack;->sendAppStartedInfo(Lcom/android/server/am/TaskRecord;Landroid/content/Intent;Z)V
...
.method final moveToFront()V
    ...
    .line 554
    sget-boolean v0, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/am/ActivityStackSupervisor;->setFocusedStackForSplitWindow(Lcom/android/server/am/ActivityStack;)V
...
.method removeTask(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 4387
    invoke-virtual {v1, v6}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    iget-object v8, v8, Lcom/android/server/am/ActivityManagerService;->mTaskPersister:Lcom/android/server/am/TaskPersister;

    invoke-virtual {p1, v8}, Lcom/android/server/am/TaskRecord;->removedFromRecents(Lcom/android/server/am/TaskPersister;)V
    ...
    .line 4412
    .local v3, "resumeHome":Z
    sget-boolean v8, Lcom/android/server/am/ActivityStack;->CAPP_SPLITWINDOW:Z

    if-eqz v8, :cond_5

    iget-object v8, p0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v8, p0}, Lcom/android/server/am/SplitWindowManager;->removeStackAndNeedHomeResume(Lcom/android/server/am/ActivityStack;)Z
    ...
    :goto_2
    invoke-virtual {v8, v6}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStack(Z)V
...
.method final resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    :goto_1
    sget-boolean v3, Lcom/lge/config/ConfigBuildFlags;->CAPP_HIDENAV:Z
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/android/server/wm/WindowManagerService;->updateNavigationState(Ljava/lang/String;Landroid/os/IBinder;Landroid/content/ComponentName;)Z
    ...
    const-string v5, "check visiblity = "
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mSplitMngr:Lcom/android/server/am/SplitWindowManager;
    ...
    invoke-virtual {v3, v0, v4}, Lcom/android/server/am/SplitWindowManager;->shouldResumeHome(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)Z
    ...
    const-string v4, "unsplit it! instead resume home"
    ...
    .line 1733
    .local v19, "cr":Lcom/android/server/am/ActivityRecord;
    ...
    const-string v5, "resumeTopActivityLocked: Launching home next. r:"
    ...
    invoke-virtual {v3, v4, v0}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeStackTask(ILcom/android/server/am/ActivityRecord;)Z
    ...
    .line 1740
    .end local v19    # "cr":Lcom/android/server/am/ActivityRecord;
    :cond_13
    move-object/from16 v0, p0

    move-object/from16 v1, v20

    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->checkAllActivityIsFinishingInTask(Lcom/android/server/am/TaskRecord;)Z
    ...
    const-string v5, "resumeTopActivityLocked: Launching home next #2"
    ...
    const-string v5, "will unsplited instead of home upcoming Callers="
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-virtual {v3, v4, v5, v6}, Landroid/os/PowerManager;->notifyActivityState(III)V
    :try_end_1
    ...
    :goto_f
    :try_start_3
    sget-object v3, Lcom/android/server/am/ActivityStack;->sAMExtARNotiMethod:Ljava/lang/reflect/Method;
...
.method resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    .locals 1
    .param p1, "prev"    # Lcom/android/server/am/ActivityRecord;
...
.method resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    .locals 3
    .param p1, "prev"    # Lcom/android/server/am/ActivityRecord;
    .param p2, "options"    # Landroid/os/Bundle;
...
.method public sendAppStartedInfo(Lcom/android/server/am/TaskRecord;Landroid/content/Intent;Z)V
    ...
    .line 4511
    .local v4, "realPackageName":Ljava/lang/String;
    if-eqz v5, :cond_3

    iget-object v6, v5, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;
    ...
    const-string v8, "nezzimom intent is not null "
    ...
    const-string v6, "com.lge.android.intent.action.VZW_OFFLOADING_TASK_STARTED"

    invoke-direct {v1, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 4538
    .local v1, "intentOffloadingAppStarted":Landroid/content/Intent;
    const-string v6, "com.lge.intent.extra.PACKAGE_NAME"
...
.method startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/SplitWindowManager;->startActivityLocked(Lcom/android/server/am/ActivityRecord;)V
