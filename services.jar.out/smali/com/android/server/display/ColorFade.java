...
final class ColorFade {
    ...
    private static final class NaturalSurfaceLayout implements DisplayTransactionListener {
        ...
        public void onDisplayTransaction() {
            ...
            r6 = this;
            monitor-enter(r6);
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
        ...
        L_0x0006:
            return;
        L_0x0007:
            r1 = r6.mDisplayManagerInternal;	 Catch:{ all -> 0x0016 }
            r2 = r6.mDisplayId;	 Catch:{ all -> 0x0016 }
            r0 = r1.getDisplayInfo(r2);	 Catch:{ all -> 0x0016 }
            r1 = r0.rotation;	 Catch:{ all -> 0x0016 }
            switch(r1) {
        ...
        L_0x0019:
            ...
            r2 = 0;
            r3 = 0;
            r1.setPosition(r2, r3);	 Catch:{ all -> 0x0016 }
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
            r2 = 1065353216; // 0x3f800000 float:1.0 double:5.263544247E-315;
            r3 = 0;
            r4 = 0;
            r5 = 1065353216; // 0x3f800000 float:1.0 double:5.263544247E-315;
            r1.setMatrix(r2, r3, r4, r5);	 Catch:{ all -> 0x0016 }
            goto L_0x0014;
        L_0x002c:
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
            r2 = 0;
            r3 = r0.logicalHeight;	 Catch:{ all -> 0x0016 }
            r3 = (float) r3;	 Catch:{ all -> 0x0016 }
            r1.setPosition(r2, r3);	 Catch:{ all -> 0x0016 }
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
            r2 = 0;
        ...
        L_0x0041:
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
            r2 = r0.logicalWidth;	 Catch:{ all -> 0x0016 }
            r2 = (float) r2;	 Catch:{ all -> 0x0016 }
            r3 = r0.logicalHeight;	 Catch:{ all -> 0x0016 }
            r3 = (float) r3;	 Catch:{ all -> 0x0016 }
            r1.setPosition(r2, r3);	 Catch:{ all -> 0x0016 }
            r1 = r6.mSurfaceControl;	 Catch:{ all -> 0x0016 }
        ...
        L_0x0058:
            ...
            goto L_0x0014;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.display.ColorFade.NaturalSurfaceLayout.onDisplayTransaction():void");
        }
    }
    ...
    public boolean draw(float level) {
        ...
        try {
            ...
            drawFaded((-FloatMath.pow(one_minus_level, 2.0f)) + 1.0f, 1.0f / (((((0.5f * (cos < 0.0f ? -1.0f : 1.0f)) * FloatMath.pow(cos, 2.0f)) + 0.5f) * 0.9f) + 0.1f), FloatMath.pow(level, 4.0f), (((-FloatMath.pow(one_minus_level, 2.0f)) + 1.0f) * 0.1f) + 0.9f);
    ...
    private boolean createSurface() {
        ...
        try {
            ...
            z = this.mSurfaceLayout;
            z.onDisplayTransaction();
            return true;
