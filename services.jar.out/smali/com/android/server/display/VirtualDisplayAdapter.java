    ...
    private final class VirtualDisplayDevice extends DisplayDevice implements DeathRecipient {
        ...
        public void setSurfaceLocked(Surface surface) {
            ...
            if (!this.mStopped && this.mSurface != surface) {
                Object obj2 = this.mSurface != null ? PENDING_SURFACE_CHANGE : null;
                if (surface == null) {
                    obj = null;
                }
                if (obj2 != obj) {
        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            ...
            if (this.mInfo == null) {
                ...
                float[] fArr = new float[PENDING_SURFACE_CHANGE];
                fArr[0] = 60.0f;
                ...
                if ((this.mFlags & 16) != 0) {
                    ...
                    displayDeviceInfo = this.mInfo;
                    displayDeviceInfo.flags |= DumpState.DUMP_PROVIDERS;
                }
                if ((this.mFlags & 4) != 0) {
                    displayDeviceInfo = this.mInfo;
