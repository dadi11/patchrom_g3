...
public class SamplingProfilerService extends Binder {
    ...
    class C00781 extends FileObserver {
        final /* synthetic */ DropBoxManager val$dropbox;

        C00781(String x0, int x1, DropBoxManager dropBoxManager) {
            this.val$dropbox = dropBoxManager;
            super(x0, x1);
        }
    ...
    private void startWorking(Context context) {
        ...
        this.snapshotObserver = new C00781(SNAPSHOT_DIR, 4, dropbox);
