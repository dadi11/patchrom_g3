...
.method public declared-synchronized handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Lcom/android/server/DataServiceQualityMonitor;->log(Ljava/lang/String;)V
    ...
    :pswitch_0
    :try_start_1
    const-string v1, "EVENT_INTERNET_CHECK_REQUEST received"

    invoke-static {v1}, Lcom/android/server/DataServiceQualityMonitor;->log(Ljava/lang/String;)V

    .line 207
    sget-boolean v1, Lcom/android/server/DataServiceQualityMonitor;->mInternetcheckProgress:Z

    if-nez v1, :cond_0

    .line 208
    const-string v1, "try Internet connection check"
    ...
    :pswitch_1
    :try_start_2
    const-string v1, "EVENT_INTERNET_CHECK_ENABLE received"
    ...
    .line 220
    :pswitch_2
    const-string v3, "EVENT_SETTING_CHANGED_DCF received"

    invoke-static {v3}, Lcom/android/server/DataServiceQualityMonitor;->log(Ljava/lang/String;)V

    .line 221
    iget-object v3, p0, Lcom/android/server/DataServiceQualityMonitor;->mContext:Landroid/content/Context;
    ...
    const-string v2, "DCF enabled changed to : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Lcom/android/server/DataServiceQualityMonitor;->mDCFEnabled:Z
    ...
    .line 224
    sget-boolean v1, Lcom/android/server/DataServiceQualityMonitor;->mDCFEnabled:Z

    if-nez v1, :cond_0

    .line 225
    invoke-virtual {p0}, Lcom/android/server/DataServiceQualityMonitor;->disableDataServiceNotify()V
    ...
    .line 229
    :pswitch_3
    const-string v3, "EVENT_SETTING_CHANGED_DATA_ENABLED received"
    ...
    :goto_2
    sput-boolean v1, Lcom/android/server/DataServiceQualityMonitor;->mDataEnabled:Z
    ...
    const-string v2, "Data enabled changed to : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Lcom/android/server/DataServiceQualityMonitor;->mDataEnabled:Z
