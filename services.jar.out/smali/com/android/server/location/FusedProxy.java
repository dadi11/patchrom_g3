...
public final class FusedProxy {
    ...
    /* renamed from: com.android.server.location.FusedProxy.1 */
    ...
    private FusedProxy(Context context, Handler handler, IFusedLocationHardware locationHardware, int overlaySwitchResId, int defaultServicePackageNameResId, int initialPackageNameResId) {
        ...
        this.mServiceWatcher = new ServiceWatcher(context2, "FusedProxy", "com.android.location.service.FusedProvider", overlaySwitchResId, defaultServicePackageNameResId, initialPackageNameResId, new C03451(), handler);
    }
