...
.field protected static final GPS_STATUS_ENGINE_OFF:I = 0x4

.field protected static final GPS_STATUS_ENGINE_ON:I = 0x3
...
.field protected mDownloadXtraDataPending:I
...
.field protected mInjectNtpTimePending:I

.field private mLastFixTime:J

.field private mLgDdmStarted:Z
...
.field protected mSuplServerHost:Ljava/lang/String;

.field protected mSuplServerPort:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 373
    iput-boolean v3, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/location/GpsLocationProvider$11;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Handler;)V
...
.method static synthetic access$1800(Lcom/android/server/location/GpsLocationProvider;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3800(Lcom/android/server/location/GpsLocationProvider;Landroid/location/Location;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3900(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3902(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4000(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method private handleDownloadXtraData()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/location/GpsLocationProvider;->broadcastLguXtraDownload([B)V
...
.method private lgddmGPSEnabled(Z)V
    .locals 2
    .param p1, "enable"    # Z

    .prologue
    .line 1383
    iput-boolean p1, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z

    .line 1384
    new-instance v0, Landroid/content/Intent;

    const-string v1, "com.lge.location.GPS_ENABLE_CHANGE"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1385
    .local v0, "intent":Landroid/content/Intent;
    const-string v1, "GPS_ENABLE_EVENT"
...
.method private lgddmstartNavigating()V
    .locals 7
    ...
    const-string v3, "lgddmstartNavigating- mStarted ="
    ...
    const-string v3, ",mLgDdmStarted= "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    const-string v1, "lgddmstartNavigating - mEnabled =false"
    ...
    .line 1340
    :cond_1
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    const-string v1, "lgddmstartNavigating - already started"
    ...
    .line 1344
    :cond_3
    invoke-direct {p0, v6}, Lcom/android/server/location/GpsLocationProvider;->lgddmGPSEnabled(Z)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/server/location/GpsLocationProvider;->native_set_position_mode(IIIII)Z
    ...
    .line 1349
    invoke-direct {p0, v2}, Lcom/android/server/location/GpsLocationProvider;->lgddmGPSEnabled(Z)V

    .line 1350
    const-string v0, "GpsLocationProvider"

    const-string v1, "set_position_mode failed in lgddmstartNavigating()"
    ...
    const-string v1, "native_start failed in lgddmstartNavigating()"
...
.method private lgddmstopNavigating()V
    .locals 4
    ...
    const-string v2, "lgddmstopNavigating- mStarted ="
    ...
    const-string v2, ",mLgDdmStarted= "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    .line 1378
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/server/location/GpsLocationProvider;->lgddmGPSEnabled(Z)V
...
.method private startNavigating(Z)V
    ...
    const-string v2, " startNavigating send intent ,mNavigating ="
...
.method private stopNavigating()V
    ...
    iget-boolean v1, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    const-string v2, "stopNavigating -lgddm is already running"
...
.method protected handleEnable()V
    ...
    const-string v3, "handleEnable ( host?  "
...
.method protected native native_set_position_mode(IIIII)Z
.end method
...
.method protected reportStatus(I)V
    ...
    const-string v3, "mLgDdmStarted == true&& mNavigating == true, don\'t send intent "
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    sget-object v4, Lcom/android/server/location/GpsLocationProvider;->mVendorName:Ljava/lang/String;
    ...
    const-string v5, "sendExtraCommand:  command "
    ...
    .line 1236
    const-string v3, "lgddm_gps_start"
    ...
    .line 1237
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->lgddmstartNavigating()V
    ...
    .line 1238
    :cond_2
    const-string v3, "lgddm_gps_stop"
    ...
    .line 1239
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->lgddmstopNavigating()V
