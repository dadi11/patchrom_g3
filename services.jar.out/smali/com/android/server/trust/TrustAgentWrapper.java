...
public class TrustAgentWrapper {
    ...
    /* renamed from: com.android.server.trust.TrustAgentWrapper.1 */
    class C05181 extends BroadcastReceiver {
        C05181() {
        }
    ...
    /* renamed from: com.android.server.trust.TrustAgentWrapper.2 */
    class C05192 extends Handler {
        C05192() {
        }
            ...
            switch (msg.what) {
                case TrustAgentWrapper.MSG_GRANT_TRUST /*1*/:
                    if (TrustAgentWrapper.this.isConnected()) {
                        ...
                        TrustAgentWrapper.this.mTrustManagerService.mArchive.logGrantTrust(TrustAgentWrapper.this.mUserId, TrustAgentWrapper.this.mName, TrustAgentWrapper.this.mMessage != null ? TrustAgentWrapper.this.mMessage.toString() : null, durationMs, initiatedByUser);
    ...
    /* renamed from: com.android.server.trust.TrustAgentWrapper.3 */
    class C05203 extends Stub {
        C05203() {
        }

        public void grantTrust(CharSequence userMessage, long durationMs, boolean initiatedByUser) {
            int i;
            Handler access$100 = TrustAgentWrapper.this.mHandler;
            if (initiatedByUser) {
                i = TrustAgentWrapper.MSG_GRANT_TRUST;
            } else {
                i = 0;
            }
            Message msg = access$100.obtainMessage(TrustAgentWrapper.MSG_GRANT_TRUST, i, 0, userMessage);
        ...
        public void setManagingTrust(boolean managingTrust) {
            ...
            access$100.obtainMessage(TrustAgentWrapper.MSG_MANAGING_TRUST, i, 0).sendToTarget();
        }
        ...
        public void onConfigureCompleted(boolean result, IBinder token) {
            ...
            access$100.obtainMessage(TrustAgentWrapper.MSG_SET_TRUST_AGENT_FEATURES_COMPLETED, i, 0, token).sendToTarget();
        }
    }

    /* renamed from: com.android.server.trust.TrustAgentWrapper.4 */
    class C05214 implements ServiceConnection {
        C05214() {
        }
    ...
    public TrustAgentWrapper(Context context, TrustManagerService trustManagerService, Intent intent, UserHandle user) {
        this.mBroadcastReceiver = new C05181();
        this.mHandler = new C05192();
        this.mCallback = new C05203();
        this.mConnection = new C05214();
        ...
        scheduleRestart();
        this.mBound = context.bindServiceAsUser(intent, this.mConnection, MSG_GRANT_TRUST, user);
        if (!this.mBound) {
