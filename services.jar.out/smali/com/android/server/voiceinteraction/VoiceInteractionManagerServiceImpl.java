...
class VoiceInteractionManagerServiceImpl {
    ...
    /* renamed from: com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl.1 */
    ...
    /* renamed from: com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl.2 */
    class C05542 implements ServiceConnection {
        C05542() {
        }
    ...
    VoiceInteractionManagerServiceImpl(Context context, Handler handler, Object lock, int userHandle, ComponentName service) {
        this.mBound = false;
        this.mBroadcastReceiver = new C05531();
        this.mConnection = new C05542();
        ...
        try {
            this.mInfo = new VoiceInteractionServiceInfo(context.getPackageManager(), service);
